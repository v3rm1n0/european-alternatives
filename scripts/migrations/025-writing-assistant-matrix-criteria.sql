...
VALUES
  ('writing-assistant', 'language_coverage', 'Language & Coverage', 'Sprachen & Abdeckung', 'Which languages and dialects are supported and at what depth.', 'Welche Sprachen und Dialekte in welcher Tiefe unterstuetzt werden.', 100),
  ...
  ('writing-assistant', 'ai_processing', 'AI & Processing Model', 'KI & Verarbeitungsmodell', 'How text analysis is performed, whether locally or in the cloud, and what AI technologies are used.', 'Wie die Textanalyse durchgefuehrt wird, ob lokal oder in der Cloud, und welche KI-Technologien verwendet werden.', 300),
  ...
  ('writing-assistant', 'privacy_data', 'Privacy & Data Handling', 'Datenschutz & Datenverarbeitung', 'How user text is processed, stored, and protected.', 'Wie Nutzertexte verarbeitet, gespeichert und geschuetzt werden.', 500),
  ('writing-assistant', 'customization', 'Customization & Teams', 'Anpassung & Teams', 'Personal dictionaries, style guides, terminology, team collaboration, and domain presets.', 'Persoenliche Woerterbuecher, Stilrichtlinien, Terminologie, Team-Zusammenarbeit und Fachbereichs-Vorlagen.', 600),
  ('writing-assistant', 'output_quality', 'Output & Feedback Quality', 'Ausgabe- & Feedback-Qualitaet', 'Quality and depth of suggestions, explanations, and correction behavior.', 'Qualitaet und Tiefe der Vorschlaege, Erklaerungen und Korrekturverhalten.', 700),
...
FROM (
  SELECT 'writing-assistant' AS category_id, 'language_coverage' AS group_key, 'supported_languages_count' AS criterion_key, 'Supported languages' AS label_en, 'Unterstuetzte Sprachen' AS label_de, 'enum' AS value_type, 'informational' AS semantics, 'optional' AS filter_mode, 1010 AS sort_order, 'How many languages the writing assistant supports.' AS help_text_en, 'Wie viele Sprachen die Schreibhilfe unterstuetzt.' AS help_text_de
  UNION ALL SELECT 'writing-assistant', 'language_coverage', 'german_support', 'German language support', 'Deutsche Sprachunterstuetzung', 'boolean', 'beneficial', 'must_match', 1020, 'Whether German language checking is supported.', 'Ob deutsche Sprachpruefung unterstuetzt wird.'
  UNION ALL SELECT 'writing-assistant', 'language_coverage', 'language_depth_model', 'Language check depth', 'Sprachpruefungstiefe', 'enum', 'tradeoff', 'optional', 1030, 'Depth of language analysis from basic spelling to full linguistic analysis.', 'Tiefe der Sprachanalyse von einfacher Rechtschreibung bis zur vollstaendigen linguistischen Analyse.'
  UNION ALL SELECT 'writing-assistant', 'language_coverage', 'dialect_variant_support', 'Dialect and variant support', 'Dialekt- und Variantenunterstuetzung', 'boolean', 'beneficial', 'optional', 1040, 'Whether regional dialects and language variants are supported.', 'Ob regionale Dialekte und Sprachvarianten unterstuetzt werden.'
  UNION ALL SELECT 'writing-assistant', 'language_coverage', 'specialized_terminology', 'Specialized terminology support', 'Unterstuetzung fuer Fachterminologie', 'boolean', 'informational', 'optional', 1050, 'Whether specialized terminology for medical, legal, or technical fields is supported.', 'Ob Fachterminologie fuer medizinische, juristische oder technische Bereiche unterstuetzt wird.'
  UNION ALL SELECT 'writing-assistant', 'writing_features', 'grammar_checking', 'Grammar checking', 'Grammatikpruefung', 'boolean', 'beneficial', 'must_match', 2010, 'Whether grammar checking is available.', 'Ob Grammatikpruefung verfuegbar ist.'
  UNION ALL SELECT 'writing-assistant', 'writing_features', 'spelling_checking', 'Spelling checking', 'Rechtschreibpruefung', 'boolean', 'beneficial', 'must_match', 2020, 'Whether spelling checking is available.', 'Ob Rechtschreibpruefung verfuegbar ist.'
  UNION ALL SELECT 'writing-assistant', 'writing_features', 'style_suggestions', 'Style suggestions', 'Stilvorschlaege', 'boolean', 'beneficial', 'optional', 2030, 'Whether writing style suggestions are provided.', 'Ob Stilvorschlaege fuer das Schreiben bereitgestellt werden.'
  ...
  UNION ALL SELECT 'writing-assistant', 'writing_features', 'plagiarism_detection', 'Plagiarism detection', 'Plagiatserkennung', 'boolean', 'informational', 'optional', 2060, 'Whether plagiarism detection is available.', 'Ob Plagiatserkennung verfuegbar ist.'
  UNION ALL SELECT 'writing-assistant', 'writing_features', 'paraphrasing_tool', 'Paraphrasing or rewrite tool', 'Umschreibungs- oder Umformulierungswerkzeug', 'boolean', 'informational', 'optional', 2070, 'Whether a paraphrasing or rewrite tool is available.', 'Ob ein Umschreibungs- oder Umformulierungswerkzeug verfuegbar ist.'
  UNION ALL SELECT 'writing-assistant', 'writing_features', 'auto_correction', 'Auto-correction', 'Autokorrektur', 'boolean', 'tradeoff', 'optional', 2080, 'Whether automatic correction without user confirmation is available.', 'Ob automatische Korrektur ohne Nutzerbestaetigung verfuegbar ist.'
  ...
  UNION ALL SELECT 'writing-assistant', 'ai_processing', 'llm_powered', 'LLM-powered features', 'LLM-basierte Funktionen', 'boolean', 'tradeoff', 'optional', 3020, 'Whether large language models are used for text analysis.', 'Ob grosse Sprachmodelle fuer die Textanalyse verwendet werden.'
  UNION ALL SELECT 'writing-assistant', 'ai_processing', 'offline_capability', 'Offline capability', 'Offline-Faehigkeit', 'boolean', 'beneficial', 'optional', 3030, 'Whether the tool can work without an internet connection.', 'Ob das Tool ohne Internetverbindung funktioniert.'
  ...
  UNION ALL SELECT 'writing-assistant', 'integration_access', 'browser_extension', 'Browser extension', 'Browser-Erweiterung', 'boolean', 'beneficial', 'optional', 4010, 'Whether a browser extension is available.', 'Ob eine Browser-Erweiterung verfuegbar ist.'
  UNION ALL SELECT 'writing-assistant', 'integration_access', 'office_suite_integration', 'Office suite integration', 'Office-Paket-Integration', 'multi_enum', 'informational', 'multi_select', 4020, 'Which office suites are supported.', 'Welche Office-Pakete unterstuetzt werden.'
  UNION ALL SELECT 'writing-assistant', 'integration_access', 'supported_platforms', 'Supported platforms', 'Unterstuetzte Plattformen', 'multi_enum', 'informational', 'multi_select', 4030, 'Which operating systems are supported.', 'Welche Betriebssysteme unterstuetzt werden.'
  UNION ALL SELECT 'writing-assistant', 'integration_access', 'mobile_keyboard', 'Mobile keyboard app', 'Mobile Tastatur-App', 'boolean', 'informational', 'optional', 4040, 'Whether a mobile keyboard integration is available.', 'Ob eine mobile Tastatur-Integration verfuegbar ist.'
  UNION ALL SELECT 'writing-assistant', 'integration_access', 'api_available', 'API available', 'API verfuegbar', 'boolean', 'beneficial', 'optional', 4050, 'Whether a developer API is available.', 'Ob eine Entwickler-API verfuegbar ist.'
  UNION ALL SELECT 'writing-assistant', 'integration_access', 'web_editor', 'Web editor', 'Web-Editor', 'boolean', 'beneficial', 'optional', 4060, 'Whether a standalone web-based editor is provided.', 'Ob ein eigenstaendiger webbasierter Editor bereitgestellt wird.'
  ...
  UNION ALL SELECT 'writing-assistant', 'privacy_data', 'encryption_in_transit', 'Encryption in transit', 'Verschluesselung bei Uebertragung', 'boolean', 'beneficial', 'optional', 5020, 'Whether text is encrypted during transmission.', 'Ob Texte bei der Uebertragung verschluesselt werden.'
  UNION ALL SELECT 'writing-assistant', 'privacy_data', 'on_premise_option', 'On-premise or self-hosted option', 'On-Premise- oder Self-Hosted-Option', 'boolean', 'tradeoff', 'optional', 5030, 'Whether an on-premise or self-hosted deployment is available.', 'Ob eine On-Premise- oder Self-Hosted-Installation verfuegbar ist.'
  ...
  UNION ALL SELECT 'writing-assistant', 'customization', 'personal_dictionary', 'Personal dictionary', 'Persoenliches Woerterbuch', 'boolean', 'beneficial', 'optional', 6010, 'Whether a personal dictionary for custom words is available.', 'Ob ein persoenliches Woerterbuch fuer benutzerdefinierte Woerter verfuegbar ist.'
  UNION ALL SELECT 'writing-assistant', 'customization', 'style_guide_support', 'Style guide support', 'Stilrichtlinien-Unterstuetzung', 'boolean', 'beneficial', 'optional', 6020, 'Whether custom or predefined style guides are supported.', 'Ob benutzerdefinierte oder vordefinierte Stilrichtlinien unterstuetzt werden.'
  UNION ALL SELECT 'writing-assistant', 'customization', 'team_shared_rules', 'Team-shared rules', 'Team-geteilte Regeln', 'boolean', 'informational', 'optional', 6030, 'Whether shared rules and dictionaries for teams are supported.', 'Ob geteilte Regeln und Woerterbuecher fuer Teams unterstuetzt werden.'
  UNION ALL SELECT 'writing-assistant', 'customization', 'terminology_database', 'Terminology database', 'Terminologie-Datenbank', 'boolean', 'informational', 'optional', 6040, 'Whether a terminology database for managing approved terms is available.', 'Ob eine Terminologie-Datenbank zur Verwaltung genehmigter Begriffe verfuegbar ist.'
  UNION ALL SELECT 'writing-assistant', 'customization', 'genre_domain_presets', 'Genre or domain presets', 'Genre- oder Fachbereichs-Vorlagen', 'boolean', 'informational', 'optional', 6050, 'Whether presets for academic, business, creative, or technical writing are available.', 'Ob Vorlagen fuer akademisches, geschaeftliches, kreatives oder technisches Schreiben verfuegbar sind.'
  UNION ALL SELECT 'writing-assistant', 'output_quality', 'explanation_depth', 'Explanation depth', 'Erklaerungstiefe', 'enum', 'tradeoff', 'optional', 7010, 'How detailed the rule explanations for corrections are.', 'Wie detailliert die Regelerklaerungen fuer Korrekturen sind.'
  UNION ALL SELECT 'writing-assistant', 'output_quality', 'suggestion_categories', 'Suggestion categories shown', 'Angezeigte Vorschlagskategorien', 'multi_enum', 'informational', 'multi_select', 7020, 'Which categories of suggestions are shown to the user.', 'Welche Kategorien von Vorschlaegen dem Nutzer angezeigt werden.'
  UNION ALL SELECT 'writing-assistant', 'output_quality', 'confidence_indicators', 'Confidence indicators', 'Konfidenzindikatoren', 'boolean', 'informational', 'optional', 7030, 'Whether the tool shows certainty levels for suggestions.', 'Ob das Tool Sicherheitsstufen fuer Vorschlaege anzeigt.'
  ...
  UNION ALL SELECT 'writing-assistant', 'openness_audit', 'security_audit', 'Independent security audit', 'Unabhaengiges Sicherheitsaudit', 'boolean', 'beneficial', 'optional', 8020, 'Whether an independent security audit has been completed.', 'Ob ein unabhaengiges Sicherheitsaudit durchgefuehrt wurde.'
  ...
  UNION ALL SELECT 'writing-assistant', 'openness_audit', 'community_contributions', 'Community contributions accepted', 'Community-Beitraege akzeptiert', 'boolean', 'informational', 'optional', 8040, 'Whether external contributions are accepted.', 'Ob externe Beitraege akzeptiert werden.'
  UNION ALL SELECT 'writing-assistant', 'pricing_fit', 'free_tier_available', 'Free tier available', 'Kostenlose Stufe verfuegbar', 'boolean', 'informational', 'optional', 9010, 'Whether a free tier is available without payment requirements.', 'Ob eine kostenlose Nutzungsstufe ohne Zahlungspflicht verfuegbar ist.'
  ...
  UNION ALL SELECT 'writing-assistant', 'pricing_fit', 'fit_profiles', 'Fit profiles', 'Eignungsprofile', 'multi_enum', 'informational', 'multi_select', 9040, 'Common user profiles the tool is well suited for.', 'Typische Nutzerprofile, fuer die das Tool gut geeignet ist.'
) AS d
...
FROM (
  ...
  UNION ALL SELECT 'writing-assistant', 'language_depth_model', 'full_linguistic', 'Full linguistic analysis', 'Vollstaendige linguistische Analyse', 'neutral', 40
  ...
  UNION ALL SELECT 'writing-assistant', 'gdpr_data_processing_location', 'eu_primary', 'EU primary', 'EU primaer', 'neutral', 20
  ...
  UNION ALL SELECT 'writing-assistant', 'explanation_depth', 'brief_explanation', 'Brief explanation', 'Kurze Erklaerung', 'neutral', 20
  ...
  UNION ALL SELECT 'writing-assistant', 'suggestion_categories', 'conciseness', 'Conciseness', 'Praegnanz', 'neutral', 50
  UNION ALL SELECT 'writing-assistant', 'suggestion_categories', 'tone', 'Tone', 'Tonalitaet', 'neutral', 60
  UNION ALL SELECT 'writing-assistant', 'source_model', 'open_source', 'Open source', 'Open Source', 'positive', 10
  UNION ALL SELECT 'writing-assistant', 'source_model', 'source_available', 'Source available', 'Quellcode verfuegbar', 'neutral', 20
  UNION ALL SELECT 'writing-assistant', 'source_model', 'partial_open', 'Partial open', 'Teilweise offen', 'neutral', 30
  UNION ALL SELECT 'writing-assistant', 'source_model', 'proprietary', 'Proprietary', 'Proprietaer', 'warning', 40
  ...
  UNION ALL SELECT 'writing-assistant', 'license_type', 'proprietary', 'Proprietary', 'Proprietaer', 'warning', 70
  ...
  UNION ALL SELECT 'writing-assistant', 'premium_features_scope', 'advanced_checks_paid', 'Advanced checks paid', 'Erweiterte Pruefungen kostenpflichtig', 'neutral', 20
