...
VALUES
  ('video-editing', 'editing_capabilities', 'Editing Capabilities', 'Bearbeitungsfähigkeiten', 'Core editing workflow features including timeline type, multi-track support, trimming precision, and clip manipulation.', 'Kernfunktionen des Bearbeitungs-Workflows einschließlich Zeitleistentyp, Mehrspur-Unterstützung, Schnittpräzision und Clip-Manipulation.', 100),
  ('video-editing', 'media_format_support', 'Media Format Support', 'Medienformat-Unterstützung', 'Input and output codec support, resolution capabilities, and handling of specialized footage formats.', 'Unterstützung für Ein- und Ausgabecodecs, Auflösungsfähigkeiten und Verarbeitung spezialisierter Aufnahmeformate.', 200),
  ...
  ('video-editing', 'audio_tools', 'Audio Tools', 'Audiowerkzeuge', 'Audio editing capabilities including mixing, effects processing, noise reduction, and voice recording features.', 'Audiobearbeitungsfähigkeiten einschließlich Mischung, Effektverarbeitung, Rauschunterdrückung und Sprachaufnahme-Funktionen.', 400),
  ('video-editing', 'performance_workflow', 'Performance & Workflow', 'Leistung & Workflow', 'Hardware acceleration, proxy editing, rendering pipeline, project management, and undo capabilities.', 'Hardwarebeschleunigung, Proxy-Bearbeitung, Rendering-Pipeline, Projektverwaltung und Rückgängig-Funktionen.', 500),
  ('video-editing', 'collaboration_sharing', 'Collaboration & Sharing', 'Zusammenarbeit & Teilen', 'Team collaboration features, review tools, direct publishing targets, and project file sharing formats.', 'Teamzusammenarbeit-Funktionen, Überprüfungswerkzeuge, Direktveröffentlichungsziele und Projektdatei-Freigabeformate.', 600),
  ('video-editing', 'platform_access', 'Platform & Access', 'Plattform & Zugriff', 'Supported operating systems, plugin extensibility, scripting automation, and offline editing support.', 'Unterstützte Betriebssysteme, Plugin-Erweiterbarkeit, Skript-Automatisierung und Offline-Bearbeitungs-Unterstützung.', 700),
  ...
  ('video-editing', 'openness_pricing', 'Openness & Pricing', 'Offenheit & Preise', 'Source code availability, software licensing, pricing structure, and target user profiles for the video editor.', 'Quellcode-Verfügbarkeit, Softwarelizenzierung, Preisstruktur und Zielgruppen-Benutzerprofile für den Videoeditor.', 900);
...
FROM (
  ...
  UNION ALL SELECT 'video-editing', 'media_format_support', 'max_export_resolution', 'Maximum export resolution', 'Maximale Exportauflösung', 'enum', 'informational', 'optional', 2030, 'The highest output resolution the editor can render to when exporting finished video projects.', 'Die höchste Ausgabeauflösung, in der der Editor fertige Videoprojekte rendern kann.'
  UNION ALL SELECT 'video-editing', 'media_format_support', 'hdr_support', 'HDR support', 'HDR-Unterstützung', 'boolean', 'informational', 'optional', 2040, 'Whether high dynamic range color spaces such as HDR10, HLG, or Dolby Vision are supported for editing and export.', 'Ob High-Dynamic-Range-Farbräume wie HDR10, HLG oder Dolby Vision für Bearbeitung und Export unterstützt werden.'
  UNION ALL SELECT 'video-editing', 'media_format_support', 'raw_footage_support', 'RAW footage support', 'RAW-Material-Unterstützung', 'boolean', 'informational', 'optional', 2050, 'Whether camera RAW formats such as Blackmagic RAW, RED R3D, or CinemaDNG can be imported and edited natively.', 'Ob Kamera-RAW-Formate wie Blackmagic RAW, RED R3D oder CinemaDNG nativ importiert und bearbeitet werden können.'
  UNION ALL SELECT 'video-editing', 'media_format_support', 'image_sequence_import', 'Image sequence import', 'Bildsequenz-Import', 'boolean', 'informational', 'optional', 2060, 'Whether numbered image sequences such as EXR or TIFF stacks can be imported as video clips on the timeline.', 'Ob nummerierte Bildsequenzen wie EXR- oder TIFF-Stapel als Videoclips auf der Zeitleiste importiert werden können.'
  UNION ALL SELECT 'video-editing', 'effects_compositing', 'builtin_video_effects', 'Built-in video effects', 'Integrierte Videöffekte', 'boolean', 'informational', 'optional', 3010, 'Whether the editor includes a library of built-in transitions, filters, and visual effects ready to use.', 'Ob der Editor eine Bibliothek mit integrierten Übergängen, Filtern und visuellen Effekten enthält.'
  UNION ALL SELECT 'video-editing', 'effects_compositing', 'color_grading', 'Color grading tools', 'Farbkorrektur-Werkzeuge', 'enum', 'informational', 'optional', 3020, 'The depth of color correction tools available, from basic brightness controls to professional-grade grading suites.', 'Die Tiefe der verfügbaren Farbkorrektur-Werkzeuge, von einfachen Helligkeitsreglern bis hin zu professionellen Grading-Suiten.'
  UNION ALL SELECT 'video-editing', 'effects_compositing', 'chroma_keying', 'Chroma keying (green screen)', 'Chroma-Keying (Greenscreen)', 'boolean', 'informational', 'optional', 3030, 'Whether the tool supports green or blue screen removal for compositing subjects over different backgrounds.', 'Ob das Werkzeug Grün- oder Bluescreen-Entfernung zum Compositing von Motiven vor verschiedenen Hintergründen unterstützt.'
  UNION ALL SELECT 'video-editing', 'effects_compositing', 'motion_tracking', 'Motion tracking', 'Bewegungsverfolgung', 'boolean', 'beneficial', 'optional', 3040, 'Whether the tool can track object movement in footage for stabilization, masking, or attaching effects to moving subjects.', 'Ob das Werkzeug Objektbewegungen im Material für Stabilisierung, Maskierung oder das Anheften von Effekten an bewegte Motive verfolgen kann.'
  ...
  UNION ALL SELECT 'video-editing', 'effects_compositing', 'title_graphics', 'Title & graphics editor', 'Titel- & Grafikeditor', 'enum', 'informational', 'optional', 3060, 'The complexity of the built-in titling system, from basic text overlays to a full motion graphics editor.', 'Die Komplexität des integrierten Titelsystems, von einfachen Texteinblendungen bis hin zu einem vollständigen Motion-Graphics-Editor.'
  UNION ALL SELECT 'video-editing', 'effects_compositing', 'ai_assisted_editing', 'AI-assisted editing', 'KI-gestützte Bearbeitung', 'multi_enum', 'informational', 'multi_select', 3070, 'AI-powered editing features such as automatic scene detection, auto-subtitles, smart reframing, or background removal.', 'KI-gestützte Bearbeitungsfunktionen wie automatische Szenenerkennung, Auto-Untertitel, intelligentes Reframing oder Hintergrundentfernung.'
  UNION ALL SELECT 'video-editing', 'audio_tools', 'audio_mixing', 'Audio mixing', 'Audiomischung', 'boolean', 'informational', 'optional', 4010, 'Whether the editor provides multi-channel audio mixing with per-track volume, panning, and level controls.', 'Ob der Editor Mehrkanal-Audiomischung mit Lautstärke-, Panning- und Pegelreglern pro Spur bietet.'
  UNION ALL SELECT 'video-editing', 'audio_tools', 'audio_effects', 'Built-in audio effects', 'Integrierte Audiöffekte', 'boolean', 'informational', 'optional', 4020, 'Whether built-in audio processing effects such as equalization, compression, reverb, or delay are included.', 'Ob integrierte Audiobearbeitungseffekte wie Equalizer, Kompression, Hall oder Verzögerung enthalten sind.'
  UNION ALL SELECT 'video-editing', 'audio_tools', 'noise_reduction', 'Noise reduction', 'Rauschunterdrückung', 'boolean', 'beneficial', 'optional', 4030, 'Whether the tool includes audio noise reduction or removal capabilities for cleaning up recorded dialogue and ambient sound.', 'Ob das Werkzeug Audiorausch-Reduktions- oder Entfernungsfunktionen zur Bereinigung aufgenommener Dialoge und Umgebungsgeräuschen enthält.'
  UNION ALL SELECT 'video-editing', 'audio_tools', 'voiceover_recording', 'Voice-over recording', 'Sprachaufnahme', 'boolean', 'informational', 'optional', 4040, 'Whether narration or commentary can be recorded directly into the timeline from within the editor.', 'Ob Erzählungen oder Kommentare direkt in die Zeitleiste innerhalb des Editors aufgenommen werden können.'
  ...
  UNION ALL SELECT 'video-editing', 'openness_pricing', 'pricing_model', 'Pricing model', 'Preismodell', 'enum', 'informational', 'optional', 9030, 'The pricing structure for obtaining and using the video editor, such as free, freemium, or subscription.', 'Die Preisstruktur für den Erwerb und die Nutzung des Videoeditors, wie kostenlos, Freemium oder Abonnement.'
  UNION ALL SELECT 'video-editing', 'openness_pricing', 'free_tier_available', 'Free tier available', 'Kostenlose Version verfügbar', 'boolean', 'informational', 'must_match', 9040, 'Whether a functional free version of the video editor is available without payment or time restrictions.', 'Ob eine funktionsfähige kostenlose Version des Videoeditors ohne Bezahlung oder Zeitbeschränkungen verfügbar ist.'
  UNION ALL SELECT 'video-editing', 'openness_pricing', 'fit_profiles', 'Fit profiles', 'Eignungsprofile', 'multi_enum', 'informational', 'multi_select', 9050, 'Target user profiles and roles the video editor is best suited for based on its features and workflow design.', 'Zielgruppen-Benutzerprofile und Rollen, für die der Videoeditor basierend auf seinen Funktionen und Workflow-Design am besten geeignet ist.'
) AS d
...
FROM (
  ...
  UNION ALL SELECT 'video-editing', 'color_grading', 'advanced', 'Scopes, LUTs, and secondary correction', 'Scopes, LUTs und Sekundärkorrektur', 'neutral', 30
  UNION ALL SELECT 'video-editing', 'color_grading', 'professional', 'Full professional grading', 'Vollständiges professionelles Grading', 'positive', 40
  ...
  UNION ALL SELECT 'video-editing', 'title_graphics', 'full_motion_graphics', 'Full motion graphics editor', 'Vollständiger Motion-Graphics-Editor', 'positive', 30
  ...
  UNION ALL SELECT 'video-editing', 'ai_assisted_editing', 'auto_reframe', 'Auto reframe (aspect ratio)', 'Automatisches Reframing (Seitenverhältnis)', 'neutral', 30
  ...
  UNION ALL SELECT 'video-editing', 'undo_history_depth', 'limited', 'Limited undo', 'Begrenztes Rückgängig', 'warning', 10
  UNION ALL SELECT 'video-editing', 'undo_history_depth', 'session', 'Session-length undo', 'Sitzungslanges Rückgängig', 'neutral', 20
  UNION ALL SELECT 'video-editing', 'undo_history_depth', 'unlimited', 'Unlimited/persistent undo', 'Unbegrenztes/dauerhaftes Rückgängig', 'positive', 30
  ...
  UNION ALL SELECT 'video-editing', 'project_sharing_format', 'proprietary_only', 'Proprietary only', 'Nur proprietär', 'warning', 10
  ...
  UNION ALL SELECT 'video-editing', 'data_processing_location', 'eu_primary', 'EU primary', 'EU primär', 'neutral', 20
  UNION ALL SELECT 'video-editing', 'data_processing_location', 'global', 'Global', 'Global', 'warning', 30
  UNION ALL SELECT 'video-editing', 'data_processing_location', 'local_device', 'Local device', 'Lokales Gerät', 'positive', 40
  ...
  UNION ALL SELECT 'video-editing', 'source_model', 'fully_open_source', 'Fully open source', 'Vollständig quelloffen', 'positive', 10
  UNION ALL SELECT 'video-editing', 'source_model', 'source_available', 'Source available', 'Quellcode verfügbar', 'neutral', 20
  UNION ALL SELECT 'video-editing', 'source_model', 'partially_open', 'Partially open', 'Teilweise offen', 'neutral', 30
  UNION ALL SELECT 'video-editing', 'source_model', 'proprietary', 'Proprietary', 'Proprietär', 'warning', 40
  ...
  UNION ALL SELECT 'video-editing', 'license_type', 'proprietary', 'Proprietary', 'Proprietär', 'neutral', 50
  ...
  UNION ALL SELECT 'video-editing', 'fit_profiles', 'educator', 'Educator', 'Pädagoge', 'neutral', 80
) AS d
