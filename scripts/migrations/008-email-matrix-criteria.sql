...
VALUES
  ...
  ('email', 'domains_identity', 'Domains & Identity', 'Domains & Identitaet', 'Custom domains, aliases, catch-all addresses, and domain authentication.', 'Eigene Domains, Aliasse, Catch-all-Adressen und Domain-Authentifizierung.', 300),
  ...
  ('email', 'encryption_privacy', 'Encryption & Privacy', 'Verschluesselung & Datenschutz', 'Mailbox encryption, E2EE, external secure mail, OpenPGP, trackers, and metadata.', 'Postfach-Verschluesselung, E2EE, sichere externe Mail, OpenPGP, Tracker und Metadaten.', 500),
  ...
  ('email', 'migration_portability', 'Migration & Portability', 'Migration & Portabilitaet', 'Import, export, forwarding, and account collection.', 'Import, Export, Weiterleitung und Abruf externer Konten.', 700),
  ('email', 'suite_productivity', 'Suite & Productivity', 'Suite & Produktivitaet', 'Calendar, contacts, suite scope, and collaboration features.', 'Kalender, Kontakte, Suite-Umfang und Zusammenarbeitsfunktionen.', 800),
...
FROM (
  ...
  UNION ALL SELECT 'email', 'service_plans', 'personal_mailbox_storage_gb', 'Personal mailbox storage (GB)', 'Postfachspeicher im Privattarif (GB)', 'number', 'informational', 'range', 1030, 'Documented mailbox storage included in a representative personal plan, measured in gigabytes.', 'Dokumentierter Postfachspeicher in einem repraesentativen Privattarif, gemessen in Gigabyte.'
  UNION ALL SELECT 'email', 'service_plans', 'max_attachment_size_mb', 'Maximum attachment size (MB)', 'Maximale Anhanggroesse (MB)', 'number', 'informational', 'range', 1040, 'Documented maximum size for one sent or received attachment.', 'Dokumentierte maximale Groesse eines gesendeten oder empfangenen Anhangs.'
  UNION ALL SELECT 'email', 'service_plans', 'pricing_model', 'Pricing model', 'Preismodell', 'enum', 'tradeoff', 'optional', 1050, 'How the service prices mailboxes, domains, usage, or infrastructure.', 'Wie der Dienst Postfaecher, Domains, Nutzung oder Infrastruktur bepreist.'
  UNION ALL SELECT 'email', 'access_protocols', 'webmail_available', 'Webmail available', 'Webmail verfuegbar', 'boolean', 'beneficial', 'optional', 2010, 'Whether mail can be read and managed through a browser or web app.', 'Ob Mail ueber einen Browser oder eine Web-App gelesen und verwaltet werden kann.'
  UNION ALL SELECT 'email', 'access_protocols', 'supported_apps', 'Supported apps', 'Unterstuetzte Apps', 'multi_enum', 'informational', 'multi_select', 2020, 'Maintained app platforms and access paths documented by the provider.', 'Vom Anbieter dokumentierte gepflegte App-Plattformen und Zugriffswege.'
  UNION ALL SELECT 'email', 'access_protocols', 'standard_mail_protocols', 'Standard mail protocols', 'Standard-Mailprotokolle', 'multi_enum', 'beneficial', 'multi_select', 2030, 'Standard or widely supported mail protocols available for clients.', 'Standardisierte oder breit unterstuetzte Mailprotokolle fuer Clients.'
  UNION ALL SELECT 'email', 'access_protocols', 'bridge_required_for_standard_clients', 'Bridge required for standard clients', 'Bridge fuer Standard-Clients erforderlich', 'boolean', 'risk', 'must_match', 2040, 'Whether standard IMAP or SMTP-style clients require a local or vendor bridge.', 'Ob Standard-Clients fuer IMAP oder SMTP eine lokale oder Anbieter-Bridge erfordern.'
  ...
  UNION ALL SELECT 'email', 'access_protocols', 'search_scope', 'Mail search scope', 'Umfang der Mail-Suche', 'enum', 'informational', 'optional', 2060, 'How mail search is supported for messages and encrypted mailboxes.', 'Wie die Mail-Suche fuer Nachrichten und verschluesselte Postfaecher unterstuetzt wird.'
  UNION ALL SELECT 'email', 'domains_identity', 'custom_domains', 'Custom domains', 'Eigene Domains', 'boolean', 'beneficial', 'must_match', 3010, 'Whether users can use their own domains for mailbox addresses.', 'Ob Nutzer eigene Domains fuer Postfachadressen verwenden koennen.'
  UNION ALL SELECT 'email', 'domains_identity', 'alias_support_model', 'Alias support model', 'Alias-Unterstuetzungsmodell', 'enum', 'tradeoff', 'optional', 3020, 'How additional email aliases are provided and limited.', 'Wie zusaetzliche E-Mail-Aliasse bereitgestellt und begrenzt werden.'
  UNION ALL SELECT 'email', 'domains_identity', 'alias_limit', 'Alias limit', 'Alias-Limit', 'number', 'informational', 'range', 3030, 'Documented maximum number of aliases for a representative account or mailbox.', 'Dokumentierte maximale Anzahl von Aliassen fuer ein repraesentatives Konto oder Postfach.'
  ...
  UNION ALL SELECT 'email', 'domains_identity', 'disposable_masked_aliases', 'Disposable or masked aliases', 'Wegwerf- oder Maskierungsaliasse', 'enum', 'tradeoff', 'optional', 3050, 'How the service supports disposable, masked, or privacy aliases.', 'Wie der Dienst Wegwerf-, Maskierungs- oder Datenschutzaliasse unterstuetzt.'
  UNION ALL SELECT 'email', 'domains_identity', 'domain_authentication_controls', 'Domain authentication controls', 'Domain-Authentifizierungskontrollen', 'multi_enum', 'beneficial', 'multi_select', 3060, 'Domain-level authentication and deliverability controls available to customers.', 'Domainweite Authentifizierungs- und Zustellbarkeitskontrollen fuer Kunden.'
  UNION ALL SELECT 'email', 'account_security', 'two_factor_auth', 'Two-factor authentication', 'Zwei-Faktor-Authentifizierung', 'boolean', 'beneficial', 'optional', 4010, 'Whether accounts can enable or require two-factor authentication.', 'Ob Konten Zwei-Faktor-Authentifizierung aktivieren oder erzwingen koennen.'
  UNION ALL SELECT 'email', 'account_security', 'hardware_security_key', 'Hardware security key support', 'Hardware-Sicherheitsschluessel', 'boolean', 'beneficial', 'optional', 4020, 'Whether accounts can use hardware security keys for login protection.', 'Ob Konten Hardware-Sicherheitsschluessel fuer den Anmeldeschutz verwenden koennen.'
  ...
  UNION ALL SELECT 'email', 'account_security', 'anti_abuse_protection', 'Spam, phishing, and malware controls', 'Spam-, Phishing- und Malware-Kontrollen', 'multi_enum', 'beneficial', 'multi_select', 4040, 'Inbound and outbound controls for spam, phishing, malware, and abusive mail.', 'Ein- und ausgehende Kontrollen fuer Spam, Phishing, Malware und missbraeuchliche Mail.'
  UNION ALL SELECT 'email', 'encryption_privacy', 'mailbox_encryption_model', 'Mailbox encryption model', 'Postfach-Verschluesselungsmodell', 'enum', 'tradeoff', 'must_match', 5010, 'How mailbox content encryption is documented for normal use.', 'Wie die Verschluesselung von Postfachinhalten fuer normale Nutzung dokumentiert ist.'
  UNION ALL SELECT 'email', 'encryption_privacy', 'e2ee_internal_default', 'E2EE within provider by default', 'E2EE innerhalb des Anbieters standardmaessig', 'boolean', 'beneficial', 'must_match', 5020, 'Whether same-provider messages are end-to-end encrypted by default.', 'Ob Nachrichten innerhalb des Anbieters standardmaessig Ende-zu-Ende-verschluesselt sind.'
  UNION ALL SELECT 'email', 'encryption_privacy', 'encrypted_external_email', 'Encrypted external email', 'Verschluesselte externe E-Mail', 'enum', 'tradeoff', 'optional', 5030, 'How encrypted messages can be sent to recipients outside the provider.', 'Wie verschluesselte Nachrichten an Empfaenger ausserhalb des Anbieters gesendet werden koennen.'
  UNION ALL SELECT 'email', 'encryption_privacy', 'openpgp_support', 'OpenPGP support', 'OpenPGP-Unterstuetzung', 'enum', 'tradeoff', 'optional', 5040, 'How OpenPGP is supported through built-in tools or external clients.', 'Wie OpenPGP ueber integrierte Werkzeuge oder externe Clients unterstuetzt wird.'
  UNION ALL SELECT 'email', 'encryption_privacy', 'tracker_remote_content_protection', 'Tracker and remote-content protection', 'Tracker- und Remote-Inhalte-Schutz', 'multi_enum', 'beneficial', 'multi_select', 5050, 'Controls for remote images, tracking pixels, proxies, and link tracking warnings.', 'Kontrollen fuer externe Bilder, Tracking-Pixel, Proxies und Link-Tracking-Warnungen.'
  ...
  UNION ALL SELECT 'email', 'data_location_compliance', 'data_region_model', 'Mailbox data region model', 'Datenregion-Modell fuer Postfaecher', 'enum', 'tradeoff', 'must_match', 6010, 'How mailbox storage location is selected or constrained.', 'Wie die Datenregion fuer Postfaecher ausgewaehlt oder eingeschraenkt wird.'
  UNION ALL SELECT 'email', 'data_location_compliance', 'eu_mailbox_storage_available', 'EU mailbox storage available', 'EU-Postfachspeicherung verfuegbar', 'boolean', 'beneficial', 'must_match', 6020, 'Whether mailbox storage in the European Union is available.', 'Ob EU-Postfachspeicherung verfuegbar ist.'
  UNION ALL SELECT 'email', 'data_location_compliance', 'hosting_infrastructure_model', 'Hosting infrastructure model', 'Hosting-Infrastrukturmodell', 'enum', 'informational', 'optional', 6030, 'The documented infrastructure model used to host mailbox data.', 'Das dokumentierte Hosting-Infrastrukturmodell fuer Postfachdaten.'
  UNION ALL SELECT 'email', 'data_location_compliance', 'data_processing_agreement', 'Data processing agreement available', 'AV-Vertrag verfuegbar', 'boolean', 'informational', 'optional', 6040, 'Whether a data processing agreement is available for customers.', 'Ob ein AV-Vertrag fuer Kunden verfuegbar ist.'
  UNION ALL SELECT 'email', 'data_location_compliance', 'compliance_profiles', 'Compliance profiles', 'Compliance-Profile', 'multi_enum', 'informational', 'multi_select', 6050, 'Documented compliance profiles or attestations relevant to email customers.', 'Dokumentierte Compliance-Profile oder Nachweise fuer E-Mail-Kunden.'
  UNION ALL SELECT 'email', 'migration_portability', 'migration_import_sources', 'Migration import sources', 'Quellen fuer Migrationsimport', 'multi_enum', 'informational', 'multi_select', 7010, 'Sources the service can import from during mailbox or account migration.', 'Quellen, aus denen der Dienst beim Migrationsimport fuer Postfaecher oder Konten importieren kann.'
  UNION ALL SELECT 'email', 'migration_portability', 'mailbox_export_available', 'Mailbox export available', 'Postfach-Export verfuegbar', 'enum', 'beneficial', 'optional', 7020, 'How users or admins can export mailbox contents.', 'Wie Nutzer oder Administratoren Postfachinhalte exportieren koennen.'
  UNION ALL SELECT 'email', 'migration_portability', 'contacts_calendar_export', 'Contacts and calendar export', 'Kontakte- und Kalenderexport', 'multi_enum', 'beneficial', 'multi_select', 7030, 'Documented export or sync formats for contacts and calendars.', 'Dokumentierte Export- oder Sync-Formate fuer Kontakte und Kalender.'
  ...
  UNION ALL SELECT 'email', 'suite_productivity', 'productivity_suite_scope', 'Productivity suite scope', 'Umfang der Produktivitaets-Suite', 'multi_enum', 'informational', 'multi_select', 8030, 'Productivity tools bundled with or tightly integrated into the email service.', 'Produktivitaets-Suite-Werkzeuge, die im E-Mail-Dienst enthalten oder eng integriert sind.'
  ...
  UNION ALL SELECT 'email', 'team_admin', 'admin_console', 'Admin console', 'Administrationskonsole', 'boolean', 'beneficial', 'optional', 9010, 'Whether an administrative console is available for teams or organizations.', 'Ob eine Administrationskonsole fuer Teams oder Organisationen verfuegbar ist.'
  ...
  UNION ALL SELECT 'email', 'team_admin', 'sso_available', 'SSO available', 'SSO verfuegbar', 'boolean', 'beneficial', 'optional', 9030, 'Whether single sign-on is available for team or business accounts.', 'Ob SSO fuer Team- oder Geschaeftskonten verfuegbar ist.'
  UNION ALL SELECT 'email', 'team_admin', 'audit_logs', 'Audit logs', 'Audit-Protokolle', 'boolean', 'beneficial', 'optional', 9040, 'Whether admins can view audit logs for email account and admin activity.', 'Ob Administratoren Audit-Protokolle fuer E-Mail-Konto- und Admin-Aktivitaeten einsehen koennen.'
  UNION ALL SELECT 'email', 'team_admin', 'retention_ediscovery', 'Retention and eDiscovery', 'Aufbewahrung und eDiscovery', 'enum', 'informational', 'optional', 9050, 'Whether retention, archive, legal hold, or eDiscovery workflows are available.', 'Ob Aufbewahrung, Archivierung, Legal Hold oder eDiscovery-Workflows verfuegbar sind.'
) AS d
...
FROM (
  ...
  UNION ALL SELECT 'email', 'service_model', 'encrypted_mailbox', 'Encrypted mailbox service', 'Verschluesselter Postfachdienst', 'positive', 20
  ...
  UNION ALL SELECT 'email', 'server_side_filters', 'rules_ui', 'Rules UI', 'Regeloberflaeche', 'positive', 30
  ...
  UNION ALL SELECT 'email', 'search_scope', 'encrypted_index', 'Encrypted index search', 'Verschluesselte Indexsuche', 'tradeoff', 30
  ...
  UNION ALL SELECT 'email', 'account_recovery_model', 'provider_reset', 'Provider reset', 'Anbieter-Ruecksetzung', 'neutral', 10
  ...
  UNION ALL SELECT 'email', 'account_recovery_model', 'recovery_key', 'Recovery key', 'Wiederherstellungsschluessel', 'positive', 30
  ...
  UNION ALL SELECT 'email', 'anti_abuse_protection', 'quarantine', 'Quarantine', 'Quarantaene', 'positive', 70
  UNION ALL SELECT 'email', 'mailbox_encryption_model', 'server_side_encryption', 'Server-side encryption', 'Serverseitige Verschluesselung', 'neutral', 10
  ...
  UNION ALL SELECT 'email', 'mailbox_encryption_model', 'client_side_user_keys', 'Client-side user keys', 'Clientseitige Nutzerschluessel', 'tradeoff', 40
  UNION ALL SELECT 'email', 'mailbox_encryption_model', 'external_client_encryption_required', 'External client encryption required', 'Externe Client-Verschluesselung erforderlich', 'warning', 50
  UNION ALL SELECT 'email', 'encrypted_external_email', 'none', 'None', 'Keine', 'neutral', 10
  UNION ALL SELECT 'email', 'encrypted_external_email', 'password_protected_portal', 'Password-protected portal', 'Passwortgeschuetztes Portal', 'tradeoff', 20
  ...
  UNION ALL SELECT 'email', 'encrypted_external_email', 'manual_key_exchange', 'Manual key exchange', 'Manueller Schluesselaustausch', 'tradeoff', 50
  ...
  UNION ALL SELECT 'email', 'openpgp_support', 'built_in_key_management', 'Built-in key management', 'Integrierte Schluesselverwaltung', 'positive', 30
  UNION ALL SELECT 'email', 'openpgp_support', 'key_import_export', 'Key import/export', 'Schluesselimport/-export', 'positive', 40
  ...
  UNION ALL SELECT 'email', 'metadata_protection_level', 'encrypted_subject', 'Encrypted subject support', 'Verschluesselte Betreffzeile', 'positive', 30
  ...
  UNION ALL SELECT 'email', 'data_region_model', 'country_specific', 'Country-specific storage', 'Laenderspezifische Speicherung', 'positive', 20
  UNION ALL SELECT 'email', 'data_region_model', 'user_selectable_region', 'User-selectable region', 'Nutzerwaehlbare Region', 'positive', 30
  UNION ALL SELECT 'email', 'data_region_model', 'provider_selected_region', 'Provider-selected region', 'Anbietergewaehlte Region', 'neutral', 40
  ...
  UNION ALL SELECT 'email', 'migration_import_sources', 'provider_assisted', 'Provider-assisted migration', 'Anbieterunterstuetzte Migration', 'positive', 70
  ...
  UNION ALL SELECT 'email', 'mailbox_export_available', 'full_account_export', 'Full account export', 'Vollstaendiger Kontoexport', 'positive', 50
  ...
  UNION ALL SELECT 'email', 'collaboration_features', 'shared_mailboxes', 'Shared mailboxes', 'Geteilte Postfaecher', 'positive', 30
