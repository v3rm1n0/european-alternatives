...
VALUES
  ...
  ('hosting', 'networking_connectivity', 'Networking & Connectivity', 'Netzwerk & Konnektivitaet', 'Network features critical for hosting decisions.', 'Netzwerkfunktionen, die fuer Hosting-Entscheidungen wichtig sind.', 300),
  ...
  ('hosting', 'security_access', 'Security & Access', 'Sicherheit & Zugang', 'Account security, server hardening, and access controls.', 'Kontosicherheit, Server-Haertung und Zugangskontrollen.', 500),
  ...
  ('hosting', 'openness_audit', 'Openness & Audit', 'Offenheit & Audit', 'Source code openness, auditability, and licensing.', 'Quellcode-Offenheit, Pruefbarkeit und Lizenzierung.', 700),
...
FROM (
  ...
  UNION ALL SELECT 'hosting', 'service_type_infrastructure', 'server_virtualization', 'Server virtualization', 'Server-Virtualisierung', 'enum', 'informational', 'optional', 1020, 'The virtualization technology used for server isolation.', 'Die verwendete Virtualisierungstechnologie fuer Server-Isolation.'
  UNION ALL SELECT 'hosting', 'service_type_infrastructure', 'root_access', 'Root/admin access', 'Root-/Admin-Zugang', 'boolean', 'tradeoff', 'optional', 1030, 'Whether full root or administrator access is available.', 'Ob vollstaendiger Root- oder Administratorzugang verfuegbar ist.'
  ...
  UNION ALL SELECT 'hosting', 'service_type_infrastructure', 'custom_iso_support', 'Custom ISO/OS image support', 'Eigene ISO-/OS-Image-Unterstuetzung', 'boolean', 'informational', 'optional', 1050, 'Whether users can install arbitrary operating system images.', 'Ob Nutzer eigene Betriebssystem-Images installieren koennen.'
  UNION ALL SELECT 'hosting', 'service_type_infrastructure', 'resource_scaling_model', 'Resource scaling model', 'Ressourcen-Skalierungsmodell', 'enum', 'tradeoff', 'optional', 1060, 'How server resources can be scaled up or down.', 'Wie Serverressourcen hoch- oder herunterskaliert werden koennen.'
  ...
  UNION ALL SELECT 'hosting', 'performance_resources', 'storage_type', 'Storage technology', 'Speichertechnologie', 'enum', 'informational', 'optional', 2020, 'The type of storage technology used for data.', 'Die verwendete Speichertechnologie fuer Daten.'
  ...
  UNION ALL SELECT 'hosting', 'performance_resources', 'uptime_sla', 'Uptime SLA', 'Verfuegbarkeits-SLA', 'boolean', 'beneficial', 'optional', 2040, 'Whether a formal uptime service level agreement is offered.', 'Ob eine formelle Verfuegbarkeits-Dienstguetevereinbarung angeboten wird.'
  ...
  UNION ALL SELECT 'hosting', 'networking_connectivity', 'ipv6_support', 'IPv6 support', 'IPv6-Unterstuetzung', 'boolean', 'beneficial', 'optional', 3010, 'Whether IPv6 connectivity is supported.', 'Ob IPv6-Konnektivitaet unterstuetzt wird.'
  ...
  UNION ALL SELECT 'hosting', 'networking_connectivity', 'private_networking', 'Private networking', 'Privates Netzwerk', 'boolean', 'beneficial', 'optional', 3030, 'Whether private VLAN or VPC networking between instances is available.', 'Ob privates VLAN- oder VPC-Netzwerk zwischen Instanzen verfuegbar ist.'
  UNION ALL SELECT 'hosting', 'networking_connectivity', 'load_balancing', 'Load balancing available', 'Lastverteilung verfuegbar', 'boolean', 'informational', 'optional', 3040, 'Whether a managed load balancer option is available.', 'Ob eine verwaltete Lastverteilungsoption verfuegbar ist.'
  ...
  UNION ALL SELECT 'hosting', 'data_location_compliance', 'datacenter_locations', 'Data center locations', 'Rechenzentrum-Standorte', 'multi_enum', 'informational', 'multi_select', 4010, 'Which geographic regions have data centers available.', 'In welchen geografischen Regionen Rechenzentren verfuegbar sind.'
  UNION ALL SELECT 'hosting', 'data_location_compliance', 'eu_datacenter_available', 'EU data center available', 'EU-Rechenzentrum verfuegbar', 'boolean', 'beneficial', 'must_match', 4020, 'Whether at least one data center is located within the EU.', 'Ob mindestens ein Rechenzentrum innerhalb der EU liegt.'
  UNION ALL SELECT 'hosting', 'data_location_compliance', 'data_processing_agreement', 'Data processing agreement available', 'Auftragsverarbeitungsvertrag verfuegbar', 'boolean', 'informational', 'optional', 4030, 'Whether a GDPR-compliant data processing agreement is available.', 'Ob ein DSGVO-konformer Auftragsverarbeitungsvertrag verfuegbar ist.'
  ...
  UNION ALL SELECT 'hosting', 'security_access', 'two_factor_auth', 'Two-factor authentication', 'Zwei-Faktor-Authentifizierung', 'boolean', 'beneficial', 'optional', 5010, 'Whether two-factor authentication is available for account access.', 'Ob Zwei-Faktor-Authentifizierung fuer den Kontozugang verfuegbar ist.'
  UNION ALL SELECT 'hosting', 'security_access', 'ssh_key_auth', 'SSH key authentication', 'SSH-Schluessel-Authentifizierung', 'boolean', 'beneficial', 'optional', 5020, 'Whether SSH key-based authentication is supported for server access.', 'Ob SSH-schluesselbasierte Authentifizierung fuer den Serverzugang unterstuetzt wird.'
  UNION ALL SELECT 'hosting', 'security_access', 'firewall_management', 'Firewall management', 'Firewall-Verwaltung', 'enum', 'informational', 'optional', 5030, 'The level of firewall management available.', 'Der verfuegbare Grad der Firewall-Verwaltung.'
  UNION ALL SELECT 'hosting', 'security_access', 'backup_service', 'Backup service available', 'Backup-Dienst verfuegbar', 'boolean', 'beneficial', 'optional', 5040, 'Whether provider-managed backup services are available.', 'Ob vom Anbieter verwaltete Backup-Dienste verfuegbar sind.'
  UNION ALL SELECT 'hosting', 'security_access', 'snapshot_support', 'Snapshot/image support', 'Snapshot-/Image-Unterstuetzung', 'boolean', 'beneficial', 'optional', 5050, 'Whether VM snapshots or server images can be created for recovery.', 'Ob VM-Snapshots oder Server-Images zur Wiederherstellung erstellt werden koennen.'
  UNION ALL SELECT 'hosting', 'developer_experience', 'api_available', 'API available', 'API verfuegbar', 'boolean', 'beneficial', 'optional', 6010, 'Whether a programmatic API for server management is available.', 'Ob eine programmatische API zur Serververwaltung verfuegbar ist.'
  UNION ALL SELECT 'hosting', 'developer_experience', 'infrastructure_as_code', 'Infrastructure as Code support', 'Infrastructure-as-Code-Unterstuetzung', 'boolean', 'informational', 'optional', 6020, 'Whether Infrastructure as Code tools like Terraform or Ansible are supported.', 'Ob Infrastructure-as-Code-Werkzeuge wie Terraform oder Ansible unterstuetzt werden.'
  UNION ALL SELECT 'hosting', 'developer_experience', 'container_support', 'Container hosting support', 'Container-Hosting-Unterstuetzung', 'multi_enum', 'informational', 'multi_select', 6030, 'Which container technologies are supported for hosting workloads.', 'Welche Container-Technologien fuer Hosting-Workloads unterstuetzt werden.'
  UNION ALL SELECT 'hosting', 'developer_experience', 'one_click_apps', 'One-click app installation', 'Ein-Klick-App-Installation', 'boolean', 'informational', 'optional', 6040, 'Whether pre-configured application images are available for quick deployment.', 'Ob vorkonfigurierte Anwendungs-Images fuer schnelle Bereitstellung verfuegbar sind.'
  UNION ALL SELECT 'hosting', 'developer_experience', 'supported_os', 'Supported operating systems', 'Unterstuetzte Betriebssysteme', 'multi_enum', 'informational', 'multi_select', 6050, 'Which operating system distributions are available for installation.', 'Welche Betriebssystem-Distributionen zur Installation verfuegbar sind.'
  UNION ALL SELECT 'hosting', 'openness_audit', 'control_panel_source', 'Control panel source model', 'Control-Panel-Quellmodell', 'enum', 'tradeoff', 'optional', 7010, 'Whether the hosting control panel is open source, source available, or proprietary.', 'Ob das Hosting-Control-Panel quelloffen, quelleinsehbar oder proprietaer ist.'
  UNION ALL SELECT 'hosting', 'openness_audit', 'security_audit', 'Independent security audit', 'Unabhaengiges Sicherheitsaudit', 'boolean', 'beneficial', 'optional', 7020, 'Whether an independent security audit has been completed.', 'Ob ein unabhaengiges Sicherheitsaudit durchgefuehrt wurde.'
  UNION ALL SELECT 'hosting', 'openness_audit', 'transparency_report', 'Transparency report published', 'Transparenzbericht veroeffentlicht', 'boolean', 'informational', 'optional', 7030, 'Whether a transparency report on government and law enforcement requests is published.', 'Ob ein Transparenzbericht ueber Behoerden- und Strafverfolgungsanfragen veroeffentlicht wird.'
  UNION ALL SELECT 'hosting', 'openness_audit', 'community_contributions', 'Community contributions accepted', 'Community-Beitraege akzeptiert', 'boolean', 'informational', 'optional', 7040, 'Whether the provider accepts community contributions or open-source engagement.', 'Ob der Anbieter Community-Beitraege oder Open-Source-Engagement akzeptiert.'
  ...
  UNION ALL SELECT 'hosting', 'pricing_fit', 'free_tier_available', 'Free tier available', 'Kostenlose Stufe verfuegbar', 'boolean', 'informational', 'optional', 8020, 'Whether a free plan or trial is available.', 'Ob ein kostenloser Tarif oder eine Testphase verfuegbar ist.'
  UNION ALL SELECT 'hosting', 'pricing_fit', 'billing_currency', 'Billing in EUR available', 'Abrechnung in EUR verfuegbar', 'boolean', 'informational', 'optional', 8030, 'Whether billing in euros is available.', 'Ob eine Abrechnung in Euro verfuegbar ist.'
  UNION ALL SELECT 'hosting', 'pricing_fit', 'fit_profiles', 'Fit profiles', 'Eignungsprofile', 'multi_enum', 'informational', 'multi_select', 8040, 'Common user profiles the hosting service is well suited for.', 'Typische Nutzerprofile, fuer die der Hosting-Dienst gut geeignet ist.'
) AS d
...
FROM (
  ...
  UNION ALL SELECT 'hosting', 'datacenter_locations', 'uk', 'United Kingdom', 'Vereinigtes Koenigreich', 'neutral', 70
  UNION ALL SELECT 'hosting', 'datacenter_locations', 'non_european', 'Non-European', 'Aussereuropaeisch', 'tradeoff', 80
  ...
  UNION ALL SELECT 'hosting', 'firewall_management', 'none_available', 'Not available', 'Nicht verfuegbar', 'warning', 10
  ...
  UNION ALL SELECT 'hosting', 'container_support', 'none_available', 'Not available', 'Nicht verfuegbar', 'neutral', 50
  ...
  UNION ALL SELECT 'hosting', 'control_panel_source', 'proprietary_panel', 'Proprietary (e.g., cPanel, Plesk)', 'Proprietaer (z.B. cPanel, Plesk)', 'warning', 30
  ...
  UNION ALL SELECT 'hosting', 'pricing_model', 'hourly', 'Hourly/pay-as-you-go', 'Stuendlich/nutzungsbasiert', 'neutral', 20
  UNION ALL SELECT 'hosting', 'pricing_model', 'yearly', 'Yearly', 'Jaehrlich', 'neutral', 30
  ...
  UNION ALL SELECT 'hosting', 'fit_profiles', 'enterprise', 'Enterprise', 'Grossunternehmen', 'neutral', 30
