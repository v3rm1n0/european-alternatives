...
VALUES
  ('media-server', 'library_media_support', 'Library & Media Support', 'Bibliothek & Medienunterstützung', 'Media type support, metadata fetching, file format compatibility, and library organization.', 'Medientyp-Unterstützung, Metadatenabruf, Dateiformatkompatibilität und Bibliotheksorganisation.', 100),
  ('media-server', 'transcoding_playback', 'Transcoding & Playback', 'Transkodierung & Wiedergabe', 'Real-time transcoding capabilities, hardware acceleration, HDR handling, and streaming quality.', 'Echtzeit-Transkodierungsfähigkeiten, Hardwarebeschleunigung, HDR-Verarbeitung und Streaming-Qualität.', 200),
  ('media-server', 'client_apps_devices', 'Client Apps & Devices', 'Client-Apps & Geräte', 'Available client applications, supported platforms, smart TV apps, and casting protocols.', 'Verfügbare Client-Anwendungen, unterstützte Plattformen, Smart-TV-Apps und Casting-Protokolle.', 300),
  ...
  ('media-server', 'live_tv_dvr', 'Live TV & DVR', 'Live-TV & DVR', 'Live television streaming, TV tuner integration, program guide, and recording features.', 'Live-Fernsehstreaming, TV-Tuner-Integration, Programmführer und Aufnahmefunktionen.', 500),
  ('media-server', 'privacy_data', 'Privacy & Data', 'Privatsphäre & Daten', 'Account requirements, telemetry policies, data processing location, and phone-home behavior.', 'Kontoanforderungen, Telemetrie-Richtlinien, Datenverarbeitungsstandort und Nachhausetelefonieren-Verhalten.', 600),
  ('media-server', 'openness_extensibility', 'Openness & Extensibility', 'Offenheit & Erweiterbarkeit', 'Source code availability, licensing terms, plugin ecosystem, and API access.', 'Quellcode-Verfügbarkeit, Lizenzbedingungen, Plugin-Ökosystem und API-Zugang.', 700),
  ('media-server', 'deployment_hosting', 'Deployment & Hosting', 'Bereitstellung & Hosting', 'Installation methods, Docker support, NAS compatibility, and hardware requirements.', 'Installationsmethoden, Docker-Unterstützung, NAS-Kompatibilität und Hardwareanforderungen.', 800),
  ('media-server', 'pricing_fit', 'Pricing & Fit', 'Preise & Eignung', 'Pricing structure, free tier availability, paid feature scope, and target audience fit.', 'Preisstruktur, Verfügbarkeit kostenloser Versionen, Umfang kostenpflichtiger Funktionen und Zielgruppeneignung.', 900);
...
FROM (
  SELECT 'media-server' AS category_id, 'library_media_support' AS group_key, 'supported_media_types' AS criterion_key, 'Supported media types' AS label_en, 'Unterstützte Medientypen' AS label_de, 'multi_enum' AS value_type, 'informational' AS semantics, 'multi_select' AS filter_mode, 1010 AS sort_order, 'The types of media content the server can organize and stream.' AS help_text_en, 'Die Arten von Medieninhalten, die der Server organisieren und streamen kann.' AS help_text_de
  UNION ALL SELECT 'media-server', 'library_media_support', 'metadata_provider_support', 'Metadata provider support', 'Metadatenanbieter-Unterstützung', 'multi_enum', 'informational', 'multi_select', 1020, 'External metadata services the server can query for media information and artwork.', 'Externe Metadaten-Dienste, die der Server für Medieninformationen und Artwork abfragen kann.'
  UNION ALL SELECT 'media-server', 'library_media_support', 'automatic_metadata_fetching', 'Automatic metadata fetching', 'Automatischer Metadatenabruf', 'boolean', 'beneficial', 'optional', 1030, 'Whether the server automatically downloads metadata, artwork, and descriptions for media files.', 'Ob der Server automatisch Metadaten, Artwork und Beschreibungen für Mediendateien abruft.'
  UNION ALL SELECT 'media-server', 'library_media_support', 'supported_file_formats', 'Supported file formats', 'Unterstützte Dateiformate', 'enum', 'informational', 'optional', 1040, 'The breadth of audio and video file formats the server can handle without conversion.', 'Die Bandbreite der Audio- und Videodateiformate, die der Server ohne Konvertierung verarbeiten kann.'
  UNION ALL SELECT 'media-server', 'library_media_support', 'subtitle_support', 'Subtitle support', 'Untertitel-Unterstützung', 'multi_enum', 'informational', 'multi_select', 1050, 'The subtitle formats and integrations supported for playback.', 'Die unterstützten Untertitelformate und Integrationen für die Wiedergabe.'
  ...
  UNION ALL SELECT 'media-server', 'transcoding_playback', 'realtime_transcoding', 'Real-time transcoding', 'Echtzeit-Transkodierung', 'boolean', 'beneficial', 'must_match', 2010, 'Whether the server can transcode media on-the-fly to match client device capabilities.', 'Ob der Server Medien in Echtzeit transkodieren kann, um sie an die Fähigkeiten des Client-Geräts anzupassen.'
  UNION ALL SELECT 'media-server', 'transcoding_playback', 'hardware_acceleration', 'Hardware acceleration support', 'Hardwarebeschleunigung', 'multi_enum', 'beneficial', 'multi_select', 2020, 'The hardware acceleration technologies supported for faster media transcoding.', 'Die unterstützten Hardwarebeschleunigungstechnologien für schnellere Medientranskodierung.'
  UNION ALL SELECT 'media-server', 'transcoding_playback', 'hdr_support', 'HDR support', 'HDR-Unterstützung', 'boolean', 'informational', 'optional', 2030, 'Whether the server can handle HDR content and tone-map for non-HDR displays.', 'Ob der Server HDR-Inhalte verarbeiten und Tone-Mapping für Nicht-HDR-Bildschirme durchführen kann.'
  UNION ALL SELECT 'media-server', 'transcoding_playback', 'direct_play', 'Direct play / direct stream', 'Direktwiedergabe / Direct Stream', 'boolean', 'beneficial', 'optional', 2040, 'Whether the server can stream media directly without transcoding when the client supports the format.', 'Ob der Server Medien direkt ohne Transkodierung streamen kann, wenn der Client das Format unterstützt.'
  UNION ALL SELECT 'media-server', 'transcoding_playback', 'max_streaming_quality', 'Maximum streaming quality', 'Maximale Streaming-Qualität', 'enum', 'informational', 'optional', 2050, 'The maximum video resolution the server supports for streaming.', 'Die maximale Videoauflösung, die der Server beim Streaming unterstützt.'
  UNION ALL SELECT 'media-server', 'transcoding_playback', 'offline_sync', 'Offline sync / download', 'Offline-Synchronisation / Download', 'boolean', 'beneficial', 'optional', 2060, 'Whether the server allows downloading media to client devices for offline playback.', 'Ob der Server das Herunterladen von Medien auf Client-Geräte für die Offline-Wiedergabe erlaubt.'
  UNION ALL SELECT 'media-server', 'client_apps_devices', 'supported_client_platforms', 'Supported client platforms', 'Unterstützte Client-Plattformen', 'multi_enum', 'informational', 'multi_select', 3010, 'The operating systems and platforms that have dedicated client apps for this server.', 'Die Betriebssysteme und Plattformen, die dedizierte Client-Apps für diesen Server haben.'
  UNION ALL SELECT 'media-server', 'client_apps_devices', 'web_player_available', 'Web player available', 'Webplayer verfügbar', 'boolean', 'beneficial', 'optional', 3020, 'Whether the server provides a built-in web-based player accessible from any browser.', 'Ob der Server einen integrierten webbasierten Player bietet, der über jeden Browser zugänglich ist.'
  UNION ALL SELECT 'media-server', 'client_apps_devices', 'smart_tv_support', 'Smart TV support', 'Smart-TV-Unterstützung', 'multi_enum', 'informational', 'multi_select', 3030, 'The smart TV platforms that have native apps for this media server.', 'Die Smart-TV-Plattformen, die native Apps für diesen Medienserver haben.'
  UNION ALL SELECT 'media-server', 'client_apps_devices', 'dlna_upnp_support', 'DLNA / UPnP support', 'DLNA / UPnP-Unterstützung', 'boolean', 'informational', 'optional', 3040, 'Whether the server supports DLNA or UPnP protocols for network media sharing.', 'Ob der Server DLNA- oder UPnP-Protokolle für die Netzwerk-Medienfreigabe unterstützt.'
  UNION ALL SELECT 'media-server', 'client_apps_devices', 'chromecast_support', 'Chromecast support', 'Chromecast-Unterstützung', 'boolean', 'informational', 'optional', 3050, 'Whether the server supports casting media to Chromecast devices.', 'Ob der Server das Streamen von Medien auf Chromecast-Geräte unterstützt.'
  UNION ALL SELECT 'media-server', 'client_apps_devices', 'remote_access', 'Remote access', 'Fernzugriff', 'enum', 'tradeoff', 'optional', 3060, 'How the server enables access from outside the local network.', 'Wie der Server den Zugriff von außerhalb des lokalen Netzwerks ermöglicht.'
  UNION ALL SELECT 'media-server', 'user_management', 'multi_user_support', 'Multi-user support', 'Mehrbenutzer-Unterstützung', 'boolean', 'beneficial', 'must_match', 4010, 'Whether the server supports multiple user accounts with separate libraries and settings.', 'Ob der Server mehrere Benutzerkonten mit separaten Bibliotheken und Einstellungen unterstützt.'
  UNION ALL SELECT 'media-server', 'user_management', 'user_profiles', 'User profiles', 'Benutzerprofile', 'boolean', 'beneficial', 'optional', 4020, 'Whether individual users can have personalized profiles with their own watch history and preferences.', 'Ob einzelne Benutzer personalisierte Profile mit eigenem Wiedergabeverlauf und eigenen Voreinstellungen haben können.'
  UNION ALL SELECT 'media-server', 'user_management', 'parental_controls', 'Parental controls', 'Kindersicherung', 'boolean', 'informational', 'optional', 4030, 'Whether the server offers content filtering or access restrictions for child accounts.', 'Ob der Server Inhaltsfilterung oder Zugriffsbeschränkungen für Kinderkonten bietet.'
  UNION ALL SELECT 'media-server', 'user_management', 'library_sharing', 'Library sharing model', 'Bibliotheksfreigabemodell', 'enum', 'tradeoff', 'optional', 4040, 'How the server allows sharing media libraries with other users.', 'Wie der Server die Freigabe von Medienbibliotheken an andere Benutzer ermöglicht.'
  UNION ALL SELECT 'media-server', 'user_management', 'watch_history_tracking', 'Watch history tracking', 'Wiedergabeverlauf-Verfolgung', 'boolean', 'informational', 'optional', 4050, 'Whether the server tracks watch progress and history across devices.', 'Ob der Server den Wiedergabefortschritt und die Historie über verschiedene Geräte hinweg verfolgt.'
  UNION ALL SELECT 'media-server', 'live_tv_dvr', 'live_tv_support', 'Live TV support', 'Live-TV-Unterstützung', 'boolean', 'informational', 'optional', 5010, 'Whether the server can stream live television channels.', 'Ob der Server Live-Fernsehkanäle streamen kann.'
  UNION ALL SELECT 'media-server', 'live_tv_dvr', 'tv_tuner_support', 'TV tuner support', 'TV-Tuner-Unterstützung', 'multi_enum', 'informational', 'multi_select', 5020, 'The TV tuner hardware and IPTV input methods supported by the server.', 'Die vom Server unterstützten TV-Tuner-Hardware und IPTV-Eingabemethoden.'
  UNION ALL SELECT 'media-server', 'live_tv_dvr', 'epg_guide', 'Electronic program guide (EPG)', 'Elektronischer Programmführer (EPG)', 'boolean', 'informational', 'optional', 5030, 'Whether the server provides an electronic program guide for browsing scheduled TV content.', 'Ob der Server einen elektronischen Programmführer zum Durchsuchen geplanter TV-Inhalte bietet.'
  UNION ALL SELECT 'media-server', 'live_tv_dvr', 'dvr_recording', 'DVR recording', 'DVR-Aufnahme', 'boolean', 'informational', 'optional', 5040, 'Whether the server can record live TV programs for later viewing.', 'Ob der Server Live-TV-Sendungen für späteres Ansehen aufzeichnen kann.'
  UNION ALL SELECT 'media-server', 'privacy_data', 'account_requirement', 'Account requirement', 'Kontoanforderung', 'enum', 'risk', 'optional', 6010, 'Whether the server requires creating an account to use its features.', 'Ob der Server die Erstellung eines Kontos für die Nutzung seiner Funktionen erfordert.'
  UNION ALL SELECT 'media-server', 'privacy_data', 'telemetry_model', 'Telemetry model', 'Telemetriemodell', 'enum', 'risk', 'optional', 6020, 'How the server handles collection and transmission of usage data.', 'Wie der Server die Erfassung und Übermittlung von Nutzungsdaten handhabt.'
  ...
  UNION ALL SELECT 'media-server', 'privacy_data', 'data_export_available', 'Data export available', 'Datenexport verfügbar', 'boolean', 'beneficial', 'optional', 6050, 'Whether user data and media metadata can be exported in a portable format.', 'Ob Benutzerdaten und Medienmetadaten in einem portablen Format exportiert werden können.'
  UNION ALL SELECT 'media-server', 'openness_extensibility', 'source_model', 'Source code model', 'Quellcode-Modell', 'enum', 'tradeoff', 'optional', 7010, 'The openness of the server source code and its availability to the public.', 'Die Offenheit des Server-Quellcodes und seine öffentliche Verfügbarkeit.'
  ...
  UNION ALL SELECT 'media-server', 'openness_extensibility', 'plugin_system', 'Plugin / add-on system', 'Plugin- / Add-on-System', 'boolean', 'beneficial', 'optional', 7030, 'Whether the server supports extending functionality through plugins or add-ons.', 'Ob der Server die Erweiterung der Funktionalität durch Plugins oder Add-ons unterstützt.'
  UNION ALL SELECT 'media-server', 'openness_extensibility', 'api_available', 'API available', 'API verfügbar', 'boolean', 'beneficial', 'optional', 7040, 'Whether the server exposes a documented API for third-party integration.', 'Ob der Server eine dokumentierte API für Drittanbieter-Integration bereitstellt.'
  UNION ALL SELECT 'media-server', 'openness_extensibility', 'community_ecosystem', 'Community ecosystem', 'Community-Ökosystem', 'enum', 'informational', 'optional', 7050, 'The size and activity level of the community around the server project.', 'Die Größe und Aktivität der Community rund um das Server-Projekt.'
  UNION ALL SELECT 'media-server', 'deployment_hosting', 'deployment_model', 'Deployment model', 'Bereitstellungsmodell', 'multi_enum', 'informational', 'multi_select', 8010, 'The installation and deployment methods available for the server.', 'Die verfügbaren Installations- und Bereitstellungsmethoden für den Server.'
  UNION ALL SELECT 'media-server', 'deployment_hosting', 'docker_support', 'Docker support', 'Docker-Unterstützung', 'boolean', 'beneficial', 'optional', 8020, 'Whether an official or well-maintained Docker image is available for the server.', 'Ob ein offizielles oder gut gepflegtes Docker-Image für den Server verfügbar ist.'
  UNION ALL SELECT 'media-server', 'deployment_hosting', 'nas_compatibility', 'NAS compatibility', 'NAS-Kompatibilität', 'multi_enum', 'informational', 'multi_select', 8030, 'The NAS platforms that officially support running this media server.', 'Die NAS-Plattformen, die den Betrieb dieses Medienservers offiziell unterstützen.'
  UNION ALL SELECT 'media-server', 'deployment_hosting', 'minimum_hardware_requirements', 'Minimum hardware requirements', 'Minimale Hardwareanforderungen', 'enum', 'informational', 'optional', 8040, 'The minimum hardware tier needed to run the server for basic media streaming.', 'Die minimale Hardware-Klasse, die für grundlegendes Medienstreaming mit dem Server erforderlich ist.'
  UNION ALL SELECT 'media-server', 'deployment_hosting', 'reverse_proxy_support', 'Reverse proxy support', 'Reverse-Proxy-Unterstützung', 'boolean', 'informational', 'optional', 8050, 'Whether the server works correctly behind a reverse proxy for secure remote access.', 'Ob der Server hinter einem Reverse-Proxy für sicheren Fernzugriff korrekt funktioniert.'
  UNION ALL SELECT 'media-server', 'pricing_fit', 'pricing_model', 'Pricing model', 'Preismodell', 'enum', 'informational', 'optional', 9010, 'The pricing structure of the server software and any associated services.', 'Die Preisstruktur der Server-Software und der zugehörigen Dienste.'
  UNION ALL SELECT 'media-server', 'pricing_fit', 'free_tier_available', 'Free tier available', 'Kostenlose Version verfügbar', 'boolean', 'informational', 'must_match', 9020, 'Whether a fully functional free version of the server is available.', 'Ob eine voll funktionsfähige kostenlose Version des Servers verfügbar ist.'
  ...
  UNION ALL SELECT 'media-server', 'pricing_fit', 'fit_profiles', 'Fit profiles', 'Eignungsprofile', 'multi_enum', 'informational', 'multi_select', 9040, 'Target audience profiles the media server is best suited for.', 'Zielgruppenprofile, für die der Medienserver am besten geeignet ist.'
) AS d
...
FROM (
  ...
  UNION ALL SELECT 'media-server', 'supported_media_types', 'audiobooks', 'Audiobooks', 'Hörbücher', 'neutral', 50
  ...
  UNION ALL SELECT 'media-server', 'supported_file_formats', 'moderate', 'Moderate (10-20 formats)', 'Mäßig (10-20 Formate)', 'neutral', 30
  ...
  UNION ALL SELECT 'media-server', 'remote_access', 'via_third_party_relay', 'Via third-party relay', 'Über Drittanbieter-Relay', 'neutral', 20
  ...
  UNION ALL SELECT 'media-server', 'remote_access', 'not_supported', 'Not supported', 'Nicht unterstützt', 'neutral', 40
  ...
  UNION ALL SELECT 'media-server', 'library_sharing', 'federated_sharing', 'Federated sharing', 'Föderierte Freigabe', 'neutral', 30
  ...
  UNION ALL SELECT 'media-server', 'data_processing_location', 'eu_primary', 'EU primary', 'EU primär', 'neutral', 30
  ...
  UNION ALL SELECT 'media-server', 'phone_home_behavior', 'optional_update_check', 'Optional update check', 'Optionale Aktualisierungsprüfung', 'neutral', 20
  UNION ALL SELECT 'media-server', 'phone_home_behavior', 'mandatory_connection', 'Mandatory connection', 'Pflichtverbindung', 'warning', 30
  UNION ALL SELECT 'media-server', 'phone_home_behavior', 'cloud_dependent', 'Cloud-dependent', 'Cloud-abhängig', 'warning', 40
  UNION ALL SELECT 'media-server', 'source_model', 'fully_open_source', 'Fully open source', 'Vollständig quelloffen', 'positive', 10
  UNION ALL SELECT 'media-server', 'source_model', 'source_available', 'Source available', 'Quellcode verfügbar', 'neutral', 20
  UNION ALL SELECT 'media-server', 'source_model', 'partially_open', 'Partially open', 'Teilweise offen', 'neutral', 30
  UNION ALL SELECT 'media-server', 'source_model', 'proprietary', 'Proprietary', 'Proprietär', 'warning', 40
  ...
  UNION ALL SELECT 'media-server', 'license_type', 'proprietary', 'Proprietary', 'Proprietär', 'neutral', 50
  UNION ALL SELECT 'media-server', 'community_ecosystem', 'large_active', 'Large and active', 'Groß und aktiv', 'neutral', 10
  UNION ALL SELECT 'media-server', 'community_ecosystem', 'medium_active', 'Medium and active', 'Mittelgroß und aktiv', 'neutral', 20
  ...
  UNION ALL SELECT 'media-server', 'minimum_hardware_requirements', 'moderate', 'Moderate (mid-range)', 'Mäßig (Mittelklasse)', 'neutral', 30
