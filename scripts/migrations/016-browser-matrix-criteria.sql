...
VALUES
  ('browser', 'rendering_standards', 'Rendering Engine & Standards', 'Rendering-Engine & Standards', 'Engine choice, web standards compliance, PWA support, and extension API compatibility.', 'Engine-Wahl, Webstandards-Kompatibilitaet, PWA-Unterstuetzung und Erweiterungs-API-Kompatibilitaet.', 100),
  ...
  ('browser', 'data_sync_account', 'Data Sync & Account', 'Datensynchronisation & Konto', 'Account requirements, sync scope, encryption model, and data export capabilities.', 'Kontoanforderungen, Synchronisationsumfang, Verschluesselungsmodell und Datenexportfunktionen.', 400),
  ('browser', 'content_blocking', 'Content Blocking & Filtering', 'Inhaltsblocker & Filterung', 'Native ad blocking, content filter extension support, filter list formats, and reader mode.', 'Nativer Werbeblocker, Unterstuetzung fuer Inhaltsfilter-Erweiterungen, Filterlistenformate und Lesemodus.', 500),
  ('browser', 'platform_distribution', 'Platform & Distribution', 'Plattform & Verteilung', 'Operating system support, mobile distribution channels, default browser settings, and portable mode.', 'Betriebssystemunterstuetzung, mobile Vertriebskanaele, Standard-Browser-Einstellungen und portabler Modus.', 600),
  ('browser', 'extensions_customization', 'Extensions & Customization', 'Erweiterungen & Anpassung', 'Extension store model, API compatibility, theme customization, and UI personalization.', 'Erweiterungsshop-Modell, API-Kompatibilitaet, Theme-Anpassung und UI-Personalisierung.', 700),
  ('browser', 'productivity_tools', 'Productivity & Built-in Tools', 'Produktivitaet & integrierte Werkzeuge', 'Tab management, PDF viewing, built-in utilities, and password management.', 'Tab-Verwaltung, PDF-Anzeige, integrierte Werkzeuge und Passwortverwaltung.', 800),
  ('browser', 'openness_architecture_fit', 'Openness, Architecture & Fit', 'Offenheit, Architektur & Eignung', 'Source code model, engine independence, protocol support, self-hosting, and user fit profiles.', 'Quellcode-Modell, Engine-Unabhaengigkeit, Protokollunterstuetzung, Selbsthosting und Nutzereignungsprofile.', 900);
...
FROM (
  ...
  UNION ALL SELECT 'browser', 'rendering_standards', 'progressive_web_app_support', 'Progressive Web App support', 'Progressive-Web-App-Unterstuetzung', 'boolean', 'beneficial', 'optional', 1030, 'Whether the browser supports installing and running Progressive Web Apps.', 'Ob der Browser die Installation und Ausfuehrung von Progressive Web Apps unterstuetzt.'
  UNION ALL SELECT 'browser', 'rendering_standards', 'webextensions_api_support', 'WebExtensions API support', 'WebExtensions-API-Unterstuetzung', 'boolean', 'beneficial', 'optional', 1040, 'Whether the browser supports the cross-browser WebExtensions API standard.', 'Ob der Browser den browsueruebergreifenden WebExtensions-API-Standard unterstuetzt.'
  UNION ALL SELECT 'browser', 'privacy_tracking', 'built_in_tracking_protection', 'Built-in tracking protection', 'Integrierter Tracking-Schutz', 'enum', 'beneficial', 'must_match', 2010, 'The level of built-in tracking protection provided by default or through settings.', 'Das Niveau des integrierten Tracking-Schutzes, standardmaessig oder ueber Einstellungen.'
  ...
  UNION ALL SELECT 'browser', 'privacy_tracking', 'dns_over_https_support', 'DNS-over-HTTPS support', 'DNS-ueber-HTTPS-Unterstuetzung', 'enum', 'beneficial', 'optional', 2040, 'The level of DNS-over-HTTPS or DNS-over-TLS support for encrypted DNS queries.', 'Das Niveau der DNS-ueber-HTTPS- oder DNS-ueber-TLS-Unterstuetzung fuer verschluesselte DNS-Anfragen.'
  UNION ALL SELECT 'browser', 'privacy_tracking', 'private_browsing_model', 'Private browsing model', 'Privates-Surfen-Modell', 'enum', 'informational', 'optional', 2050, 'How the private or incognito browsing mode works and what protections it provides.', 'Wie der private oder Inkognito-Modus funktioniert und welche Schutzmassnahmen er bietet.'
  ...
  UNION ALL SELECT 'browser', 'security_updates', 'security_audit_transparency', 'Security audit transparency', 'Sicherheitsaudit-Transparenz', 'enum', 'informational', 'optional', 3040, 'Whether security audits or bug bounty results are publicly published.', 'Ob Sicherheitsaudits oder Bug-Bounty-Ergebnisse oeffentlich veroeffentlicht werden.'
  UNION ALL SELECT 'browser', 'data_sync_account', 'account_required', 'Account required', 'Konto erforderlich', 'boolean', 'risk', 'must_match', 4010, 'Whether an account is required for basic browser usage.', 'Ob ein Konto fuer die grundlegende Browsernutzung erforderlich ist.'
  UNION ALL SELECT 'browser', 'data_sync_account', 'sync_features', 'Sync features', 'Synchronisationsfunktionen', 'multi_enum', 'informational', 'multi_select', 4020, 'Data types that can be synced across devices when using the browser sync feature.', 'Datentypen, die bei Nutzung der Browser-Synchronisation geraeteuebergreifend synchronisiert werden koennen.'
  UNION ALL SELECT 'browser', 'data_sync_account', 'sync_encryption_model', 'Sync encryption model', 'Synchronisations-Verschluesselungsmodell', 'enum', 'tradeoff', 'optional', 4030, 'How synced browser data is encrypted during transfer and storage.', 'Wie synchronisierte Browserdaten bei Uebertragung und Speicherung verschluesselt werden.'
  UNION ALL SELECT 'browser', 'data_sync_account', 'data_export_available', 'Data export available', 'Datenexport verfuegbar', 'boolean', 'beneficial', 'optional', 4040, 'Whether users can export their browser data such as bookmarks, history, or passwords.', 'Ob Nutzer ihre Browserdaten wie Lesezeichen, Verlauf oder Passwoerter exportieren koennen.'
  ...
  UNION ALL SELECT 'browser', 'content_blocking', 'content_filter_extension_support', 'Content filter extension support', 'Inhaltsfilter-Erweiterungsunterstuetzung', 'enum', 'tradeoff', 'optional', 5020, 'The level of support for content blocker extensions and their capabilities.', 'Das Unterstuetzungsniveau fuer Inhaltsblocker-Erweiterungen und deren Faehigkeiten.'
  UNION ALL SELECT 'browser', 'content_blocking', 'supported_filter_list_formats', 'Supported filter list formats', 'Unterstuetzte Filterlistenformate', 'multi_enum', 'informational', 'multi_select', 5030, 'Filter list formats that the browser or its extensions can consume for content blocking.', 'Filterlistenformate, die der Browser oder seine Erweiterungen fuer Inhaltsblockierung verwenden koennen.'
  UNION ALL SELECT 'browser', 'content_blocking', 'reader_mode_available', 'Reader mode available', 'Lesemodus verfuegbar', 'boolean', 'beneficial', 'optional', 5040, 'Whether the browser offers a built-in reader or distraction-free mode.', 'Ob der Browser einen integrierten Lese- oder ablenkungsfreien Modus bietet.'
  UNION ALL SELECT 'browser', 'platform_distribution', 'supported_platforms', 'Supported platforms', 'Unterstuetzte Plattformen', 'multi_enum', 'informational', 'multi_select', 6010, 'Operating systems and device types where the browser is available.', 'Betriebssysteme und Geraetetypen, auf denen der Browser verfuegbar ist.'
  UNION ALL SELECT 'browser', 'platform_distribution', 'mobile_app_distribution', 'Mobile app distribution', 'Mobile App-Verteilung', 'multi_enum', 'informational', 'multi_select', 6020, 'Distribution channels for the mobile version of the browser.', 'Vertriebskanaele fuer die mobile Version des Browsers.'
  ...
  UNION ALL SELECT 'browser', 'platform_distribution', 'portable_mode_available', 'Portable mode available', 'Portabler Modus verfuegbar', 'boolean', 'beneficial', 'optional', 6040, 'Whether a portable or USB version of the browser exists.', 'Ob eine portable oder USB-Version des Browsers existiert.'
  ...
  UNION ALL SELECT 'browser', 'extensions_customization', 'extension_api_compatibility', 'Extension API compatibility', 'Erweiterungs-API-Kompatibilitaet', 'multi_enum', 'informational', 'multi_select', 7020, 'Extension API standards that the browser supports for add-on development.', 'Erweiterungs-API-Standards, die der Browser fuer die Add-on-Entwicklung unterstuetzt.'
  UNION ALL SELECT 'browser', 'extensions_customization', 'theme_customization_level', 'Theme customization level', 'Theme-Anpassungsstufe', 'enum', 'informational', 'optional', 7030, 'The depth of visual theme customization available to users.', 'Die Tiefe der visuellen Theme-Anpassung, die Nutzern zur Verfuegung steht.'
  UNION ALL SELECT 'browser', 'extensions_customization', 'ui_customization_features', 'UI customization features', 'UI-Anpassungsfunktionen', 'multi_enum', 'informational', 'multi_select', 7040, 'User interface customization options such as toolbar, sidebar, and tab bar settings.', 'Anpassungsoptionen der Benutzeroberflaeche wie Symbolleiste, Seitenleiste und Tab-Leisten-Einstellungen.'
  UNION ALL SELECT 'browser', 'productivity_tools', 'tab_management_features', 'Tab management features', 'Tab-Verwaltungsfunktionen', 'multi_enum', 'beneficial', 'multi_select', 8010, 'Tab organization and management features available in the browser.', 'Tab-Organisations- und Verwaltungsfunktionen, die im Browser verfuegbar sind.'
  ...
  UNION ALL SELECT 'browser', 'productivity_tools', 'built_in_tools', 'Built-in tools', 'Integrierte Werkzeuge', 'multi_enum', 'informational', 'multi_select', 8030, 'Utilities and tools built into the browser such as screenshot, translate, or developer tools.', 'Im Browser integrierte Werkzeuge wie Screenshot, Uebersetzer oder Entwicklerwerkzeuge.'
  ...
  UNION ALL SELECT 'browser', 'openness_architecture_fit', 'engine_independence', 'Engine independence', 'Engine-Unabhaengigkeit', 'enum', 'tradeoff', 'optional', 9020, 'Whether the browser maintains its own engine or is based on another project.', 'Ob der Browser eine eigene Engine pflegt oder auf einem anderen Projekt basiert.'
  UNION ALL SELECT 'browser', 'openness_architecture_fit', 'protocol_support', 'Protocol support', 'Protokollunterstuetzung', 'multi_enum', 'informational', 'multi_select', 9030, 'Network and application protocols supported beyond standard HTTP.', 'Netzwerk- und Anwendungsprotokolle, die ueber Standard-HTTP hinaus unterstuetzt werden.'
  ...
  UNION ALL SELECT 'browser', 'openness_architecture_fit', 'fit_profiles', 'Fit profiles', 'Eignungsprofile', 'multi_enum', 'informational', 'multi_select', 9050, 'Common user profiles or use cases the browser is well suited for.', 'Typische Nutzerprofile oder Anwendungsfaelle, fuer die der Browser gut geeignet ist.'
) AS d
...
FROM (
  ...
  UNION ALL SELECT 'browser', 'web_standards_profile', 'full_modern', 'Full modern', 'Vollstaendig modern', 'positive', 10
  UNION ALL SELECT 'browser', 'web_standards_profile', 'mostly_compliant', 'Mostly compliant', 'Weitgehend konform', 'neutral', 20
  UNION ALL SELECT 'browser', 'web_standards_profile', 'selective_support', 'Selective support', 'Selektive Unterstuetzung', 'tradeoff', 30
  ...
  UNION ALL SELECT 'browser', 'fingerprinting_resistance', 'basic_mitigations', 'Basic mitigations', 'Einfache Gegenmassnahmen', 'neutral', 20
  ...
  UNION ALL SELECT 'browser', 'third_party_cookie_default', 'allowed_by_default', 'Allowed by default', 'Standardmaessig erlaubt', 'warning', 10
  UNION ALL SELECT 'browser', 'third_party_cookie_default', 'partitioned', 'Partitioned', 'Partitioniert', 'neutral', 20
  UNION ALL SELECT 'browser', 'third_party_cookie_default', 'blocked_by_default', 'Blocked by default', 'Standardmaessig blockiert', 'positive', 30
  ...
  UNION ALL SELECT 'browser', 'dns_over_https_support', 'default_on', 'Default on', 'Standardmaessig aktiv', 'positive', 30
  ...
  UNION ALL SELECT 'browser', 'sandboxing_model', 'full_os_sandbox', 'Full OS sandbox', 'Vollstaendige OS-Sandbox', 'positive', 40
  UNION ALL SELECT 'browser', 'security_audit_transparency', 'none_public', 'None public', 'Keine oeffentlich', 'neutral', 10
  ...
  UNION ALL SELECT 'browser', 'sync_features', 'passwords', 'Passwords', 'Passwoerter', 'neutral', 30
  ...
  UNION ALL SELECT 'browser', 'sync_encryption_model', 'not_encrypted', 'Not encrypted', 'Nicht verschluesselt', 'warning', 10
  ...
  UNION ALL SELECT 'browser', 'sync_encryption_model', 'e2ee', 'End-to-end encrypted', 'Ende-zu-Ende-verschluesselt', 'positive', 40
  UNION ALL SELECT 'browser', 'content_filter_extension_support', 'none', 'None', 'Keine', 'warning', 10
  UNION ALL SELECT 'browser', 'content_filter_extension_support', 'mv3_limited', 'MV3 limited', 'MV3 eingeschraenkt', 'tradeoff', 20
  UNION ALL SELECT 'browser', 'content_filter_extension_support', 'mv3_full', 'MV3 full', 'MV3 vollstaendig', 'neutral', 30
  UNION ALL SELECT 'browser', 'content_filter_extension_support', 'mv2_full', 'MV2 full', 'MV2 vollstaendig', 'positive', 40
  ...
  UNION ALL SELECT 'browser', 'extension_api_compatibility', 'proprietary_api', 'Proprietary API', 'Proprietaere API', 'tradeoff', 40
  ...
  UNION ALL SELECT 'browser', 'theme_customization_level', 'full_css_customization', 'Full CSS customization', 'Vollstaendige CSS-Anpassung', 'positive', 40
  ...
  UNION ALL SELECT 'browser', 'ui_customization_features', 'keyboard_shortcuts', 'Keyboard shortcuts', 'Tastenkuerzel', 'neutral', 40
  ...
  UNION ALL SELECT 'browser', 'built_in_tools', 'page_translator', 'Page translator', 'Seitenuebersetzer', 'neutral', 30
  ...
  UNION ALL SELECT 'browser', 'password_manager_model', 'basic_save_fill', 'Basic save/fill', 'Einfaches Speichern/Ausfuellen', 'neutral', 20
  ...
  UNION ALL SELECT 'browser', 'source_code_model', 'source_available', 'Source available', 'Quellcode verfuegbar', 'neutral', 20
  UNION ALL SELECT 'browser', 'source_code_model', 'partial_open', 'Partial open', 'Teilweise offen', 'tradeoff', 30
  UNION ALL SELECT 'browser', 'source_code_model', 'proprietary', 'Proprietary', 'Proprietaer', 'warning', 40
  UNION ALL SELECT 'browser', 'engine_independence', 'independent_engine', 'Independent engine', 'Unabhaengige Engine', 'positive', 10
  ...
  UNION ALL SELECT 'browser', 'fit_profiles', 'everyday_browsing', 'Everyday browsing', 'Alltaegliches Surfen', 'neutral', 20
