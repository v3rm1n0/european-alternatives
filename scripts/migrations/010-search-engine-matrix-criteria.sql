...
VALUES
  ('search-engine', 'result_source', 'Result Source & Index', 'Ergebnisquelle & Index', 'Where search results come from, including index ownership, upstream sources, freshness, and regional controls.', 'Woher Suchergebnisse stammen, einschliesslich Index-Eigentum, Upstream-Quellen, Aktualitaet und Regionskontrollen.', 100),
  ...
  ('search-engine', 'result_types', 'Result Types & Verticals', 'Ergebnistypen & Vertikale', 'Supported search verticals and controls for images, news, maps, local, and multimedia results.', 'Unterstuetzte Suchvertikale und Kontrollen fuer Bilder, Nachrichten, Karten, lokale und Multimedia-Ergebnisse.', 400),
  ...
  ('search-engine', 'ads_commercial', 'Ads & Commercial Model', 'Anzeigen & Geschaeftsmodell', 'Search ads, labeling, affiliate or shopping links, subscriptions, and paid access models.', 'Suchanzeigen, Kennzeichnung, Affiliate- oder Shopping-Links, Abos und Bezahlmodelle.', 600),
  ('search-engine', 'access_integrations', 'Access & Integrations', 'Zugriff & Integrationen', 'Ways to access the search engine, browser integration, APIs, self-hosting, and OpenSearch support.', 'Zugriffswege zur Suchmaschine, Browser-Integration, APIs, Selbsthosting und OpenSearch-Unterstuetzung.', 700),
  ...
  ('search-engine', 'fit_profiles', 'Fit Profiles', 'Eignungsprofile', 'Common user profiles and query types the search engine is suited to support.', 'Typische Nutzerprofile und Anfragearten, fuer die die Suchmaschine geeignet ist.', 900);
...
FROM (
  SELECT 'search-engine' AS category_id, 'result_source' AS group_key, 'search_source_model' AS criterion_key, 'Search source model' AS label_en, 'Suchquellenmodell' AS label_de, 'enum' AS value_type, 'tradeoff' AS semantics, 'optional' AS filter_mode, 1010 AS sort_order, 'The documented model used to source web results, such as own index, metasearch, upstream API, hybrid, vertical, or self-hosted mode.' AS help_text_en, 'Das dokumentierte Modell fuer Web-Ergebnisse, etwa eigener Index, Metasuche, Upstream-API, Hybrid, vertikal oder selbstgehostet.' AS help_text_de
  ...
  UNION ALL SELECT 'search-engine', 'result_source', 'result_freshness_controls', 'Result freshness controls', 'Frische-Kontrollen fuer Ergebnisse', 'multi_enum', 'beneficial', 'multi_select', 1040, 'Controls users can apply to prefer recent, date-limited, sorted, or cached results.', 'Kontrollen, mit denen Nutzer aktuelle, zeitlich begrenzte, sortierte oder zwischengespeicherte Ergebnisse bevorzugen koennen.'
  UNION ALL SELECT 'search-engine', 'result_source', 'regional_language_controls', 'Region and language controls', 'Regions- und Sprachkontrollen', 'multi_enum', 'beneficial', 'multi_select', 1050, 'Controls for country, region, interface language, result language, location override, or location bias.', 'Kontrollen fuer Land, Region, Oberflaechensprache, Ergebnissprache, Standortvorgabe oder Standortgewichtung.'
  UNION ALL SELECT 'search-engine', 'privacy_personalization', 'account_required_for_search', 'Account required for search', 'Konto fuer Suche erforderlich', 'boolean', 'risk', 'must_match', 2010, 'Whether ordinary web searches require signing in before results can be viewed.', 'Ob normale Websuchen eine Anmeldung erfordern, bevor Ergebnisse angezeigt werden.'
  UNION ALL SELECT 'search-engine', 'privacy_personalization', 'query_logging_retention', 'Query logging retention', 'Speicherdauer fuer Suchanfragen', 'enum', 'risk', 'optional', 2020, 'The documented retention model for search queries or personal search history.', 'Das dokumentierte Aufbewahrungsmodell fuer Suchanfragen oder persoenliche Suchhistorie.'
  UNION ALL SELECT 'search-engine', 'privacy_personalization', 'ip_address_handling', 'IP address handling', 'Umgang mit IP-Adressen', 'enum', 'risk', 'optional', 2030, 'How IP addresses are logged, anonymized, proxied, retained, or used for personalization in search.', 'Wie IP-Adressen bei der Suche gespeichert, anonymisiert, weitergeleitet, aufbewahrt oder fuer Personalisierung genutzt werden.'
  UNION ALL SELECT 'search-engine', 'privacy_personalization', 'personalized_results', 'Personalized results', 'Personalisierte Ergebnisse', 'enum', 'tradeoff', 'optional', 2040, 'Whether result ranking or suggestions are personalized, optional, account based, on by default, or unclear.', 'Ob Ergebnisranking oder Vorschlaege personalisiert, optional, kontobasiert, standardmaessig aktiv oder unklar sind.'
  UNION ALL SELECT 'search-engine', 'privacy_personalization', 'cookie_free_search', 'Cookie-free search', 'Suche ohne Cookies', 'boolean', 'beneficial', 'optional', 2050, 'Whether basic web search can be used without accepting or relying on cookies.', 'Ob grundlegende Websuche ohne Akzeptieren oder Nutzen von Cookies moeglich ist.'
  UNION ALL SELECT 'search-engine', 'privacy_personalization', 'third_party_trackers_on_results', 'Third-party trackers on result pages', 'Drittanbieter-Tracker auf Ergebnisseiten', 'boolean', 'risk', 'optional', 2060, 'Whether search result pages document or expose third-party tracking scripts, pixels, or similar trackers.', 'Ob Suchergebnisseiten Drittanbieter-Tracking-Skripte, Pixel oder aehnliche Tracker dokumentieren oder ausliefern.'
  UNION ALL SELECT 'search-engine', 'query_controls', 'advanced_search_operators', 'Advanced search operators', 'Erweiterte Suchoperatoren', 'multi_enum', 'beneficial', 'multi_select', 3010, 'Advanced query syntax documented for exact matches, exclusions, site limits, file types, Boolean logic, title, or URL matching.', 'Dokumentierte erweiterte Suchsyntax fuer exakte Treffer, Ausschluesse, Site-Begrenzung, Dateitypen, Boolesche Logik, Titel oder URL-Treffer.'
  UNION ALL SELECT 'search-engine', 'query_controls', 'search_filter_controls', 'Search filter controls', 'Suchfilter-Kontrollen', 'multi_enum', 'beneficial', 'multi_select', 3020, 'Search filters users can apply for date, region, language, safe search, content type, license, or source.', 'Suchfilter fuer Datum, Region, Sprache, Safe Search, Inhaltstyp, Lizenz oder Quelle.'
  ...
  UNION ALL SELECT 'search-engine', 'query_controls', 'result_page_features', 'Result page features', 'Funktionen der Ergebnisseite', 'multi_enum', 'informational', 'multi_select', 3040, 'Result page aids such as snippets, cached pages, knowledge panels, related questions, suggestions, or source labels.', 'Hilfen auf der Ergebnisseite wie Auszuege, Cache-Seiten, Wissenspanels, verwandte Fragen, Vorschlaege oder Quellenhinweise.'
  UNION ALL SELECT 'search-engine', 'query_controls', 'spelling_query_assistance', 'Spelling and query assistance', 'Rechtschreib- und Anfragehilfe', 'multi_enum', 'informational', 'multi_select', 3050, 'Assistance features for spelling correction, autocomplete, related searches, or synonym expansion.', 'Hilfsfunktionen fuer Rechtschreibkorrektur, Autovervollstaendigung, verwandte Suchanfragen oder Synonymerweiterung.'
  ...
  UNION ALL SELECT 'search-engine', 'result_types', 'image_search_filters', 'Image search filters', 'Bildsuchfilter', 'multi_enum', 'beneficial', 'multi_select', 4020, 'Image search controls for size, color, type, license, freshness, or safe search.', 'Bildsuchkontrollen fuer Groesse, Farbe, Typ, Lizenz, Aktualitaet oder Safe Search.'
  UNION ALL SELECT 'search-engine', 'result_types', 'news_search_controls', 'News search controls', 'Nachrichten-Suchkontrollen', 'multi_enum', 'informational', 'multi_select', 4030, 'News search controls for a dedicated vertical, source, date, region, or publisher labels.', 'Nachrichten-Suchkontrollen fuer eine eigene Vertikale, Quelle, Datum, Region oder Herausgeberhinweise.'
  ...
  UNION ALL SELECT 'search-engine', 'result_types', 'multimedia_search_controls', 'Multimedia search controls', 'Multimedia-Suchkontrollen', 'multi_enum', 'informational', 'multi_select', 4050, 'Controls for multimedia results such as duration, source site, resolution, reverse image upload, transcript, or caption search.', 'Kontrollen fuer Multimedia-Ergebnisse wie Dauer, Quellseite, Aufloesung, Rueckwaertsbild-Upload, Transkript- oder Untertitelsuche.'
  UNION ALL SELECT 'search-engine', 'ai_answers', 'ai_answer_mode', 'AI answer mode', 'KI-Antwortmodus', 'enum', 'tradeoff', 'optional', 5010, 'Whether AI answers are absent, optional, separate, shown by default, or default with opt-out.', 'Ob KI-Antworten fehlen, optional sind, separat angeboten werden, standardmaessig erscheinen oder mit Opt-out aktiv sind.'
  UNION ALL SELECT 'search-engine', 'ai_answers', 'ai_source_citations', 'AI source citations', 'Quellenangaben fuer KI', 'enum', 'informational', 'optional', 5020, 'How AI answer sources are shown, such as links, inline citations, quotes, not applicable, or unclear.', 'Wie Quellen fuer KI-Antworten angezeigt werden, etwa Links, Inline-Quellenangaben, Zitate, nicht anwendbar oder unklar.'
  UNION ALL SELECT 'search-engine', 'ai_answers', 'ai_data_use_controls', 'AI data-use controls', 'Kontrollen zur KI-Datennutzung', 'enum', 'risk', 'optional', 5030, 'Controls or policies for whether search data is used for AI training or related AI features.', 'Kontrollen oder Richtlinien dazu, ob Suchdaten fuer KI-Training oder verwandte KI-Funktionen genutzt werden.'
  UNION ALL SELECT 'search-engine', 'ai_answers', 'non_ai_instant_answers', 'Non-AI instant answers', 'Nicht-KI-Sofortantworten', 'multi_enum', 'informational', 'multi_select', 5040, 'Non-AI answer modules such as calculator, conversion, weather, dictionary, encyclopedia, finance, sports, or time zones.', 'Nicht-KI-Antwortmodule wie Rechner, Umrechnung, Wetter, Woerterbuch, Enzyklopaedie, Finanzen, Sport oder Zeitzonen.'
  UNION ALL SELECT 'search-engine', 'ads_commercial', 'search_ads_model', 'Search ads model', 'Suchanzeigenmodell', 'enum', 'tradeoff', 'optional', 6010, 'The documented model for ads in search results, including none, contextual, keyword, personalized, shopping, or unclear modes.', 'Das dokumentierte Modell fuer Anzeigen in Suchergebnissen, einschliesslich keine, kontextbezogen, Keyword, personalisiert, Shopping oder unklar.'
  ...
  UNION ALL SELECT 'search-engine', 'ads_commercial', 'affiliate_shopping_links', 'Affiliate or shopping links', 'Affiliate- oder Shopping-Links', 'boolean', 'tradeoff', 'optional', 6030, 'Whether result pages include documented affiliate links, shopping placements, or similar commercial links.', 'Ob Ergebnisseiten dokumentierte Affiliate-Links, Shopping-Platzierungen oder aehnliche kommerzielle Links enthalten.'
  ...
  UNION ALL SELECT 'search-engine', 'access_integrations', 'access_paths', 'Access paths', 'Zugriffswege', 'multi_enum', 'informational', 'multi_select', 7010, 'Documented ways to use the search engine, including web, mobile web, extensions, apps, onion service, API, or self-hosted deployment.', 'Dokumentierte Nutzungswege der Suchmaschine, einschliesslich Web, mobiles Web, Erweiterungen, Apps, Onion-Dienst, API oder selbstgehostete Bereitstellung.'
  UNION ALL SELECT 'search-engine', 'access_integrations', 'browser_default_support', 'Browser default-search support', 'Unterstuetzung als Browser-Standardsuche', 'boolean', 'beneficial', 'optional', 7020, 'Whether the service documents support for use as a browser default search engine.', 'Ob der Dienst die Nutzung als Browser-Standardsuche dokumentiert.'
  UNION ALL SELECT 'search-engine', 'access_integrations', 'developer_api', 'Developer API', 'Entwickler-API', 'enum', 'tradeoff', 'optional', 7030, 'The documented availability and model of search APIs for developers or teams.', 'Die dokumentierte Verfuegbarkeit und das Modell von Such-APIs fuer Entwickler oder Teams.'
  UNION ALL SELECT 'search-engine', 'access_integrations', 'self_hosting_available', 'Self-hosting available', 'Selbsthosting verfuegbar', 'boolean', 'tradeoff', 'optional', 7040, 'Whether users can deploy or operate the search engine or metasearch software themselves.', 'Ob Nutzer die Suchmaschine oder Metasuchsoftware selbst bereitstellen oder betreiben koennen.'
  UNION ALL SELECT 'search-engine', 'access_integrations', 'opensearch_description_support', 'OpenSearch description support', 'OpenSearch-Description-Unterstuetzung', 'boolean', 'beneficial', 'optional', 7050, 'Whether an OpenSearch description is documented for browser search integration.', 'Ob eine OpenSearch-Description fuer Browser-Suchintegration dokumentiert ist.'
  UNION ALL SELECT 'search-engine', 'safety_transparency', 'safe_search_controls', 'Safe search controls', 'Safe-Search-Kontrollen', 'enum', 'informational', 'optional', 8010, 'The documented model for safe search controls, from none to granular or lockable profiles.', 'Das dokumentierte Modell fuer Safe-Search-Kontrollen, von keine bis granular oder sperrbare Profile.'
  UNION ALL SELECT 'search-engine', 'safety_transparency', 'malware_phishing_warnings', 'Malware and phishing warnings', 'Malware- und Phishing-Warnungen', 'boolean', 'beneficial', 'optional', 8020, 'Whether result pages document warnings for malware, phishing, unsafe links, or similar threats.', 'Ob Ergebnisseiten Warnungen vor Malware, Phishing, unsicheren Links oder aehnlichen Bedrohungen dokumentieren.'
  ...
  UNION ALL SELECT 'search-engine', 'safety_transparency', 'result_transparency_signals', 'Result transparency signals', 'Transparenzsignale in Ergebnissen', 'multi_enum', 'informational', 'multi_select', 8040, 'Visible signals in results such as source ownership, publication date, cache, ranking explanation, ad disclosure, or AI disclosure.', 'Sichtbare Signale in Ergebnissen wie Quelleninhaber, Veroeffentlichungsdatum, Cache, Ranking-Erklaerung, Anzeigenhinweis oder KI-Hinweis.'
  UNION ALL SELECT 'search-engine', 'fit_profiles', 'fit_profiles', 'Fit profiles', 'Eignungsprofile', 'multi_enum', 'informational', 'multi_select', 9010, 'Common user profiles the search engine is especially suited to support.', 'Typische Nutzerprofile, fuer die die Suchmaschine besonders geeignet ist.'
  UNION ALL SELECT 'search-engine', 'fit_profiles', 'best_query_types', 'Best query types', 'Beste Anfragearten', 'multi_enum', 'informational', 'multi_select', 9020, 'Query types where the service documents or commonly supports a strong product fit.', 'Anfragearten, fuer die der Dienst eine starke Eignung dokumentiert oder typischerweise unterstuetzt.'
) AS d
...
FROM (
  ...
  UNION ALL SELECT 'search-engine', 'result_freshness_controls', 'recent_results', 'Recent results filter', 'Filter fuer aktuelle Ergebnisse', 'positive', 20
  UNION ALL SELECT 'search-engine', 'result_freshness_controls', 'news_freshness', 'News freshness sorting', 'Aktualitaetssortierung fuer Nachrichten', 'neutral', 30
  ...
  UNION ALL SELECT 'search-engine', 'regional_language_controls', 'country_region', 'Country or region selector', 'Laender- oder Regionsauswahl', 'positive', 10
  UNION ALL SELECT 'search-engine', 'regional_language_controls', 'interface_language', 'Interface language', 'Oberflaechensprache', 'neutral', 20
  ...
  UNION ALL SELECT 'search-engine', 'ip_address_handling', 'anonymized', 'Anonymized or truncated', 'Anonymisiert oder gekuerzt', 'positive', 20
  ...
  UNION ALL SELECT 'search-engine', 'ip_address_handling', 'retained_for_security', 'Retained for security', 'Fuer Sicherheit gespeichert', 'neutral', 40
  UNION ALL SELECT 'search-engine', 'ip_address_handling', 'retained_for_personalization', 'Retained for personalization', 'Fuer Personalisierung gespeichert', 'warning', 50
  ...
  UNION ALL SELECT 'search-engine', 'personalized_results', 'default_on', 'On by default', 'Standardmaessig aktiv', 'warning', 40
  ...
  UNION ALL SELECT 'search-engine', 'advanced_search_operators', 'exclude_terms', 'Exclude terms', 'Begriffe ausschliessen', 'positive', 20
  ...
  UNION ALL SELECT 'search-engine', 'result_page_features', 'snippets', 'Result snippets', 'Ergebnisauszuege', 'neutral', 10
  ...
  UNION ALL SELECT 'search-engine', 'result_page_features', 'query_suggestions', 'Query suggestions', 'Suchvorschlaege', 'neutral', 50
  ...
  UNION ALL SELECT 'search-engine', 'spelling_query_assistance', 'autocomplete', 'Autocomplete', 'Autovervollstaendigung', 'neutral', 20
  ...
  UNION ALL SELECT 'search-engine', 'image_search_filters', 'size', 'Size', 'Groesse', 'positive', 10
  ...
  UNION ALL SELECT 'search-engine', 'image_search_filters', 'freshness', 'Freshness', 'Aktualitaet', 'neutral', 50
  ...
  UNION ALL SELECT 'search-engine', 'multimedia_search_controls', 'resolution', 'Resolution filter', 'Aufloesungsfilter', 'neutral', 30
  UNION ALL SELECT 'search-engine', 'multimedia_search_controls', 'upload_reverse_image', 'Upload/reverse image search', 'Upload-/Rueckwaertsbildsuche', 'tradeoff', 40
  ...
  UNION ALL SELECT 'search-engine', 'ai_answer_mode', 'default_summarization', 'Default summarization', 'Standardmaessige Zusammenfassung', 'tradeoff', 40
  ...
  UNION ALL SELECT 'search-engine', 'ai_data_use_controls', 'not_used_for_ai', 'Not used for AI training', 'Nicht fuer KI-Training genutzt', 'positive', 10
  UNION ALL SELECT 'search-engine', 'ai_data_use_controls', 'opt_in_training', 'Opt-in training', 'Opt-in fuer Training', 'positive', 20
  UNION ALL SELECT 'search-engine', 'ai_data_use_controls', 'opt_out_available', 'Opt-out available', 'Opt-out verfuegbar', 'neutral', 30
  ...
  UNION ALL SELECT 'search-engine', 'non_ai_instant_answers', 'dictionary', 'Dictionary', 'Woerterbuch', 'neutral', 40
  UNION ALL SELECT 'search-engine', 'non_ai_instant_answers', 'encyclopedia', 'Encyclopedia', 'Enzyklopaedie', 'neutral', 50
  ...
  UNION ALL SELECT 'search-engine', 'developer_api', 'public_search_api', 'Public search API', 'Oeffentliche Such-API', 'positive', 20
  ...
  UNION ALL SELECT 'search-engine', 'safe_search_controls', 'default_strict', 'Strict by default', 'Standardmaessig streng', 'tradeoff', 50
  ...
  UNION ALL SELECT 'search-engine', 'result_transparency_signals', 'date_published', 'Date published', 'Veroeffentlichungsdatum', 'positive', 20
  ...
  UNION ALL SELECT 'search-engine', 'result_transparency_signals', 'ranking_explanation', 'Ranking explanation', 'Ranking-Erklaerung', 'positive', 40
  ...
  UNION ALL SELECT 'search-engine', 'fit_profiles', 'independent_index', 'Independent-index preference', 'Praeferenz fuer unabhaengigen Index', 'positive', 20
