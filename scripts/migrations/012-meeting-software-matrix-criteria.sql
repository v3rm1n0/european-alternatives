...
VALUES
  ...
  ('meeting-software', 'platforms_devices', 'Platforms & Devices', 'Plattformen & Geraete', 'Supported clients, browsers, phones, room systems, and bandwidth modes.', 'Unterstuetzte Clients, Browser, Telefone, Raumgeraete und Bandbreitenmodi.', 200),
  ('meeting-software', 'capacity_formats', 'Capacity & Formats', 'Kapazitaet & Formate', 'Participant limits, meeting duration, webinars, registration, and scheduling.', 'Teilnehmergrenzen, Meetingdauer, Webinare, Registrierung und Terminplanung.', 300),
  ...
  ('meeting-software', 'security_controls', 'Security & Host Controls', 'Sicherheit & Host-Kontrollen', 'Meeting access controls, encryption, moderation, and participant permissions.', 'Meeting-Zugriffskontrollen, Verschluesselung, Moderation und Teilnehmerberechtigungen.', 500),
  ...
  ('meeting-software', 'deployment_interop', 'Deployment & Interop', 'Bereitstellung & Interop', 'SaaS or self-hosting model, protocols, federation, and deployment requirements.', 'SaaS- oder Selbsthosting-Modell, Protokolle, Foederation und Bereitstellungsanforderungen.', 800),
  ('meeting-software', 'accessibility_fit', 'Accessibility & Fit', 'Barrierefreiheit & Eignung', 'Accessibility capabilities, language support, and user-fit profiles.', 'Barrierefreiheitsfunktionen, Sprachunterstuetzung und Eignungsprofile.', 900);
...
FROM (
  ...
  UNION ALL SELECT 'meeting-software', 'joining_access', 'guest_join_without_account', 'Guest join without account', 'Gastbeitritt ohne Konto', 'boolean', 'beneficial', 'must_match', 1020, 'Whether participants can join a meeting as guests without creating an account.', 'Ob Teilnehmer einem Meeting als Gaeste beitreten koennen, ohne ein Konto zu erstellen.'
  UNION ALL SELECT 'meeting-software', 'joining_access', 'browser_join_supported', 'Browser join supported', 'Beitritt im Browser unterstuetzt', 'boolean', 'beneficial', 'optional', 1030, 'Whether participants can join meetings from a supported web browser.', 'Ob Teilnehmer Meetings ueber einen unterstuetzten Webbrowser beitreten koennen.'
  UNION ALL SELECT 'meeting-software', 'joining_access', 'invitation_join_methods', 'Invitation and join methods', 'Einladungs- und Beitrittsmethoden', 'multi_enum', 'informational', 'multi_select', 1040, 'Documented ways hosts can invite participants or participants can join a meeting.', 'Dokumentierte Wege, wie Hosts Teilnehmer einladen oder Teilnehmer einem Meeting beitreten koennen.'
  UNION ALL SELECT 'meeting-software', 'joining_access', 'waiting_room_or_lobby', 'Waiting room or lobby', 'Warteraum oder Lobby', 'boolean', 'beneficial', 'optional', 1050, 'Whether hosts can hold participants before admitting them to a meeting.', 'Ob Hosts Teilnehmer vor dem Eintritt in ein Meeting zurueckhalten koennen.'
  UNION ALL SELECT 'meeting-software', 'platforms_devices', 'supported_platforms', 'Supported platforms', 'Unterstuetzte Plattformen', 'multi_enum', 'informational', 'multi_select', 2010, 'Maintained platforms, operating systems, devices, and access paths for meeting users.', 'Gepflegte Plattformen, Betriebssysteme, Geraete und Zugriffswege fuer Meeting-Nutzer.'
  UNION ALL SELECT 'meeting-software', 'platforms_devices', 'desktop_apps', 'Desktop apps', 'Desktop-Apps', 'boolean', 'beneficial', 'optional', 2020, 'Whether maintained desktop applications are available for meeting use.', 'Ob gepflegte Desktop-Anwendungen fuer Meetings verfuegbar sind.'
  UNION ALL SELECT 'meeting-software', 'platforms_devices', 'mobile_apps', 'Mobile apps', 'Mobile Apps', 'boolean', 'beneficial', 'optional', 2030, 'Whether maintained mobile applications are available for meeting use.', 'Ob gepflegte Mobile-Apps fuer Meetings verfuegbar sind.'
  UNION ALL SELECT 'meeting-software', 'platforms_devices', 'room_system_support', 'Room system support', 'Raumgeraete-Unterstuetzung', 'enum', 'tradeoff', 'optional', 2040, 'How the product supports meeting room devices, gateways, or vendor room systems.', 'Wie das Produkt Meeting-Raumgeraete, Gateways oder Anbieter-Raumsysteme unterstuetzt.'
  UNION ALL SELECT 'meeting-software', 'platforms_devices', 'pstn_dial_in', 'PSTN dial-in', 'PSTN-Einwahl', 'boolean', 'tradeoff', 'optional', 2050, 'Whether participants can join meetings through a telephone dial-in number.', 'Ob Teilnehmer Meetings ueber eine Telefoneinwahlnummer beitreten koennen.'
  UNION ALL SELECT 'meeting-software', 'platforms_devices', 'low_bandwidth_mode', 'Low-bandwidth mode', 'Modus fuer geringe Bandbreite', 'boolean', 'beneficial', 'optional', 2060, 'Whether the product documents a mode or controls for constrained network connections.', 'Ob das Produkt einen Modus oder Kontrollen fuer eingeschraenkte Netzwerkverbindungen dokumentiert.'
  UNION ALL SELECT 'meeting-software', 'capacity_formats', 'max_participants', 'Maximum participants', 'Maximale Teilnehmerzahl', 'number', 'informational', 'range', 3010, 'Documented maximum participant count for a standard interactive meeting.', 'Dokumentierte maximale Teilnehmerzahl fuer ein normales interaktives Meeting.'
  UNION ALL SELECT 'meeting-software', 'capacity_formats', 'meeting_duration_limit_minutes', 'Meeting duration limit (minutes)', 'Zeitlimit fuer Meetings (Minuten)', 'number', 'informational', 'range', 3020, 'Documented maximum meeting duration in minutes for standard meetings.', 'Dokumentiertes maximales Zeitlimit in Minuten fuer normale Meetings.'
  UNION ALL SELECT 'meeting-software', 'capacity_formats', 'recurring_meetings', 'Recurring meetings', 'Wiederkehrende Meetings', 'boolean', 'beneficial', 'optional', 3030, 'Whether hosts can schedule meetings that repeat on a defined cadence.', 'Ob Hosts Meetings planen koennen, die sich in einem festgelegten Rhythmus wiederholen.'
  UNION ALL SELECT 'meeting-software', 'capacity_formats', 'breakout_rooms', 'Breakout rooms', 'Breakout-Raeume', 'boolean', 'beneficial', 'optional', 3040, 'Whether hosts can split participants into smaller meeting rooms or sessions.', 'Ob Hosts Teilnehmer in kleinere Meeting-Raeume oder Sitzungen aufteilen koennen.'
  UNION ALL SELECT 'meeting-software', 'capacity_formats', 'webinar_or_town_hall_mode', 'Webinar or town hall mode', 'Webinar- oder Town-Hall-Modus', 'enum', 'informational', 'optional', 3050, 'Whether the product documents larger presentation-oriented meeting formats.', 'Ob das Produkt groessere praesentationsorientierte Meeting-Formate dokumentiert.'
  UNION ALL SELECT 'meeting-software', 'capacity_formats', 'registration_rsvp_support', 'Registration or RSVP support', 'Registrierung oder RSVP', 'boolean', 'beneficial', 'optional', 3060, 'Whether hosts can collect participant registration, RSVP, or attendee details before a meeting.', 'Ob Hosts vor einem Meeting Registrierung, RSVP oder Teilnehmerdaten erfassen koennen.'
  UNION ALL SELECT 'meeting-software', 'capacity_formats', 'scheduling_calendar_support', 'Scheduling and calendar support', 'Termin- und Kalenderunterstuetzung', 'multi_enum', 'informational', 'multi_select', 3070, 'Documented scheduling and calendar features for creating or joining meetings.', 'Dokumentierte Termin- und Kalenderfunktionen zum Erstellen oder Beitreten von Meetings.'
  UNION ALL SELECT 'meeting-software', 'collaboration_tools', 'screen_sharing', 'Screen sharing', 'Bildschirmfreigabe', 'boolean', 'beneficial', 'must_match', 4010, 'Whether participants or hosts can share a screen or application window during a meeting.', 'Ob Teilnehmer oder Hosts waehrend eines Meetings einen Bildschirm oder ein Anwendungsfenster freigeben koennen.'
  UNION ALL SELECT 'meeting-software', 'collaboration_tools', 'remote_control', 'Remote control', 'Fernsteuerung', 'boolean', 'tradeoff', 'optional', 4020, 'Whether a participant can request or grant remote control of a shared screen.', 'Ob ein Teilnehmer die Fernsteuerung eines freigegebenen Bildschirms anfordern oder gewaehren kann.'
  ...
  UNION ALL SELECT 'meeting-software', 'collaboration_tools', 'shared_notes_docs', 'Shared notes or documents', 'Gemeinsame Notizen oder Dokumente', 'multi_enum', 'informational', 'multi_select', 4040, 'Documented shared notes, agenda, document, or action-item features for meetings.', 'Dokumentierte gemeinsame Notiz-, Agenda-, Dokument- oder Aufgabenfunktionen fuer Meetings.'
  UNION ALL SELECT 'meeting-software', 'collaboration_tools', 'in_meeting_chat', 'In-meeting chat', 'Chat im Meeting', 'boolean', 'beneficial', 'optional', 4050, 'Whether participants can exchange chat messages during a meeting.', 'Ob Teilnehmer waehrend eines Meetings Chatnachrichten austauschen koennen.'
  ...
  UNION ALL SELECT 'meeting-software', 'collaboration_tools', 'file_sharing', 'File sharing', 'Dateifreigabe', 'boolean', 'beneficial', 'optional', 4070, 'Whether users can share files in or alongside meetings.', 'Ob Nutzer Dateien in Meetings oder begleitend dazu teilen koennen.'
  UNION ALL SELECT 'meeting-software', 'security_controls', 'meeting_passcodes', 'Meeting passcodes', 'Meeting-Passcodes', 'boolean', 'beneficial', 'optional', 5010, 'Whether meetings can be protected with a passcode or equivalent join secret.', 'Ob Meetings mit einem Passcode oder gleichwertigen Beitrittsgeheimnis geschuetzt werden koennen.'
  UNION ALL SELECT 'meeting-software', 'security_controls', 'e2ee_available', 'E2EE availability', 'E2EE-Verfuegbarkeit', 'enum', 'beneficial', 'optional', 5020, 'How end-to-end encryption is documented for meetings or meeting modes.', 'Wie Ende-zu-Ende-Verschluesselung fuer Meetings oder Meeting-Modi dokumentiert ist.'
  UNION ALL SELECT 'meeting-software', 'security_controls', 'host_moderation_controls', 'Host moderation controls', 'Host-Moderationskontrollen', 'multi_enum', 'beneficial', 'multi_select', 5030, 'Meeting controls that let hosts moderate participants and meeting flow.', 'Meeting-Kontrollen, mit denen Hosts Teilnehmer und Meeting-Ablauf moderieren koennen.'
  UNION ALL SELECT 'meeting-software', 'security_controls', 'participant_permissions', 'Participant permissions', 'Teilnehmerberechtigungen', 'multi_enum', 'beneficial', 'multi_select', 5040, 'Permissions hosts or admins can control for participant actions during meetings.', 'Berechtigungen, die Hosts oder Admins fuer Teilnehmeraktionen in Meetings steuern koennen.'
  UNION ALL SELECT 'meeting-software', 'security_controls', 'authenticated_participant_controls', 'Authenticated participant controls', 'Kontrollen fuer authentifizierte Teilnehmer', 'boolean', 'beneficial', 'optional', 5050, 'Whether hosts or admins can limit access or features to authenticated participants.', 'Ob Hosts oder Admins Zugriff oder Funktionen auf authentifizierte Teilnehmer beschraenken koennen.'
  UNION ALL SELECT 'meeting-software', 'security_controls', 'abuse_reporting_controls', 'Abuse reporting controls', 'Missbrauchsmeldungen', 'boolean', 'beneficial', 'optional', 5060, 'Whether users can report abuse, disruption, or unsafe behavior from meeting contexts.', 'Ob Nutzer Missbrauch, Stoerungen oder unsicheres Verhalten aus Meeting-Kontexten melden koennen.'
  UNION ALL SELECT 'meeting-software', 'recording_data', 'recording_available', 'Recording availability', 'Aufzeichnungsverfuegbarkeit', 'enum', 'tradeoff', 'optional', 6010, 'Whether and how meeting recording is available for standard meetings.', 'Ob und wie Meeting-Aufzeichnung fuer normale Meetings verfuegbar ist.'
  ...
  UNION ALL SELECT 'meeting-software', 'recording_data', 'data_residency_options', 'Data residency options', 'Optionen fuer Datenresidenz', 'enum', 'tradeoff', 'optional', 6050, 'Documented residency options for meeting data, recordings, transcripts, or admin data.', 'Dokumentierte Residenzoptionen fuer Meeting-Daten, Aufzeichnungen, Transkripte oder Administrationsdaten.'
  UNION ALL SELECT 'meeting-software', 'recording_data', 'ai_meeting_features', 'AI meeting features', 'KI-Meeting-Funktionen', 'multi_enum', 'tradeoff', 'multi_select', 6060, 'AI-assisted meeting features such as summaries, assistants, action items, translation, or insights.', 'KI-gestuetzte Meeting-Funktionen wie Zusammenfassungen, Assistenten, Aufgabenpunkte, Uebersetzung oder Einblicke.'
  ...
  UNION ALL SELECT 'meeting-software', 'admin_integrations', 'sso_support', 'SSO support', 'SSO-Unterstuetzung', 'enum', 'beneficial', 'optional', 7020, 'Documented single sign-on methods for organizational meeting accounts.', 'Dokumentierte Single-Sign-on-Methoden fuer organisatorische Meeting-Konten.'
  ...
  UNION ALL SELECT 'meeting-software', 'admin_integrations', 'audit_logs', 'Audit logs', 'Audit-Protokolle', 'boolean', 'beneficial', 'optional', 7040, 'Whether admins can access audit logs for meeting or account activity.', 'Ob Admins Audit-Protokolle fuer Meeting- oder Kontoaktivitaeten abrufen koennen.'
  UNION ALL SELECT 'meeting-software', 'admin_integrations', 'calendar_integrations', 'Calendar integrations', 'Kalenderintegrationen', 'multi_enum', 'informational', 'multi_select', 7050, 'Calendar systems documented for scheduling, invitations, or meeting join workflows.', 'Kalendersysteme, die fuer Terminplanung, Einladungen oder Beitrittsablaeufe dokumentiert sind.'
  UNION ALL SELECT 'meeting-software', 'admin_integrations', 'app_marketplace_api', 'Apps, APIs, and automation', 'Apps, APIs und Automatisierung', 'multi_enum', 'tradeoff', 'multi_select', 7060, 'Documented APIs, webhooks, apps, SDKs, marketplaces, or automation connectors.', 'Dokumentierte APIs, Webhooks, Apps, SDKs, Marktplaetze oder Automatisierungs-Connectoren.'
  ...
  UNION ALL SELECT 'meeting-software', 'deployment_interop', 'deployment_model', 'Deployment model', 'Bereitstellungsmodell', 'enum', 'tradeoff', 'optional', 8010, 'The primary deployment model documented for the meeting product.', 'Das primaere Bereitstellungsmodell, das fuer das Meeting-Produkt dokumentiert ist.'
  UNION ALL SELECT 'meeting-software', 'deployment_interop', 'self_hosting_available', 'Self-hosting available', 'Selbsthosting verfuegbar', 'boolean', 'tradeoff', 'optional', 8020, 'Whether organizations can operate compatible meeting infrastructure themselves.', 'Ob Organisationen kompatible Meeting-Infrastruktur selbst betreiben koennen.'
  UNION ALL SELECT 'meeting-software', 'deployment_interop', 'protocol_interoperability', 'Protocol interoperability', 'Protokoll-Interoperabilitaet', 'multi_enum', 'tradeoff', 'multi_select', 8030, 'Documented protocols, gateways, or standards used for meeting interoperability.', 'Dokumentierte Protokolle, Gateways oder Standards fuer Meeting-Interoperabilitaet.'
  UNION ALL SELECT 'meeting-software', 'deployment_interop', 'federation_or_multi_server', 'Federation or multi-server model', 'Foederation oder Mehrserver-Modell', 'enum', 'tradeoff', 'optional', 8040, 'Whether meetings depend on centralized service, federation, peer-to-peer, or multi-server operation.', 'Ob Meetings von zentralisiertem Dienst, Foederation, Peer-to-peer- oder Mehrserverbetrieb abhaengen.'
  UNION ALL SELECT 'meeting-software', 'deployment_interop', 'deployment_requirements', 'Deployment requirements', 'Bereitstellungsanforderungen', 'multi_enum', 'informational', 'multi_select', 8050, 'Infrastructure components documented for operating or integrating the meeting system.', 'Infrastrukturkomponenten, die fuer Betrieb oder Integration des Meeting-Systems dokumentiert sind.'
  UNION ALL SELECT 'meeting-software', 'accessibility_fit', 'accessibility_features', 'Accessibility features', 'Barrierefreiheitsfunktionen', 'multi_enum', 'beneficial', 'multi_select', 9010, 'Documented accessibility features for meeting participants and hosts.', 'Dokumentierte Barrierefreiheitsfunktionen fuer Meeting-Teilnehmer und Hosts.'
  UNION ALL SELECT 'meeting-software', 'accessibility_fit', 'live_captions', 'Live captions', 'Live-Untertitel', 'boolean', 'beneficial', 'optional', 9020, 'Whether live captions are available during meetings.', 'Ob Live-Untertitel waehrend Meetings verfuegbar sind.'
  UNION ALL SELECT 'meeting-software', 'accessibility_fit', 'language_interpretation_translation', 'Interpretation and translation', 'Dolmetschen und Uebersetzung', 'multi_enum', 'informational', 'multi_select', 9030, 'Documented interpretation, caption translation, live translation, or language support features.', 'Dokumentierte Funktionen fuer Dolmetschen, Untertiteluebersetzung, Live-Uebersetzung oder Sprachunterstuetzung.'
  UNION ALL SELECT 'meeting-software', 'accessibility_fit', 'fit_profiles', 'Fit profiles', 'Eignungsprofile', 'multi_enum', 'informational', 'multi_select', 9040, 'Common meeting use cases or organization profiles the product is suited to support.', 'Typische Meeting-Anwendungsfaelle oder Organisationsprofile, fuer die das Produkt geeignet ist.'
) AS d
...
FROM (
  ...
  UNION ALL SELECT 'meeting-software', 'supported_platforms', 'room_devices', 'Room devices', 'Raumgeraete', 'tradeoff', 70
  ...
  UNION ALL SELECT 'meeting-software', 'room_system_support', 'dedicated_room_devices', 'Dedicated room devices', 'Dedizierte Raumgeraete', 'tradeoff', 30
  ...
  UNION ALL SELECT 'meeting-software', 'e2ee_available', 'optional_meetings', 'Optional for meetings', 'Optional fuer Meetings', 'positive', 30
  UNION ALL SELECT 'meeting-software', 'e2ee_available', 'default_meetings', 'Default for meetings', 'Standard fuer Meetings', 'positive', 40
  ...
  UNION ALL SELECT 'meeting-software', 'participant_permissions', 'name_change_control', 'Name-change control', 'Namensaenderungskontrolle', 'neutral', 60
  ...
  UNION ALL SELECT 'meeting-software', 'data_residency_options', 'eu_region', 'EU region available', 'EU-Region verfuegbar', 'positive', 30
  ...
  UNION ALL SELECT 'meeting-software', 'ai_meeting_features', 'real_time_translation', 'Real-time translation', 'Echtzeit-Uebersetzung', 'tradeoff', 40
  ...
  UNION ALL SELECT 'meeting-software', 'app_marketplace_api', 'public_api', 'Public API', 'Oeffentliche API', 'positive', 10
  ...
  UNION ALL SELECT 'meeting-software', 'federation_or_multi_server', 'federated', 'Federated', 'Foederiert', 'positive', 30
  ...
  UNION ALL SELECT 'meeting-software', 'accessibility_features', 'screen_reader_support', 'Screen-reader support', 'Screenreader-Unterstuetzung', 'positive', 20
  ...
  UNION ALL SELECT 'meeting-software', 'language_interpretation_translation', 'translated_captions', 'Translated captions', 'Uebersetzte Untertitel', 'neutral', 20
  UNION ALL SELECT 'meeting-software', 'language_interpretation_translation', 'live_translation', 'Live translation', 'Live-Uebersetzung', 'tradeoff', 30
  UNION ALL SELECT 'meeting-software', 'language_interpretation_translation', 'multilingual_ui', 'Multilingual UI', 'Mehrsprachige Oberflaeche', 'neutral', 40
  UNION ALL SELECT 'meeting-software', 'language_interpretation_translation', 'rtl_support', 'RTL support', 'RTL-Unterstuetzung', 'neutral', 50
  UNION ALL SELECT 'meeting-software', 'fit_profiles', 'small_team_meetings', 'Small team meetings', 'Kleine Teammeetings', 'neutral', 10
  UNION ALL SELECT 'meeting-software', 'fit_profiles', 'public_webinars', 'Public webinars', 'Oeffentliche Webinare', 'tradeoff', 20
  ...
  UNION ALL SELECT 'meeting-software', 'fit_profiles', 'large_enterprise', 'Large enterprise', 'Grosse Unternehmen', 'neutral', 60
