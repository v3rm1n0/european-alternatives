...
VALUES
  ...
  ('office-suite', 'platform_access', 'Platform & Access', 'Plattform & Zugriff', 'Where users can edit documents and whether offline or account-based access is required.', 'Wo Nutzer Dokumente bearbeiten koennen und ob Offline- oder kontobasierter Zugriff erforderlich ist.', 200),
  ('office-suite', 'file_formats', 'File Formats', 'Dateiformate', 'Compatibility with office formats, PDF workflows, export formats, and legacy files.', 'Kompatibilitaet mit Office-Formaten, PDF-Workflows, Exportformaten und alten Dateien.', 300),
  ('office-suite', 'collaboration_review', 'Collaboration & Review', 'Zusammenarbeit & Pruefung', 'Co-editing, comments, sharing, version history, and review workflows.', 'Gemeinsame Bearbeitung, Kommentare, Freigaben, Versionsverlauf und Pruef-Workflows.', 400),
  ('office-suite', 'document_spreadsheet_depth', 'Document & Spreadsheet Depth', 'Dokument- & Tabellenfunktionen', 'Advanced authoring, spreadsheet, presentation, template, and automation features.', 'Erweiterte Funktionen fuer Textverarbeitung, Tabellen, Praesentationen, Vorlagen und Automatisierung.', 500),
  ...
  ('office-suite', 'security_privacy', 'Security & Privacy Controls', 'Sicherheits- & Datenschutzkontrollen', 'Document protection, link security, DLP, retention, encryption, and telemetry controls.', 'Dokumentschutz, Link-Sicherheit, DLP, Aufbewahrung, Verschluesselung und Telemetrie-Kontrollen.', 700),
  ('office-suite', 'integrations_portability', 'Integrations & Portability', 'Integrationen & Portabilitaet', 'APIs, extensions, storage integrations, migration paths, and interoperability standards.', 'APIs, Erweiterungen, Speicher-Integrationen, Migrationswege und Interoperabilitaetsstandards.', 800),
  ('office-suite', 'accessibility_fit', 'Accessibility & Fit', 'Barrierefreiheit & Eignung', 'Accessibility, language tools, RTL support, AI assistance model, and common fit profiles.', 'Barrierefreiheit, Sprachwerkzeuge, RTL-Unterstuetzung, KI-Assistenzmodell und typische Eignungsprofile.', 900);
...
FROM (
  ...
  UNION ALL SELECT 'office-suite', 'suite_components', 'pdf_workflow', 'PDF workflow', 'PDF-Workflow', 'multi_enum', 'beneficial', 'multi_select', 1020, 'PDF-related capabilities such as export, import, editing, forms, signing, redaction, or OCR.', 'PDF-bezogene Funktionen wie Export, Import, Bearbeitung, Formulare, Signatur, Schwaerzung oder OCR.'
  ...
  UNION ALL SELECT 'office-suite', 'suite_components', 'templates_available', 'Templates available', 'Vorlagen verfuegbar', 'boolean', 'beneficial', 'optional', 1040, 'Whether the suite provides built-in or officially documented templates for common documents.', 'Ob das Paket eingebaute oder offiziell dokumentierte Vorlagen fuer haeufige Dokumente bereitstellt.'
  ...
  UNION ALL SELECT 'office-suite', 'platform_access', 'desktop_apps', 'Desktop apps', 'Desktop-Apps', 'boolean', 'beneficial', 'optional', 2010, 'Whether full editing applications are available for desktop operating systems.', 'Ob vollwertige Bearbeitungsprogramme fuer Desktop-Betriebssysteme verfuegbar sind.'
  UNION ALL SELECT 'office-suite', 'platform_access', 'web_editing', 'Browser editing', 'Bearbeitung im Browser', 'boolean', 'beneficial', 'must_match', 2020, 'Whether users can create or edit office documents in a web browser.', 'Ob Nutzer Office-Dokumente in einem Webbrowser erstellen oder bearbeiten koennen.'
  UNION ALL SELECT 'office-suite', 'platform_access', 'mobile_platforms', 'Mobile platforms', 'Mobile Plattformen', 'multi_enum', 'informational', 'multi_select', 2030, 'Mobile platforms or app distribution channels with documented editing support.', 'Mobile Plattformen oder App-Vertriebskanaele mit dokumentierter Bearbeitungsunterstuetzung.'
  UNION ALL SELECT 'office-suite', 'platform_access', 'offline_editing', 'Offline editing', 'Offline-Bearbeitung', 'boolean', 'beneficial', 'must_match', 2040, 'Whether documents can be edited without an active network connection after setup.', 'Ob Dokumente nach der Einrichtung ohne aktive Netzwerkverbindung bearbeitet werden koennen.'
  ...
  UNION ALL SELECT 'office-suite', 'file_formats', 'native_format_model', 'Native format model', 'Natives Formatmodell', 'enum', 'tradeoff', 'optional', 3010, 'The default or primary file format model used for saved documents.', 'Das standardmaessige oder primaere Dateiformatmodell fuer gespeicherte Dokumente.'
  UNION ALL SELECT 'office-suite', 'file_formats', 'ooxml_compatibility', 'OOXML compatibility', 'OOXML-Kompatibilitaet', 'enum', 'informational', 'optional', 3020, 'The documented level of Microsoft Office OOXML view, edit, import, export, or native support.', 'Der dokumentierte Umfang von Anzeige, Bearbeitung, Import, Export oder nativer Unterstuetzung fuer Microsoft-Office-OOXML.'
  UNION ALL SELECT 'office-suite', 'file_formats', 'odf_support', 'ODF support', 'ODF-Unterstuetzung', 'enum', 'beneficial', 'optional', 3030, 'The documented level of OpenDocument Format support or certification.', 'Der dokumentierte Umfang der Unterstuetzung oder Zertifizierung fuer das OpenDocument-Format.'
  UNION ALL SELECT 'office-suite', 'file_formats', 'legacy_format_support', 'Legacy format support', 'Unterstuetzung alter Formate', 'multi_enum', 'informational', 'multi_select', 3040, 'Older or compatibility formats the suite can open, save, or convert.', 'Aeltere oder kompatibilitaetsbezogene Formate, die das Paket oeffnen, speichern oder konvertieren kann.'
  UNION ALL SELECT 'office-suite', 'file_formats', 'export_formats', 'Export formats', 'Exportformate', 'multi_enum', 'beneficial', 'multi_select', 3050, 'Documented export formats available from the suite.', 'Dokumentierte Exportformate, die aus dem Paket verfuegbar sind.'
  UNION ALL SELECT 'office-suite', 'file_formats', 'format_fidelity_tools', 'Format fidelity tools', 'Werkzeuge fuer Format-Treue', 'multi_enum', 'informational', 'multi_select', 3060, 'Tools or warnings that help preserve layout and formatting across conversions.', 'Werkzeuge oder Warnungen, die Layout und Formatierung bei Konvertierungen erhalten helfen.'
  UNION ALL SELECT 'office-suite', 'collaboration_review', 'real_time_coediting', 'Real-time co-editing', 'Echtzeit-Zusammenarbeit', 'boolean', 'beneficial', 'must_match', 4010, 'Whether multiple users can edit the same document at the same time.', 'Ob mehrere Nutzer dasselbe Dokument gleichzeitig bearbeiten koennen.'
  UNION ALL SELECT 'office-suite', 'collaboration_review', 'comments_mentions', 'Comments and mentions', 'Kommentare und Erwaehnungen', 'boolean', 'beneficial', 'optional', 4020, 'Whether documents support comments, replies, or mentions for collaboration.', 'Ob Dokumente Kommentare, Antworten oder Erwaehnungen fuer Zusammenarbeit unterstuetzen.'
  UNION ALL SELECT 'office-suite', 'collaboration_review', 'track_changes_review', 'Track changes/review mode', 'Aenderungsverfolgung/Pruefmodus', 'boolean', 'beneficial', 'optional', 4030, 'Whether documents support tracked changes, suggestions, or a review mode.', 'Ob Dokumente Aenderungsverfolgung, Vorschlaege oder einen Pruefmodus unterstuetzen.'
  UNION ALL SELECT 'office-suite', 'collaboration_review', 'sharing_link_controls', 'Sharing link controls', 'Kontrollen fuer Freigabelinks', 'multi_enum', 'beneficial', 'multi_select', 4040, 'Controls available for document sharing links and invitation permissions.', 'Kontrollen fuer Dokument-Freigabelinks und Einladungsberechtigungen.'
  UNION ALL SELECT 'office-suite', 'collaboration_review', 'external_guest_collaboration', 'External guest collaboration', 'Externe Gast-Zusammenarbeit', 'enum', 'tradeoff', 'optional', 4050, 'How the suite supports collaboration with people outside the owning workspace or organization.', 'Wie das Paket Zusammenarbeit mit Personen ausserhalb des besitzenden Arbeitsbereichs oder der Organisation unterstuetzt.'
  ...
  UNION ALL SELECT 'office-suite', 'collaboration_review', 'collaboration_presence', 'Collaboration presence', 'Praesenz bei Zusammenarbeit', 'multi_enum', 'informational', 'multi_select', 4070, 'Presence and activity features that help collaborators see document activity.', 'Praesenz- und Aktivitaetsfunktionen, mit denen Beteiligte Dokumentaktivitaeten sehen koennen.'
  UNION ALL SELECT 'office-suite', 'document_spreadsheet_depth', 'mail_merge', 'Mail merge', 'Serienbriefe', 'boolean', 'beneficial', 'optional', 5010, 'Whether the word processor supports mail merge or equivalent bulk document generation.', 'Ob die Textverarbeitung Serienbriefe oder gleichwertige Massendokument-Erstellung unterstuetzt.'
  ...
  UNION ALL SELECT 'office-suite', 'document_spreadsheet_depth', 'advanced_layout_tools', 'Advanced layout tools', 'Erweiterte Layout-Werkzeuge', 'multi_enum', 'informational', 'multi_select', 5030, 'Advanced document layout and publishing tools available in the suite.', 'Erweiterte Werkzeuge fuer Dokumentlayout und Publikation im Paket.'
  UNION ALL SELECT 'office-suite', 'document_spreadsheet_depth', 'spreadsheet_advanced_features', 'Advanced spreadsheet features', 'Erweiterte Tabellenfunktionen', 'multi_enum', 'beneficial', 'multi_select', 5040, 'Advanced spreadsheet analysis, validation, charting, or data features.', 'Erweiterte Tabellenfunktionen fuer Analyse, Validierung, Diagramme oder Daten.'
  UNION ALL SELECT 'office-suite', 'document_spreadsheet_depth', 'presentation_features', 'Presentation features', 'Praesentationsfunktionen', 'multi_enum', 'informational', 'multi_select', 5050, 'Presentation authoring or delivery features beyond basic slide editing.', 'Funktionen fuer Erstellung oder Vortrag von Praesentationen jenseits einfacher Folienbearbeitung.'
  UNION ALL SELECT 'office-suite', 'document_spreadsheet_depth', 'macro_scripting_model', 'Macro/scripting model', 'Makro-/Skriptmodell', 'enum', 'tradeoff', 'optional', 5060, 'The documented automation or scripting model for documents and spreadsheets.', 'Das dokumentierte Automatisierungs- oder Skriptmodell fuer Dokumente und Tabellen.'
  UNION ALL SELECT 'office-suite', 'document_spreadsheet_depth', 'vba_macro_compatibility', 'VBA macro compatibility', 'VBA-Makro-Kompatibilitaet', 'enum', 'tradeoff', 'optional', 5070, 'The documented level of compatibility with Microsoft Office VBA macros.', 'Der dokumentierte Kompatibilitaetsumfang mit Microsoft-Office-VBA-Makros.'
  UNION ALL SELECT 'office-suite', 'deployment_admin', 'deployment_model', 'Deployment model', 'Bereitstellungsmodell', 'enum', 'tradeoff', 'optional', 6010, 'The primary hosted, desktop, self-hosted, hybrid, or mobile-only deployment model.', 'Das primaere gehostete, Desktop-, selbstgehostete, hybride oder nur mobile Bereitstellungsmodell.'
  UNION ALL SELECT 'office-suite', 'deployment_admin', 'self_hosting_available', 'Self-hosting available', 'Selbsthosting verfuegbar', 'boolean', 'tradeoff', 'optional', 6020, 'Whether organizations can operate the office suite or collaboration server themselves.', 'Ob Organisationen das Office-Paket oder den Kollaborationsserver selbst betreiben koennen.'
  UNION ALL SELECT 'office-suite', 'deployment_admin', 'storage_backend_model', 'Storage backend model', 'Speicher-Backend-Modell', 'enum', 'tradeoff', 'optional', 6030, 'How documents are stored, including local files, provider storage, or configurable backends.', 'Wie Dokumente gespeichert werden, einschliesslich lokaler Dateien, Anbieterspeicher oder konfigurierbarer Backends.'
  UNION ALL SELECT 'office-suite', 'deployment_admin', 'admin_console_available', 'Admin console available', 'Administrationskonsole verfuegbar', 'boolean', 'informational', 'optional', 6040, 'Whether administrators have a documented management console for users or settings.', 'Ob Administratoren eine dokumentierte Verwaltungskonsole fuer Nutzer oder Einstellungen haben.'
  UNION ALL SELECT 'office-suite', 'deployment_admin', 'role_access_controls', 'Role/access controls', 'Rollen-/Zugriffskontrollen', 'multi_enum', 'beneficial', 'multi_select', 6050, 'Role, permission, workspace, folder, locking, or public-access controls for documents.', 'Rollen-, Berechtigungs-, Arbeitsbereichs-, Ordner-, Sperr- oder Oeffentlichkeitskontrollen fuer Dokumente.'
  UNION ALL SELECT 'office-suite', 'deployment_admin', 'audit_logs', 'Audit logs', 'Audit-Protokolle', 'boolean', 'beneficial', 'optional', 6060, 'Whether administrators can review documented audit logs for document or account activity.', 'Ob Administratoren dokumentierte Audit-Protokolle fuer Dokument- oder Kontoaktivitaeten einsehen koennen.'
  UNION ALL SELECT 'office-suite', 'deployment_admin', 'data_residency_controls', 'Data residency controls', 'Datenresidenz-Kontrollen', 'boolean', 'informational', 'optional', 6070, 'Whether administrators can control or choose where office data is hosted.', 'Ob Administratoren kontrollieren oder waehlen koennen, wo Office-Daten gehostet werden.'
  UNION ALL SELECT 'office-suite', 'security_privacy', 'document_password_protection', 'Document password protection', 'Dokument-Passwortschutz', 'boolean', 'beneficial', 'optional', 7010, 'Whether individual documents can be protected with passwords or similar access controls.', 'Ob einzelne Dokumente mit Passwoertern oder aehnlichen Zugriffskontrollen geschuetzt werden koennen.'
  UNION ALL SELECT 'office-suite', 'security_privacy', 'client_side_encryption_model', 'Client-side encryption model', 'Clientseitiges Verschluesselungsmodell', 'enum', 'tradeoff', 'optional', 7020, 'How client-side encryption is documented and how it affects collaboration.', 'Wie clientseitige Verschluesselung dokumentiert ist und wie sie Zusammenarbeit beeinflusst.'
  UNION ALL SELECT 'office-suite', 'security_privacy', 'sharing_security_controls', 'Sharing security controls', 'Sicherheitskontrollen fuer Freigaben', 'multi_enum', 'beneficial', 'multi_select', 7030, 'Security controls that protect shared documents and shared links.', 'Sicherheitskontrollen, die geteilte Dokumente und Freigabelinks schuetzen.'
  UNION ALL SELECT 'office-suite', 'security_privacy', 'dlp_retention_controls', 'DLP/retention controls', 'DLP-/Aufbewahrungskontrollen', 'multi_enum', 'beneficial', 'multi_select', 7040, 'Administrative controls for data loss prevention, retention, labels, scanning, or sessions.', 'Administrationskontrollen fuer DLP, Aufbewahrung, Labels, Scans oder Sitzungen.'
  UNION ALL SELECT 'office-suite', 'security_privacy', 'telemetry_control_model', 'Telemetry control model', 'Telemetrie-Kontrollmodell', 'enum', 'risk', 'optional', 7050, 'How product telemetry is documented and whether users or administrators can control it.', 'Wie Produkttelemetrie dokumentiert ist und ob Nutzer oder Administratoren sie steuern koennen.'
  UNION ALL SELECT 'office-suite', 'integrations_portability', 'developer_api', 'Developer API', 'Entwickler-API', 'multi_enum', 'informational', 'multi_select', 8010, 'Developer interfaces for documents, administration, storage, events, or SDK-based automation.', 'Entwicklerschnittstellen fuer Dokumente, Administration, Speicher, Ereignisse oder SDK-basierte Automatisierung.'
  UNION ALL SELECT 'office-suite', 'integrations_portability', 'extension_plugin_model', 'Extension/plugin model', 'Erweiterungs-/Plugin-Modell', 'enum', 'tradeoff', 'optional', 8020, 'The documented model for extensions, plugins, add-ins, marketplaces, or managed add-ons.', 'Das dokumentierte Modell fuer Erweiterungen, Plugins, Add-ins, Marktplatzangebote oder verwaltete Add-ons.'
  UNION ALL SELECT 'office-suite', 'integrations_portability', 'cloud_storage_integrations', 'Cloud storage integrations', 'Cloud-Speicher-Integrationen', 'multi_enum', 'informational', 'multi_select', 8030, 'Storage locations and connectors the suite can use for documents.', 'Speicherorte und Konnektoren, die das Paket fuer Dokumente nutzen kann.'
  UNION ALL SELECT 'office-suite', 'integrations_portability', 'bulk_import_migration', 'Bulk import/migration', 'Massenimport/-migration', 'multi_enum', 'beneficial', 'multi_select', 8040, 'Bulk import, workspace migration, upload, or drive-import paths documented for moving documents in.', 'Dokumentierte Wege fuer Massenimport, Arbeitsbereichsmigration, Upload oder Drive-Import zum Umzug von Dokumenten.'
  UNION ALL SELECT 'office-suite', 'integrations_portability', 'standards_interoperability', 'Standards interoperability', 'Standard-Interoperabilitaet', 'multi_enum', 'beneficial', 'multi_select', 8050, 'Standards or protocols supported for document formats, storage, embedding, or content management.', 'Unterstuetzte Standards oder Protokolle fuer Dokumentformate, Speicher, Einbettung oder Content-Management.'
  UNION ALL SELECT 'office-suite', 'accessibility_fit', 'accessibility_features', 'Accessibility features', 'Barrierefreiheitsfunktionen', 'multi_enum', 'beneficial', 'multi_select', 9010, 'Documented accessibility features for navigating, reading, editing, checking, or tagging documents.', 'Dokumentierte Barrierefreiheitsfunktionen fuer Navigation, Lesen, Bearbeiten, Pruefung oder Auszeichnung von Dokumenten.'
  UNION ALL SELECT 'office-suite', 'accessibility_fit', 'language_tools', 'Language tools', 'Sprachwerkzeuge', 'multi_enum', 'informational', 'multi_select', 9020, 'Writing and interface language tools such as spelling, grammar, hyphenation, thesaurus, translation, or multilingual UI.', 'Sprachwerkzeuge fuer Schreiben und Oberflaeche wie Rechtschreibung, Grammatik, Silbentrennung, Thesaurus, Uebersetzung oder mehrsprachige UI.'
  UNION ALL SELECT 'office-suite', 'accessibility_fit', 'right_to_left_support', 'Right-to-left support', 'Rechts-nach-links-Unterstuetzung', 'boolean', 'informational', 'optional', 9030, 'Whether the suite documents support for right-to-left scripts in editing or layout.', 'Ob das Paket Unterstuetzung fuer Rechts-nach-links-Schriften bei Bearbeitung oder Layout dokumentiert.'
  ...
  UNION ALL SELECT 'office-suite', 'accessibility_fit', 'fit_profiles', 'Fit profiles', 'Eignungsprofile', 'multi_enum', 'informational', 'multi_select', 9050, 'Common user or organization profiles the suite is designed to fit.', 'Typische Nutzer- oder Organisationsprofile, fuer die das Paket geeignet ist.'
) AS d
...
FROM (
  ...
  UNION ALL SELECT 'office-suite', 'included_editors', 'presentation', 'Presentation', 'Praesentation', 'positive', 30
  ...
  UNION ALL SELECT 'office-suite', 'pdf_workflow', 'pdf_redaction', 'PDF redaction', 'PDF-Schwaerzung', 'positive', 60
  ...
  UNION ALL SELECT 'office-suite', 'equation_or_scientific_tools', 'footnotes_endnotes', 'Footnotes/endnotes', 'Fuss-/Endnoten', 'neutral', 50
  ...
  UNION ALL SELECT 'office-suite', 'native_format_model', 'proprietary_default', 'Proprietary default', 'Proprietaerer Standard', 'warning', 20
  ...
  UNION ALL SELECT 'office-suite', 'ooxml_compatibility', 'not_supported', 'Not supported', 'Nicht unterstuetzt', 'warning', 10
  ...
  UNION ALL SELECT 'office-suite', 'odf_support', 'not_supported', 'Not supported', 'Nicht unterstuetzt', 'warning', 10
  ...
  UNION ALL SELECT 'office-suite', 'format_fidelity_tools', 'compatibility_checker', 'Compatibility checker', 'Kompatibilitaetspruefung', 'positive', 10
  ...
  UNION ALL SELECT 'office-suite', 'format_fidelity_tools', 'change_summary', 'Change summary', 'Aenderungszusammenfassung', 'neutral', 40
  ...
  UNION ALL SELECT 'office-suite', 'sharing_link_controls', 'password_protected_links', 'Password protected links', 'Passwortgeschuetzte Links', 'positive', 30
  ...
  UNION ALL SELECT 'office-suite', 'sharing_link_controls', 'domain_restriction', 'Domain restriction', 'Domain-Beschraenkung', 'positive', 60
  UNION ALL SELECT 'office-suite', 'sharing_link_controls', 'invite_only', 'Invite only', 'Nur Einladung', 'neutral', 70
  UNION ALL SELECT 'office-suite', 'external_guest_collaboration', 'not_supported', 'Not supported', 'Nicht unterstuetzt', 'warning', 10
  UNION ALL SELECT 'office-suite', 'external_guest_collaboration', 'public_link_only', 'Public link only', 'Nur oeffentlicher Link', 'tradeoff', 20
  ...
  UNION ALL SELECT 'office-suite', 'external_guest_collaboration', 'federated_external', 'Federated external', 'Foederiert extern', 'tradeoff', 50
  UNION ALL SELECT 'office-suite', 'collaboration_presence', 'presence_indicators', 'Presence indicators', 'Praesenzanzeigen', 'neutral', 10
  UNION ALL SELECT 'office-suite', 'collaboration_presence', 'live_cursors', 'Live cursors', 'Live-Cursor', 'neutral', 20
  UNION ALL SELECT 'office-suite', 'collaboration_presence', 'activity_feed', 'Activity feed', 'Aktivitaetsfeed', 'neutral', 30
  UNION ALL SELECT 'office-suite', 'collaboration_presence', 'assignment_mentions', 'Assignment mentions', 'Aufgaben-Erwaehnungen', 'positive', 40
  ...
  UNION ALL SELECT 'office-suite', 'citation_bibliography_tools', 'footnotes_endnotes', 'Footnotes/endnotes', 'Fuss-/Endnoten', 'neutral', 60
  ...
  UNION ALL SELECT 'office-suite', 'presentation_features', 'presenter_view', 'Presenter view', 'Praesentationsansicht', 'positive', 20
  UNION ALL SELECT 'office-suite', 'presentation_features', 'animations_transitions', 'Animations/transitions', 'Animationen/Uebergaenge', 'neutral', 30
  ...
  UNION ALL SELECT 'office-suite', 'presentation_features', 'live_present', 'Live present', 'Live-Praesentation', 'neutral', 60
  ...
  UNION ALL SELECT 'office-suite', 'storage_backend_model', 'user_selected_storage', 'User-selected storage', 'Vom Nutzer gewaehlter Speicher', 'positive', 50
  ...
  UNION ALL SELECT 'office-suite', 'role_access_controls', 'owner_admin_roles', 'Owner/admin roles', 'Eigentuemer-/Admin-Rollen', 'positive', 20
  ...
  UNION ALL SELECT 'office-suite', 'role_access_controls', 'public_access_controls', 'Public access controls', 'Oeffentlichkeitskontrollen', 'neutral', 60
  ...
  UNION ALL SELECT 'office-suite', 'client_side_encryption_model', 'limited_collaboration_when_encrypted', 'Limited collaboration when encrypted', 'Begrenzte Zusammenarbeit bei Verschluesselung', 'tradeoff', 50
  UNION ALL SELECT 'office-suite', 'sharing_security_controls', 'passwords', 'Passwords', 'Passwoerter', 'positive', 10
  ...
  UNION ALL SELECT 'office-suite', 'dlp_retention_controls', 'device_session_controls', 'Device/session controls', 'Geraete-/Sitzungskontrollen', 'tradeoff', 60
  ...
  UNION ALL SELECT 'office-suite', 'telemetry_control_model', 'disabled_by_default', 'Disabled by default', 'Standardmaessig deaktiviert', 'positive', 50
  ...
  UNION ALL SELECT 'office-suite', 'accessibility_features', 'accessibility_checker', 'Accessibility checker', 'Barrierefreiheitspruefung', 'positive', 40
  ...
  UNION ALL SELECT 'office-suite', 'language_tools', 'spellcheck', 'Spellcheck', 'Rechtschreibpruefung', 'positive', 10
  UNION ALL SELECT 'office-suite', 'language_tools', 'grammar_check', 'Grammar check', 'Grammatikpruefung', 'neutral', 20
  ...
  UNION ALL SELECT 'office-suite', 'language_tools', 'translation', 'Translation', 'Uebersetzung', 'tradeoff', 50
  ...
  UNION ALL SELECT 'office-suite', 'ai_assistance_model', 'bring_your_own_key', 'Bring your own key', 'Eigener Schluessel', 'tradeoff', 50
  ...
  UNION ALL SELECT 'office-suite', 'fit_profiles', 'personal_offline', 'Personal offline', 'Persoenlich offline', 'neutral', 10
  ...
  UNION ALL SELECT 'office-suite', 'fit_profiles', 'ms_office_compatibility', 'MS Office compatibility', 'MS-Office-Kompatibilitaet', 'tradeoff', 70
) AS d
