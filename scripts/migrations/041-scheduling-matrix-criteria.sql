...
VALUES
  ('scheduling', 'booking_types', 'Booking Types & Formats', 'Buchungstypen & Formate', 'Supported appointment types, group booking, round-robin, and scheduling formats.', 'Unterstützte Termintypen, Gruppenbuchung, Round-Robin und Planungsformate.', 100),
  ('scheduling', 'availability_management', 'Availability & Time Rules', 'Verfügbarkeit & Zeitregeln', 'Calendar-connected availability, buffer times, timezone handling, and booking limits.', 'Kalenderverbundene Verfügbarkeit, Pufferzeiten, Zeitzonen-Handling und Buchungslimits.', 200),
  ('scheduling', 'booking_pages', 'Booking Pages & Customization', 'Buchungsseiten & Anpassung', 'Booking page presentation, branding, embedding, and custom domain support.', 'Buchungsseitenpräsentation, Branding, Einbettung und benutzerdefinierte Domainunterstützung.', 300),
  ...
  ('scheduling', 'notifications_workflows', 'Notifications & Workflows', 'Benachrichtigungen & Workflows', 'Booking confirmations, reminders, cancellation policies, and follow-up automation.', 'Buchungsbestätigungen, Erinnerungen, Stornierungsrichtlinien und Folgeautomatisierung.', 500),
  ...
  ('scheduling', 'privacy_data', 'Privacy & Data', 'Privatsphäre & Daten', 'Account requirements, data processing location, data export, and telemetry.', 'Kontoanforderungen, Datenverarbeitungsstandort, Datenexport und Telemetrie.', 700),
  ('scheduling', 'openness_deployment', 'Openness & Deployment', 'Offenheit & Bereitstellung', 'Source code availability, self-hosting, licensing, and deployment options.', 'Quellcode-Verfügbarkeit, Selbst-Hosting, Lizenzierung und Bereitstellungsoptionen.', 800),
...
FROM (
  ...
  UNION ALL SELECT 'scheduling', 'booking_types', 'collective_scheduling', 'Collective scheduling', 'Kollektive Terminplanung', 'boolean', 'beneficial', 'optional', 1040, 'Whether the tool requires all selected hosts to be available before a slot is offered.', 'Ob das Tool verlangt, dass alle ausgewählten Gastgeber verfügbar sind, bevor ein Zeitfenster angeboten wird.'
  UNION ALL SELECT 'scheduling', 'booking_types', 'recurring_appointments', 'Recurring appointments', 'Wiederkehrende Termine', 'boolean', 'beneficial', 'optional', 1050, 'Whether invitees can book recurring appointments on a regular schedule.', 'Ob Eingeladene wiederkehrende Termine in regelmäßigen Abständen buchen können.'
  UNION ALL SELECT 'scheduling', 'booking_types', 'event_type_variety', 'Event type variety', 'Eventtypvielfalt', 'enum', 'informational', 'optional', 1060, 'The range of configurable event types and duration options available to hosts.', 'Die Bandbreite konfigurierbarer Eventtypen und Daueroptionen für Gastgeber.'
  UNION ALL SELECT 'scheduling', 'availability_management', 'calendar_connected_availability', 'Calendar-connected availability', 'Kalenderverbundene Verfügbarkeit', 'boolean', 'beneficial', 'must_match', 2010, 'Whether available time slots are derived from connected calendar data in real time.', 'Ob verfügbare Zeitfenster in Echtzeit aus verbundenen Kalenderdaten abgeleitet werden.'
  ...
  UNION ALL SELECT 'scheduling', 'availability_management', 'buffer_times', 'Buffer times between bookings', 'Pufferzeiten zwischen Buchungen', 'boolean', 'beneficial', 'optional', 2030, 'Whether hosts can enforce minimum gaps between consecutive bookings.', 'Ob Gastgeber Mindestabstände zwischen aufeinanderfolgenden Buchungen erzwingen können.'
  UNION ALL SELECT 'scheduling', 'availability_management', 'booking_limits', 'Daily / weekly booking limits', 'Tägliche / wöchentliche Buchungslimits', 'boolean', 'beneficial', 'optional', 2040, 'Whether hosts can set maximum booking counts per day or week.', 'Ob Gastgeber maximale Buchungsanzahlen pro Tag oder Woche festlegen können.'
  UNION ALL SELECT 'scheduling', 'availability_management', 'minimum_notice_period', 'Minimum notice period', 'Mindestvorlaufzeit', 'boolean', 'informational', 'optional', 2050, 'Whether hosts can require a minimum lead time before an appointment can be booked.', 'Ob Gastgeber eine Mindestvorlaufzeit vor der Buchung eines Termins verlangen können.'
  UNION ALL SELECT 'scheduling', 'availability_management', 'date_range_restrictions', 'Date range restrictions', 'Datumsbereichsbeschränkungen', 'boolean', 'informational', 'optional', 2060, 'Whether hosts can limit bookable dates to a specific future window.', 'Ob Gastgeber buchbare Termine auf ein bestimmtes zukünftiges Zeitfenster beschränken können.'
  ...
  UNION ALL SELECT 'scheduling', 'booking_pages', 'custom_domain_support', 'Custom domain support', 'Benutzerdefinierte Domainunterstützung', 'boolean', 'beneficial', 'optional', 3020, 'Whether the booking page can be served from a custom domain name.', 'Ob die Buchungsseite über einen benutzerdefinierten Domainnamen bereitgestellt werden kann.'
  UNION ALL SELECT 'scheduling', 'booking_pages', 'embed_widget', 'Embeddable widget', 'Einbettbares Widget', 'boolean', 'beneficial', 'optional', 3030, 'Whether the booking interface can be embedded into external websites.', 'Ob die Buchungsoberfläche in externe Websites eingebettet werden kann.'
  UNION ALL SELECT 'scheduling', 'booking_pages', 'multi_event_page', 'Multi-event-type page', 'Seite mit mehreren Eventtypen', 'boolean', 'informational', 'optional', 3040, 'Whether a single page can list multiple event types for invitees to choose from.', 'Ob eine einzelne Seite mehrere Eventtypen auflisten kann, aus denen Eingeladene wählen können.'
  UNION ALL SELECT 'scheduling', 'booking_pages', 'custom_questions', 'Custom booking questions', 'Benutzerdefinierte Buchungsfragen', 'boolean', 'beneficial', 'optional', 3050, 'Whether hosts can add custom intake questions to the booking form.', 'Ob Gastgeber benutzerdefinierte Aufnahmefragen zum Buchungsformular hinzufügen können.'
  UNION ALL SELECT 'scheduling', 'calendar_integrations', 'calendar_providers', 'Calendar provider support', 'Kalenderanbieter-Unterstützung', 'multi_enum', 'informational', 'multi_select', 4010, 'Which calendar platforms are supported for availability checking and event creation.', 'Welche Kalenderplattformen für Verfügbarkeitsprüfung und Eventerstellung unterstützt werden.'
  UNION ALL SELECT 'scheduling', 'calendar_integrations', 'two_way_calendar_sync', 'Two-way calendar sync', 'Bidirektionale Kalendersynchronisation', 'boolean', 'beneficial', 'must_match', 4020, 'Whether booked appointments are written back to the connected calendar automatically.', 'Ob gebuchte Termine automatisch in den verbundenen Kalender zurückgeschrieben werden.'
  UNION ALL SELECT 'scheduling', 'calendar_integrations', 'conferencing_auto_link', 'Conferencing auto-link', 'Konferenz-Auto-Link', 'multi_enum', 'informational', 'multi_select', 4030, 'Which video conferencing providers can be auto-linked to booked appointments.', 'Welche Videokonferenzanbieter automatisch mit gebuchten Terminen verknüpft werden können.'
  UNION ALL SELECT 'scheduling', 'calendar_integrations', 'ical_feed', 'iCal feed support', 'iCal-Feed-Unterstützung', 'boolean', 'informational', 'optional', 4040, 'Whether the tool provides an iCal feed URL for subscribing in external calendar apps.', 'Ob das Tool eine iCal-Feed-URL zum Abonnieren in externen Kalender-Apps bereitstellt.'
  UNION ALL SELECT 'scheduling', 'notifications_workflows', 'email_confirmations', 'Email confirmations', 'E-Mail-Bestätigungen', 'boolean', 'beneficial', 'optional', 5010, 'Whether booking confirmation emails are sent to hosts and invitees automatically.', 'Ob Buchungsbestätigungs-E-Mails automatisch an Gastgeber und Eingeladene gesendet werden.'
  UNION ALL SELECT 'scheduling', 'notifications_workflows', 'reminder_channels', 'Reminder channels', 'Erinnerungskanäle', 'multi_enum', 'informational', 'multi_select', 5020, 'The communication channels available for sending appointment reminders.', 'Die verfügbaren Kommunikationskanäle zum Versenden von Terminerinnerungen.'
  UNION ALL SELECT 'scheduling', 'notifications_workflows', 'cancellation_rescheduling', 'Cancellation / rescheduling', 'Stornierung / Umbuchung', 'enum', 'informational', 'optional', 5030, 'How invitees can cancel or reschedule their booked appointments.', 'Wie Eingeladene ihre gebuchten Termine stornieren oder umbuchen können.'
  UNION ALL SELECT 'scheduling', 'notifications_workflows', 'workflow_automation', 'Workflow automation', 'Workflow-Automatisierung', 'enum', 'informational', 'optional', 5040, 'The level of automated workflow support for pre- and post-booking actions.', 'Das Niveau der automatisierten Workflow-Unterstützung für Aktionen vor und nach der Buchung.'
  ...
  UNION ALL SELECT 'scheduling', 'team_routing', 'routing_forms', 'Routing forms', 'Routing-Formulare', 'boolean', 'beneficial', 'optional', 6020, 'Whether intake forms can route invitees to the appropriate team member or event type.', 'Ob Aufnahmeformulare Eingeladene zum passenden Teammitglied oder Eventtyp weiterleiten können.'
  UNION ALL SELECT 'scheduling', 'team_routing', 'managed_team_availability', 'Managed team availability', 'Verwaltete Teamverfügbarkeit', 'boolean', 'beneficial', 'optional', 6030, 'Whether administrators can manage availability rules across the entire team.', 'Ob Administratoren Verfügbarkeitsregeln für das gesamte Team verwalten können.'
  UNION ALL SELECT 'scheduling', 'team_routing', 'payment_collection', 'Payment collection', 'Zahlungseinzug', 'boolean', 'informational', 'optional', 6040, 'Whether payment can be collected at the time of booking through integrated processors.', 'Ob Zahlungen zum Zeitpunkt der Buchung über integrierte Zahlungsanbieter eingezogen werden können.'
  UNION ALL SELECT 'scheduling', 'privacy_data', 'account_requirement', 'Account requirement', 'Kontoanforderung', 'enum', 'risk', 'optional', 7010, 'What type of account invitees must create to book an appointment.', 'Welche Art von Konto Eingeladene erstellen müssen, um einen Termin zu buchen.'
  ...
  UNION ALL SELECT 'scheduling', 'privacy_data', 'data_export_available', 'Data export available', 'Datenexport verfügbar', 'boolean', 'beneficial', 'optional', 7030, 'Whether booking data and account information can be exported in a portable format.', 'Ob Buchungsdaten und Kontoinformationen in einem portablen Format exportiert werden können.'
  UNION ALL SELECT 'scheduling', 'privacy_data', 'telemetry_model', 'Telemetry model', 'Telemetriemodell', 'enum', 'risk', 'optional', 7040, 'How the tool handles collection and transmission of usage analytics data.', 'Wie das Tool die Erfassung und Übermittlung von Nutzungsanalysedaten handhabt.'
  UNION ALL SELECT 'scheduling', 'openness_deployment', 'source_model', 'Source code model', 'Quellcode-Modell', 'enum', 'tradeoff', 'optional', 8010, 'The openness of the scheduling tool source code and its public availability.', 'Die Offenheit des Quellcodes des Planungstools und seine öffentliche Verfügbarkeit.'
  ...
  UNION ALL SELECT 'scheduling', 'openness_deployment', 'hosting_model', 'Hosting model', 'Hosting-Modell', 'enum', 'tradeoff', 'must_match', 8040, 'Whether the tool is available as a cloud service, self-hosted, or both.', 'Ob das Tool als Cloud-Dienst, selbst gehostet oder beides verfügbar ist.'
  UNION ALL SELECT 'scheduling', 'pricing_fit', 'pricing_model', 'Pricing model', 'Preismodell', 'enum', 'informational', 'optional', 9010, 'The pricing structure of the scheduling tool and any associated services.', 'Die Preisstruktur des Planungstools und der zugehörigen Dienste.'
  UNION ALL SELECT 'scheduling', 'pricing_fit', 'free_tier_available', 'Free tier available', 'Kostenlose Version verfügbar', 'boolean', 'informational', 'must_match', 9020, 'Whether a functional free version of the scheduling tool is available.', 'Ob eine funktionsfähige kostenlose Version des Planungstools verfügbar ist.'
  UNION ALL SELECT 'scheduling', 'pricing_fit', 'event_type_limit_free', 'Event type limit (free tier)', 'Eventtypbegrenzung (kostenlose Version)', 'enum', 'informational', 'optional', 9030, 'How many event types are available on the free tier of the scheduling tool.', 'Wie viele Eventtypen in der kostenlosen Version des Planungstools verfügbar sind.'
  UNION ALL SELECT 'scheduling', 'pricing_fit', 'fit_profiles', 'Fit profiles', 'Eignungsprofile', 'multi_enum', 'informational', 'multi_select', 9040, 'Target audience profiles the scheduling tool is best suited for.', 'Zielgruppenprofile, für die das Planungstool am besten geeignet ist.'
) AS d
...
FROM (
  ...
  UNION ALL SELECT 'scheduling', 'event_type_variety', 'fully_customizable', 'Fully customizable', 'Vollständig anpassbar', 'neutral', 30
  UNION ALL SELECT 'scheduling', 'timezone_handling', 'automatic_detection', 'Automatic detection', 'Automatische Erkennung', 'neutral', 10
  UNION ALL SELECT 'scheduling', 'timezone_handling', 'invitee_selects', 'Invitee selects', 'Eingeladener wählt', 'neutral', 20
  ...
  UNION ALL SELECT 'scheduling', 'cancellation_rescheduling', 'not_supported', 'Not supported', 'Nicht unterstützt', 'neutral', 40
  ...
  UNION ALL SELECT 'scheduling', 'data_processing_location', 'eu_primary', 'EU primary', 'EU primär', 'neutral', 20
  ...
  UNION ALL SELECT 'scheduling', 'source_model', 'fully_open_source', 'Fully open source', 'Vollständig quelloffen', 'positive', 10
  UNION ALL SELECT 'scheduling', 'source_model', 'source_available', 'Source available', 'Quellcode verfügbar', 'neutral', 20
  UNION ALL SELECT 'scheduling', 'source_model', 'partially_open', 'Partially open', 'Teilweise offen', 'neutral', 30
  UNION ALL SELECT 'scheduling', 'source_model', 'proprietary', 'Proprietary', 'Proprietär', 'warning', 40
  ...
  UNION ALL SELECT 'scheduling', 'license_type', 'proprietary', 'Proprietary', 'Proprietär', 'neutral', 50
  ...
  UNION ALL SELECT 'scheduling', 'event_type_limit_free', 'generous_5_plus', 'Generous (5+)', 'Großzügig (5+)', 'neutral', 20
  ...
  UNION ALL SELECT 'scheduling', 'fit_profiles', 'educator_coach', 'Educator / coach', 'Pädagoge / Coach', 'neutral', 60
) AS d
