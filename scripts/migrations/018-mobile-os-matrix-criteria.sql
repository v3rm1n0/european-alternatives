...
VALUES
  ('mobile-os', 'platform_hardware', 'Platform & Hardware', 'Plattform & Hardware', 'Core platform capabilities including CPU architecture support, device compatibility model, and supported form factors.', 'Kernplattform-Faehigkeiten einschliesslich CPU-Architektur-Unterstuetzung, Geraetekompatibilitaetsmodell und unterstuetzte Formfaktoren.', 100),
  ('mobile-os', 'installation_provisioning', 'Installation & Provisioning', 'Installation & Bereitstellung', 'How the operating system is obtained and installed, including bootloader requirements, installation methods, and carrier activation.', 'Wie das Betriebssystem bezogen und installiert wird, einschliesslich Bootloader-Anforderungen, Installationsmethoden und Carrier-Aktivierung.', 200),
  ('mobile-os', 'security_updates', 'Security & Updates', 'Sicherheit & Updates', 'Security posture including update delivery, patch cadence, verified boot, sandboxing, and encryption.', 'Sicherheitslage einschliesslich Update-Bereitstellung, Patch-Kadenz, Verified Boot, Sandboxing und Verschluesselung.', 300),
  ('mobile-os', 'privacy_permissions', 'Privacy & Permissions', 'Datenschutz & Berechtigungen', 'Privacy controls including telemetry defaults, permission granularity, location privacy, advertising ID, and account requirements.', 'Datenschutzkontrollen einschliesslich Telemetrie-Standards, Berechtigungsgranularitaet, Standort-Datenschutz, Werbe-ID und Kontoanforderungen.', 400),
  ('mobile-os', 'app_ecosystem', 'App Ecosystem', 'App-Oekosystem', 'Application availability, distribution model, sideloading policy, compatibility layers, and alternative app stores.', 'Anwendungsverfuegbarkeit, Verteilungsmodell, Sideloading-Richtlinie, Kompatibilitaetsschichten und alternative App-Stores.', 500),
  ('mobile-os', 'connectivity_telephony', 'Connectivity & Telephony', 'Konnektivitaet & Telefonie', 'Cellular, wireless, and telephony capabilities including baseband model, VoLTE, eSIM, Bluetooth, and Wi-Fi standards.', 'Mobilfunk-, Drahtlos- und Telefonie-Faehigkeiten einschliesslich Baseband-Modell, VoLTE, eSIM, Bluetooth und Wi-Fi-Standards.', 600),
  ('mobile-os', 'user_experience', 'User Experience & Accessibility', 'Nutzererfahrung & Barrierefreiheit', 'User interface customization, accessibility features, multi-user support, and notification architecture.', 'Benutzeroberflaechen-Anpassung, Barrierefreiheitsfunktionen, Mehrbenutzer-Unterstuetzung und Benachrichtigungsarchitektur.', 700),
  ('mobile-os', 'data_portability', 'Data Portability & Backup', 'Datenportabilitaet & Backup', 'Backup model, encrypted backups, data export, and device-to-device migration support.', 'Backup-Modell, verschluesselte Backups, Datenexport und Geraet-zu-Geraet-Migrationsunterstuetzung.', 800),
  ('mobile-os', 'openness_governance', 'Openness, Governance & Fit', 'Offenheit, Governance & Eignung', 'Source code model, governance structure, commercial support availability, and target user fit profiles.', 'Quellcode-Modell, Governance-Struktur, Verfuegbarkeit von kommerziellem Support und Zielgruppen-Eignungsprofile.', 900);
...
FROM (
  SELECT 'mobile-os' AS category_id, 'platform_hardware' AS group_key, 'supported_cpu_architectures' AS criterion_key, 'Supported CPU architectures' AS label_en, 'Unterstuetzte CPU-Architekturen' AS label_de, 'multi_enum' AS value_type, 'informational' AS semantics, 'multi_select' AS filter_mode, 1010 AS sort_order, 'Processor architectures officially supported by the mobile operating system.' AS help_text_en, 'Offiziell vom mobilen Betriebssystem unterstuetzte Prozessorarchitekturen.' AS help_text_de
  UNION ALL SELECT 'mobile-os', 'platform_hardware', 'device_compatibility_model', 'Device compatibility model', 'Geraetekompatibilitaetsmodell', 'enum', 'tradeoff', 'optional', 1020, 'Whether the OS is locked to specific devices or supports generic hardware.', 'Ob das Betriebssystem an bestimmte Geraete gebunden ist oder generische Hardware unterstuetzt.'
  ...
  UNION ALL SELECT 'mobile-os', 'platform_hardware', 'supported_device_form_factors', 'Supported device form factors', 'Unterstuetzte Geraeteformfaktoren', 'multi_enum', 'informational', 'multi_select', 1040, 'Device form factors supported by the operating system.', 'Vom Betriebssystem unterstuetzte Geraeteformfaktoren.'
  ...
  UNION ALL SELECT 'mobile-os', 'installation_provisioning', 'installation_method', 'Installation method', 'Installationsmethode', 'multi_enum', 'informational', 'multi_select', 2020, 'Methods available for installing the operating system on a device.', 'Verfuegbare Methoden zur Installation des Betriebssystems auf einem Geraet.'
  UNION ALL SELECT 'mobile-os', 'installation_provisioning', 'carrier_activation_support', 'Carrier activation support', 'Carrier-Aktivierungsunterstuetzung', 'enum', 'tradeoff', 'optional', 2030, 'Whether the OS supports carrier provisioning and activation workflows.', 'Ob das Betriebssystem Carrier-Bereitstellungs- und Aktivierungs-Workflows unterstuetzt.'
  UNION ALL SELECT 'mobile-os', 'installation_provisioning', 'factory_image_available', 'Factory image available', 'Werksabbild verfuegbar', 'boolean', 'beneficial', 'optional', 2040, 'Whether official factory images are available for restoring the device to a known-good state.', 'Ob offizielle Werksabbilder verfuegbar sind, um das Geraet in einen bekannten guten Zustand zurueckzusetzen.'
  UNION ALL SELECT 'mobile-os', 'security_updates', 'security_update_cadence', 'Security update cadence', 'Sicherheitsupdate-Kadenz', 'enum', 'beneficial', 'must_match', 3010, 'How frequently security patches are released by the vendor.', 'Wie haeufig Sicherheitspatches vom Anbieter veroeffentlicht werden.'
  UNION ALL SELECT 'mobile-os', 'security_updates', 'update_delivery_model', 'Update delivery model', 'Update-Bereitstellungsmodell', 'enum', 'tradeoff', 'optional', 3020, 'How operating system updates are delivered to end-user devices.', 'Wie Betriebssystem-Updates an Endgeraete ausgeliefert werden.'
  UNION ALL SELECT 'mobile-os', 'security_updates', 'verified_boot', 'Verified boot', 'Verified Boot', 'boolean', 'beneficial', 'optional', 3030, 'Whether the OS supports a verified boot chain to ensure system integrity.', 'Ob das Betriebssystem eine verifizierte Boot-Kette zur Sicherstellung der Systemintegritaet unterstuetzt.'
  ...
  UNION ALL SELECT 'mobile-os', 'security_updates', 'full_disk_encryption_default', 'Full-disk encryption default', 'Vollverschluesselung-Standard', 'enum', 'beneficial', 'optional', 3050, 'Whether full-disk encryption is enabled by default on the device.', 'Ob die Vollverschluesselung standardmaessig auf dem Geraet aktiviert ist.'
  UNION ALL SELECT 'mobile-os', 'security_updates', 'biometric_authentication', 'Biometric authentication', 'Biometrische Authentifizierung', 'multi_enum', 'informational', 'multi_select', 3060, 'Biometric authentication methods supported by the operating system.', 'Vom Betriebssystem unterstuetzte biometrische Authentifizierungsmethoden.'
  ...
  UNION ALL SELECT 'mobile-os', 'privacy_permissions', 'telemetry_opt_out', 'Telemetry opt-out', 'Telemetrie-Opt-out', 'enum', 'beneficial', 'optional', 4020, 'Whether and how telemetry can be reduced or fully disabled by the user.', 'Ob und wie Telemetrie vom Nutzer reduziert oder vollstaendig deaktiviert werden kann.'
  UNION ALL SELECT 'mobile-os', 'privacy_permissions', 'permission_granularity', 'Permission granularity', 'Berechtigungsgranularitaet', 'enum', 'tradeoff', 'optional', 4030, 'The level of fine-grained control over individual app permissions.', 'Der Grad der feingranularen Kontrolle ueber einzelne App-Berechtigungen.'
  UNION ALL SELECT 'mobile-os', 'privacy_permissions', 'location_privacy_controls', 'Location privacy controls', 'Standort-Datenschutzkontrollen', 'multi_enum', 'beneficial', 'multi_select', 4040, 'Available controls for managing location data access by apps and the system.', 'Verfuegbare Kontrollen zur Verwaltung des Standortdatenzugriffs durch Apps und das System.'
  UNION ALL SELECT 'mobile-os', 'privacy_permissions', 'advertising_id_controls', 'Advertising ID controls', 'Werbe-ID-Kontrollen', 'enum', 'beneficial', 'optional', 4050, 'Controls available for managing the device advertising identifier.', 'Verfuegbare Kontrollen zur Verwaltung der Geraete-Werbe-ID.'
  UNION ALL SELECT 'mobile-os', 'privacy_permissions', 'account_required', 'Account required', 'Konto erforderlich', 'boolean', 'risk', 'must_match', 4060, 'Whether an online account is required for basic usage of the operating system.', 'Ob ein Online-Konto fuer die grundlegende Nutzung des Betriebssystems erforderlich ist.'
  UNION ALL SELECT 'mobile-os', 'app_ecosystem', 'primary_app_store', 'Primary app store', 'Primaerer App-Store', 'enum', 'tradeoff', 'optional', 5010, 'The default or primary app store bundled with the operating system.', 'Der Standard- oder primaere App-Store, der mit dem Betriebssystem ausgeliefert wird.'
  UNION ALL SELECT 'mobile-os', 'app_ecosystem', 'sideloading_support', 'Sideloading support', 'Sideloading-Unterstuetzung', 'enum', 'tradeoff', 'optional', 5020, 'Whether and how easily apps can be installed from sources outside the primary app store.', 'Ob und wie einfach Apps aus Quellen ausserhalb des primaeren App-Stores installiert werden koennen.'
  UNION ALL SELECT 'mobile-os', 'app_ecosystem', 'android_app_compatibility', 'Android app compatibility', 'Android-App-Kompatibilitaet', 'enum', 'informational', 'optional', 5030, 'The level of compatibility with Android applications.', 'Der Grad der Kompatibilitaet mit Android-Anwendungen.'
  UNION ALL SELECT 'mobile-os', 'app_ecosystem', 'progressive_web_app_support', 'Progressive Web App support', 'Progressive-Web-App-Unterstuetzung', 'boolean', 'beneficial', 'optional', 5040, 'Whether Progressive Web Apps can be installed and used as first-class applications.', 'Ob Progressive Web Apps als vollwertige Anwendungen installiert und genutzt werden koennen.'
  UNION ALL SELECT 'mobile-os', 'app_ecosystem', 'app_store_alternatives_allowed', 'App store alternatives allowed', 'Alternative App-Stores erlaubt', 'boolean', 'tradeoff', 'optional', 5050, 'Whether alternative app stores can be installed alongside or instead of the primary store.', 'Ob alternative App-Stores neben oder anstelle des primaeren Stores installiert werden koennen.'
  ...
  UNION ALL SELECT 'mobile-os', 'connectivity_telephony', 'volte_support', 'VoLTE support', 'VoLTE-Unterstuetzung', 'enum', 'informational', 'optional', 6020, 'The level of Voice over LTE support for modern carrier voice calls.', 'Der Grad der Voice-over-LTE-Unterstuetzung fuer moderne Carrier-Sprachanrufe.'
  UNION ALL SELECT 'mobile-os', 'connectivity_telephony', 'esim_support', 'eSIM support', 'eSIM-Unterstuetzung', 'boolean', 'informational', 'optional', 6030, 'Whether the operating system supports embedded SIM provisioning.', 'Ob das Betriebssystem eingebettete SIM-Bereitstellung unterstuetzt.'
  UNION ALL SELECT 'mobile-os', 'connectivity_telephony', 'bluetooth_version', 'Bluetooth version', 'Bluetooth-Version', 'enum', 'informational', 'optional', 6040, 'The highest Bluetooth standard version supported by the operating system stack.', 'Die hoechste vom Betriebssystem-Stack unterstuetzte Bluetooth-Standardversion.'
  UNION ALL SELECT 'mobile-os', 'connectivity_telephony', 'wifi_standards', 'Wi-Fi standards supported', 'Unterstuetzte Wi-Fi-Standards', 'multi_enum', 'informational', 'multi_select', 6050, 'Wi-Fi standards supported by the operating system network stack.', 'Vom Betriebssystem-Netzwerk-Stack unterstuetzte Wi-Fi-Standards.'
  UNION ALL SELECT 'mobile-os', 'user_experience', 'ui_customization_level', 'UI customization level', 'UI-Anpassungsgrad', 'enum', 'informational', 'optional', 7010, 'The level of user interface customization available to the user.', 'Der Grad der Benutzeroberflaechen-Anpassung, der dem Nutzer zur Verfuegung steht.'
  UNION ALL SELECT 'mobile-os', 'user_experience', 'accessibility_features', 'Accessibility features', 'Barrierefreiheitsfunktionen', 'multi_enum', 'beneficial', 'multi_select', 7020, 'Built-in accessibility features for users with disabilities.', 'Integrierte Barrierefreiheitsfunktionen fuer Nutzer mit Behinderungen.'
  UNION ALL SELECT 'mobile-os', 'user_experience', 'multi_user_support', 'Multi-user support', 'Mehrbenutzer-Unterstuetzung', 'boolean', 'informational', 'optional', 7030, 'Whether the operating system supports multiple user profiles on a single device.', 'Ob das Betriebssystem mehrere Benutzerprofile auf einem Geraet unterstuetzt.'
  ...
  UNION ALL SELECT 'mobile-os', 'data_portability', 'backup_model', 'Backup model', 'Backup-Modell', 'enum', 'tradeoff', 'optional', 8010, 'The primary backup model supported by the operating system.', 'Das primaere vom Betriebssystem unterstuetzte Backup-Modell.'
  UNION ALL SELECT 'mobile-os', 'data_portability', 'encrypted_backup_available', 'Encrypted backup available', 'Verschluesseltes Backup verfuegbar', 'boolean', 'beneficial', 'optional', 8020, 'Whether end-to-end encrypted backups are available.', 'Ob Ende-zu-Ende-verschluesselte Backups verfuegbar sind.'
  UNION ALL SELECT 'mobile-os', 'data_portability', 'data_export_available', 'Data export available', 'Datenexport verfuegbar', 'boolean', 'beneficial', 'optional', 8030, 'Whether a built-in mechanism exists for exporting user data in a portable format.', 'Ob ein integrierter Mechanismus zum Exportieren von Nutzerdaten in einem portablen Format existiert.'
  UNION ALL SELECT 'mobile-os', 'data_portability', 'device_migration_model', 'Device migration model', 'Geraetemigrationsmodell', 'enum', 'tradeoff', 'optional', 8040, 'The supported method for transferring data when switching to a new device.', 'Die unterstuetzte Methode zur Datenuebertragung beim Wechsel auf ein neues Geraet.'
  ...
  UNION ALL SELECT 'mobile-os', 'openness_governance', 'commercial_support_available', 'Commercial support available', 'Kommerzieller Support verfuegbar', 'boolean', 'informational', 'optional', 9030, 'Whether paid professional support contracts or enterprise support tiers are available.', 'Ob bezahlte professionelle Support-Vertraege oder Enterprise-Support-Stufen verfuegbar sind.'
  UNION ALL SELECT 'mobile-os', 'openness_governance', 'fit_profiles', 'Fit profiles', 'Eignungsprofile', 'multi_enum', 'informational', 'multi_select', 9040, 'Common user profiles or use cases the operating system is well suited for.', 'Typische Nutzerprofile oder Anwendungsfaelle, fuer die das Betriebssystem gut geeignet ist.'
) AS d
...
FROM (
  ...
  UNION ALL SELECT 'mobile-os', 'device_compatibility_model', 'device_specific_builds', 'Device-specific builds', 'Geraetespezifische Builds', 'neutral', 20
  ...
  UNION ALL SELECT 'mobile-os', 'carrier_activation_support', 'full_support', 'Full support', 'Volle Unterstuetzung', 'positive', 10
  UNION ALL SELECT 'mobile-os', 'carrier_activation_support', 'partial_support', 'Partial support', 'Teilweise Unterstuetzung', 'tradeoff', 20
  UNION ALL SELECT 'mobile-os', 'carrier_activation_support', 'manual_apn_only', 'Manual APN only', 'Nur manuelles APN', 'tradeoff', 30
  UNION ALL SELECT 'mobile-os', 'carrier_activation_support', 'not_supported', 'Not supported', 'Nicht unterstuetzt', 'warning', 40
  ...
  UNION ALL SELECT 'mobile-os', 'security_update_cadence', 'irregular', 'Irregular', 'Unregelmaessig', 'tradeoff', 30
  UNION ALL SELECT 'mobile-os', 'security_update_cadence', 'rolling', 'Rolling', 'Fortlaufend', 'positive', 40
  UNION ALL SELECT 'mobile-os', 'security_update_cadence', 'vendor_dependent', 'Vendor dependent', 'Herstellerabhaengig', 'warning', 50
  ...
  UNION ALL SELECT 'mobile-os', 'update_delivery_model', 'app_store_update', 'App-store-like update', 'App-Store-aehnliches Update', 'neutral', 30
  UNION ALL SELECT 'mobile-os', 'update_delivery_model', 'manual_flash', 'Manual flash', 'Manueller Flash', 'tradeoff', 40
  UNION ALL SELECT 'mobile-os', 'application_sandboxing', 'full_selinux', 'Full SELinux', 'Vollstaendiges SELinux', 'positive', 10
  ...
  UNION ALL SELECT 'mobile-os', 'full_disk_encryption_default', 'always_encrypted', 'Always encrypted', 'Immer verschluesselt', 'positive', 10
  UNION ALL SELECT 'mobile-os', 'full_disk_encryption_default', 'default_on', 'Default on', 'Standardmaessig aktiv', 'positive', 20
  UNION ALL SELECT 'mobile-os', 'full_disk_encryption_default', 'opt_in', 'Opt-in', 'Opt-in', 'neutral', 30
  UNION ALL SELECT 'mobile-os', 'full_disk_encryption_default', 'not_available', 'Not available', 'Nicht verfuegbar', 'warning', 40
  ...
  UNION ALL SELECT 'mobile-os', 'telemetry_opt_out', 'fully_disableable', 'Fully disableable', 'Vollstaendig deaktivierbar', 'positive', 20
  ...
  UNION ALL SELECT 'mobile-os', 'location_privacy_controls', 'precise_approximate_toggle', 'Precise/approximate toggle', 'Praezise/ungefaehr-Umschalter', 'positive', 10
  ...
  UNION ALL SELECT 'mobile-os', 'advertising_id_controls', 'resettable', 'Resettable', 'Zuruecksetzbar', 'neutral', 30
  ...
  UNION ALL SELECT 'mobile-os', 'sideloading_support', 'restricted', 'Restricted', 'Eingeschraenkt', 'tradeoff', 30
  ...
  UNION ALL SELECT 'mobile-os', 'android_app_compatibility', 'compatibility_layer', 'Compatibility layer', 'Kompatibilitaetsschicht', 'tradeoff', 20
  UNION ALL SELECT 'mobile-os', 'android_app_compatibility', 'limited', 'Limited', 'Eingeschraenkt', 'tradeoff', 30
  ...
  UNION ALL SELECT 'mobile-os', 'baseband_firmware_model', 'vendor_dependent', 'Vendor dependent', 'Herstellerabhaengig', 'neutral', 30
  UNION ALL SELECT 'mobile-os', 'volte_support', 'full_support', 'Full support', 'Volle Unterstuetzung', 'positive', 10
  UNION ALL SELECT 'mobile-os', 'volte_support', 'carrier_dependent', 'Carrier dependent', 'Carrier-abhaengig', 'tradeoff', 20
  UNION ALL SELECT 'mobile-os', 'volte_support', 'partial', 'Partial', 'Teilweise', 'tradeoff', 30
  UNION ALL SELECT 'mobile-os', 'volte_support', 'not_supported', 'Not supported', 'Nicht unterstuetzt', 'warning', 40
  ...
  UNION ALL SELECT 'mobile-os', 'bluetooth_version', 'driver_dependent', 'Driver dependent', 'Treiberabhaengig', 'neutral', 40
  ...
  UNION ALL SELECT 'mobile-os', 'ui_customization_level', 'moderate', 'Moderate', 'Maessig', 'neutral', 20
  ...
  UNION ALL SELECT 'mobile-os', 'accessibility_features', 'magnification', 'Magnification', 'Vergroesserung', 'positive', 20
  ...
  UNION ALL SELECT 'mobile-os', 'device_migration_model', 'phone_to_phone_transfer', 'Phone-to-phone transfer', 'Telefon-zu-Telefon-Uebertragung', 'positive', 10
  ...
  UNION ALL SELECT 'mobile-os', 'device_migration_model', 'not_supported', 'Not supported', 'Nicht unterstuetzt', 'warning', 40
  UNION ALL SELECT 'mobile-os', 'source_code_model', 'open_source', 'Open source', 'Open Source', 'positive', 10
  UNION ALL SELECT 'mobile-os', 'source_code_model', 'source_available', 'Source available', 'Quellcode verfuegbar', 'neutral', 20
  UNION ALL SELECT 'mobile-os', 'source_code_model', 'partial_open', 'Partial open', 'Teilweise offen', 'tradeoff', 30
  UNION ALL SELECT 'mobile-os', 'source_code_model', 'proprietary', 'Proprietary', 'Proprietaer', 'warning', 40
  UNION ALL SELECT 'mobile-os', 'governance_model', 'community_driven', 'Community driven', 'Community-getrieben', 'positive', 10
  UNION ALL SELECT 'mobile-os', 'governance_model', 'foundation_backed', 'Foundation backed', 'Stiftungsunterstuetzt', 'positive', 20
