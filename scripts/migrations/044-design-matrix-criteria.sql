...
VALUES
  ('design', 'design_capabilities', 'Design Capabilities', 'Design-Faehigkeiten', 'Core design capabilities including vector editing, raster editing, prototyping, and layout support.', 'Kerndesign-Faehigkeiten einschliesslich Vektorbearbeitung, Rasterbearbeitung, Prototyping und Layout-Unterstuetzung.', 100),
  ('design', 'canvas_output', 'Canvas & Output', 'Leinwand & Ausgabe', 'Canvas resolution, color model support, and available export formats for design output.', 'Leinwandaufloesung, Farbmodell-Unterstuetzung und verfuegbare Exportformate fuer die Designausgabe.', 200),
  ('design', 'prototyping_interaction', 'Prototyping & Interaction', 'Prototyping & Interaktion', 'Interactive prototyping, animation, developer handoff, and design token capabilities.', 'Interaktives Prototyping, Animation, Entwickleruebergabe und Design-Token-Faehigkeiten.', 300),
  ('design', 'collaboration_workflow', 'Collaboration & Workflow', 'Zusammenarbeit & Workflow', 'Real-time collaboration, feedback tools, version history, and design system support.', 'Echtzeit-Zusammenarbeit, Feedbackwerkzeuge, Versionsverlauf und Designsystem-Unterstuetzung.', 400),
  ('design', 'platform_access', 'Platform & Access', 'Plattform & Zugriff', 'Supported operating systems, offline editing, plugin ecosystem, and API availability.', 'Unterstuetzte Betriebssysteme, Offline-Bearbeitung, Plugin-Oekosystem und API-Verfuegbarkeit.', 500),
  ('design', 'file_compatibility', 'File Compatibility', 'Dateikompatibilitaet', 'Import and export format support and interoperability with other design tools.', 'Import- und Exportformat-Unterstuetzung und Interoperabilitaet mit anderen Design-Werkzeugen.', 600),
  ('design', 'privacy_data', 'Privacy & Data Handling', 'Datenschutz & Datenverarbeitung', 'Telemetry collection, data processing location, and data export capabilities.', 'Telemetrie-Erfassung, Datenverarbeitungsstandort und Datenexport-Moeglichkeiten.', 700),
  ('design', 'openness_licensing', 'Openness & Licensing', 'Offenheit & Lizenzierung', 'Source code availability, licensing, self-hosting capability, and deployment models.', 'Quellcode-Verfuegbarkeit, Lizenzierung, Selbsthosting-Faehigkeit und Bereitstellungsmodelle.', 800),
  ('design', 'pricing_fit', 'Pricing & Fit', 'Preise & Eignung', 'Pricing structure, free tier availability, and target user profiles.', 'Preisstruktur, Verfuegbarkeit kostenloser Versionen und Zielgruppen-Benutzerprofile.', 900);
...
FROM (
  SELECT 'design' AS category_id, 'design_capabilities' AS group_key, 'primary_design_type' AS criterion_key, 'Primary design type' AS label_en, 'Primaerer Designtyp' AS label_de, 'multi_enum' AS value_type, 'informational' AS semantics, 'multi_select' AS filter_mode, 1010 AS sort_order, 'The main design disciplines this tool is built for, such as UI/UX, illustration, photo editing, or motion graphics.' AS help_text_en, 'Die Hauptdesign-Disziplinen, fuer die dieses Werkzeug entwickelt wurde, wie UI/UX, Illustration, Fotobearbeitung oder Bewegtgrafik.' AS help_text_de
  ...
  UNION ALL SELECT 'design', 'design_capabilities', 'raster_editing', 'Raster/photo editing', 'Raster-/Fotobearbeitung', 'boolean', 'informational', 'optional', 1030, 'Whether the tool supports pixel-based image editing for photographs and raster artwork.', 'Ob das Werkzeug pixelbasierte Bildbearbeitung fuer Fotografien und Rastergrafiken unterstuetzt.'
  UNION ALL SELECT 'design', 'design_capabilities', 'prototyping_support', 'Prototyping support', 'Prototyping-Unterstuetzung', 'boolean', 'informational', 'optional', 1040, 'Whether the tool includes features for creating interactive design prototypes.', 'Ob das Werkzeug Funktionen zum Erstellen interaktiver Design-Prototypen enthaelt.'
  UNION ALL SELECT 'design', 'design_capabilities', 'layout_desktop_publishing', 'Layout/desktop publishing', 'Layout/Desktop-Publishing', 'boolean', 'informational', 'optional', 1050, 'Whether the tool supports multi-page layouts for print publications and documents.', 'Ob das Werkzeug mehrseitige Layouts fuer Druckpublikationen und Dokumente unterstuetzt.'
  UNION ALL SELECT 'design', 'canvas_output', 'color_model_support', 'Color model support', 'Farbmodell-Unterstuetzung', 'multi_enum', 'informational', 'multi_select', 2010, 'Which color models and spaces the tool natively supports for color selection and output.', 'Welche Farbmodelle und Farbraeume das Werkzeug nativ fuer Farbauswahl und Ausgabe unterstuetzt.'
  UNION ALL SELECT 'design', 'canvas_output', 'max_canvas_resolution', 'Maximum canvas resolution', 'Maximale Leinwandaufloesung', 'enum', 'informational', 'optional', 2020, 'The maximum canvas or artboard resolution supported by the tool.', 'Die maximale Leinwand- oder Zeichenflaechen-Aufloesung, die das Werkzeug unterstuetzt.'
  UNION ALL SELECT 'design', 'canvas_output', 'export_formats', 'Export formats', 'Exportformate', 'multi_enum', 'informational', 'multi_select', 2030, 'The file formats available when exporting finished designs from the tool.', 'Die Dateiformate, die beim Exportieren fertiger Designs aus dem Werkzeug verfuegbar sind.'
  ...
  UNION ALL SELECT 'design', 'prototyping_interaction', 'interactive_prototyping', 'Interactive prototyping', 'Interaktives Prototyping', 'boolean', 'informational', 'optional', 3010, 'Whether the tool allows creating clickable prototypes with linked screens and interactions.', 'Ob das Werkzeug das Erstellen klickbarer Prototypen mit verlinkten Bildschirmen und Interaktionen ermoeglicht.'
  UNION ALL SELECT 'design', 'prototyping_interaction', 'animation_support', 'Animation support', 'Animationsunterstuetzung', 'boolean', 'informational', 'optional', 3020, 'Whether the tool includes animation timeline or motion design capabilities for UI transitions.', 'Ob das Werkzeug Animationszeitleisten oder Motion-Design-Funktionen fuer UI-Uebergaenge enthaelt.'
  UNION ALL SELECT 'design', 'prototyping_interaction', 'developer_handoff', 'Developer handoff', 'Entwickleruebergabe', 'boolean', 'beneficial', 'optional', 3030, 'Whether the tool provides features to generate CSS, code snippets, or specs for developers.', 'Ob das Werkzeug Funktionen bietet, um CSS, Code-Snippets oder Spezifikationen fuer Entwickler zu generieren.'
  UNION ALL SELECT 'design', 'prototyping_interaction', 'design_token_support', 'Design token support', 'Design-Token-Unterstuetzung', 'boolean', 'informational', 'optional', 3040, 'Whether the tool supports design tokens for systematic color, spacing, and typography management.', 'Ob das Werkzeug Design-Tokens fuer systematisches Farb-, Abstands- und Typografie-Management unterstuetzt.'
  UNION ALL SELECT 'design', 'collaboration_workflow', 'real_time_collaboration', 'Real-time collaboration', 'Echtzeit-Zusammenarbeit', 'boolean', 'beneficial', 'must_match', 4010, 'Whether multiple users can simultaneously edit the same design file in real time.', 'Ob mehrere Benutzer gleichzeitig dieselbe Designdatei in Echtzeit bearbeiten koennen.'
  ...
  UNION ALL SELECT 'design', 'collaboration_workflow', 'version_history', 'Version history', 'Versionsverlauf', 'boolean', 'beneficial', 'optional', 4030, 'Whether the tool tracks and allows restoration of previous versions of a design file.', 'Ob das Werkzeug fruehere Versionen einer Designdatei nachverfolgt und deren Wiederherstellung ermoeglicht.'
  UNION ALL SELECT 'design', 'collaboration_workflow', 'design_system_support', 'Design system / component library', 'Designsystem / Komponentenbibliothek', 'boolean', 'beneficial', 'optional', 4040, 'Whether the tool supports reusable component libraries and shared design system assets.', 'Ob das Werkzeug wiederverwendbare Komponentenbibliotheken und gemeinsame Designsystem-Assets unterstuetzt.'
  UNION ALL SELECT 'design', 'collaboration_workflow', 'asset_management', 'Asset management', 'Asset-Verwaltung', 'boolean', 'informational', 'optional', 4050, 'Whether the tool includes features for organizing, tagging, and sharing design assets across projects.', 'Ob das Werkzeug Funktionen zum Organisieren, Taggen und Teilen von Design-Assets ueber Projekte hinweg enthaelt.'
  UNION ALL SELECT 'design', 'platform_access', 'supported_platforms', 'Supported platforms', 'Unterstuetzte Plattformen', 'multi_enum', 'informational', 'multi_select', 5010, 'The operating systems and platforms on which the design tool is available.', 'Die Betriebssysteme und Plattformen, auf denen das Design-Werkzeug verfuegbar ist.'
  UNION ALL SELECT 'design', 'platform_access', 'offline_editing', 'Offline editing', 'Offline-Bearbeitung', 'boolean', 'beneficial', 'must_match', 5020, 'Whether the tool allows editing designs without an active internet connection.', 'Ob das Werkzeug das Bearbeiten von Designs ohne aktive Internetverbindung ermoeglicht.'
  UNION ALL SELECT 'design', 'platform_access', 'plugin_ecosystem', 'Plugin / extension ecosystem', 'Plugin-/Erweiterungs-Oekosystem', 'boolean', 'beneficial', 'optional', 5030, 'Whether the tool supports third-party plugins or extensions to add functionality.', 'Ob das Werkzeug Drittanbieter-Plugins oder Erweiterungen zur Funktionserweiterung unterstuetzt.'
  UNION ALL SELECT 'design', 'platform_access', 'api_available', 'API available', 'API verfuegbar', 'boolean', 'beneficial', 'optional', 5040, 'Whether a programmable API is available for automating design operations and integrations.', 'Ob eine programmierbare API fuer die Automatisierung von Design-Operationen und Integrationen verfuegbar ist.'
  UNION ALL SELECT 'design', 'file_compatibility', 'import_formats', 'Import formats', 'Importformate', 'multi_enum', 'informational', 'multi_select', 6010, 'The file formats that can be imported into the tool for editing or reference.', 'Die Dateiformate, die in das Werkzeug zum Bearbeiten oder als Referenz importiert werden koennen.'
  UNION ALL SELECT 'design', 'file_compatibility', 'sketch_file_import', 'Sketch file import', 'Sketch-Datei-Import', 'boolean', 'informational', 'optional', 6020, 'Whether the tool can open and edit Sketch (.sketch) files natively.', 'Ob das Werkzeug Sketch-Dateien (.sketch) nativ oeffnen und bearbeiten kann.'
  ...
  UNION ALL SELECT 'design', 'file_compatibility', 'psd_file_import', 'PSD file import', 'PSD-Datei-Import', 'boolean', 'informational', 'optional', 6040, 'Whether the tool can open and edit Adobe Photoshop (.psd) files with layer support.', 'Ob das Werkzeug Adobe-Photoshop-Dateien (.psd) mit Ebenenunterstuetzung oeffnen und bearbeiten kann.'
  UNION ALL SELECT 'design', 'privacy_data', 'telemetry_model', 'Telemetry model', 'Telemetriemodell', 'enum', 'risk', 'optional', 7010, 'How the design tool collects and transmits usage data and analytics to the vendor.', 'Wie das Design-Werkzeug Nutzungsdaten und Analysen an den Anbieter erfasst und uebertraegt.'
  ...
  UNION ALL SELECT 'design', 'privacy_data', 'data_export_available', 'Data export available', 'Datenexport verfuegbar', 'boolean', 'beneficial', 'optional', 7030, 'Whether all design files and account data can be exported in portable formats for migration.', 'Ob alle Designdateien und Kontodaten in portablen Formaten fuer die Migration exportiert werden koennen.'
  UNION ALL SELECT 'design', 'openness_licensing', 'source_model', 'Source code model', 'Quellcode-Modell', 'enum', 'tradeoff', 'optional', 8010, 'The availability and openness of the design tool source code.', 'Die Verfuegbarkeit und Offenheit des Quellcodes des Design-Werkzeugs.'
  ...
  UNION ALL SELECT 'design', 'pricing_fit', 'pricing_model', 'Pricing model', 'Preismodell', 'enum', 'informational', 'optional', 9010, 'The pricing structure for obtaining and using the design tool.', 'Die Preisstruktur fuer den Erwerb und die Nutzung des Design-Werkzeugs.'
  UNION ALL SELECT 'design', 'pricing_fit', 'free_tier_available', 'Free tier available', 'Kostenlose Version verfuegbar', 'boolean', 'informational', 'must_match', 9020, 'Whether a functional free version of the tool is available without payment or time limits.', 'Ob eine funktionsfaehige kostenlose Version des Werkzeugs ohne Bezahlung oder Zeitlimits verfuegbar ist.'
  UNION ALL SELECT 'design', 'pricing_fit', 'fit_profiles', 'Fit profiles', 'Eignungsprofile', 'multi_enum', 'informational', 'multi_select', 9030, 'Target user profiles and roles the design tool is best suited for based on features and workflow.', 'Zielgruppen-Benutzerprofile und Rollen, fuer die das Design-Werkzeug basierend auf Funktionen und Arbeitsablauf am besten geeignet ist.'
) AS d
...
FROM (
  ...
  UNION ALL SELECT 'design', 'max_canvas_resolution', 'above_8k', 'Above 8K', 'Ueber 8K', 'neutral', 30
  ...
  UNION ALL SELECT 'design', 'data_processing_location', 'eu_primary', 'EU primary', 'EU primaer', 'neutral', 20
  UNION ALL SELECT 'design', 'data_processing_location', 'global', 'Global', 'Global', 'warning', 30
  UNION ALL SELECT 'design', 'data_processing_location', 'local_device', 'Local device', 'Lokales Geraet', 'positive', 40
  ...
  UNION ALL SELECT 'design', 'source_model', 'fully_open_source', 'Fully open source', 'Vollstaendig quelloffen', 'positive', 10
  UNION ALL SELECT 'design', 'source_model', 'source_available', 'Source available', 'Quellcode verfuegbar', 'neutral', 20
  UNION ALL SELECT 'design', 'source_model', 'partially_open', 'Partially open', 'Teilweise offen', 'neutral', 30
  UNION ALL SELECT 'design', 'source_model', 'proprietary', 'Proprietary', 'Proprietaer', 'warning', 40
  ...
  UNION ALL SELECT 'design', 'license_type', 'proprietary', 'Proprietary', 'Proprietaer', 'neutral', 50
  ...
  UNION ALL SELECT 'design', 'fit_profiles', 'enterprise', 'Enterprise', 'Grossunternehmen', 'neutral', 80
) AS d
