...
VALUES
  ('gis', 'spatial_data_formats', 'Spatial Data Formats', 'Raumdatenformate', 'Supported vector, raster, point cloud, and web service data formats for import and interoperability.', 'Unterstützte Vektor-, Raster-, Punktwolken- und Webdienst-Datenformate für Import und Interoperabilität.', 100),
  ('gis', 'analysis_processing', 'Analysis & Processing', 'Analyse & Verarbeitung', 'Spatial analysis capabilities including vector operations, raster processing, statistics, geocoding, and terrain modeling.', 'Räumliche Analysefähigkeiten einschließlich Vektoroperationen, Rasterverarbeitung, Statistik, Geokodierung und Geländemodellierung.', 200),
  ...
  ('gis', 'coordinate_projection', 'Coordinate Systems & Projection', 'Koordinatensysteme & Projektion', 'Coordinate reference system support, on-the-fly reprojection, custom definitions, and datum transformations.', 'Unterstützung von Koordinatenreferenzsystemen, Echtzeit-Reprojektion, benutzerdefinierte Definitionen und Datumstransformationen.', 400),
  ('gis', 'data_management', 'Data Management & Storage', 'Datenverwaltung & Speicherung', 'Spatial indexing, versioned editing, attribute management, topology validation, and dataset scalability.', 'Räumliche Indizierung, versionierte Bearbeitung, Attributverwaltung, Topologievalidierung und Datensatzskalierbarkeit.', 500),
  ('gis', 'field_mobile', 'Field & Mobile Capabilities', 'Feld- & Mobilfähigkeiten', 'Mobile data collection, offline editing, GPS integration, custom forms, and field-to-server synchronization.', 'Mobile Datenerfassung, Offline-Bearbeitung, GPS-Integration, benutzerdefinierte Formulare und Feld-zu-Server-Synchronisierung.', 600),
  ('gis', 'extensibility_automation', 'Extensibility & Automation', 'Erweiterbarkeit & Automatisierung', 'Plugin support, scripting languages, processing frameworks, REST APIs, and command-line tooling.', 'Plugin-Unterstützung, Skriptsprachen, Verarbeitungs-Frameworks, REST-APIs und Kommandozeilen-Werkzeuge.', 700),
  ('gis', 'platform_deployment', 'Platform & Deployment', 'Plattform & Bereitstellung', 'Operating system support, deployment options, self-hosting, data residency, account requirements, and telemetry.', 'Betriebssystem-Unterstützung, Bereitstellungsoptionen, Selbst-Hosting, Datenresidenz, Kontoanforderungen und Telemetrie.', 800),
  ('gis', 'openness_pricing', 'Openness & Pricing', 'Offenheit & Preise', 'Source code availability, licensing, OGC standards compliance, pricing structure, and target user profiles.', 'Quellcode-Verfügbarkeit, Lizenzierung, OGC-Standardkonformität, Preisstruktur und Zielgruppen-Benutzerprofile.', 900);
...
FROM (
  SELECT 'gis' AS category_id, 'spatial_data_formats' AS group_key, 'vector_format_support' AS criterion_key, 'Vector format support' AS label_en, 'Vektorformat-Unterstützung' AS label_de, 'multi_enum' AS value_type, 'informational' AS semantics, 'multi_select' AS filter_mode, 1010 AS sort_order, 'The vector geospatial data formats the tool can import and export, such as Shapefile, GeoJSON, GeoPackage, and KML.' AS help_text_en, 'Die Vektor-Geodatenformate, die das Werkzeug importieren und exportieren kann, wie Shapefile, GeoJSON, GeoPackage und KML.' AS help_text_de
  UNION ALL SELECT 'gis', 'spatial_data_formats', 'raster_format_support', 'Raster format support', 'Rasterformat-Unterstützung', 'multi_enum', 'informational', 'multi_select', 1020, 'The raster imagery and gridded data formats supported for reading and writing, including GeoTIFF, JPEG2000, and NetCDF.', 'Die unterstützten Rasterbilder- und Gitterdatenformate zum Lesen und Schreiben, einschließlich GeoTIFF, JPEG2000 und NetCDF.'
  UNION ALL SELECT 'gis', 'spatial_data_formats', 'point_cloud_support', 'Point cloud support', 'Punktwolken-Unterstützung', 'boolean', 'informational', 'optional', 1030, 'Whether the tool can load and visualize point cloud data from LiDAR scanners or photogrammetry workflows.', 'Ob das Werkzeug Punktwolkendaten aus LiDAR-Scannern oder Photogrammetrie-Workflows laden und visualisieren kann.'
  UNION ALL SELECT 'gis', 'spatial_data_formats', 'gps_track_support', 'GPS track/waypoint support', 'GPS-Track/Wegpunkt-Unterstützung', 'boolean', 'informational', 'optional', 1040, 'Whether GPS tracks, waypoints, and routes in formats such as GPX or NMEA can be imported and displayed.', 'Ob GPS-Tracks, Wegpunkte und Routen in Formaten wie GPX oder NMEA importiert und angezeigt werden können.'
  UNION ALL SELECT 'gis', 'spatial_data_formats', 'wms_wfs_support', 'WMS/WFS/WMTS support', 'WMS/WFS/WMTS-Unterstützung', 'multi_enum', 'informational', 'multi_select', 1050, 'The OGC web service protocols supported for consuming remote geospatial data layers from external servers.', 'Die unterstützten OGC-Webdienstprotokolle zum Abrufen entfernter Geodatenlayer von externen Servern.'
  UNION ALL SELECT 'gis', 'spatial_data_formats', 'database_connectivity', 'Spatial database connectivity', 'Räumliche Datenbankanbindung', 'multi_enum', 'informational', 'multi_select', 1060, 'The spatial database engines the tool can connect to for reading and writing geospatial features directly.', 'Die räumlichen Datenbank-Engines, mit denen sich das Werkzeug zum direkten Lesen und Schreiben von Geoobjekten verbinden kann.'
  UNION ALL SELECT 'gis', 'spatial_data_formats', 'cad_format_support', 'CAD format support', 'CAD-Format-Unterstützung', 'boolean', 'informational', 'optional', 1070, 'Whether engineering and architecture CAD files such as DXF or DWG can be imported into the GIS environment.', 'Ob Ingenieur- und Architektur-CAD-Dateien wie DXF oder DWG in die GIS-Umgebung importiert werden können.'
  UNION ALL SELECT 'gis', 'analysis_processing', 'vector_analysis_tools', 'Vector analysis tools', 'Vektoranalyse-Werkzeuge', 'multi_enum', 'informational', 'multi_select', 2010, 'The geoprocessing operations available for vector data, such as buffering, overlay analysis, and spatial joins.', 'Die verfügbaren Geoverarbeitungsoperationen für Vektordaten, wie Pufferung, Überlagerungsanalyse und räumliche Verknüpfungen.'
  UNION ALL SELECT 'gis', 'analysis_processing', 'raster_analysis_tools', 'Raster analysis tools', 'Rasteranalyse-Werkzeuge', 'multi_enum', 'informational', 'multi_select', 2020, 'The analysis functions available for raster data, including reclassification, map algebra, and terrain derivatives.', 'Die verfügbaren Analysefunktionen für Rasterdaten, einschließlich Reklassifikation, Kartenalgebra und Geländeableitungen.'
  UNION ALL SELECT 'gis', 'analysis_processing', 'spatial_statistics', 'Spatial statistics', 'Räumliche Statistik', 'boolean', 'informational', 'optional', 2030, 'Whether the tool provides statistical methods designed for spatially referenced data, such as hotspot analysis and autocorrelation.', 'Ob das Werkzeug statistische Methoden für räumlich referenzierte Daten bereitstellt, wie Hotspot-Analyse und Autokorrelation.'
  UNION ALL SELECT 'gis', 'analysis_processing', 'geocoding_support', 'Geocoding/reverse geocoding', 'Geokodierung/Rückwärtsgeokodierung', 'boolean', 'beneficial', 'optional', 2040, 'Whether addresses or place names can be converted to coordinates and vice versa using built-in or connected services.', 'Ob Adressen oder Ortsnamen mithilfe integrierter oder verbundener Dienste in Koordinaten umgewandelt werden können und umgekehrt.'
  UNION ALL SELECT 'gis', 'analysis_processing', 'terrain_analysis', 'Terrain/elevation analysis', 'Gelände-/Höhenanalyse', 'boolean', 'informational', 'optional', 2050, 'Whether the tool supports elevation-based analyses such as slope, aspect, hillshade, and contour generation from DEMs.', 'Ob das Werkzeug höhenbasierte Analysen wie Neigung, Exposition, Schummerung und Konturenerzeugung aus DEMs unterstützt.'
  UNION ALL SELECT 'gis', 'analysis_processing', 'network_analysis', 'Network/routing analysis', 'Netzwerk-/Routenanalyse', 'boolean', 'informational', 'optional', 2060, 'Whether routing, shortest path, service area, and other graph-based analyses on transportation networks are available.', 'Ob Routenberechnung, kürzester Pfad, Einzugsbereiche und andere graphbasierte Analysen auf Verkehrsnetzwerken verfügbar sind.'
  ...
  UNION ALL SELECT 'gis', 'platform_deployment', 'telemetry_model', 'Telemetry model', 'Telemetriemodell', 'enum', 'risk', 'optional', 8060, 'How the GIS tool collects and transmits usage analytics and diagnostic telemetry data to the vendor.', 'Wie das GIS-Werkzeug Nutzungsanalysen und diagnostische Telemetriedaten an den Anbieter erfasst und überträgt.'
  UNION ALL SELECT 'gis', 'openness_pricing', 'source_model', 'Source code model', 'Quellcode-Modell', 'enum', 'tradeoff', 'optional', 9010, 'The availability and openness of the GIS tool source code for inspection, modification, and community contribution.', 'Die Verfügbarkeit und Offenheit des GIS-Werkzeug-Quellcodes zur Einsicht, Modifikation und Gemeinschaftsbeteiligung.'
  UNION ALL SELECT 'gis', 'openness_pricing', 'license_type', 'License type', 'Lizenztyp', 'enum', 'informational', 'optional', 9020, 'The software license governing redistribution and use of the GIS tool, from copyleft to permissive to proprietary.', 'Die Softwarelizenz, die Weiterverbreitung und Nutzung des GIS-Werkzeugs regelt, von Copyleft über permissiv bis proprietär.'
  UNION ALL SELECT 'gis', 'openness_pricing', 'ogc_compliance', 'OGC standards compliance', 'OGC-Standardkonformität', 'multi_enum', 'beneficial', 'multi_select', 9030, 'Which Open Geospatial Consortium interoperability standards the tool formally implements or supports.', 'Welche Interoperabilitätsstandards des Open Geospatial Consortium das Werkzeug formell implementiert oder unterstützt.'
  UNION ALL SELECT 'gis', 'openness_pricing', 'pricing_model', 'Pricing model', 'Preismodell', 'enum', 'informational', 'optional', 9040, 'The pricing structure for obtaining and using the GIS tool, such as free, freemium, subscription, or one-time purchase.', 'Die Preisstruktur für den Erwerb und die Nutzung des GIS-Werkzeugs, wie kostenlos, Freemium, Abonnement oder Einmalkauf.'
  UNION ALL SELECT 'gis', 'openness_pricing', 'free_tier_available', 'Free tier available', 'Kostenlose Version verfügbar', 'boolean', 'informational', 'must_match', 9050, 'Whether a functional free version of the GIS tool is available without payment requirements or time-limited trials.', 'Ob eine funktionsfähige kostenlose Version des GIS-Werkzeugs ohne Zahlungsanforderungen oder zeitlich begrenzte Testversionen verfügbar ist.'
  UNION ALL SELECT 'gis', 'openness_pricing', 'fit_profiles', 'Fit profiles', 'Eignungsprofile', 'multi_enum', 'informational', 'multi_select', 9060, 'Target user roles and professional profiles the GIS tool is best suited for based on its features and workflow design.', 'Zielgruppen-Benutzerrollen und professionelle Profile, für die das GIS-Werkzeug basierend auf seinen Funktionen und Workflow-Design am besten geeignet ist.'
) AS d
...
FROM (
  ...
  UNION ALL SELECT 'gis', 'vector_analysis_tools', 'overlay', 'Overlay/intersection', 'Überlagerung/Verschneidung', 'neutral', 20
  UNION ALL SELECT 'gis', 'vector_analysis_tools', 'dissolve', 'Dissolve/merge', 'Zusammenführen/Verschmelzen', 'neutral', 30
  UNION ALL SELECT 'gis', 'vector_analysis_tools', 'spatial_join', 'Spatial join', 'Räumliche Verknüpfung', 'neutral', 40
  UNION ALL SELECT 'gis', 'vector_analysis_tools', 'voronoi', 'Voronoi/Thiessen', 'Voronoi/Thiessen', 'neutral', 50
  UNION ALL SELECT 'gis', 'vector_analysis_tools', 'convex_hull', 'Convex hull', 'Konvexe Hülle', 'neutral', 60
  ...
  UNION ALL SELECT 'gis', 'crs_support_model', 'epsg_registry', 'Full EPSG registry', 'Vollständiges EPSG-Register', 'neutral', 20
  ...
  UNION ALL SELECT 'gis', 'max_dataset_scale', 'small', 'Small datasets < 100K features', 'Kleine Datensätze < 100K Objekte', 'warning', 10
  UNION ALL SELECT 'gis', 'max_dataset_scale', 'medium', 'Medium up to 1M features', 'Mittel bis 1M Objekte', 'neutral', 20
  UNION ALL SELECT 'gis', 'max_dataset_scale', 'large', 'Large 1M-10M features', 'Groß 1M-10M Objekte', 'neutral', 30
  ...
  UNION ALL SELECT 'gis', 'scripting_language', 'sql', 'SQL expressions', 'SQL-Ausdrücke', 'neutral', 40
  ...
  UNION ALL SELECT 'gis', 'data_processing_location', 'eu_primary', 'EU primary', 'EU primär', 'neutral', 20
  UNION ALL SELECT 'gis', 'data_processing_location', 'global', 'Global', 'Global', 'warning', 30
  UNION ALL SELECT 'gis', 'data_processing_location', 'local_device', 'Local device', 'Lokales Gerät', 'positive', 40
  ...
  UNION ALL SELECT 'gis', 'source_model', 'fully_open_source', 'Fully open source', 'Vollständig quelloffen', 'positive', 10
  UNION ALL SELECT 'gis', 'source_model', 'source_available', 'Source available', 'Quellcode verfügbar', 'neutral', 20
  UNION ALL SELECT 'gis', 'source_model', 'partially_open', 'Partially open', 'Teilweise offen', 'neutral', 30
  UNION ALL SELECT 'gis', 'source_model', 'proprietary', 'Proprietary', 'Proprietär', 'warning', 40
  ...
  UNION ALL SELECT 'gis', 'license_type', 'proprietary', 'Proprietary', 'Proprietär', 'neutral', 50
  UNION ALL SELECT 'gis', 'ogc_compliance', 'ogc_simple_features', 'Simple Features', 'Simple Features', 'neutral', 10
  UNION ALL SELECT 'gis', 'ogc_compliance', 'ogc_wms', 'WMS compliance', 'WMS-Konformität', 'neutral', 20
  UNION ALL SELECT 'gis', 'ogc_compliance', 'ogc_wfs', 'WFS compliance', 'WFS-Konformität', 'neutral', 30
  UNION ALL SELECT 'gis', 'ogc_compliance', 'ogc_geopackage', 'GeoPackage compliance', 'GeoPackage-Konformität', 'neutral', 40
  UNION ALL SELECT 'gis', 'ogc_compliance', 'ogc_api', 'OGC API compliance', 'OGC-API-Konformität', 'neutral', 50
  ...
  UNION ALL SELECT 'gis', 'fit_profiles', 'hobbyist', 'Hobbyist/OSM contributor', 'Hobbyist/OSM-Beiträger', 'neutral', 70
