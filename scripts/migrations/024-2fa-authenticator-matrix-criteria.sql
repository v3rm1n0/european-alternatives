...
VALUES
  ('2fa-authenticator', 'supported_methods', 'Supported 2FA Methods', 'Unterstuetzte 2FA-Methoden', 'Which second-factor authentication methods and algorithms are supported.', 'Welche Zweitfaktor-Authentifizierungsmethoden und Algorithmen unterstuetzt werden.', 100),
  ('2fa-authenticator', 'token_management', 'Token Management', 'Token-Verwaltung', 'How tokens and entries are added, organized, and displayed.', 'Wie Token und Eintraege hinzugefuegt, organisiert und angezeigt werden.', 200),
  ('2fa-authenticator', 'security_protection', 'Security & Protection', 'Sicherheit & Schutz', 'Encryption, app locking, and code protection measures.', 'Verschluesselung, App-Sperrung und Schutz von Codes.', 300),
  ('2fa-authenticator', 'backup_sync', 'Backup & Sync', 'Backup & Synchronisierung', 'How token data is backed up and synchronized across devices.', 'Wie Token-Daten gesichert und zwischen Geraeten synchronisiert werden.', 400),
  ('2fa-authenticator', 'platform_access', 'Platform & Access', 'Plattform & Zugriff', 'Supported operating systems, devices, and access methods.', 'Unterstuetzte Betriebssysteme, Geraete und Zugriffsmethoden.', 500),
  ('2fa-authenticator', 'migration_portability', 'Migration & Portability', 'Migration & Portabilitaet', 'Importing from other apps and exporting token data.', 'Import aus anderen Apps und Export von Token-Daten.', 600),
  ('2fa-authenticator', 'usability_ux', 'Usability & UX', 'Bedienbarkeit & UX', 'Daily use convenience, accessibility, and interface quality.', 'Komfort im taeglichen Gebrauch, Barrierefreiheit und Oberflaechen-Qualitaet.', 700),
...
FROM (
  SELECT '2fa-authenticator' AS category_id, 'supported_methods' AS group_key, 'totp_support' AS criterion_key, 'TOTP support' AS label_en, 'TOTP-Unterstuetzung' AS label_de, 'boolean' AS value_type, 'beneficial' AS semantics, 'must_match' AS filter_mode, 1010 AS sort_order, 'Whether time-based one-time passwords are supported.' AS help_text_en, 'Ob zeitbasierte Einmalpasswoerter unterstuetzt werden.' AS help_text_de
  UNION ALL SELECT '2fa-authenticator', 'supported_methods', 'hotp_support', 'HOTP support', 'HOTP-Unterstuetzung', 'boolean', 'informational', 'optional', 1020, 'Whether HMAC-based one-time passwords are supported.', 'Ob HMAC-basierte Einmalpasswoerter unterstuetzt werden.'
  UNION ALL SELECT '2fa-authenticator', 'supported_methods', 'push_authentication', 'Push-based authentication', 'Push-basierte Authentifizierung', 'boolean', 'informational', 'optional', 1030, 'Whether push notification authentication is supported.', 'Ob Push-Benachrichtigungs-Authentifizierung unterstuetzt wird.'
  UNION ALL SELECT '2fa-authenticator', 'supported_methods', 'supported_otp_algorithms', 'Supported OTP algorithms', 'Unterstuetzte OTP-Algorithmen', 'multi_enum', 'informational', 'multi_select', 1040, 'Which hash algorithms are supported for OTP generation.', 'Welche Hash-Algorithmen fuer die OTP-Generierung unterstuetzt werden.'
  UNION ALL SELECT '2fa-authenticator', 'supported_methods', 'passkey_storage', 'Passkey or FIDO2 credential storage', 'Passkey- oder FIDO2-Speicherung', 'boolean', 'informational', 'optional', 1050, 'Whether passkeys or FIDO2 credentials can be stored.', 'Ob Passkeys oder FIDO2-Anmeldedaten gespeichert werden koennen.'
  UNION ALL SELECT '2fa-authenticator', 'supported_methods', 'steam_guard_support', 'Steam Guard token support', 'Steam-Guard-Token-Unterstuetzung', 'boolean', 'informational', 'optional', 1060, 'Whether Steam Guard tokens can be managed.', 'Ob Steam-Guard-Token verwaltet werden koennen.'
  UNION ALL SELECT '2fa-authenticator', 'token_management', 'token_entry_methods', 'Token entry methods', 'Token-Eingabemethoden', 'multi_enum', 'informational', 'multi_select', 2010, 'How new tokens can be added to the app.', 'Wie neue Token zur App hinzugefuegt werden koennen.'
  UNION ALL SELECT '2fa-authenticator', 'token_management', 'token_organization', 'Token organization', 'Token-Organisation', 'multi_enum', 'beneficial', 'multi_select', 2020, 'How tokens can be organized and grouped.', 'Wie Token organisiert und gruppiert werden koennen.'
  UNION ALL SELECT '2fa-authenticator', 'token_management', 'icon_or_logo_support', 'Service icon or logo display', 'Dienst-Icon- oder Logo-Anzeige', 'boolean', 'beneficial', 'optional', 2030, 'Whether service icons or logos are displayed for entries.', 'Ob Dienst-Icons oder Logos fuer Eintraege angezeigt werden.'
  UNION ALL SELECT '2fa-authenticator', 'token_management', 'search_capability', 'Token search', 'Token-Suche', 'boolean', 'beneficial', 'optional', 2040, 'Whether tokens can be searched by name or issuer.', 'Ob Token nach Name oder Aussteller durchsucht werden koennen.'
  UNION ALL SELECT '2fa-authenticator', 'token_management', 'custom_token_period', 'Custom token period support', 'Benutzerdefinierte Token-Periode', 'boolean', 'informational', 'optional', 2050, 'Whether custom token refresh periods can be configured.', 'Ob benutzerdefinierte Token-Aktualisierungsperioden eingestellt werden koennen.'
  ...
  UNION ALL SELECT '2fa-authenticator', 'security_protection', 'encryption_at_rest', 'Encryption at rest', 'Verschluesselung im Ruhezustand', 'boolean', 'beneficial', 'must_match', 3010, 'Whether stored tokens are encrypted on the device.', 'Ob gespeicherte Token auf dem Geraet verschluesselt werden.'
  UNION ALL SELECT '2fa-authenticator', 'security_protection', 'app_lock_method', 'App lock method', 'App-Sperrmethode', 'multi_enum', 'beneficial', 'multi_select', 3020, 'Which methods are available to lock the app.', 'Welche Methoden zum Sperren der App verfuegbar sind.'
  ...
  UNION ALL SELECT '2fa-authenticator', 'security_protection', 'secure_storage_backend', 'Secure storage backend', 'Sicheres Speicher-Backend', 'enum', 'tradeoff', 'optional', 3060, 'Which secure storage mechanism is used for key material.', 'Welcher sichere Speichermechanismus fuer Schluesselmaterial verwendet wird.'
  UNION ALL SELECT '2fa-authenticator', 'backup_sync', 'sync_model', 'Sync model', 'Synchronisierungsmodell', 'enum', 'tradeoff', 'must_match', 4010, 'How token data is synchronized between devices.', 'Wie Token-Daten zwischen Geraeten synchronisiert werden.'
  UNION ALL SELECT '2fa-authenticator', 'backup_sync', 'encrypted_backup', 'Encrypted backup', 'Verschluesseltes Backup', 'boolean', 'beneficial', 'must_match', 4020, 'Whether backups are encrypted.', 'Ob Backups verschluesselt werden.'
  UNION ALL SELECT '2fa-authenticator', 'backup_sync', 'backup_methods', 'Backup methods', 'Backup-Methoden', 'multi_enum', 'informational', 'multi_select', 4030, 'Which backup methods are available.', 'Welche Backup-Methoden verfuegbar sind.'
  UNION ALL SELECT '2fa-authenticator', 'backup_sync', 'multi_device_sync', 'Multi-device sync', 'Mehrgeraete-Synchronisierung', 'boolean', 'beneficial', 'optional', 4040, 'Whether tokens can be synced across multiple devices.', 'Ob Token ueber mehrere Geraete synchronisiert werden koennen.'
  UNION ALL SELECT '2fa-authenticator', 'backup_sync', 'offline_functionality', 'Offline functionality', 'Offline-Funktionalitaet', 'boolean', 'beneficial', 'optional', 4050, 'Whether codes can be generated without an internet connection.', 'Ob Codes ohne Internetverbindung generiert werden koennen.'
  ...
  UNION ALL SELECT '2fa-authenticator', 'platform_access', 'supported_platforms', 'Supported platforms', 'Unterstuetzte Plattformen', 'multi_enum', 'informational', 'multi_select', 5010, 'Which operating systems are supported.', 'Welche Betriebssysteme unterstuetzt werden.'
  UNION ALL SELECT '2fa-authenticator', 'platform_access', 'browser_extension', 'Browser extension available', 'Browser-Erweiterung verfuegbar', 'boolean', 'beneficial', 'optional', 5020, 'Whether a browser extension is available.', 'Ob eine Browser-Erweiterung verfuegbar ist.'
  UNION ALL SELECT '2fa-authenticator', 'platform_access', 'desktop_app', 'Desktop app available', 'Desktop-App verfuegbar', 'boolean', 'beneficial', 'optional', 5030, 'Whether a standalone desktop application is available.', 'Ob eine eigenstaendige Desktop-Anwendung verfuegbar ist.'
  UNION ALL SELECT '2fa-authenticator', 'platform_access', 'wearable_support', 'Wearable device support', 'Wearable-Geraete-Unterstuetzung', 'multi_enum', 'informational', 'multi_select', 5040, 'Which wearable platforms are supported.', 'Welche Wearable-Plattformen unterstuetzt werden.'
  UNION ALL SELECT '2fa-authenticator', 'platform_access', 'widget_support', 'Home screen widget', 'Startbildschirm-Widget', 'boolean', 'beneficial', 'optional', 5050, 'Whether a home screen widget for quick code access is available.', 'Ob ein Startbildschirm-Widget fuer schnellen Code-Zugriff verfuegbar ist.'
  UNION ALL SELECT '2fa-authenticator', 'migration_portability', 'import_sources', 'Import sources', 'Import-Quellen', 'multi_enum', 'informational', 'multi_select', 6010, 'From which other authenticator apps tokens can be imported.', 'Aus welchen anderen Authentifikator-Apps Token importiert werden koennen.'
  UNION ALL SELECT '2fa-authenticator', 'migration_portability', 'export_formats', 'Export formats', 'Export-Formate', 'multi_enum', 'informational', 'multi_select', 6020, 'In which formats token data can be exported.', 'In welchen Formaten Token-Daten exportiert werden koennen.'
  ...
  UNION ALL SELECT '2fa-authenticator', 'migration_portability', 'cross_app_uri_scheme', 'Standard otpauth URI scheme', 'Standard-otpauth-URI-Schema', 'boolean', 'beneficial', 'optional', 6040, 'Whether the standard otpauth URI scheme is supported.', 'Ob das Standard-otpauth-URI-Schema unterstuetzt wird.'
  ...
  UNION ALL SELECT '2fa-authenticator', 'usability_ux', 'token_countdown_display', 'Token countdown display', 'Token-Countdown-Anzeige', 'boolean', 'beneficial', 'optional', 7020, 'Whether a visual countdown for token expiration is displayed.', 'Ob ein visueller Countdown fuer den Token-Ablauf angezeigt wird.'
  UNION ALL SELECT '2fa-authenticator', 'usability_ux', 'dark_mode', 'Dark mode support', 'Dunkelmodus-Unterstuetzung', 'boolean', 'informational', 'optional', 7030, 'Whether a dark mode or theme is available.', 'Ob ein Dunkelmodus oder Theme verfuegbar ist.'
  UNION ALL SELECT '2fa-authenticator', 'usability_ux', 'localization_languages', 'Localization support', 'Lokalisierungsunterstuetzung', 'enum', 'informational', 'optional', 7040, 'How many languages the app is available in.', 'In wie vielen Sprachen die App verfuegbar ist.'
  UNION ALL SELECT '2fa-authenticator', 'usability_ux', 'accessibility_features', 'Accessibility features', 'Barrierefreiheits-Funktionen', 'boolean', 'informational', 'optional', 7050, 'Whether accessibility features like screen reader support are available.', 'Ob Barrierefreiheits-Funktionen wie Screenreader-Unterstuetzung verfuegbar sind.'
  ...
  UNION ALL SELECT '2fa-authenticator', 'openness_audit', 'security_audit', 'Independent security audit', 'Unabhaengiges Sicherheitsaudit', 'boolean', 'beneficial', 'optional', 8020, 'Whether an independent security audit has been completed.', 'Ob ein unabhaengiges Sicherheitsaudit durchgefuehrt wurde.'
  UNION ALL SELECT '2fa-authenticator', 'openness_audit', 'reproducible_builds', 'Reproducible builds', 'Reproduzierbare Builds', 'boolean', 'beneficial', 'optional', 8030, 'Whether builds can be independently verified.', 'Ob Builds unabhaengig verifiziert werden koennen.'
  ...
  UNION ALL SELECT '2fa-authenticator', 'openness_audit', 'community_contributions', 'Community contributions accepted', 'Community-Beitraege akzeptiert', 'boolean', 'informational', 'optional', 8050, 'Whether external contributions are accepted.', 'Ob externe Beitraege akzeptiert werden.'
  UNION ALL SELECT '2fa-authenticator', 'pricing_fit', 'free_tier_available', 'Free tier available', 'Kostenlose Stufe verfuegbar', 'boolean', 'informational', 'optional', 9010, 'Whether a free tier is available without payment requirements.', 'Ob eine kostenlose Nutzungsstufe ohne Zahlungspflicht verfuegbar ist.'
  ...
  UNION ALL SELECT '2fa-authenticator', 'pricing_fit', 'fit_profiles', 'Fit profiles', 'Eignungsprofile', 'multi_enum', 'informational', 'multi_select', 9040, 'Common user profiles the app is well suited for.', 'Typische Nutzerprofile, fuer die die App gut geeignet ist.'
) AS d
...
FROM (
  ...
  UNION ALL SELECT '2fa-authenticator', 'app_lock_method', 'device_lock', 'Device lock', 'Geraetesperre', 'neutral', 40
  ...
  UNION ALL SELECT '2fa-authenticator', 'secure_storage_backend', 'encrypted_file', 'Encrypted file', 'Verschluesselte Datei', 'neutral', 20
  ...
  UNION ALL SELECT '2fa-authenticator', 'backup_methods', 'encrypted_file_export', 'Encrypted file export', 'Verschluesselter Dateiexport', 'neutral', 20
  UNION ALL SELECT '2fa-authenticator', 'backup_methods', 'qr_code_export', 'QR code export', 'QR-Code-Export', 'neutral', 30
  UNION ALL SELECT '2fa-authenticator', 'backup_methods', 'manual_key_copy', 'Manual key copy', 'Manuelle Schluesselkopie', 'neutral', 40
  UNION ALL SELECT '2fa-authenticator', 'backup_methods', 'device_transfer', 'Device transfer', 'Geraeteuebertragung', 'neutral', 50
  ...
  UNION ALL SELECT '2fa-authenticator', 'export_formats', 'encrypted_file', 'Encrypted file', 'Verschluesselte Datei', 'neutral', 10
  ...
  UNION ALL SELECT '2fa-authenticator', 'source_model', 'source_available', 'Source available', 'Quellcode verfuegbar', 'neutral', 20
  UNION ALL SELECT '2fa-authenticator', 'source_model', 'partial_open', 'Partial open', 'Teilweise offen', 'neutral', 30
  UNION ALL SELECT '2fa-authenticator', 'source_model', 'proprietary', 'Proprietary', 'Proprietaer', 'warning', 40
  ...
  UNION ALL SELECT '2fa-authenticator', 'license_type', 'proprietary', 'Proprietary', 'Proprietaer', 'warning', 70
  ...
  UNION ALL SELECT '2fa-authenticator', 'fit_profiles', 'personal', 'Personal', 'Persoenlich', 'neutral', 10
