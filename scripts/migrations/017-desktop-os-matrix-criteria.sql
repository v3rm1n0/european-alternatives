...
VALUES
  ('desktop-os', 'kernel_architecture', 'Kernel & Architecture', 'Kernel & Architektur', 'Core technical foundation including kernel type, CPU architecture support, init system, and real-time capability.', 'Technische Grundlage einschließlich Kernel-Typ, CPU-Architektur-Unterstützung, Init-System und Echtzeitfähigkeit.', 100),
  ('desktop-os', 'installation_setup', 'Installation & Setup', 'Installation & Einrichtung', 'Acquisition, installation methods, disk encryption, system requirements, and live mode availability.', 'Beschaffung, Installationsmethoden, Festplattenverschlüsselung, Systemanforderungen und Live-Modus-Verfügbarkeit.', 200),
  ('desktop-os', 'desktop_environment_ux', 'Desktop Environment & UX', 'Desktop-Umgebung & UX', 'User-facing interface, default desktop environment, customizability, accessibility, and touchscreen support.', 'Benutzeroberfläche, Standard-Desktop-Umgebung, Anpassbarkeit, Barrierefreiheit und Touchscreen-Unterstützung.', 300),
  ...
  ('desktop-os', 'security_hardening', 'Security & Hardening', 'Sicherheit & Härtung', 'Mandatory access control, application sandboxing, secure boot, verified boot, and firewall.', 'Mandatory Access Control, Anwendungssandboxing, Secure Boot, Verified Boot und Firewall.', 500),
  ('desktop-os', 'privacy_telemetry', 'Privacy & Telemetry', 'Datenschutz & Telemetrie', 'Default telemetry level, opt-out options, account requirements, and local account availability.', 'Standard-Telemetrielevel, Opt-out-Optionen, Kontoanforderungen und Verfügbarkeit lokaler Konten.', 600),
  ('desktop-os', 'hardware_drivers', 'Hardware & Driver Support', 'Hardware & Treiberunterstützung', 'GPU driver model, peripheral compatibility, Bluetooth support, and printer support.', 'GPU-Treibermodell, Peripherie-Kompatibilität, Bluetooth-Unterstützung und Druckerunterstützung.', 700),
  ('desktop-os', 'interoperability_migration', 'Interoperability & Migration', 'Interoperabilität & Migration', 'Cross-platform app compatibility, default file system, and file sharing protocols.', 'Plattformübergreifende App-Kompatibilität, Standard-Dateisystem und Dateifreigabeprotokolle.', 800),
...
FROM (
  ...
  UNION ALL SELECT 'desktop-os', 'kernel_architecture', 'real_time_capable', 'Real-time capable', 'Echtzeitfähig', 'boolean', 'informational', 'optional', 1040, 'Whether the operating system supports real-time kernel scheduling or an RT-capable kernel variant.', 'Ob das Betriebssystem Echtzeit-Kernel-Scheduling oder eine echtzeitfähige Kernel-Variante unterstützt.'
  UNION ALL SELECT 'desktop-os', 'installation_setup', 'installation_method', 'Installation method', 'Installationsmethode', 'multi_enum', 'informational', 'multi_select', 2010, 'Methods available for installing the operating system on hardware.', 'Verfügbare Methoden zur Installation des Betriebssystems auf Hardware.'
  UNION ALL SELECT 'desktop-os', 'installation_setup', 'disk_encryption_setup', 'Disk encryption setup', 'Festplattenverschlüsselung bei Einrichtung', 'enum', 'beneficial', 'optional', 2020, 'Whether full-disk encryption is offered or enabled by default during installation.', 'Ob Vollverschlüsselung der Festplatte bei der Installation angeboten oder standardmäßig aktiviert wird.'
  ...
  UNION ALL SELECT 'desktop-os', 'installation_setup', 'live_mode_available', 'Live mode available', 'Live-Modus verfügbar', 'boolean', 'beneficial', 'optional', 2040, 'Whether the operating system can be booted and tried from removable media without installation.', 'Ob das Betriebssystem von Wechselmedien gestartet und getestet werden kann, ohne es zu installieren.'
  UNION ALL SELECT 'desktop-os', 'desktop_environment_ux', 'default_desktop_environment', 'Default desktop environment', 'Standard-Desktop-Umgebung', 'enum', 'tradeoff', 'optional', 3010, 'The desktop environment or shell shipped by default with the operating system.', 'Die standardmäßig mit dem Betriebssystem ausgelieferte Desktop-Umgebung oder Shell.'
  ...
  UNION ALL SELECT 'desktop-os', 'desktop_environment_ux', 'accessibility_features', 'Accessibility features', 'Barrierefreiheitsfunktionen', 'multi_enum', 'beneficial', 'multi_select', 3030, 'Built-in accessibility features for users with disabilities.', 'Integrierte Barrierefreiheitsfunktionen für Nutzer mit Behinderungen.'
  UNION ALL SELECT 'desktop-os', 'desktop_environment_ux', 'touchscreen_support', 'Touchscreen support', 'Touchscreen-Unterstützung', 'boolean', 'informational', 'optional', 3040, 'Whether the operating system provides native touchscreen and tablet mode support.', 'Ob das Betriebssystem native Touchscreen- und Tablet-Modus-Unterstützung bietet.'
  UNION ALL SELECT 'desktop-os', 'package_management', 'package_manager_type', 'Package manager type', 'Paketmanager-Typ', 'enum', 'informational', 'optional', 4010, 'The primary system package manager used for software installation and updates.', 'Der primäre Systempaketmanager für Softwareinstallation und -updates.'
  UNION ALL SELECT 'desktop-os', 'package_management', 'universal_package_formats', 'Universal package formats', 'Universelle Paketformate', 'multi_enum', 'informational', 'multi_select', 4020, 'Cross-distribution or universal software packaging formats supported.', 'Unterstützte distributionsübergreifende oder universelle Software-Paketformate.'
  ...
  UNION ALL SELECT 'desktop-os', 'package_management', 'unattended_updates', 'Unattended updates', 'Unbeaufsichtigte Updates', 'enum', 'beneficial', 'optional', 4040, 'The level of automatic or unattended update capability provided by the operating system.', 'Der Grad der automatischen oder unbeaufsichtigten Update-Fähigkeit des Betriebssystems.'
  UNION ALL SELECT 'desktop-os', 'security_hardening', 'mandatory_access_control', 'Mandatory access control', 'Mandatory Access Control', 'enum', 'beneficial', 'optional', 5010, 'The mandatory access control framework used for process and file-level security policies.', 'Das Mandatory-Access-Control-Framework für Prozess- und Datei-Sicherheitsrichtlinien.'
  ...
  UNION ALL SELECT 'desktop-os', 'security_hardening', 'secure_boot_support', 'Secure Boot support', 'Secure-Boot-Unterstützung', 'boolean', 'beneficial', 'optional', 5030, 'Whether the operating system supports UEFI Secure Boot.', 'Ob das Betriebssystem UEFI Secure Boot unterstützt.'
  UNION ALL SELECT 'desktop-os', 'security_hardening', 'verified_boot', 'Verified boot', 'Verified Boot', 'boolean', 'beneficial', 'optional', 5040, 'Whether the operating system supports a full verified or measured boot chain.', 'Ob das Betriebssystem eine vollständig verifizierte oder gemessene Boot-Kette unterstützt.'
  ...
  UNION ALL SELECT 'desktop-os', 'privacy_telemetry', 'telemetry_opt_out', 'Telemetry opt-out', 'Telemetrie-Opt-out', 'enum', 'beneficial', 'optional', 6020, 'Whether and how telemetry can be reduced or fully disabled by the user.', 'Ob und wie Telemetrie vom Nutzer reduziert oder vollständig deaktiviert werden kann.'
  UNION ALL SELECT 'desktop-os', 'privacy_telemetry', 'account_required', 'Account required', 'Konto erforderlich', 'boolean', 'risk', 'must_match', 6030, 'Whether an online account is required for basic usage of the operating system.', 'Ob ein Online-Konto für die grundlegende Nutzung des Betriebssystems erforderlich ist.'
  UNION ALL SELECT 'desktop-os', 'privacy_telemetry', 'local_account_option', 'Local account option', 'Lokales Konto möglich', 'boolean', 'beneficial', 'optional', 6040, 'Whether a fully offline local account can be used without connecting to an online service.', 'Ob ein vollständig offline lokales Konto ohne Verbindung zu einem Online-Dienst genutzt werden kann.'
  UNION ALL SELECT 'desktop-os', 'hardware_drivers', 'gpu_driver_model', 'GPU driver model', 'GPU-Treibermodell', 'enum', 'tradeoff', 'optional', 7010, 'The primary model for GPU driver support and distribution.', 'Das primäre Modell für GPU-Treiberunterstützung und -verteilung.'
  UNION ALL SELECT 'desktop-os', 'hardware_drivers', 'peripheral_plug_and_play', 'Peripheral plug-and-play', 'Peripherie-Plug-and-Play', 'enum', 'informational', 'optional', 7020, 'How well peripherals such as USB devices, webcams, and input devices work out of the box.', 'Wie gut Peripheriegeräte wie USB-Geräte, Webcams und Eingabegeräte sofort funktionieren.'
  UNION ALL SELECT 'desktop-os', 'hardware_drivers', 'bluetooth_support', 'Bluetooth support', 'Bluetooth-Unterstützung', 'boolean', 'informational', 'optional', 7030, 'Whether a built-in Bluetooth stack is available for device pairing and audio.', 'Ob ein integrierter Bluetooth-Stack für Gerätekopplung und Audio verfügbar ist.'
  UNION ALL SELECT 'desktop-os', 'hardware_drivers', 'printer_support_model', 'Printer support model', 'Druckerunterstützungsmodell', 'enum', 'informational', 'optional', 7040, 'The printing subsystem and driver model used for printer support.', 'Das Drucksubsystem und Treibermodell für Druckerunterstützung.'
  UNION ALL SELECT 'desktop-os', 'interoperability_migration', 'windows_app_compatibility', 'Windows app compatibility', 'Windows-App-Kompatibilität', 'enum', 'informational', 'optional', 8010, 'The documented level of compatibility for running Windows applications.', 'Der dokumentierte Grad der Kompatibilität zum Ausführen von Windows-Anwendungen.'
  UNION ALL SELECT 'desktop-os', 'interoperability_migration', 'linux_app_compatibility', 'Linux app compatibility', 'Linux-App-Kompatibilität', 'enum', 'informational', 'optional', 8020, 'The documented level of compatibility for running Linux applications.', 'Der dokumentierte Grad der Kompatibilität zum Ausführen von Linux-Anwendungen.'
  UNION ALL SELECT 'desktop-os', 'interoperability_migration', 'file_system_default', 'Default file system', 'Standard-Dateisystem', 'enum', 'informational', 'optional', 8030, 'The default file system used for the root or system partition.', 'Das Standard-Dateisystem für die Root- oder Systempartition.'
  UNION ALL SELECT 'desktop-os', 'interoperability_migration', 'cross_platform_file_sharing', 'Cross-platform file sharing', 'Plattformübergreifende Dateifreigabe', 'multi_enum', 'informational', 'multi_select', 8040, 'Network file sharing protocols supported for cross-platform interoperability.', 'Unterstützte Netzwerk-Dateifreigabeprotokolle für plattformübergreifende Interoperabilität.'
  ...
  UNION ALL SELECT 'desktop-os', 'openness_governance_fit', 'commercial_support_available', 'Commercial support available', 'Kommerzieller Support verfügbar', 'boolean', 'informational', 'optional', 9030, 'Whether paid professional support contracts or enterprise support tiers are available.', 'Ob bezahlte professionelle Support-Verträge oder Enterprise-Support-Stufen verfügbar sind.'
  UNION ALL SELECT 'desktop-os', 'openness_governance_fit', 'fit_profiles', 'Fit profiles', 'Eignungsprofile', 'multi_enum', 'informational', 'multi_select', 9040, 'Common user profiles or use cases the operating system is well suited for.', 'Typische Nutzerprofile oder Anwendungsfälle, für die das Betriebssystem gut geeignet ist.'
) AS d
...
FROM (
  ...
  UNION ALL SELECT 'desktop-os', 'disk_encryption_setup', 'default_on', 'Default on', 'Standardmäßig aktiv', 'positive', 30
  UNION ALL SELECT 'desktop-os', 'disk_encryption_setup', 'always_encrypted', 'Always encrypted', 'Immer verschlüsselt', 'positive', 40
  ...
  UNION ALL SELECT 'desktop-os', 'accessibility_features', 'magnification', 'Magnification', 'Vergrößerung', 'positive', 20
  ...
  UNION ALL SELECT 'desktop-os', 'unattended_updates', 'default_auto', 'Default auto', 'Standardmäßig automatisch', 'positive', 40
  ...
  UNION ALL SELECT 'desktop-os', 'telemetry_opt_out', 'fully_disableable', 'Fully disableable', 'Vollständig deaktivierbar', 'positive', 20
  ...
  UNION ALL SELECT 'desktop-os', 'gpu_driver_model', 'proprietary_drivers', 'Proprietary drivers', 'Proprietäre Treiber', 'tradeoff', 20
  UNION ALL SELECT 'desktop-os', 'gpu_driver_model', 'hybrid_open_proprietary', 'Hybrid open/proprietary', 'Hybrid offen/proprietär', 'neutral', 30
  ...
  UNION ALL SELECT 'desktop-os', 'peripheral_plug_and_play', 'moderate', 'Moderate', 'Mäßig', 'tradeoff', 30
  UNION ALL SELECT 'desktop-os', 'peripheral_plug_and_play', 'limited', 'Limited', 'Eingeschränkt', 'warning', 40
  ...
  UNION ALL SELECT 'desktop-os', 'printer_support_model', 'limited', 'Limited', 'Eingeschränkt', 'warning', 40
  ...
  UNION ALL SELECT 'desktop-os', 'source_code_model', 'source_available', 'Source available', 'Quellcode verfügbar', 'neutral', 20
  UNION ALL SELECT 'desktop-os', 'source_code_model', 'partial_open', 'Partial open', 'Teilweise offen', 'tradeoff', 30
  UNION ALL SELECT 'desktop-os', 'source_code_model', 'proprietary', 'Proprietary', 'Proprietär', 'warning', 40
  UNION ALL SELECT 'desktop-os', 'governance_model', 'community_driven', 'Community driven', 'Community-getrieben', 'positive', 10
  UNION ALL SELECT 'desktop-os', 'governance_model', 'foundation_backed', 'Foundation backed', 'Stiftungsunterstützt', 'positive', 20
  ...
  UNION ALL SELECT 'desktop-os', 'fit_profiles', 'beginner', 'Beginner', 'Anfänger', 'neutral', 60
