...
VALUES
  ('smart-home', 'protocols_connectivity', 'Protocols & Connectivity', 'Protokolle & Konnektivitaet', 'Supported communication protocols and connectivity standards.', 'Unterstuetzte Kommunikationsprotokolle und Konnektivitaetsstandards.', 100),
  ('smart-home', 'local_control_architecture', 'Local Control & Architecture', 'Lokale Steuerung & Architektur', 'Local operation capabilities, cloud dependency, and system architecture.', 'Lokale Betriebsfaehigkeiten, Cloud-Abhaengigkeit und Systemarchitektur.', 200),
  ...
  ('smart-home', 'privacy_data', 'Privacy & Data', 'Privatsphaere & Daten', 'Data processing, telemetry controls, and privacy features.', 'Datenverarbeitung, Telemetriesteuerung und Datenschutzfunktionen.', 400),
  ('smart-home', 'openness_extensibility', 'Openness & Extensibility', 'Offenheit & Erweiterbarkeit', 'Source code model, licensing, integrations, and extensibility options.', 'Quellcode-Modell, Lizenzierung, Integrationen und Erweiterungsmoeglichkeiten.', 500),
  ('smart-home', 'voice_assistant_ui', 'Voice Assistant & UI', 'Sprachassistent & Benutzeroberflaeche', 'Voice assistant support, mobile apps, and dashboard features.', 'Sprachassistent-Unterstuetzung, mobile Apps und Dashboard-Funktionen.', 600),
  ('smart-home', 'hardware_deployment', 'Hardware & Deployment', 'Hardware & Bereitstellung', 'Hub hardware requirements, supported platforms, and backup options.', 'Hub-Hardware-Anforderungen, unterstuetzte Plattformen und Sicherungsoptionen.', 700),
...
FROM (
  SELECT 'smart-home' AS category_id, 'protocols_connectivity' AS group_key, 'supported_protocols' AS criterion_key, 'Supported protocols' AS label_en, 'Unterstuetzte Protokolle' AS label_de, 'multi_enum' AS value_type, 'informational' AS semantics, 'multi_select' AS filter_mode, 1010 AS sort_order, 'Which communication protocols the platform supports.' AS help_text_en, 'Welche Kommunikationsprotokolle die Plattform unterstuetzt.' AS help_text_de
  UNION ALL SELECT 'smart-home', 'protocols_connectivity', 'matter_support', 'Matter support', 'Matter-Unterstuetzung', 'boolean', 'beneficial', 'optional', 1020, 'Whether the platform supports the Matter smart home standard.', 'Ob die Plattform den Matter-Smart-Home-Standard unterstuetzt.'
  ...
  UNION ALL SELECT 'smart-home', 'protocols_connectivity', 'local_network_protocol', 'Local network protocol', 'Lokales Netzwerkprotokoll', 'enum', 'informational', 'optional', 1040, 'The network topology used for local device communication.', 'Die Netzwerktopologie fuer die lokale Geraetekommunikation.'
  UNION ALL SELECT 'smart-home', 'local_control_architecture', 'local_only_operation', 'Local-only operation', 'Nur-lokal-Betrieb', 'boolean', 'beneficial', 'must_match', 2010, 'Whether the system can operate entirely without cloud connectivity.', 'Ob das System vollstaendig ohne Cloud-Anbindung betrieben werden kann.'
  UNION ALL SELECT 'smart-home', 'local_control_architecture', 'cloud_dependency_level', 'Cloud dependency level', 'Cloud-Abhaengigkeitsstufe', 'enum', 'tradeoff', 'optional', 2020, 'How much the platform depends on cloud services for core functionality.', 'Wie stark die Plattform fuer Kernfunktionen von Cloud-Diensten abhaengt.'
  UNION ALL SELECT 'smart-home', 'local_control_architecture', 'self_hosting_available', 'Self-hosting available', 'Selbst-Hosting verfuegbar', 'boolean', 'tradeoff', 'optional', 2030, 'Whether the platform can be self-hosted on user-owned hardware.', 'Ob die Plattform auf eigener Hardware selbst gehostet werden kann.'
  UNION ALL SELECT 'smart-home', 'local_control_architecture', 'network_architecture', 'Network architecture', 'Netzwerkarchitektur', 'enum', 'informational', 'optional', 2040, 'The system architecture for managing connected devices.', 'Die Systemarchitektur fuer die Verwaltung verbundener Geraete.'
  UNION ALL SELECT 'smart-home', 'local_control_architecture', 'offline_automation_execution', 'Offline automation execution', 'Offline-Automatisierungsausfuehrung', 'boolean', 'beneficial', 'optional', 2050, 'Whether automations continue to execute when the internet is offline.', 'Ob Automatisierungen weiterlaufen, wenn das Internet offline ist.'
  UNION ALL SELECT 'smart-home', 'automation_scenes', 'automation_engine_type', 'Automation engine type', 'Automatisierungs-Engine-Typ', 'enum', 'informational', 'optional', 3010, 'The type of automation engine used for creating rules and routines.', 'Der Typ der Automatisierungs-Engine fuer die Erstellung von Regeln und Routinen.'
  UNION ALL SELECT 'smart-home', 'automation_scenes', 'scene_support', 'Scene support', 'Szenenunterstuetzung', 'boolean', 'informational', 'optional', 3020, 'Whether predefined scenes for controlling multiple devices are supported.', 'Ob vordefinierte Szenen zur Steuerung mehrerer Geraete unterstuetzt werden.'
  UNION ALL SELECT 'smart-home', 'automation_scenes', 'conditional_logic', 'Conditional logic', 'Bedingte Logik', 'boolean', 'informational', 'optional', 3030, 'Whether automations support conditional logic such as if-then rules.', 'Ob Automatisierungen bedingte Logik wie Wenn-Dann-Regeln unterstuetzen.'
  UNION ALL SELECT 'smart-home', 'automation_scenes', 'scheduling_support', 'Scheduling support', 'Zeitplanunterstuetzung', 'boolean', 'informational', 'optional', 3040, 'Whether time-based scheduling of automations is available.', 'Ob zeitbasierte Planung von Automatisierungen verfuegbar ist.'
  UNION ALL SELECT 'smart-home', 'automation_scenes', 'energy_monitoring', 'Energy monitoring', 'Energieueberwachung', 'boolean', 'informational', 'optional', 3050, 'Whether energy consumption monitoring and reporting is supported.', 'Ob Energieverbrauchsueberwachung und -berichterstattung unterstuetzt wird.'
  UNION ALL SELECT 'smart-home', 'privacy_data', 'data_processing_location', 'Data processing location', 'Datenverarbeitungsstandort', 'enum', 'tradeoff', 'must_match', 4010, 'Where user and device data is primarily processed.', 'Wo Benutzer- und Geraetedaten vorrangig verarbeitet werden.'
  UNION ALL SELECT 'smart-home', 'privacy_data', 'telemetry_opt_out', 'Telemetry opt-out', 'Telemetrie-Abmeldung', 'boolean', 'beneficial', 'optional', 4020, 'Whether users can opt out of telemetry and usage data collection.', 'Ob Benutzer die Telemetrie- und Nutzungsdatenerfassung abschalten koennen.'
  ...
  UNION ALL SELECT 'smart-home', 'privacy_data', 'gdpr_dpa_available', 'GDPR DPA available', 'DSGVO-AVV verfuegbar', 'boolean', 'informational', 'optional', 4040, 'Whether a GDPR-compliant data processing agreement is available.', 'Ob ein DSGVO-konformer Auftragsverarbeitungsvertrag verfuegbar ist.'
  UNION ALL SELECT 'smart-home', 'privacy_data', 'data_export', 'Data export', 'Datenexport', 'boolean', 'beneficial', 'optional', 4050, 'Whether users can export their data in a portable format.', 'Ob Benutzer ihre Daten in einem portablen Format exportieren koennen.'
  UNION ALL SELECT 'smart-home', 'openness_extensibility', 'source_code_model', 'Source code model', 'Quellcode-Modell', 'enum', 'tradeoff', 'optional', 5010, 'Whether the source code is open source, source available, or proprietary.', 'Ob der Quellcode quelloffen, quelleinsehbar oder proprietaer ist.'
  ...
  UNION ALL SELECT 'smart-home', 'openness_extensibility', 'third_party_integrations', 'Third-party integrations', 'Drittanbieter-Integrationen', 'multi_enum', 'informational', 'multi_select', 5030, 'Which third-party platforms and services can be integrated.', 'Welche Drittanbieter-Plattformen und -Dienste integriert werden koennen.'
  UNION ALL SELECT 'smart-home', 'openness_extensibility', 'api_available', 'API available', 'API verfuegbar', 'boolean', 'beneficial', 'optional', 5040, 'Whether an API is available for custom integrations and development.', 'Ob eine API fuer individuelle Integrationen und Entwicklung verfuegbar ist.'
  UNION ALL SELECT 'smart-home', 'openness_extensibility', 'custom_device_support', 'Custom device support', 'Unterstuetzung eigener Geraete', 'boolean', 'tradeoff', 'optional', 5050, 'Whether custom or DIY devices can be added to the platform.', 'Ob eigene oder selbstgebaute Geraete zur Plattform hinzugefuegt werden koennen.'
  ...
  UNION ALL SELECT 'smart-home', 'voice_assistant_ui', 'voice_assistant_support', 'Voice assistant support', 'Sprachassistent-Unterstuetzung', 'multi_enum', 'informational', 'multi_select', 6010, 'Which voice assistants are supported for voice control.', 'Welche Sprachassistenten fuer die Sprachsteuerung unterstuetzt werden.'
  UNION ALL SELECT 'smart-home', 'voice_assistant_ui', 'mobile_app', 'Mobile app', 'Mobile App', 'multi_enum', 'informational', 'multi_select', 6020, 'Which mobile platforms are supported with a native app.', 'Welche mobilen Plattformen mit einer nativen App unterstuetzt werden.'
  UNION ALL SELECT 'smart-home', 'voice_assistant_ui', 'web_dashboard', 'Web dashboard', 'Web-Dashboard', 'boolean', 'beneficial', 'optional', 6030, 'Whether a web-based dashboard for managing the smart home is available.', 'Ob ein webbasiertes Dashboard zur Verwaltung des Smart Home verfuegbar ist.'
  ...
  UNION ALL SELECT 'smart-home', 'hardware_deployment', 'supported_platforms', 'Supported platforms', 'Unterstuetzte Plattformen', 'multi_enum', 'informational', 'multi_select', 7020, 'Which hardware platforms the smart home software can run on.', 'Auf welchen Hardware-Plattformen die Smart-Home-Software laufen kann.'
  UNION ALL SELECT 'smart-home', 'hardware_deployment', 'wireless_standard', 'Wireless standard', 'Funkstandard', 'multi_enum', 'informational', 'multi_select', 7030, 'Which wireless radio standards are supported for device connectivity.', 'Welche drahtlosen Funkstandards fuer die Geraeteverbindung unterstuetzt werden.'
  UNION ALL SELECT 'smart-home', 'hardware_deployment', 'backup_and_restore', 'Backup and restore', 'Sicherung und Wiederherstellung', 'boolean', 'beneficial', 'optional', 7040, 'Whether configuration backup and restore functionality is available.', 'Ob Konfigurations-Sicherung und -Wiederherstellung verfuegbar ist.'
  ...
  UNION ALL SELECT 'smart-home', 'pricing_fit', 'subscription_required_for_core', 'Subscription required for core features', 'Abonnement fuer Kernfunktionen erforderlich', 'boolean', 'risk', 'optional', 8020, 'Whether a paid subscription is required to use core smart home features.', 'Ob ein kostenpflichtiges Abonnement fuer die Nutzung der Smart-Home-Kernfunktionen erforderlich ist.'
  UNION ALL SELECT 'smart-home', 'pricing_fit', 'fit_profiles', 'Fit profiles', 'Eignungsprofile', 'multi_enum', 'informational', 'multi_select', 8030, 'Common user profiles the smart home platform is well suited for.', 'Typische Nutzerprofile, fuer die die Smart-Home-Plattform gut geeignet ist.'
) AS d
...
FROM (
  ...
  UNION ALL SELECT 'smart-home', 'cloud_dependency_level', 'none', 'No cloud dependency', 'Keine Cloud-Abhaengigkeit', 'positive', 30
  ...
  UNION ALL SELECT 'smart-home', 'data_processing_location', 'eu_primary', 'EU primary, non-EU fallback', 'EU primaer, Nicht-EU-Ausweichstandort', 'neutral', 20
  ...
  UNION ALL SELECT 'smart-home', 'account_requirement', 'not_needed', 'No account needed', 'Kein Konto noetig', 'positive', 30
  ...
  UNION ALL SELECT 'smart-home', 'source_code_model', 'proprietary', 'Proprietary', 'Proprietaer', 'warning', 30
  ...
  UNION ALL SELECT 'smart-home', 'license_type', 'proprietary', 'Proprietary', 'Proprietaer', 'warning', 50
  ...
  UNION ALL SELECT 'smart-home', 'supported_platforms', 'dedicated_appliance', 'Dedicated appliance', 'Dediziertes Geraet', 'neutral', 40
