...
VALUES
  ('video-hosting', 'accounts_channels', 'Accounts & Channels', 'Konten & Kanäle', 'Account requirements, channel models, and creator identity controls.', 'Kontoanforderungen, Kanalmodelle und Kontrollen für Creator-Identität.', 100),
  ...
  ('video-hosting', 'playback_delivery', 'Playback & Delivery', 'Wiedergabe & Auslieferung', 'Player, streaming, embed, quality, download, and device support.', 'Player, Streaming, Einbettung, Qualität, Download und Geräteunterstützung.', 300),
  ...
  ('video-hosting', 'moderation_safety', 'Moderation & Safety', 'Moderation & Sicherheit', 'Creator moderation, user reporting, copyright handling, and sensitive-content controls.', 'Creator-Moderation, Nutzermeldungen, Urheberrechtsverfahren und Kontrollen für sensible Inhalte.', 600),
  ...
  ('video-hosting', 'creator_business', 'Creator & Business Tools', 'Creator- & Geschäftswerkzeuge', 'Monetization, paid content, publishing workflow, and creator support features.', 'Monetarisierung, bezahlte Inhalte, Veröffentlichungsablauf und Creator-Unterstützung.', 800),
  ('video-hosting', 'interoperability_portability', 'Interoperability & Portability', 'Interoperabilität & Portabilität', 'Federation, APIs, embeds, syndication, import, export, and migration.', 'Föderation, APIs, Einbettung, Syndikation, Import, Export und Migration.', 900),
...
FROM (
  SELECT 'video-hosting' AS category_id, 'accounts_channels' AS group_key, 'account_required_to_watch' AS criterion_key, 'Account required to watch' AS label_en, 'Konto zum Ansehen erforderlich' AS label_de, 'boolean' AS value_type, 'risk' AS semantics, 'must_match' AS filter_mode, 1010 AS sort_order, 'Whether viewers must create or sign in to an account before watching videos.' AS help_text_en, 'Ob Zuschauer ein Konto erstellen oder sich anmelden müssen, bevor sie Videos ansehen können.' AS help_text_de
  UNION ALL SELECT 'video-hosting', 'accounts_channels', 'account_required_to_upload', 'Account required to upload', 'Konto zum Hochladen erforderlich', 'boolean', 'informational', 'optional', 1020, 'Whether creators must have an account before uploading or publishing videos.', 'Ob Creator ein Konto benötigen, bevor sie Videos hochladen oder veröffentlichen können.'
  UNION ALL SELECT 'video-hosting', 'accounts_channels', 'channel_profile_model', 'Channel/profile model', 'Kanal-/Profilmodell', 'enum', 'informational', 'optional', 1030, 'The documented model for creator channels, public profiles, organization channels, or instance accounts.', 'Das dokumentierte Modell für Creator-Kanäle, öffentliche Profile, Organisationskanäle oder Instanzkonten.'
  UNION ALL SELECT 'video-hosting', 'accounts_channels', 'pseudonymous_channels_supported', 'Pseudonymous channels supported', 'Pseudonyme Kanäle unterstützt', 'boolean', 'beneficial', 'optional', 1040, 'Whether creators can publish through a channel or profile that does not require a real-name public identity.', 'Ob Creator über einen Kanal oder ein Profil veröffentlichen können, das keine öffentliche Klarnamenidentität verlangt.'
  UNION ALL SELECT 'video-hosting', 'accounts_channels', 'organization_or_brand_accounts', 'Organization/brand accounts', 'Organisations-/Markenkonten', 'boolean', 'informational', 'optional', 1050, 'Whether the platform supports channels or accounts intended for organizations, teams, or brands.', 'Ob die Plattform Kanäle oder Konten für Organisationen, Teams oder Marken unterstützt.'
  UNION ALL SELECT 'video-hosting', 'upload_ingest', 'supported_upload_methods', 'Supported upload methods', 'Unterstützte Upload-Methoden', 'multi_enum', 'informational', 'multi_select', 2010, 'Documented ways creators can upload, import, or ingest video content.', 'Dokumentierte Wege, wie Creator Videoinhalte hochladen, importieren oder einspeisen können.'
  UNION ALL SELECT 'video-hosting', 'upload_ingest', 'supported_input_formats', 'Supported input formats', 'Unterstützte Eingabeformate', 'multi_enum', 'informational', 'multi_select', 2020, 'Documented media input formats accepted for video or audio uploads.', 'Dokumentierte Medieneingabeformate, die für Video- oder Audio-Uploads akzeptiert werden.'
  UNION ALL SELECT 'video-hosting', 'upload_ingest', 'max_video_file_size_mb', 'Maximum video file size (MB)', 'Maximale Videodateigröße (MB)', 'number', 'informational', 'range', 2030, 'Documented maximum uploaded video file size in megabytes for standard creator uploads.', 'Dokumentierte maximale hochgeladene Videodateigröße in Megabyte für normale Creator-Uploads.'
  UNION ALL SELECT 'video-hosting', 'upload_ingest', 'max_video_duration_minutes', 'Maximum video duration (minutes)', 'Maximale Videolänge (Minuten)', 'number', 'informational', 'range', 2040, 'Documented maximum video duration in minutes for standard uploads.', 'Dokumentierte maximale Videolänge in Minuten für normale Uploads.'
  UNION ALL SELECT 'video-hosting', 'upload_ingest', 'storage_quota_model', 'Storage quota model', 'Speicherkontingent-Modell', 'enum', 'tradeoff', 'optional', 2050, 'How storage or upload capacity limits are documented for creator accounts or instances.', 'Wie Speicher- oder Uploadkapazitätsgrenzen für Creator-Konten oder Instanzen dokumentiert sind.'
  ...
  UNION ALL SELECT 'video-hosting', 'upload_ingest', 'thumbnail_and_metadata_tools', 'Thumbnail and metadata tools', 'Thumbnail- und Metadatenwerkzeuge', 'multi_enum', 'beneficial', 'multi_select', 2070, 'Tools creators can use to manage thumbnails, tags, chapters, scheduling, and video metadata.', 'Werkzeuge, mit denen Creator Thumbnails, Tags, Kapitel, Planung und Videometadaten verwalten können.'
  UNION ALL SELECT 'video-hosting', 'playback_delivery', 'embedded_player_available', 'Embedded player available', 'Eingebetteter Player verfügbar', 'boolean', 'beneficial', 'optional', 3010, 'Whether videos can be embedded through a documented player on external sites.', 'Ob Videos über einen dokumentierten Player auf externen Websites eingebettet werden können.'
  UNION ALL SELECT 'video-hosting', 'playback_delivery', 'adaptive_streaming_available', 'Adaptive streaming available', 'Adaptives Streaming verfügbar', 'boolean', 'beneficial', 'optional', 3020, 'Whether playback can adapt stream quality to device or network conditions.', 'Ob die Wiedergabe die Streamqualität an Gerät oder Netzwerkbedingungen anpassen kann.'
  UNION ALL SELECT 'video-hosting', 'playback_delivery', 'playback_quality_options', 'Playback quality options', 'Wiedergabequalitätsoptionen', 'multi_enum', 'informational', 'multi_select', 3030, 'Documented playback resolutions, quality selectors, or quality tiers available to viewers.', 'Dokumentierte Wiedergabeauflösungen, Qualitätsauswahl oder Qualitätsstufen für Zuschauer.'
  UNION ALL SELECT 'video-hosting', 'playback_delivery', 'player_distribution_channels', 'Player distribution channels', 'Player-Vertriebskanäle', 'multi_enum', 'informational', 'multi_select', 3040, 'Documented channels for distributing videos outside the main web player.', 'Dokumentierte Kanäle zur Verbreitung von Videos außerhalb des primären Webplayers.'
  UNION ALL SELECT 'video-hosting', 'playback_delivery', 'offline_download_model', 'Offline/download model', 'Offline-/Download-Modell', 'enum', 'tradeoff', 'optional', 3050, 'How creators or viewers can download videos or use offline playback, if documented.', 'Wie Creator oder Zuschauer Videos herunterladen oder Offline-Wiedergabe nutzen können, sofern dokumentiert.'
  UNION ALL SELECT 'video-hosting', 'playback_delivery', 'drm_or_restricted_playback', 'DRM or restricted playback', 'DRM oder eingeschränkte Wiedergabe', 'boolean', 'risk', 'must_match', 3060, 'Whether playback is documented as using DRM, app-only playback, or other access restrictions.', 'Ob die Wiedergabe laut Dokumentation DRM, App-Zwang oder andere Zugriffsbeschränkungen verwendet.'
  UNION ALL SELECT 'video-hosting', 'live_streaming', 'live_streaming_model', 'Live streaming model', 'Livestreaming-Modell', 'enum', 'tradeoff', 'optional', 4010, 'How live streaming is supported, including native live, RTMP ingest, premieres, or restreaming.', 'Wie Livestreaming unterstützt wird, einschließlich nativer Livestreams, RTMP-Ingest, Premieren oder Restreaming.'
  UNION ALL SELECT 'video-hosting', 'live_streaming', 'external_rtmp_ingest', 'External RTMP ingest', 'Externer RTMP-Ingest', 'boolean', 'beneficial', 'optional', 4020, 'Whether creators can send a live stream from external encoder software over RTMP.', 'Ob Creator einen Livestream aus externer Encoder-Software per RTMP einspeisen können.'
  UNION ALL SELECT 'video-hosting', 'live_streaming', 'scheduled_streams_or_premieres', 'Scheduled streams or premieres', 'Geplante Streams oder Premieren', 'boolean', 'informational', 'optional', 4030, 'Whether creators can schedule live streams, premieres, or planned live events.', 'Ob Creator Livestreams, Premieren oder geplante Live-Events terminieren können.'
  UNION ALL SELECT 'video-hosting', 'live_streaming', 'live_interaction_tools', 'Live interaction tools', 'Live-Interaktionswerkzeuge', 'multi_enum', 'informational', 'multi_select', 4040, 'Viewer interaction and moderation tools available during live streams.', 'Interaktions- und Moderationswerkzeuge für Zuschauer während Livestreams.'
  UNION ALL SELECT 'video-hosting', 'live_streaming', 'stream_recording_archive', 'Stream recording/archive', 'Stream-Aufzeichnung/-Archiv', 'boolean', 'beneficial', 'optional', 4050, 'Whether completed live streams can be recorded, archived, or published as replay videos.', 'Ob abgeschlossene Livestreams aufgezeichnet, archiviert oder als Replay-Videos veröffentlicht werden können.'
  UNION ALL SELECT 'video-hosting', 'live_streaming', 'low_latency_streaming', 'Low-latency streaming', 'Streaming mit geringer Latenz', 'boolean', 'informational', 'optional', 4060, 'Whether the platform documents low-latency or reduced-delay streaming modes.', 'Ob die Plattform Modi für geringe Latenz oder reduzierte Verzögerung beim Streaming dokumentiert.'
  UNION ALL SELECT 'video-hosting', 'discovery_engagement', 'search_available', 'Search available', 'Suche verfügbar', 'boolean', 'beneficial', 'optional', 5010, 'Whether viewers can search for videos, channels, or public media within the platform.', 'Ob Zuschauer innerhalb der Plattform nach Videos, Kanälen oder öffentlichen Medien suchen können.'
  ...
  UNION ALL SELECT 'video-hosting', 'discovery_engagement', 'comment_model', 'Comment model', 'Kommentarmodell', 'enum', 'tradeoff', 'optional', 5050, 'How comments are supported and moderated for videos, if comments are available.', 'Wie Kommentare für Videos unterstützt und moderiert werden, sofern Kommentare verfügbar sind.'
  UNION ALL SELECT 'video-hosting', 'discovery_engagement', 'playlists_or_collections', 'Playlists or collections', 'Playlists oder Sammlungen', 'boolean', 'beneficial', 'optional', 5060, 'Whether users can organize videos into playlists, collections, channels, or similar groups.', 'Ob Nutzer Videos in Playlists, Sammlungen, Kanälen oder ähnlichen Gruppen organisieren können.'
  ...
  UNION ALL SELECT 'video-hosting', 'moderation_safety', 'reporting_enforcement_tools', 'Reporting and enforcement tools', 'Melde- und Durchsetzungswerkzeuge', 'multi_enum', 'beneficial', 'multi_select', 6020, 'Tools for users or moderators to report, review, or enforce against unsafe or infringing content.', 'Werkzeuge für Nutzer oder Moderatoren, um unsichere oder rechtsverletzende Inhalte zu melden, zu prüfen oder durchzusetzen.'
  ...
  UNION ALL SELECT 'video-hosting', 'moderation_safety', 'copyright_handling_model', 'Copyright handling model', 'Urheberrechtsmodell', 'enum', 'tradeoff', 'optional', 6040, 'How copyright complaints, takedowns, automated matching, claims, or creator licensing are documented.', 'Wie Urheberrechtsbeschwerden, Entfernungen, automatischer Abgleich, Ansprüche oder Creator-Lizenzen dokumentiert sind.'
  UNION ALL SELECT 'video-hosting', 'moderation_safety', 'sensitive_content_controls', 'Sensitive-content controls', 'Kontrollen für sensible Inhalte', 'multi_enum', 'beneficial', 'multi_select', 6050, 'Controls for age gates, content warnings, sensitive media labels, or parental restrictions.', 'Kontrollen für Altersabfragen, Inhaltswarnungen, Sensibel-Labels oder Jugendschutzbeschränkungen.'
  UNION ALL SELECT 'video-hosting', 'moderation_safety', 'appeal_process_documented', 'Appeal process documented', 'Einspruchsverfahren dokumentiert', 'boolean', 'beneficial', 'optional', 6060, 'Whether users or creators have a documented appeal process for moderation or enforcement actions.', 'Ob Nutzer oder Creator ein dokumentiertes Einspruchsverfahren gegen Moderations- oder Durchsetzungsmaßnahmen haben.'
  UNION ALL SELECT 'video-hosting', 'privacy_data_ads', 'default_video_visibility', 'Default video visibility', 'Standard-Sichtbarkeit für Videos', 'enum', 'tradeoff', 'optional', 7010, 'The documented default visibility for newly uploaded or newly published videos.', 'Die dokumentierte Standardsichtbarkeit für neu hochgeladene oder neu veröffentlichte Videos.'
  UNION ALL SELECT 'video-hosting', 'privacy_data_ads', 'video_visibility_controls', 'Video visibility controls', 'Sichtbarkeitskontrollen für Videos', 'multi_enum', 'beneficial', 'multi_select', 7020, 'Visibility controls creators can apply to individual videos, releases, or audiences.', 'Sichtbarkeitskontrollen, die Creator auf einzelne Videos, Veröffentlichungen oder Zielgruppen anwenden können.'
  UNION ALL SELECT 'video-hosting', 'privacy_data_ads', 'ads_tracking_model', 'Ads/tracking model', 'Anzeigen-/Tracking-Modell', 'enum', 'risk', 'optional', 7030, 'How advertising, sponsorship, personalization, or viewer tracking are documented for the platform.', 'Wie Anzeigen, Sponsoring, Personalisierung oder Zuschauertracking für die Plattform dokumentiert sind.'
  UNION ALL SELECT 'video-hosting', 'privacy_data_ads', 'ad_personalization_controls', 'Ad personalization controls', 'Kontrollen für Anzeigenpersonalisierung', 'multi_enum', 'beneficial', 'multi_select', 7040, 'Controls users have over personalized ads, interests, third-party tracking, or no-ads tiers.', 'Kontrollen der Nutzer über personalisierte Anzeigen, Interessen, Drittanbieter-Tracking oder werbefreie Tarife.'
  UNION ALL SELECT 'video-hosting', 'privacy_data_ads', 'data_export_formats', 'Data export formats', 'Datenexportformate', 'multi_enum', 'beneficial', 'multi_select', 7050, 'Documented export options for account data, videos, metadata, subtitles, analytics, or comments.', 'Dokumentierte Exportoptionen für Kontodaten, Videos, Metadaten, Untertitel, Analysen oder Kommentare.'
  UNION ALL SELECT 'video-hosting', 'privacy_data_ads', 'analytics_depth', 'Analytics depth', 'Analyseumfang', 'enum', 'informational', 'optional', 7060, 'The level of viewer, engagement, retention, geography, or realtime analytics documented for creators.', 'Der dokumentierte Umfang von Zuschauer-, Engagement-, Retention-, Geografie- oder Echtzeit-Analysen für Creator.'
  UNION ALL SELECT 'video-hosting', 'creator_business', 'monetization_tools', 'Monetization tools', 'Monetarisierungswerkzeuge', 'multi_enum', 'informational', 'multi_select', 8010, 'Documented ways creators can earn money or receive support through the platform.', 'Dokumentierte Wege, wie Creator über die Plattform Einnahmen erzielen oder Unterstützung erhalten können.'
  UNION ALL SELECT 'video-hosting', 'creator_business', 'paid_content_support', 'Paid content support', 'Unterstützung für bezahlte Inhalte', 'multi_enum', 'informational', 'multi_select', 8020, 'Paid video, subscription, rental, ticketed live, or private-sale models documented for creators.', 'Bezahlvideo-, Abo-, Leih-, Ticket-Livestream- oder Privatverkaufsmodelle, die für Creator dokumentiert sind.'
  UNION ALL SELECT 'video-hosting', 'creator_business', 'creator_support_tools', 'Creator support tools', 'Creator-Unterstützungswerkzeuge', 'multi_enum', 'informational', 'multi_select', 8030, 'Publishing workflow tools that support creators before or after publishing videos.', 'Veröffentlichungswerkzeuge, die Creator vor oder nach der Veröffentlichung von Videos unterstützen.'
  UNION ALL SELECT 'video-hosting', 'creator_business', 'revenue_share_transparency', 'Revenue-share transparency', 'Transparenz der Umsatzbeteiligung', 'enum', 'informational', 'optional', 8040, 'How clearly revenue share rates, monetization eligibility, or partner-only limits are documented.', 'Wie klar Umsatzbeteiligungssätze, Monetarisierungsberechtigung oder Partnerbeschränkungen dokumentiert sind.'
  UNION ALL SELECT 'video-hosting', 'interoperability_portability', 'federation_protocols', 'Federation and syndication protocols', 'Föderations- und Syndikationsprotokolle', 'multi_enum', 'tradeoff', 'multi_select', 9010, 'Documented federation, syndication, feed, or embed protocols supported by the platform.', 'Dokumentierte Föderations-, Syndikations-, Feed- oder Einbettungsprotokolle, die die Plattform unterstützt.'
  UNION ALL SELECT 'video-hosting', 'interoperability_portability', 'embed_oembed_support', 'Embed/oEmbed support', 'Embed-/oEmbed-Unterstützung', 'boolean', 'beneficial', 'optional', 9020, 'Whether the platform documents oEmbed or comparable embed discovery support.', 'Ob die Plattform oEmbed oder vergleichbare Unterstützung für Einbettungserkennung dokumentiert.'
  UNION ALL SELECT 'video-hosting', 'interoperability_portability', 'developer_api', 'Developer API', 'Entwickler-API', 'enum', 'tradeoff', 'optional', 9030, 'The documented API level available for reading, uploading, administration, or paid access.', 'Der dokumentierte API-Umfang für Lesen, Uploads, Administration oder bezahlten Zugriff.'
  UNION ALL SELECT 'video-hosting', 'interoperability_portability', 'portability_migration', 'Portability and migration', 'Portabilität und Migration', 'multi_enum', 'beneficial', 'multi_select', 9040, 'Documented options for account export, video import, channel migration, redirects, or bulk download.', 'Dokumentierte Optionen für Kontoexport, Videoimport, Kanalmigration, Weiterleitungen oder Massendownload.'
  UNION ALL SELECT 'video-hosting', 'interoperability_portability', 'import_from_external_platforms', 'Import from external platforms', 'Import von externen Plattformen', 'boolean', 'informational', 'optional', 9050, 'Whether creators can import videos or channels from external video platforms.', 'Ob Creator Videos oder Kanäle von externen Videoplattformen importieren können.'
  UNION ALL SELECT 'video-hosting', 'deployment_fit', 'deployment_model', 'Deployment model', 'Bereitstellungsmodell', 'enum', 'tradeoff', 'optional', 10010, 'The primary hosted, self-hosted, federated, hybrid, or managed deployment model.', 'Das primäre gehostete, selbstgehostete, föderierte, hybride oder verwaltete Bereitstellungsmodell.'
  UNION ALL SELECT 'video-hosting', 'deployment_fit', 'self_hosting_available', 'Self-hosting available', 'Selbsthosting verfügbar', 'boolean', 'tradeoff', 'optional', 10020, 'Whether organizations or communities can operate the video hosting software themselves.', 'Ob Organisationen oder Communities die Video-Hosting-Software selbst betreiben können.'
  UNION ALL SELECT 'video-hosting', 'deployment_fit', 'admin_controls', 'Admin controls', 'Administrationskontrollen', 'multi_enum', 'beneficial', 'multi_select', 10030, 'Administrative controls available for users, quotas, moderation, policies, logs, or storage.', 'Administrationskontrollen für Nutzer, Kontingente, Moderation, Regeln, Protokolle oder Speicher.'
  UNION ALL SELECT 'video-hosting', 'deployment_fit', 'accessibility_features', 'Accessibility features', 'Barrierefreiheitsfunktionen', 'multi_enum', 'beneficial', 'multi_select', 10040, 'Documented accessibility features for watching, navigating, captioning, transcripts, or metadata.', 'Dokumentierte Barrierefreiheitsfunktionen für Ansehen, Navigation, Untertitel, Transkripte oder Metadaten.'
  UNION ALL SELECT 'video-hosting', 'deployment_fit', 'fit_profiles', 'Fit profiles', 'Eignungsprofile', 'multi_enum', 'informational', 'multi_select', 10050, 'Common viewer, creator, organization, community, education, live, or archive use cases the platform fits.', 'Typische Zuschauer-, Creator-, Organisations-, Community-, Bildungs-, Live- oder Archiv-Anwendungsfälle, für die die Plattform geeignet ist.'
) AS d
...
FROM (
  SELECT 'video-hosting' AS category_id, 'channel_profile_model' AS criterion_key, 'personal_channels' AS option_key, 'Personal channels' AS label_en, 'Persönliche Kanäle' AS label_de, 'neutral' AS display_tone, 10 AS sort_order
  UNION ALL SELECT 'video-hosting', 'channel_profile_model', 'organization_channels', 'Organization channels', 'Organisationskanäle', 'neutral', 20
  UNION ALL SELECT 'video-hosting', 'channel_profile_model', 'brand_channels', 'Brand channels', 'Marken-Kanäle', 'neutral', 30
  UNION ALL SELECT 'video-hosting', 'channel_profile_model', 'instance_accounts', 'Instance accounts', 'Instanzkonten', 'tradeoff', 40
  UNION ALL SELECT 'video-hosting', 'channel_profile_model', 'no_public_channels', 'No public channels', 'Keine öffentlichen Kanäle', 'warning', 50
  ...
  UNION ALL SELECT 'video-hosting', 'thumbnail_and_metadata_tools', 'scheduled_publish', 'Scheduled publishing', 'Geplante Veröffentlichung', 'positive', 50
  ...
  UNION ALL SELECT 'video-hosting', 'playback_quality_options', 'manual_quality_selector', 'Manual quality selector', 'Manuelle Qualitätsauswahl', 'positive', 50
  ...
  UNION ALL SELECT 'video-hosting', 'offline_download_model', 'viewer_downloads', 'Viewer downloads', 'Downloads für Zuschauer', 'positive', 30
  ...
  UNION ALL SELECT 'video-hosting', 'discovery_feed_model', 'federated_timeline', 'Federated timeline', 'Föderierte Timeline', 'tradeoff', 50
  ...
  UNION ALL SELECT 'video-hosting', 'comment_model', 'federated_comments', 'Federated comments', 'Föderierte Kommentare', 'tradeoff', 30
  ...
  UNION ALL SELECT 'video-hosting', 'creator_moderation_tools', 'age_restriction', 'Age restriction', 'Altersbeschränkung', 'positive', 40
  UNION ALL SELECT 'video-hosting', 'creator_moderation_tools', 'geo_restriction', 'Geo restriction', 'Geobeschränkung', 'tradeoff', 50
  ...
  UNION ALL SELECT 'video-hosting', 'reporting_enforcement_tools', 'trusted_flaggers', 'Trusted flaggers', 'Vertrauenswürdige Melder', 'tradeoff', 40
  ...
  UNION ALL SELECT 'video-hosting', 'content_policy_transparency', 'public_rules', 'Public rules', 'Öffentliche Regeln', 'neutral', 20
  ...
  UNION ALL SELECT 'video-hosting', 'content_policy_transparency', 'action_notices', 'Action notices', 'Maßnahmenhinweise', 'positive', 40
  UNION ALL SELECT 'video-hosting', 'content_policy_transparency', 'public_modlog', 'Public moderation log', 'Öffentliches Moderationsprotokoll', 'tradeoff', 50
  ...
  UNION ALL SELECT 'video-hosting', 'copyright_handling_model', 'manual_claims', 'Manual claims', 'Manuelle Ansprüche', 'neutral', 30
  ...
  UNION ALL SELECT 'video-hosting', 'default_video_visibility', 'public', 'Public', 'Öffentlich', 'neutral', 10
  ...
  UNION ALL SELECT 'video-hosting', 'video_visibility_controls', 'public', 'Public', 'Öffentlich', 'neutral', 10
  ...
  UNION ALL SELECT 'video-hosting', 'video_visibility_controls', 'password_protected', 'Password protected', 'Passwortgeschützt', 'positive', 40
  UNION ALL SELECT 'video-hosting', 'video_visibility_controls', 'members_only', 'Members only', 'Nur Mitglieder', 'tradeoff', 50
  UNION ALL SELECT 'video-hosting', 'video_visibility_controls', 'scheduled_release', 'Scheduled release', 'Geplante Veröffentlichung', 'neutral', 60
  ...
  UNION ALL SELECT 'video-hosting', 'ad_personalization_controls', 'opt_out_personalized_ads', 'Personalized-ads opt-out', 'Opt-out für personalisierte Anzeigen', 'positive', 10
  ...
  UNION ALL SELECT 'video-hosting', 'ad_personalization_controls', 'third_party_tracking_controls', 'Third-party tracking controls', 'Kontrollen für Drittanbieter-Tracking', 'positive', 30
  ...
  UNION ALL SELECT 'video-hosting', 'paid_content_support', 'private_sales', 'Private sales', 'Privatverkäufe', 'tradeoff', 60
  ...
  UNION ALL SELECT 'video-hosting', 'creator_support_tools', 'scheduled_publish', 'Scheduled publishing', 'Geplante Veröffentlichung', 'positive', 60
  UNION ALL SELECT 'video-hosting', 'revenue_share_transparency', 'none', 'None', 'Keine', 'neutral', 10
  UNION ALL SELECT 'video-hosting', 'revenue_share_transparency', 'published_rates', 'Published rates', 'Veröffentlichte Sätze', 'positive', 20
  UNION ALL SELECT 'video-hosting', 'revenue_share_transparency', 'tier_dependent', 'Tier dependent', 'Tarifabhängig', 'tradeoff', 30
  ...
  UNION ALL SELECT 'video-hosting', 'developer_api', 'public_write_api', 'Public write/upload API', 'Öffentliche Schreib-/Upload-API', 'positive', 30
  ...
  UNION ALL SELECT 'video-hosting', 'portability_migration', 'federation_followers', 'Federation followers', 'Föderierte Follower', 'tradeoff', 40
  ...
  UNION ALL SELECT 'video-hosting', 'deployment_model', 'federated_instance', 'Federated instance', 'Föderierte Instanz', 'positive', 30
  ...
  UNION ALL SELECT 'video-hosting', 'fit_profiles', 'privacy_sensitive', 'Privacy-sensitive publishing', 'Datenschutzsensible Veröffentlichung', 'positive', 80
  UNION ALL SELECT 'video-hosting', 'fit_profiles', 'public_media_archive', 'Public media archive', 'Öffentliches Medienarchiv', 'tradeoff', 90
) AS d
