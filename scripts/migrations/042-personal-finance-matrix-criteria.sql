...
VALUES
  ('personal-finance', 'budgeting_expense_management', 'Budgeting & Expense Management', 'Budgetierung & Ausgabenverwaltung', 'Budget methods, transaction categorization, recurring rules, and currency support.', 'Budgetmethoden, Transaktionskategorisierung, wiederkehrende Regeln und Währungsunterstützung.', 100),
  ('personal-finance', 'account_aggregation_import', 'Account Aggregation & Data Import', 'Kontoaggregation & Datenimport', 'Bank synchronization methods, multi-institution support, and file import formats.', 'Banksynchronisationsmethoden, Multi-Institutions-Unterstützung und Dateiimportformate.', 200),
  ...
  ('personal-finance', 'reporting_analytics', 'Reporting & Analytics', 'Berichte & Analysen', 'Net worth tracking, cash flow analysis, spending trends, and report exports.', 'Vermögenserfassung, Cashflow-Analyse, Ausgabentrends und Berichtsexporte.', 400),
  ...
  ('personal-finance', 'platform_access', 'Platform & Access', 'Plattform & Zugriff', 'Supported platforms, offline availability, household sharing, and mobile apps.', 'Unterstützte Plattformen, Offline-Verfügbarkeit, Haushaltsfreigabe und mobile Apps.', 600),
  ('personal-finance', 'privacy_data_control', 'Privacy & Data Control', 'Privatsphäre & Datenkontrolle', 'Data storage model, credential handling, processing location, and telemetry.', 'Datenspeichermodell, Zugangsdatenhandhabung, Verarbeitungsstandort und Telemetrie.', 700),
  ('personal-finance', 'openness_deployment', 'Openness & Deployment', 'Offenheit & Bereitstellung', 'Source code availability, licensing, self-hosting, and deployment options.', 'Quellcode-Verfügbarkeit, Lizenzierung, Selbst-Hosting und Bereitstellungsoptionen.', 800),
  ('personal-finance', 'pricing_fit', 'Pricing & Fit', 'Preise & Eignung', 'Pricing model, free tier availability, and target audience profiles.', 'Preismodell, Verfügbarkeit kostenloser Versionen und Zielgruppenprofile.', 900);
...
FROM (
  ...
  UNION ALL SELECT 'personal-finance', 'account_aggregation_import', 'multi_institution_support', 'Multi-institution support', 'Multi-Institutions-Unterstützung', 'boolean', 'beneficial', 'must_match', 2020, 'Whether the tool supports connecting to multiple banks or financial institutions simultaneously.', 'Ob das Tool die Verbindung zu mehreren Banken oder Finanzinstituten gleichzeitig unterstützt.'
  ...
  UNION ALL SELECT 'personal-finance', 'account_aggregation_import', 'supported_import_formats', 'Supported import formats', 'Unterstützte Importformate', 'multi_enum', 'informational', 'multi_select', 2040, 'The file formats supported for importing transaction data from external sources.', 'Die Dateiformate, die für den Import von Transaktionsdaten aus externen Quellen unterstützt werden.'
  UNION ALL SELECT 'personal-finance', 'account_aggregation_import', 'manual_transaction_entry', 'Manual transaction entry', 'Manuelle Transaktionseingabe', 'boolean', 'informational', 'optional', 2050, 'Whether users can manually add transactions when automatic import is unavailable.', 'Ob Benutzer Transaktionen manuell hinzufügen können, wenn kein automatischer Import verfügbar ist.'
  UNION ALL SELECT 'personal-finance', 'investment_portfolio_tracking', 'portfolio_tracking', 'Portfolio tracking', 'Portfolio-Tracking', 'boolean', 'beneficial', 'optional', 3010, 'Whether the tool tracks investment portfolio holdings, allocations, and values over time.', 'Ob das Tool Anlageportfolio-Bestände, Allokationen und Werte im Zeitverlauf verfolgt.'
  ...
  UNION ALL SELECT 'personal-finance', 'investment_portfolio_tracking', 'dividend_tracking', 'Dividend tracking', 'Dividendenverfolgung', 'boolean', 'informational', 'optional', 3040, 'Whether the tool tracks dividend income from portfolio holdings.', 'Ob das Tool Dividendeneinkünfte aus Portfoliobeständen verfolgt.'
  UNION ALL SELECT 'personal-finance', 'investment_portfolio_tracking', 'cost_basis_tracking', 'Cost basis tracking', 'Anschaffungskostenverfolgung', 'boolean', 'informational', 'optional', 3050, 'Whether the tool tracks the original purchase cost of investments for gain or loss calculation.', 'Ob das Tool die ursprünglichen Anschaffungskosten von Investitionen für die Gewinn- oder Verlustberechnung verfolgt.'
  ...
  UNION ALL SELECT 'personal-finance', 'reporting_analytics', 'net_worth_dashboard', 'Net worth dashboard', 'Vermögensübersicht', 'boolean', 'beneficial', 'optional', 4010, 'Whether the tool provides a consolidated net worth overview across all accounts.', 'Ob das Tool eine konsolidierte Vermögensübersicht über alle Konten bietet.'
  UNION ALL SELECT 'personal-finance', 'reporting_analytics', 'cash_flow_analysis', 'Cash flow analysis', 'Cashflow-Analyse', 'boolean', 'beneficial', 'optional', 4020, 'Whether the tool analyzes income versus expenses to show cash flow patterns.', 'Ob das Tool Einnahmen gegenüber Ausgaben analysiert, um Cashflow-Muster aufzuzeigen.'
  ...
  UNION ALL SELECT 'personal-finance', 'reporting_analytics', 'tax_report_generation', 'Tax report generation', 'Steuerberichterstellung', 'boolean', 'informational', 'optional', 4040, 'Whether the tool can generate tax-relevant reports for investment gains or deductions.', 'Ob das Tool steuerrelevante Berichte für Anlagegewinne oder Abzüge erstellen kann.'
  UNION ALL SELECT 'personal-finance', 'reporting_analytics', 'custom_report_builder', 'Custom report builder', 'Benutzerdefinierter Berichtsersteller', 'boolean', 'informational', 'optional', 4050, 'Whether users can build custom reports with self-selected metrics and date ranges.', 'Ob Benutzer benutzerdefinierte Berichte mit selbst gewählten Kennzahlen und Zeiträumen erstellen können.'
  UNION ALL SELECT 'personal-finance', 'reporting_analytics', 'report_export_formats', 'Report export formats', 'Berichtsexportformate', 'multi_enum', 'informational', 'multi_select', 4060, 'The file formats available for exporting generated reports.', 'Die Dateiformate, die für den Export erstellter Berichte verfügbar sind.'
  UNION ALL SELECT 'personal-finance', 'financial_planning_goals', 'savings_goal_tracking', 'Savings goal tracking', 'Sparzielverfolgung', 'boolean', 'beneficial', 'optional', 5010, 'Whether the tool supports setting and tracking progress toward savings goals.', 'Ob das Tool das Setzen und Verfolgen von Fortschritten bei Sparzielen unterstützt.'
  UNION ALL SELECT 'personal-finance', 'financial_planning_goals', 'debt_payoff_planning', 'Debt payoff planning', 'Schuldenabbauplanung', 'boolean', 'informational', 'optional', 5020, 'Whether the tool provides planning tools for debt reduction strategies.', 'Ob das Tool Planungswerkzeuge für Schuldenabbaustrategien bereitstellt.'
  UNION ALL SELECT 'personal-finance', 'financial_planning_goals', 'cash_flow_forecasting', 'Cash flow forecasting', 'Cashflow-Prognose', 'boolean', 'informational', 'optional', 5030, 'Whether the tool can project future cash flow based on recurring transactions.', 'Ob das Tool zukünftigen Cashflow basierend auf wiederkehrenden Transaktionen prognostizieren kann.'
  UNION ALL SELECT 'personal-finance', 'financial_planning_goals', 'retirement_projection', 'Retirement projection', 'Ruhestandsprojektion', 'boolean', 'informational', 'optional', 5040, 'Whether the tool offers retirement planning projections based on current savings.', 'Ob das Tool Ruhestandsplanungsprojektionen basierend auf aktuellem Sparvermögen bietet.'
  UNION ALL SELECT 'personal-finance', 'platform_access', 'supported_platforms', 'Supported platforms', 'Unterstützte Plattformen', 'multi_enum', 'informational', 'multi_select', 6010, 'The platforms on which the tool is available for use.', 'Die Plattformen, auf denen das Tool zur Nutzung verfügbar ist.'
  ...
  UNION ALL SELECT 'personal-finance', 'platform_access', 'multi_user_household', 'Multi-user / household support', 'Mehrbenutzer- / Haushaltsunterstützung', 'boolean', 'informational', 'optional', 6030, 'Whether multiple users or household members can share an account or data set.', 'Ob mehrere Benutzer oder Haushaltsmitglieder ein Konto oder einen Datensatz teilen können.'
  UNION ALL SELECT 'personal-finance', 'platform_access', 'mobile_app_available', 'Mobile app available', 'Mobile App verfügbar', 'boolean', 'informational', 'optional', 6040, 'Whether a dedicated mobile application is available for the tool.', 'Ob eine dedizierte mobile Anwendung für das Tool verfügbar ist.'
  ...
  UNION ALL SELECT 'personal-finance', 'privacy_data_control', 'data_export_available', 'Data export available', 'Datenexport verfügbar', 'boolean', 'beneficial', 'optional', 7040, 'Whether all user data can be exported in a portable format for migration.', 'Ob alle Benutzerdaten in einem portablen Format für die Migration exportiert werden können.'
  UNION ALL SELECT 'personal-finance', 'privacy_data_control', 'telemetry_model', 'Telemetry model', 'Telemetriemodell', 'enum', 'risk', 'optional', 7050, 'How the tool collects and transmits usage analytics and telemetry data.', 'Wie das Tool Nutzungsanalysen und Telemetriedaten erfasst und überträgt.'
  UNION ALL SELECT 'personal-finance', 'openness_deployment', 'source_model', 'Source code model', 'Quellcode-Modell', 'enum', 'tradeoff', 'optional', 8010, 'The availability and openness of the tool source code.', 'Die Verfügbarkeit und Offenheit des Quellcodes des Tools.'
  ...
  UNION ALL SELECT 'personal-finance', 'openness_deployment', 'hosting_model', 'Hosting model', 'Hosting-Modell', 'enum', 'tradeoff', 'must_match', 8040, 'Whether the tool is available as cloud, self-hosted, local app, or a combination.', 'Ob das Tool als Cloud-Dienst, selbst gehostet, lokale App oder Kombination verfügbar ist.'
  UNION ALL SELECT 'personal-finance', 'pricing_fit', 'pricing_model', 'Pricing model', 'Preismodell', 'enum', 'informational', 'optional', 9010, 'The pricing structure for accessing the tool and its features.', 'Die Preisstruktur für den Zugang zum Tool und seinen Funktionen.'
  UNION ALL SELECT 'personal-finance', 'pricing_fit', 'free_tier_available', 'Free tier available', 'Kostenlose Version verfügbar', 'boolean', 'informational', 'must_match', 9020, 'Whether a functional free version of the tool is available without payment.', 'Ob eine funktionsfähige kostenlose Version des Tools ohne Bezahlung verfügbar ist.'
  UNION ALL SELECT 'personal-finance', 'pricing_fit', 'fit_profiles', 'Fit profiles', 'Eignungsprofile', 'multi_enum', 'informational', 'multi_select', 9030, 'Target audience profiles the tool is best suited for based on features and focus.', 'Zielgruppenprofile, für die das Tool basierend auf Funktionen und Schwerpunkt am besten geeignet ist.'
) AS d
...
FROM (
  ...
  UNION ALL SELECT 'personal-finance', 'asset_classes_tracked', 'crypto', 'Cryptocurrency', 'Kryptowährungen', 'neutral', 50
  ...
  UNION ALL SELECT 'personal-finance', 'data_storage_model', 'local_only', 'Local device only', 'Nur lokales Gerät', 'positive', 10
  ...
  UNION ALL SELECT 'personal-finance', 'bank_credential_handling', 'locally_encrypted', 'Locally encrypted storage', 'Lokal verschlüsselt gespeichert', 'neutral', 40
  UNION ALL SELECT 'personal-finance', 'data_processing_location', 'eu_only', 'EU only', 'Nur EU', 'positive', 10
  UNION ALL SELECT 'personal-finance', 'data_processing_location', 'eu_primary', 'EU primary', 'EU primär', 'neutral', 20
  UNION ALL SELECT 'personal-finance', 'data_processing_location', 'global', 'Global', 'Global', 'warning', 30
  UNION ALL SELECT 'personal-finance', 'data_processing_location', 'local_device', 'Local device', 'Lokales Gerät', 'positive', 40
  ...
  UNION ALL SELECT 'personal-finance', 'source_model', 'fully_open_source', 'Fully open source', 'Vollständig quelloffen', 'positive', 10
  UNION ALL SELECT 'personal-finance', 'source_model', 'source_available', 'Source available', 'Quellcode verfügbar', 'neutral', 20
  UNION ALL SELECT 'personal-finance', 'source_model', 'partially_open', 'Partially open', 'Teilweise offen', 'neutral', 30
  UNION ALL SELECT 'personal-finance', 'source_model', 'proprietary', 'Proprietary', 'Proprietär', 'warning', 40
  ...
  UNION ALL SELECT 'personal-finance', 'license_type', 'proprietary', 'Proprietary', 'Proprietär', 'neutral', 50
