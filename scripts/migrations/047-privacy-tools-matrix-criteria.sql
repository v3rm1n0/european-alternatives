...
VALUES
  ('privacy-tools', 'protection_scope', 'Protection Scope & Methods', 'Schutzumfang & Methoden', 'Types of threats and tracking techniques the tool protects against, including ad blocking, malware defense, and fingerprint resistance.', 'Arten von Bedrohungen und Tracking-Techniken, gegen die das Werkzeug schuetzt, einschliesslich Werbeblockierung, Malware-Abwehr und Fingerabdruck-Resistenz.', 100),
  ('privacy-tools', 'network_security', 'Network & Traffic Security', 'Netzwerk- & Verkehrssicherheit', 'Network-level privacy capabilities such as DNS encryption, firewall rule granularity, and traffic analysis prevention.', 'Datenschutzfaehigkeiten auf Netzwerkebene wie DNS-Verschluesselung, Firewall-Regelgranularitaet und Verhinderung von Verkehrsanalyse.', 200),
  ('privacy-tools', 'filter_rules', 'Filter Lists & Rule Engines', 'Filterlisten & Regel-Engines', 'How blocking rules are defined, maintained, and customized including built-in filter lists, custom rules, and update mechanisms.', 'Wie Blockierungsregeln definiert, gepflegt und angepasst werden, einschliesslich integrierter Filterlisten, benutzerdefinierter Regeln und Aktualisierungsmechanismen.', 300),
  ('privacy-tools', 'privacy_data_handling', 'Privacy & Data Handling', 'Datenschutz & Datenverarbeitung', 'What data the tool itself collects and how it handles user information, including telemetry, retention, and third-party sharing policies.', 'Welche Daten das Werkzeug selbst erhebt und wie es Benutzerinformationen handhabt, einschliesslich Telemetrie-, Aufbewahrungs- und Drittanbieter-Weitergaberichtlinien.', 400),
  ('privacy-tools', 'platform_integration', 'Platform & Integration', 'Plattform & Integration', 'Where and how the tool operates across different platforms, browsers, routers, and mobile devices.', 'Wo und wie das Werkzeug auf verschiedenen Plattformen, Browsern, Routern und mobilen Geraeten arbeitet.', 500),
  ('privacy-tools', 'configuration_usability', 'Configuration & Usability', 'Konfiguration & Benutzerfreundlichkeit', 'Setup complexity, dashboard capabilities, parental controls, and ease of daily use for various user skill levels.', 'Einrichtungskomplexitaet, Dashboard-Faehigkeiten, Kindersicherungen und Benutzerfreundlichkeit im Alltag fuer verschiedene Kenntnisstufen.', 600),
  ('privacy-tools', 'architecture_control', 'Architecture & Control', 'Architektur & Kontrolle', 'Underlying processing architecture including cloud vs. local operation, self-hosting options, and update mechanisms.', 'Zugrunde liegende Verarbeitungsarchitektur einschliesslich Cloud- vs. lokaler Verarbeitung, Selbst-Hosting-Optionen und Aktualisierungsmechanismen.', 700),
  ('privacy-tools', 'openness_governance', 'Openness & Governance', 'Offenheit & Governance', 'Source code availability, licensing model, independent security audits, and community contribution governance.', 'Quellcode-Verfuegbarkeit, Lizenzmodell, unabhaengige Sicherheitspruefungen und Governance der Gemeinschaftsbeteiligung.', 800),
  ('privacy-tools', 'pricing_fit', 'Pricing & Fit', 'Preise & Eignung', 'Cost structure, account requirements, data processing location, and target user profiles for privacy-conscious audiences.', 'Kostenstruktur, Kontoanforderungen, Datenverarbeitungsstandort und Zielbenutzerprofile fuer datenschutzbewusste Zielgruppen.', 900);
...
FROM (
  SELECT 'privacy-tools' AS category_id, 'protection_scope' AS group_key, 'protection_type' AS criterion_key, 'Protection type' AS label_en, 'Schutztyp' AS label_de, 'multi_enum' AS value_type, 'informational' AS semantics, 'multi_select' AS filter_mode, 1010 AS sort_order, 'The categories of threats this tool addresses, such as tracker blocking, ad blocking, malware defense, or firewall capabilities.' AS help_text_en, 'Die Kategorien von Bedrohungen, die dieses Werkzeug adressiert, wie Tracker-Blockierung, Werbeblockierung, Malware-Abwehr oder Firewall-Faehigkeiten.' AS help_text_de
  UNION ALL SELECT 'privacy-tools', 'protection_scope', 'tracker_blocking_method', 'Tracker blocking method', 'Tracker-Blockierungsmethode', 'enum', 'informational', 'optional', 1020, 'The primary technical approach used to identify and block tracking requests, from DNS sinkholes to heuristic detection.', 'Der primaere technische Ansatz zur Identifizierung und Blockierung von Tracking-Anfragen, von DNS-Sinkhole bis heuristischer Erkennung.'
  UNION ALL SELECT 'privacy-tools', 'protection_scope', 'ad_blocking_included', 'Ad blocking included', 'Werbeblockierung enthalten', 'boolean', 'informational', 'optional', 1030, 'Whether the tool includes built-in advertisement blocking as part of its privacy protection features.', 'Ob das Werkzeug eine integrierte Werbeblockierung als Teil seiner Datenschutzfunktionen enthaelt.'
  UNION ALL SELECT 'privacy-tools', 'protection_scope', 'malware_protection', 'Malware/phishing protection', 'Malware-/Phishing-Schutz', 'boolean', 'beneficial', 'optional', 1040, 'Whether the tool actively blocks known malware distribution sites and phishing attempts to protect users from threats.', 'Ob das Werkzeug bekannte Malware-Verbreitungsseiten und Phishing-Versuche aktiv blockiert, um Benutzer vor Bedrohungen zu schuetzen.'
  UNION ALL SELECT 'privacy-tools', 'protection_scope', 'fingerprint_resistance', 'Fingerprint resistance', 'Fingerabdruck-Resistenz', 'boolean', 'beneficial', 'optional', 1050, 'Whether the tool reduces browser or device fingerprinting by masking or normalizing identifiable attributes.', 'Ob das Werkzeug Browser- oder Geraete-Fingerprinting durch Maskierung oder Normalisierung identifizierbarer Attribute reduziert.'
  UNION ALL SELECT 'privacy-tools', 'protection_scope', 'cookie_management', 'Cookie management', 'Cookie-Verwaltung', 'enum', 'informational', 'optional', 1060, 'How the tool handles browser cookies, from automatic deletion of third-party cookies to full cookie isolation.', 'Wie das Werkzeug Browser-Cookies behandelt, von automatischer Loeschung von Drittanbieter-Cookies bis zur vollstaendigen Cookie-Isolation.'
  UNION ALL SELECT 'privacy-tools', 'network_security', 'dns_encryption', 'DNS encryption support', 'DNS-Verschluesselungsunterstuetzung', 'multi_enum', 'beneficial', 'multi_select', 2010, 'The DNS encryption protocols supported to prevent DNS query interception and surveillance by network observers.', 'Die unterstuetzten DNS-Verschluesselungsprotokolle zur Verhinderung von DNS-Abfrage-Abfangen und Ueberwachung durch Netzwerkbeobachter.'
  UNION ALL SELECT 'privacy-tools', 'network_security', 'firewall_granularity', 'Firewall rule granularity', 'Firewall-Regelgranularitaet', 'enum', 'informational', 'optional', 2020, 'The level of detail at which firewall rules can be defined, from broad application-level to fine-grained packet-level control.', 'Der Detaillierungsgrad, auf dem Firewall-Regeln definiert werden koennen, von breiter Anwendungsebene bis feingranularer Paketebenen-Kontrolle.'
  UNION ALL SELECT 'privacy-tools', 'network_security', 'traffic_inspection_model', 'Network traffic inspection', 'Netzwerkverkehr-Inspektion', 'enum', 'informational', 'optional', 2030, 'The depth of network traffic analysis the tool performs to identify and filter unwanted connections.', 'Die Tiefe der Netzwerkverkehrsanalyse, die das Werkzeug durchfuehrt, um unerwuenschte Verbindungen zu identifizieren und zu filtern.'
  UNION ALL SELECT 'privacy-tools', 'network_security', 'ip_leak_prevention', 'IP leak prevention', 'IP-Leck-Verhinderung', 'boolean', 'beneficial', 'optional', 2040, 'Whether the tool includes mechanisms to prevent accidental IP address leaks through WebRTC, DNS, or other side channels.', 'Ob das Werkzeug Mechanismen zur Verhinderung versehentlicher IP-Adress-Lecks durch WebRTC, DNS oder andere Seitenkanaele enthaelt.'
  UNION ALL SELECT 'privacy-tools', 'network_security', 'per_app_rules', 'Per-app/per-domain rules', 'Pro-App-/Pro-Domain-Regeln', 'boolean', 'beneficial', 'optional', 2050, 'Whether blocking and filtering rules can be configured individually for specific applications or domains.', 'Ob Blockierungs- und Filterregeln individuell fuer bestimmte Anwendungen oder Domains konfiguriert werden koennen.'
  UNION ALL SELECT 'privacy-tools', 'filter_rules', 'builtin_filter_lists', 'Built-in filter lists', 'Integrierte Filterlisten', 'multi_enum', 'informational', 'multi_select', 3010, 'The pre-installed filter list subscriptions available out of the box for blocking trackers, ads, and malware domains.', 'Die vorinstallierten Filterlisten-Abonnements, die direkt verfuegbar sind, um Tracker, Werbung und Malware-Domains zu blockieren.'
  UNION ALL SELECT 'privacy-tools', 'filter_rules', 'custom_rule_support', 'Custom rule support', 'Benutzerdefinierte Regelunterstuetzung', 'boolean', 'beneficial', 'optional', 3020, 'Whether users can create their own blocking rules beyond the provided filter lists for tailored privacy protection.', 'Ob Benutzer eigene Blockierungsregeln ueber die bereitgestellten Filterlisten hinaus fuer massgeschneiderten Datenschutz erstellen koennen.'
  UNION ALL SELECT 'privacy-tools', 'filter_rules', 'rule_syntax_compat', 'Rule syntax compatibility', 'Regelsyntax-Kompatibilitaet', 'multi_enum', 'informational', 'multi_select', 3030, 'Which filter rule syntax formats the tool understands, enabling reuse of community-maintained filter lists.', 'Welche Filterregel-Syntaxformate das Werkzeug versteht, um die Wiederverwendung von gemeinschaftlich gepflegten Filterlisten zu ermoeglichen.'
  UNION ALL SELECT 'privacy-tools', 'filter_rules', 'filter_list_auto_update', 'Filter list auto-update', 'Filterlisten-Autoaktualisierung', 'boolean', 'beneficial', 'optional', 3040, 'Whether subscribed filter lists are automatically updated to include newly discovered trackers and threats.', 'Ob abonnierte Filterlisten automatisch aktualisiert werden, um neu entdeckte Tracker und Bedrohungen einzuschliessen.'
  UNION ALL SELECT 'privacy-tools', 'filter_rules', 'allowlist_management', 'Allowlist/exception management', 'Freigabelisten-/Ausnahmeverwaltung', 'boolean', 'informational', 'optional', 3050, 'Whether the tool provides an interface for managing allowed sites or exceptions when blocking causes compatibility issues.', 'Ob das Werkzeug eine Oberflaeche zur Verwaltung von erlaubten Seiten oder Ausnahmen bietet, wenn Blockierung Kompatibilitaetsprobleme verursacht.'
  UNION ALL SELECT 'privacy-tools', 'privacy_data_handling', 'local_only_operation', 'Local-only operation', 'Nur-lokaler Betrieb', 'boolean', 'beneficial', 'must_match', 4010, 'Whether the tool processes all data locally on the device without sending queries or telemetry to external servers.', 'Ob das Werkzeug alle Daten lokal auf dem Geraet verarbeitet, ohne Abfragen oder Telemetrie an externe Server zu senden.'
  UNION ALL SELECT 'privacy-tools', 'privacy_data_handling', 'telemetry_model', 'Telemetry model', 'Telemetriemodell', 'enum', 'risk', 'optional', 4020, 'How the tool collects and transmits usage analytics data to its developers, from no collection to mandatory reporting.', 'Wie das Werkzeug Nutzungsanalysedaten an seine Entwickler erhebt und uebertraegt, von keiner Erhebung bis zur Pflichtberichterstattung.'
  UNION ALL SELECT 'privacy-tools', 'privacy_data_handling', 'crash_reporting_model', 'Crash/diagnostic reporting', 'Absturz-/Diagnoseberichterstattung', 'enum', 'informational', 'optional', 4030, 'How the tool handles crash and diagnostic data collection, and whether users can control this behavior.', 'Wie das Werkzeug die Erfassung von Absturz- und Diagnosedaten handhabt und ob Benutzer dieses Verhalten steuern koennen.'
  ...
  UNION ALL SELECT 'privacy-tools', 'privacy_data_handling', 'third_party_data_sharing', 'Third-party data sharing', 'Drittanbieter-Datenweitergabe', 'boolean', 'risk', 'must_match', 4050, 'Whether the tool shares any collected user data with third-party companies for analytics, advertising, or other purposes.', 'Ob das Werkzeug gesammelte Benutzerdaten mit Drittunternehmen fuer Analysen, Werbung oder andere Zwecke teilt.'
  UNION ALL SELECT 'privacy-tools', 'platform_integration', 'supported_platforms', 'Supported platforms', 'Unterstuetzte Plattformen', 'multi_enum', 'informational', 'multi_select', 5010, 'The operating systems and device types on which the privacy tool can be installed and used.', 'Die Betriebssysteme und Geraetetypen, auf denen das Datenschutz-Werkzeug installiert und genutzt werden kann.'
  ...
  UNION ALL SELECT 'privacy-tools', 'platform_integration', 'browser_extensions', 'Browser extensions available', 'Verfuegbare Browser-Erweiterungen', 'multi_enum', 'informational', 'multi_select', 5030, 'Which web browsers are supported through dedicated extension or add-on versions of the privacy tool.', 'Welche Webbrowser durch dedizierte Erweiterungs- oder Add-on-Versionen des Datenschutz-Werkzeugs unterstuetzt werden.'
  UNION ALL SELECT 'privacy-tools', 'platform_integration', 'router_deployment', 'Router/network-level deployment', 'Router-/Netzwerkebenen-Einsatz', 'boolean', 'informational', 'optional', 5040, 'Whether the tool can be deployed on a router or network appliance to protect all connected devices simultaneously.', 'Ob das Werkzeug auf einem Router oder Netzwerkgeraet eingesetzt werden kann, um alle verbundenen Geraete gleichzeitig zu schuetzen.'
  UNION ALL SELECT 'privacy-tools', 'platform_integration', 'mobile_platform_support', 'Mobile platform support', 'Mobilplattform-Unterstuetzung', 'multi_enum', 'informational', 'multi_select', 5050, 'The mobile operating systems and platform-specific integration methods available for the privacy tool.', 'Die mobilen Betriebssysteme und plattformspezifischen Integrationsmethoden, die fuer das Datenschutz-Werkzeug verfuegbar sind.'
  UNION ALL SELECT 'privacy-tools', 'configuration_usability', 'setup_complexity', 'Setup complexity', 'Einrichtungskomplexitaet', 'enum', 'tradeoff', 'optional', 6010, 'The level of technical knowledge and effort required to install and configure the tool for effective use.', 'Das Niveau an technischem Wissen und Aufwand, das fuer die Installation und Konfiguration des Werkzeugs fuer effektive Nutzung erforderlich ist.'
  UNION ALL SELECT 'privacy-tools', 'configuration_usability', 'dashboard_ui', 'Dashboard/reporting UI', 'Dashboard-/Berichtsoberflaeche', 'boolean', 'informational', 'optional', 6020, 'Whether the tool provides a visual dashboard for monitoring blocking statistics, traffic patterns, and protection status.', 'Ob das Werkzeug ein visuelles Dashboard zur Ueberwachung von Blockierungsstatistiken, Verkehrsmustern und Schutzstatus bereitstellt.'
  UNION ALL SELECT 'privacy-tools', 'configuration_usability', 'parental_controls', 'Parental/family controls', 'Kindersicherung/Familienkontrollen', 'boolean', 'informational', 'optional', 6030, 'Whether the tool includes features for managing content filtering and access controls for family members or children.', 'Ob das Werkzeug Funktionen zur Verwaltung von Inhaltsfilterung und Zugangskontrollen fuer Familienmitglieder oder Kinder enthaelt.'
  UNION ALL SELECT 'privacy-tools', 'configuration_usability', 'scheduled_rules', 'Scheduled rules', 'Geplante Regeln', 'boolean', 'informational', 'optional', 6040, 'Whether blocking and filtering rules can be scheduled to activate or deactivate at specific times of day.', 'Ob Blockierungs- und Filterregeln geplant werden koennen, um zu bestimmten Tageszeiten aktiviert oder deaktiviert zu werden.'
  UNION ALL SELECT 'privacy-tools', 'configuration_usability', 'notifications_alerts', 'Notifications/alerts', 'Benachrichtigungen/Warnungen', 'boolean', 'informational', 'optional', 6050, 'Whether the tool sends notifications or alerts about blocked threats, filter list updates, or security events.', 'Ob das Werkzeug Benachrichtigungen oder Warnungen ueber blockierte Bedrohungen, Filterlistenaktualisierungen oder Sicherheitsereignisse sendet.'
  UNION ALL SELECT 'privacy-tools', 'architecture_control', 'processing_architecture', 'Processing architecture', 'Verarbeitungsarchitektur', 'enum', 'tradeoff', 'must_match', 7010, 'Whether blocking and filtering is performed locally on the device, in the cloud, or through a self-hosted server.', 'Ob Blockierung und Filterung lokal auf dem Geraet, in der Cloud oder ueber einen selbst gehosteten Server durchgefuehrt werden.'
  UNION ALL SELECT 'privacy-tools', 'architecture_control', 'self_hosting_available', 'Self-hosting available', 'Selbst-Hosting verfuegbar', 'boolean', 'beneficial', 'must_match', 7020, 'Whether the tool can be installed and operated on self-managed infrastructure for full data sovereignty.', 'Ob das Werkzeug auf eigener Infrastruktur installiert und betrieben werden kann fuer vollstaendige Datensouveraenitaet.'
  UNION ALL SELECT 'privacy-tools', 'architecture_control', 'update_mechanism', 'Update mechanism', 'Aktualisierungsmechanismus', 'enum', 'informational', 'optional', 7030, 'How the tool receives software updates, from automatic background updates to manual package manager installations.', 'Wie das Werkzeug Software-Updates erhaelt, von automatischen Hintergrundaktualisierungen bis manuellen Paketmanager-Installationen.'
  UNION ALL SELECT 'privacy-tools', 'architecture_control', 'api_automation_support', 'API/automation support', 'API-/Automatisierungsunterstuetzung', 'boolean', 'beneficial', 'optional', 7040, 'Whether the tool provides a programmable API or automation interface for scripted configuration and monitoring.', 'Ob das Werkzeug eine programmierbare API oder Automatisierungsschnittstelle fuer skriptgesteuerte Konfiguration und Ueberwachung bereitstellt.'
  UNION ALL SELECT 'privacy-tools', 'architecture_control', 'data_export_available', 'Data export available', 'Datenexport verfuegbar', 'boolean', 'beneficial', 'optional', 7050, 'Whether blocking logs, configuration, and statistics can be exported for backup or analysis in external tools.', 'Ob Blockierungsprotokolle, Konfiguration und Statistiken zur Sicherung oder Analyse in externen Werkzeugen exportiert werden koennen.'
  UNION ALL SELECT 'privacy-tools', 'openness_governance', 'source_model', 'Source code model', 'Quellcode-Modell', 'enum', 'tradeoff', 'optional', 8010, 'The availability and openness of the privacy tool source code for independent inspection and community contribution.', 'Die Verfuegbarkeit und Offenheit des Datenschutz-Werkzeug-Quellcodes fuer unabhaengige Einsicht und Gemeinschaftsbeteiligung.'
  UNION ALL SELECT 'privacy-tools', 'openness_governance', 'license_type', 'License type', 'Lizenztyp', 'enum', 'informational', 'optional', 8020, 'The software license governing redistribution and use of the privacy tool, from copyleft to permissive to proprietary.', 'Die Softwarelizenz, die Weiterverbreitung und Nutzung des Datenschutz-Werkzeugs regelt, von Copyleft ueber permissiv bis proprietaer.'
  UNION ALL SELECT 'privacy-tools', 'openness_governance', 'security_audit', 'Independent security audit', 'Unabhaengige Sicherheitspruefung', 'boolean', 'beneficial', 'optional', 8030, 'Whether the tool has undergone an independent third-party security audit with publicly available results.', 'Ob das Werkzeug einer unabhaengigen Sicherheitspruefung durch Dritte mit oeffentlich verfuegbaren Ergebnissen unterzogen wurde.'
  UNION ALL SELECT 'privacy-tools', 'openness_governance', 'bug_bounty_program', 'Bug bounty program', 'Bug-Bounty-Programm', 'boolean', 'informational', 'optional', 8040, 'Whether the developer operates a bug bounty program rewarding security researchers for discovering vulnerabilities.', 'Ob der Entwickler ein Bug-Bounty-Programm betreibt, das Sicherheitsforscher fuer die Entdeckung von Schwachstellen belohnt.'
  UNION ALL SELECT 'privacy-tools', 'openness_governance', 'community_model', 'Community contribution model', 'Gemeinschaftsbeitragsmodell', 'enum', 'informational', 'optional', 8050, 'How external developers and users can contribute to the privacy tool development through code, translations, or filter lists.', 'Wie externe Entwickler und Benutzer zur Entwicklung des Datenschutz-Werkzeugs durch Code, Uebersetzungen oder Filterlisten beitragen koennen.'
  UNION ALL SELECT 'privacy-tools', 'pricing_fit', 'pricing_model', 'Pricing model', 'Preismodell', 'enum', 'informational', 'optional', 9010, 'The pricing structure for obtaining and using the privacy tool, such as free, freemium, subscription, or donation-based.', 'Die Preisstruktur fuer den Erwerb und die Nutzung des Datenschutz-Werkzeugs, wie kostenlos, Freemium, Abonnement oder spendenbasiert.'
  UNION ALL SELECT 'privacy-tools', 'pricing_fit', 'free_tier_available', 'Free tier available', 'Kostenlose Version verfuegbar', 'boolean', 'informational', 'must_match', 9020, 'Whether a functional free version of the privacy tool is available without payment or time-limited trial restrictions.', 'Ob eine funktionsfaehige kostenlose Version des Datenschutz-Werkzeugs ohne Zahlungs- oder zeitlich begrenzte Testbeschraenkungen verfuegbar ist.'
...
FROM (
  ...
  UNION ALL SELECT 'privacy-tools', 'cookie_management', 'auto_delete', 'Auto-delete', 'Automatisches Loeschen', 'neutral', 10
  ...
  UNION ALL SELECT 'privacy-tools', 'dns_encryption', 'dns_over_https', 'DNS over HTTPS', 'DNS ueber HTTPS', 'neutral', 10
  UNION ALL SELECT 'privacy-tools', 'dns_encryption', 'dns_over_tls', 'DNS over TLS', 'DNS ueber TLS', 'neutral', 20
  ...
  UNION ALL SELECT 'privacy-tools', 'builtin_filter_lists', 'fanboy_annoyance', 'Fanboy Annoyance List', 'Fanboy-Stoerungsliste', 'neutral', 30
  ...
  UNION ALL SELECT 'privacy-tools', 'rule_syntax_compat', 'regex', 'Regular expressions', 'Regulaere Ausdruecke', 'neutral', 40
  ...
  UNION ALL SELECT 'privacy-tools', 'source_model', 'fully_open_source', 'Fully open source', 'Vollstaendig quelloffen', 'positive', 10
  UNION ALL SELECT 'privacy-tools', 'source_model', 'source_available', 'Source available', 'Quellcode verfuegbar', 'neutral', 20
  UNION ALL SELECT 'privacy-tools', 'source_model', 'partially_open', 'Partially open', 'Teilweise offen', 'neutral', 30
  UNION ALL SELECT 'privacy-tools', 'source_model', 'proprietary', 'Proprietary', 'Proprietaer', 'warning', 40
  ...
  UNION ALL SELECT 'privacy-tools', 'license_type', 'proprietary', 'Proprietary', 'Proprietaer', 'neutral', 60
  UNION ALL SELECT 'privacy-tools', 'community_model', 'open_contributions', 'Open contributions', 'Offene Beitraege', 'neutral', 10
  UNION ALL SELECT 'privacy-tools', 'community_model', 'managed_contributions', 'Managed contributions', 'Verwaltete Beitraege', 'neutral', 20
  UNION ALL SELECT 'privacy-tools', 'community_model', 'enterprise_only', 'Enterprise only', 'Nur Unternehmen', 'neutral', 30
  UNION ALL SELECT 'privacy-tools', 'community_model', 'no_contributions', 'No contributions', 'Keine Beitraege', 'neutral', 40
  ...
  UNION ALL SELECT 'privacy-tools', 'data_processing_location', 'eu_primary', 'EU primary', 'EU primaer', 'neutral', 20
  UNION ALL SELECT 'privacy-tools', 'data_processing_location', 'global', 'Global', 'Global', 'warning', 30
  UNION ALL SELECT 'privacy-tools', 'data_processing_location', 'local_device', 'Local device', 'Lokales Geraet', 'positive', 40
