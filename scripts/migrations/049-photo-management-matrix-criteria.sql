...
VALUES
  ...
  ('photo-management', 'storage_backup', 'Storage & Backup', 'Speicher & Backup', 'Where photos are stored, how storage quotas work, and which backup strategies are available.', 'Wo Fotos gespeichert werden, wie Speicherkontingente funktionieren und welche Backup-Strategien verfuegbar sind.', 200),
  ('photo-management', 'sharing_collaboration', 'Sharing & Collaboration', 'Teilen & Zusammenarbeit', 'Mechanisms for sharing photos with others through public links, shared albums, and access controls.', 'Mechanismen zum Teilen von Fotos mit anderen ueber oeffentliche Links, geteilte Alben und Zugriffskontrollen.', 300),
  ('photo-management', 'editing_enhancement', 'Editing & Enhancement', 'Bearbeitung & Verbesserung', 'Built-in editing tools, RAW workflow support, and AI-driven enhancement features for photo refinement.', 'Integrierte Bearbeitungswerkzeuge, RAW-Workflow-Unterstuetzung und KI-gestuetzte Verbesserungsfunktionen zur Fotooptimierung.', 400),
  ('photo-management', 'platform_access', 'Platform & Access', 'Plattform & Zugriff', 'Operating systems, web access, offline use, and third-party integrations supported by the photo tool.', 'Betriebssysteme, Web-Zugriff, Offline-Nutzung und Drittanbieter-Integrationen, die vom Foto-Werkzeug unterstuetzt werden.', 500),
  ('photo-management', 'privacy_data', 'Privacy & Data', 'Datenschutz & Daten', 'Data processing jurisdiction, encryption guarantees, and how the tool handles sensitive metadata and accounts.', 'Datenverarbeitungs-Zustaendigkeit, Verschluesselungsgarantien und wie das Werkzeug sensible Metadaten und Konten behandelt.', 600),
  ('photo-management', 'openness_standards', 'Openness & Standards', 'Offenheit & Standards', 'Source code transparency, licensing terms, self-hosting feasibility, and adherence to open photo formats.', 'Quellcode-Transparenz, Lizenzbedingungen, Selbsthosting-Moeglichkeit und Einhaltung offener Fotoformate.', 700),
  ('photo-management', 'pricing_fit', 'Pricing & Fit', 'Preise & Eignung', 'Cost structure, free tier availability, free tier limitations, and target user profiles for the photo tool.', 'Kostenstruktur, Verfuegbarkeit der kostenlosen Stufe, deren Einschraenkungen und Zielnutzerprofile fuer das Foto-Werkzeug.', 800);
...
FROM (
  SELECT 'photo-management' AS category_id, 'library_organization' AS group_key, 'photo_import_sources' AS criterion_key, 'Photo import sources' AS label_en, 'Foto-Importquellen' AS label_de, 'multi_enum' AS value_type, 'informational' AS semantics, 'multi_select' AS filter_mode, 1010 AS sort_order, 'Channels through which photos can enter the library, such as mobile capture, desktop apps, or external sources.' AS help_text_en, 'Kanaele, ueber die Fotos in die Bibliothek gelangen koennen, zum Beispiel mobile Aufnahme, Desktop-Apps oder externe Quellen.' AS help_text_de
  UNION ALL SELECT 'photo-management', 'library_organization', 'auto_upload_mobile', 'Auto-upload from mobile', 'Auto-Upload vom Mobilgeraet', 'boolean', 'beneficial', 'optional', 1020, 'Whether the mobile companion app can automatically back up new photos taken on the device.', 'Ob die mobile Begleit-App neue auf dem Geraet aufgenommene Fotos automatisch sichern kann.'
  ...
  UNION ALL SELECT 'photo-management', 'library_organization', 'duplicate_detection', 'Duplicate detection', 'Duplikaterkennung', 'boolean', 'beneficial', 'optional', 1080, 'Whether the tool identifies and helps deduplicate visually similar or identical photos in the library.', 'Ob das Werkzeug visuell aehnliche oder identische Fotos in der Bibliothek identifiziert und beim Deduplizieren hilft.'
  UNION ALL SELECT 'photo-management', 'storage_backup', 'storage_type', 'Storage type', 'Speichertyp', 'enum', 'tradeoff', 'must_match', 2010, 'The fundamental storage architecture of the service, from pure cloud hosting to fully self-hosted deployments.', 'Die grundlegende Speicherarchitektur des Dienstes, von reinem Cloud-Hosting bis zu vollstaendig selbstgehosteten Bereitstellungen.'
  UNION ALL SELECT 'photo-management', 'storage_backup', 'storage_quota_model', 'Storage quota model', 'Speicherkontingent-Modell', 'enum', 'tradeoff', 'optional', 2020, 'How storage capacity is allocated and charged to users, including unlimited and tiered options.', 'Wie Speicherkapazitaet zugewiesen und Nutzern berechnet wird, einschliesslich unbegrenzter und gestaffelter Optionen.'
  UNION ALL SELECT 'photo-management', 'storage_backup', 'original_quality_preservation', 'Original quality preservation', 'Erhalt der Originalqualitaet', 'boolean', 'beneficial', 'optional', 2030, 'Whether the service stores uploaded photos in their original quality without recompression.', 'Ob der Dienst hochgeladene Fotos in ihrer Originalqualitaet ohne erneute Komprimierung speichert.'
  UNION ALL SELECT 'photo-management', 'storage_backup', 'backup_strategy', 'Backup strategy', 'Backup-Strategie', 'multi_enum', 'informational', 'multi_select', 2040, 'Available approaches for safeguarding the photo library against loss through multiple copies or sync.', 'Verfuegbare Ansaetze zum Schutz der Fotobibliothek vor Verlust durch mehrere Kopien oder Synchronisation.'
  UNION ALL SELECT 'photo-management', 'storage_backup', 'file_versioning', 'File versioning', 'Datei-Versionierung', 'boolean', 'informational', 'optional', 2050, 'Whether the tool keeps prior versions of edited photos so earlier states can be restored.', 'Ob das Werkzeug fruehere Versionen bearbeiteter Fotos aufbewahrt, sodass ein frueherer Zustand wiederhergestellt werden kann.'
  UNION ALL SELECT 'photo-management', 'storage_backup', 'trash_recovery', 'Trash / recovery', 'Papierkorb / Wiederherstellung', 'boolean', 'beneficial', 'optional', 2060, 'Whether deleted photos can be recovered from a trash or recycle bin within a retention window.', 'Ob geloeschte Fotos innerhalb eines Aufbewahrungsfensters aus einem Papierkorb wiederhergestellt werden koennen.'
  UNION ALL SELECT 'photo-management', 'sharing_collaboration', 'public_link_sharing', 'Public link sharing', 'Oeffentliches Link-Teilen', 'boolean', 'informational', 'optional', 3010, 'Whether photos or albums can be shared via public hyperlinks accessible without an account.', 'Ob Fotos oder Alben ueber oeffentliche Hyperlinks geteilt werden koennen, die ohne Konto zugaenglich sind.'
  UNION ALL SELECT 'photo-management', 'sharing_collaboration', 'shared_albums', 'Shared albums', 'Geteilte Alben', 'boolean', 'beneficial', 'optional', 3020, 'Whether multiple users can contribute to and view the same album with synchronized updates.', 'Ob mehrere Nutzer zum selben Album beitragen und es mit synchronisierten Aktualisierungen ansehen koennen.'
  UNION ALL SELECT 'photo-management', 'sharing_collaboration', 'family_sharing', 'Family sharing / multi-user', 'Familien-Teilen / Mehrbenutzer', 'boolean', 'beneficial', 'optional', 3030, 'Whether the service includes household plans or multi-user accounts for family or group use.', 'Ob der Dienst Haushaltsplaene oder Mehrbenutzerkonten fuer Familien- oder Gruppennutzung umfasst.'
  UNION ALL SELECT 'photo-management', 'sharing_collaboration', 'access_control_model', 'Access control model', 'Zugriffskontrollmodell', 'enum', 'informational', 'optional', 3040, 'How access to shared photos and albums is restricted through passwords, roles, or expiry rules.', 'Wie der Zugriff auf geteilte Fotos und Alben durch Passwoerter, Rollen oder Ablaufregeln eingeschraenkt wird.'
  UNION ALL SELECT 'photo-management', 'sharing_collaboration', 'external_sharing_platforms', 'External sharing platforms', 'Externe Teilen-Plattformen', 'multi_enum', 'informational', 'multi_select', 3050, 'Outbound channels supported for sharing photos to other services like social media or email.', 'Ausgehende Kanaele zum Teilen von Fotos an andere Dienste wie soziale Medien oder E-Mail.'
  UNION ALL SELECT 'photo-management', 'editing_enhancement', 'built_in_editor', 'Built-in editor', 'Integrierter Editor', 'boolean', 'informational', 'optional', 4010, 'Whether the platform includes an integrated photo editor without needing external software.', 'Ob die Plattform einen integrierten Foto-Editor enthaelt, ohne dass externe Software benoetigt wird.'
  UNION ALL SELECT 'photo-management', 'editing_enhancement', 'editing_capabilities', 'Editing capabilities', 'Bearbeitungsfunktionen', 'multi_enum', 'informational', 'multi_select', 4020, 'The categories of editing operations the built-in editor supports, from crop to non-destructive edits.', 'Die Kategorien von Bearbeitungsoperationen, die der integrierte Editor unterstuetzt, von Zuschnitt bis hin zu nicht-destruktiven Bearbeitungen.'
  UNION ALL SELECT 'photo-management', 'editing_enhancement', 'raw_format_support', 'RAW format support', 'RAW-Format-Unterstuetzung', 'boolean', 'informational', 'must_match', 4030, 'Whether the platform can ingest, render, and process camera RAW files end-to-end.', 'Ob die Plattform Kamera-RAW-Dateien durchgaengig aufnehmen, darstellen und verarbeiten kann.'
  UNION ALL SELECT 'photo-management', 'editing_enhancement', 'ai_enhancement', 'AI enhancement features', 'KI-Verbesserungsfunktionen', 'boolean', 'informational', 'optional', 4040, 'Whether the tool offers AI-powered enhancement features such as upscaling, denoising, or auto-fix.', 'Ob das Werkzeug KI-gestuetzte Verbesserungsfunktionen wie Hochskalierung, Rauschunterdrueckung oder Auto-Korrektur bietet.'
  UNION ALL SELECT 'photo-management', 'editing_enhancement', 'video_support', 'Video support', 'Video-Unterstuetzung', 'boolean', 'informational', 'optional', 4050, 'Whether the photo tool also stores, plays, and manages video clips alongside still images.', 'Ob das Foto-Werkzeug auch Videoclips neben Standbildern speichert, abspielt und verwaltet.'
  UNION ALL SELECT 'photo-management', 'platform_access', 'supported_platforms', 'Supported platforms', 'Unterstuetzte Plattformen', 'multi_enum', 'informational', 'multi_select', 5010, 'Operating systems and device types on which the photo tool has native applications.', 'Betriebssysteme und Geraetetypen, fuer die das Foto-Werkzeug native Anwendungen bietet.'
  UNION ALL SELECT 'photo-management', 'platform_access', 'web_access', 'Web access', 'Web-Zugriff', 'boolean', 'beneficial', 'optional', 5020, 'Whether the photo library can be browsed and managed entirely through a web browser.', 'Ob die Fotobibliothek vollstaendig ueber einen Webbrowser durchsucht und verwaltet werden kann.'
  UNION ALL SELECT 'photo-management', 'platform_access', 'offline_access', 'Offline access', 'Offline-Zugriff', 'boolean', 'beneficial', 'optional', 5030, 'Whether photos can be viewed and worked with while the device has no network connection.', 'Ob Fotos angesehen und bearbeitet werden koennen, waehrend das Geraet keine Netzwerkverbindung hat.'
  UNION ALL SELECT 'photo-management', 'platform_access', 'api_available', 'API available', 'API verfuegbar', 'boolean', 'beneficial', 'optional', 5040, 'Whether the platform exposes a public API for automation, scripting, and external integrations.', 'Ob die Plattform eine oeffentliche API fuer Automatisierung, Skripting und externe Integrationen bereitstellt.'
  UNION ALL SELECT 'photo-management', 'platform_access', 'third_party_integrations', 'Third-party integrations', 'Drittanbieter-Integrationen', 'multi_enum', 'informational', 'multi_select', 5050, 'Which external storage systems and protocols the tool integrates with for sync or backup.', 'Mit welchen externen Speichersystemen und Protokollen sich das Werkzeug fuer Synchronisation oder Backup verbindet.'
  ...
  UNION ALL SELECT 'photo-management', 'privacy_data', 'encryption_model', 'Encryption model', 'Verschluesselungsmodell', 'enum', 'tradeoff', 'optional', 6020, 'The encryption guarantees protecting photos from unauthorized access in transit and at rest.', 'Die Verschluesselungsgarantien, die Fotos vor unbefugtem Zugriff bei der Uebertragung und Speicherung schuetzen.'
  ...
  UNION ALL SELECT 'photo-management', 'privacy_data', 'data_export_available', 'Data export available', 'Datenexport verfuegbar', 'boolean', 'beneficial', 'optional', 6060, 'Whether users can export their full library, including originals and metadata, in standard formats.', 'Ob Nutzer ihre vollstaendige Bibliothek, einschliesslich Originale und Metadaten, in Standardformaten exportieren koennen.'
  UNION ALL SELECT 'photo-management', 'openness_standards', 'source_code_model', 'Source code model', 'Quellcode-Modell', 'enum', 'tradeoff', 'optional', 7010, 'The openness of the underlying source code, from fully open to closed proprietary releases.', 'Die Offenheit des zugrundeliegenden Quellcodes, von vollstaendig offen bis hin zu geschlossenen proprietaeren Versionen.'
  UNION ALL SELECT 'photo-management', 'openness_standards', 'license_type', 'License type', 'Lizenztyp', 'enum', 'informational', 'optional', 7020, 'The software license that governs redistribution and modification of the photo tool.', 'Die Softwarelizenz, die die Weitergabe und Aenderung des Foto-Werkzeugs regelt.'
  UNION ALL SELECT 'photo-management', 'openness_standards', 'self_hosting_available', 'Self-hosting available', 'Selbsthosting verfuegbar', 'boolean', 'beneficial', 'must_match', 7030, 'Whether the photo platform can be installed and operated on user-controlled infrastructure.', 'Ob die Foto-Plattform auf nutzergesteuerter Infrastruktur installiert und betrieben werden kann.'
  UNION ALL SELECT 'photo-management', 'openness_standards', 'photo_format_support', 'Photo format support', 'Foto-Format-Unterstuetzung', 'multi_enum', 'informational', 'multi_select', 7040, 'Which image file formats the tool accepts for upload and displays without conversion.', 'Welche Bilddatei-Formate das Werkzeug zum Hochladen akzeptiert und ohne Konvertierung anzeigt.'
  UNION ALL SELECT 'photo-management', 'openness_standards', 'export_format_options', 'Export format options', 'Export-Formatoptionen', 'multi_enum', 'informational', 'multi_select', 7050, 'The output formats and bundle structures available when exporting the library or albums.', 'Die Ausgabeformate und Paketstrukturen, die beim Exportieren der Bibliothek oder von Alben verfuegbar sind.'
  UNION ALL SELECT 'photo-management', 'pricing_fit', 'pricing_model', 'Pricing model', 'Preismodell', 'enum', 'informational', 'optional', 8010, 'The cost structure of the photo tool, from free to subscription to one-time purchase.', 'Die Kostenstruktur des Foto-Werkzeugs, von kostenlos ueber Abonnement bis zum Einmalkauf.'
  UNION ALL SELECT 'photo-management', 'pricing_fit', 'free_tier_available', 'Free tier available', 'Kostenlose Stufe verfuegbar', 'boolean', 'informational', 'must_match', 8020, 'Whether the photo tool offers a non-trial free tier usable for everyday photo management.', 'Ob das Foto-Werkzeug eine dauerhaft kostenlose Stufe bietet, die fuer die taegliche Foto-Verwaltung nutzbar ist.'
  UNION ALL SELECT 'photo-management', 'pricing_fit', 'free_tier_limitations', 'Free tier limitations', 'Einschraenkungen der kostenlosen Stufe', 'multi_enum', 'tradeoff', 'multi_select', 8030, 'The restrictions imposed on the free tier compared to the paid versions of the photo tool.', 'Die Einschraenkungen, die fuer die kostenlose Stufe im Vergleich zu den kostenpflichtigen Versionen des Foto-Werkzeugs gelten.'
  UNION ALL SELECT 'photo-management', 'pricing_fit', 'fit_profiles', 'Fit profiles', 'Eignungsprofile', 'multi_enum', 'informational', 'multi_select', 8040, 'User profiles and use cases the photo tool is best matched to based on its overall feature set.', 'Nutzerprofile und Anwendungsfaelle, fuer die das Foto-Werkzeug aufgrund seines Gesamtfunktionsumfangs am besten geeignet ist.'
) AS d
...
FROM (
  ...
  UNION ALL SELECT 'photo-management', 'storage_type', 'local_device', 'Local device', 'Lokales Geraet', 'neutral', 40
  ...
  UNION ALL SELECT 'photo-management', 'access_control_model', 'password_protected', 'Password-protected', 'Passwortgeschuetzt', 'neutral', 10
  ...
  UNION ALL SELECT 'photo-management', 'data_processing_location', 'eu_primary', 'EU primary', 'EU primaer', 'neutral', 20
  ...
  UNION ALL SELECT 'photo-management', 'encryption_model', 'in_transit_only', 'In-transit only', 'Nur bei Uebertragung', 'neutral', 30
  UNION ALL SELECT 'photo-management', 'encryption_model', 'none', 'None', 'Keine', 'warning', 40
  UNION ALL SELECT 'photo-management', 'face_recognition_privacy', 'on_device', 'On-device', 'Auf dem Geraet', 'positive', 10
  ...
  UNION ALL SELECT 'photo-management', 'face_recognition_privacy', 'not_available', 'Not available', 'Nicht verfuegbar', 'neutral', 40
  UNION ALL SELECT 'photo-management', 'source_code_model', 'fully_open', 'Fully open', 'Vollstaendig offen', 'positive', 10
  UNION ALL SELECT 'photo-management', 'source_code_model', 'source_available', 'Source available', 'Quellcode verfuegbar', 'neutral', 20
  UNION ALL SELECT 'photo-management', 'source_code_model', 'partially_open', 'Partially open', 'Teilweise offen', 'neutral', 30
  UNION ALL SELECT 'photo-management', 'source_code_model', 'proprietary', 'Proprietary', 'Proprietaer', 'warning', 40
  ...
  UNION ALL SELECT 'photo-management', 'license_type', 'proprietary', 'Proprietary license', 'Proprietaere Lizenz', 'neutral', 60
