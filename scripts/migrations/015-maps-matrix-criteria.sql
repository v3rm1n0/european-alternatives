...
VALUES
  ...
  ('maps', 'routing_navigation', 'Routing & Navigation', 'Routing & Navigation', 'Turn-by-turn support, route modes, traffic, transit, route controls, and guidance features.', 'Schrittweise Navigation, Routenmodi, Verkehr, ÖPNV, Routensteuerung und Navigationshinweise.', 200),
  ...
  ('maps', 'places_discovery', 'Places & Local Discovery', 'Orte & lokale Suche', 'Place search, details, reviews, business listings, commerce hooks, and indoor maps.', 'Ortssuche, Details, Bewertungen, Unternehmenseinträge, Commerce-Anbindungen und Innenraumkarten.', 500),
  ('maps', 'transport_mobility', 'Transport & Mobility', 'Verkehr & Mobilität', 'Public transit, mobility services, EV routing, cycling, walking, hiking, and professional routing.', 'Öffentlicher Verkehr, Mobilitätsdienste, EV-Routing, Radfahren, Fußwege, Wandern und professionelles Routing.', 600),
  ('maps', 'platforms_accessibility', 'Platforms & Accessibility', 'Plattformen & Barrierefreiheit', 'Device support, app distribution, vehicle integrations, accessibility, and voice/language support.', 'Geräteunterstützung, App-Verteilung, Fahrzeugintegration, Barrierefreiheit und Sprachunterstützung.', 700),
  ('maps', 'customization_portability', 'Customization & Portability', 'Anpassung & Portabilität', 'Saved places, custom maps, import/export, route/list sharing, and personal data export.', 'Gespeicherte Orte, eigene Karten, Import/Export, Teilen von Routen/Listen und Export persönlicher Daten.', 800),
...
FROM (
  ...
  UNION ALL SELECT 'maps', 'map_data_coverage', 'map_update_model', 'Map update model', 'Kartenaktualisierungsmodell', 'enum', 'informational', 'optional', 1050, 'How map data updates are delivered, reviewed, imported, or packaged.', 'Wie Kartendaten-Aktualisierungen bereitgestellt, geprüft, importiert oder paketiert werden.'
  UNION ALL SELECT 'maps', 'map_data_coverage', 'map_layers_available', 'Map layers available', 'Kartenebenen verfügbar', 'multi_enum', 'informational', 'multi_select', 1060, 'Documented map layers such as standard, satellite, terrain, transit, cycling, or traffic.', 'Dokumentierte Kartenebenen wie Standard, Satellit, Gelände, ÖPNV, Fahrrad oder Verkehr.'
  UNION ALL SELECT 'maps', 'routing_navigation', 'turn_by_turn_navigation', 'Turn-by-turn navigation', 'Schrittweise Navigation', 'boolean', 'beneficial', 'must_match', 2010, 'Whether the product provides turn-by-turn navigation for at least one travel mode.', 'Ob das Produkt schrittweise Navigation für mindestens einen Reisemodus bereitstellt.'
  UNION ALL SELECT 'maps', 'routing_navigation', 'routing_modes', 'Routing modes', 'Routing-Modi', 'multi_enum', 'beneficial', 'multi_select', 2020, 'Travel modes with documented route planning or navigation support.', 'Reisemodi mit dokumentierter Routenplanung oder Navigationsunterstützung.'
  UNION ALL SELECT 'maps', 'routing_navigation', 'live_traffic_routing', 'Live traffic routing', 'Routing mit Echtzeitverkehr', 'boolean', 'beneficial', 'optional', 2030, 'Whether routing can use live traffic or current road conditions.', 'Ob Routing Echtzeitverkehr oder aktuelle Straßenbedingungen nutzen kann.'
  UNION ALL SELECT 'maps', 'routing_navigation', 'public_transit_routing_model', 'Public transit routing model', 'ÖPNV-Routingmodell', 'enum', 'informational', 'optional', 2040, 'The documented level of public transit routing support and real-time data.', 'Der dokumentierte Umfang der ÖPNV-Routing-Unterstützung und Echtzeitdaten.'
  UNION ALL SELECT 'maps', 'routing_navigation', 'route_optimization_features', 'Route optimization features', 'Routenoptimierungsfunktionen', 'multi_enum', 'beneficial', 'multi_select', 2050, 'Route controls and optimization options available during trip planning.', 'Routensteuerungen und Optimierungsoptionen, die bei der Reiseplanung verfügbar sind.'
  UNION ALL SELECT 'maps', 'routing_navigation', 'guidance_features', 'Guidance features', 'Navigationshinweise', 'multi_enum', 'beneficial', 'multi_select', 2060, 'Navigation guidance features documented for active trips.', 'Dokumentierte Navigationshinweise für aktive Fahrten.'
  ...
  UNION ALL SELECT 'maps', 'offline_resilience', 'offline_maps_available', 'Offline maps available', 'Offline-Karten verfügbar', 'boolean', 'beneficial', 'must_match', 3010, 'Whether map areas can be downloaded or used without an active network connection.', 'Ob Kartengebiete ohne aktive Netzwerkverbindung heruntergeladen oder genutzt werden können.'
  UNION ALL SELECT 'maps', 'offline_resilience', 'offline_routing_available', 'Offline routing available', 'Offline-Routing verfügbar', 'boolean', 'beneficial', 'optional', 3020, 'Whether route planning or navigation works with downloaded data while offline.', 'Ob Routenplanung oder Navigation mit heruntergeladenen Daten offline funktioniert.'
  UNION ALL SELECT 'maps', 'offline_resilience', 'offline_search_available', 'Offline search available', 'Offline-Suche verfügbar', 'boolean', 'beneficial', 'optional', 3030, 'Whether address or place search is documented for offline map data.', 'Ob Adress- oder Ortssuche für Offline-Kartendaten dokumentiert ist.'
  UNION ALL SELECT 'maps', 'offline_resilience', 'offline_download_model', 'Offline download model', 'Offline-Downloadmodell', 'enum', 'tradeoff', 'optional', 3040, 'How users select, receive, or cache offline map data.', 'Wie Nutzer Offline-Kartendaten auswählen, erhalten oder zwischenspeichern.'
  ...
  UNION ALL SELECT 'maps', 'offline_resilience', 'low_connectivity_mode', 'Low-connectivity mode', 'Modus für schlechte Verbindung', 'boolean', 'informational', 'optional', 3060, 'Whether the product documents behavior optimized for weak or intermittent connections.', 'Ob das Produkt Verhalten für schwache oder unterbrochene Verbindungen dokumentiert.'
  UNION ALL SELECT 'maps', 'privacy_location', 'account_required_for_navigation', 'Account required for navigation', 'Konto für Navigation erforderlich', 'boolean', 'risk', 'must_match', 4010, 'Whether using navigation requires signing in to an account.', 'Ob die Nutzung der Navigation eine Anmeldung mit einem Konto erfordert.'
  ...
  UNION ALL SELECT 'maps', 'privacy_location', 'location_data_retention', 'Location data retention', 'Speicherdauer für Standortdaten', 'enum', 'risk', 'optional', 4030, 'The documented retention model for location data or navigation activity.', 'Das dokumentierte Aufbewahrungsmodell für Standortdaten oder Navigationsaktivitäten.'
  UNION ALL SELECT 'maps', 'privacy_location', 'third_party_tracking_on_map', 'Third-party tracking on map', 'Drittanbieter-Tracking auf Karten', 'boolean', 'risk', 'optional', 4040, 'Whether third-party tracking, advertising, or analytics is documented in map surfaces.', 'Ob Drittanbieter-Tracking, Werbung oder Analyse in Kartenoberflächen dokumentiert ist.'
  UNION ALL SELECT 'maps', 'privacy_location', 'live_location_sharing', 'Live location sharing', 'Live-Standortfreigabe', 'boolean', 'tradeoff', 'optional', 4050, 'Whether users can share their live location with other people.', 'Ob Nutzer ihren Live-Standort mit anderen Personen teilen können.'
  UNION ALL SELECT 'maps', 'privacy_location', 'personalization_ads_model', 'Personalization/ads model', 'Personalisierungs-/Anzeigenmodell', 'enum', 'tradeoff', 'optional', 4060, 'How personalization, recommendations, promotions, or ads are documented for the map product.', 'Wie Personalisierung, Empfehlungen, Werbung oder Anzeigen für das Kartenprodukt dokumentiert sind.'
  UNION ALL SELECT 'maps', 'places_discovery', 'place_search_available', 'Place search available', 'Ortssuche verfügbar', 'boolean', 'beneficial', 'optional', 5010, 'Whether the product supports searching for places or local businesses.', 'Ob das Produkt die Suche nach Orten oder lokalen Unternehmen unterstützt.'
  UNION ALL SELECT 'maps', 'places_discovery', 'place_detail_fields', 'Place detail fields', 'Detailfelder für Orte', 'multi_enum', 'informational', 'multi_select', 5020, 'Documented details available on place pages or local search results.', 'Dokumentierte Details auf Ortsseiten oder in lokalen Suchergebnissen.'
  ...
  UNION ALL SELECT 'maps', 'places_discovery', 'business_listing_management', 'Business listing management', 'Verwaltung von Unternehmenseinträgen', 'enum', 'tradeoff', 'optional', 5040, 'How businesses can claim, update, or feed listing data.', 'Wie Unternehmen Einträge beanspruchen, aktualisieren oder per Feed bereitstellen können.'
  ...
  UNION ALL SELECT 'maps', 'places_discovery', 'indoor_maps_available', 'Indoor maps available', 'Innenraumkarten verfügbar', 'boolean', 'informational', 'optional', 5060, 'Whether indoor venue maps or floor-level maps are documented.', 'Ob Innenraumkarten oder etagenbezogene Karten dokumentiert sind.'
  UNION ALL SELECT 'maps', 'transport_mobility', 'realtime_transit_available', 'Real-time transit available', 'Echtzeit-ÖPNV verfügbar', 'boolean', 'beneficial', 'optional', 6010, 'Whether public transit information includes documented real-time departures or disruptions.', 'Ob ÖPNV-Informationen dokumentierte Echtzeit-Abfahrten oder Störungen enthalten.'
  UNION ALL SELECT 'maps', 'transport_mobility', 'supported_mobility_services', 'Supported mobility services', 'Unterstützte Mobilitätsdienste', 'multi_enum', 'informational', 'multi_select', 6020, 'Mobility services integrated into routing, search, or map views.', 'Mobilitätsdienste, die in Routing, Suche oder Kartenansichten integriert sind.'
  UNION ALL SELECT 'maps', 'transport_mobility', 'ev_routing_charging_features', 'EV routing/charging features', 'EV-Routing-/Ladefunktionen', 'multi_enum', 'beneficial', 'multi_select', 6030, 'Electric-vehicle routing, charger search, availability, or charging stop features.', 'Funktionen für EV-Routing, Ladesäulensuche, Verfügbarkeit oder Ladestopps.'
  UNION ALL SELECT 'maps', 'transport_mobility', 'cycling_features', 'Cycling features', 'Fahrradfunktionen', 'multi_enum', 'beneficial', 'multi_select', 6040, 'Cycling-specific map, routing, safety, or elevation features.', 'Fahrradspezifische Karten-, Routing-, Sicherheits- oder Höhenfunktionen.'
  UNION ALL SELECT 'maps', 'transport_mobility', 'walking_hiking_features', 'Walking/hiking features', 'Fuß-/Wanderfunktionen', 'multi_enum', 'beneficial', 'multi_select', 6050, 'Walking, hiking, trail, elevation, or step-free route features.', 'Fußweg-, Wander-, Pfad-, Höhen- oder stufenfreie Routenfunktionen.'
  UNION ALL SELECT 'maps', 'transport_mobility', 'truck_or_professional_routing', 'Truck/professional routing', 'Lkw-/Profi-Routing', 'multi_enum', 'informational', 'multi_select', 6060, 'Professional routing capabilities for trucks, fleets, deliveries, tolls, or restrictions.', 'Professionelle Routing-Funktionen für Lkw, Flotten, Lieferungen, Maut oder Beschränkungen.'
  UNION ALL SELECT 'maps', 'platforms_accessibility', 'supported_platforms', 'Supported platforms', 'Unterstützte Plattformen', 'multi_enum', 'informational', 'multi_select', 7010, 'Platforms where the product documents app, web, or navigation support.', 'Plattformen, auf denen das Produkt App-, Web- oder Navigationsunterstützung dokumentiert.'
  UNION ALL SELECT 'maps', 'platforms_accessibility', 'mobile_app_distribution', 'Mobile app distribution', 'Mobile App-Verteilung', 'multi_enum', 'informational', 'multi_select', 7020, 'Distribution channels documented for mobile apps or installable packages.', 'Dokumentierte Vertriebskanäle für mobile Apps oder installierbare Pakete.'
  ...
  UNION ALL SELECT 'maps', 'platforms_accessibility', 'accessibility_features', 'Accessibility features', 'Barrierefreiheitsfunktionen', 'multi_enum', 'beneficial', 'multi_select', 7040, 'Accessibility features documented for map use, routing, or navigation.', 'Dokumentierte Barrierefreiheitsfunktionen für Kartennutzung, Routing oder Navigation.'
  UNION ALL SELECT 'maps', 'platforms_accessibility', 'voice_language_support', 'Voice/language support', 'Sprach-/Stimmenunterstützung', 'multi_enum', 'informational', 'multi_select', 7050, 'Voice guidance, speech, localization, or language support documented for navigation.', 'Dokumentierte Sprachführung, Sprachausgabe, Lokalisierung oder Sprachunterstützung für Navigation.'
  UNION ALL SELECT 'maps', 'customization_portability', 'saved_places_lists', 'Saved places/lists', 'Gespeicherte Orte/Listen', 'boolean', 'beneficial', 'optional', 8010, 'Whether users can save places, favorites, collections, or lists.', 'Ob Nutzer Orte, Favoriten, Sammlungen oder Listen speichern können.'
  ...
  UNION ALL SELECT 'maps', 'customization_portability', 'import_export_formats', 'Import/export formats', 'Import-/Exportformate', 'multi_enum', 'beneficial', 'multi_select', 8030, 'Documented geospatial, route, favorite, or place import and export formats.', 'Dokumentierte Geodaten-, Routen-, Favoriten- oder Ortsformate für Import und Export.'
  UNION ALL SELECT 'maps', 'customization_portability', 'sharing_collaboration_features', 'Sharing/collaboration features', 'Teilen-/Zusammenarbeitsfunktionen', 'multi_enum', 'informational', 'multi_select', 8040, 'Ways to share routes, locations, lists, public maps, or embedded map views.', 'Möglichkeiten zum Teilen von Routen, Standorten, Listen, öffentlichen Karten oder eingebetteten Kartenansichten.'
  UNION ALL SELECT 'maps', 'customization_portability', 'data_export_available', 'Data export available', 'Datenexport verfügbar', 'boolean', 'beneficial', 'optional', 8050, 'Whether users can export personal map data, saved places, or account map activity.', 'Ob Nutzer persönliche Kartendaten, gespeicherte Orte oder Konto-Kartenaktivitäten exportieren können.'
  UNION ALL SELECT 'maps', 'openness_operations', 'contribution_editing_model', 'Contribution/editing model', 'Beitrags-/Bearbeitungsmodell', 'enum', 'tradeoff', 'optional', 9010, 'How users can contribute map edits, corrections, feedback, or community changes.', 'Wie Nutzer Kartenbearbeitungen, Korrekturen, Feedback oder Community-Änderungen beitragen können.'
  UNION ALL SELECT 'maps', 'openness_operations', 'self_hosting_or_local_server', 'Self-hosting/local server', 'Selbsthosting/lokaler Server', 'boolean', 'tradeoff', 'optional', 9020, 'Whether the map stack, tiles, routing, or local server can be operated by the user or organization.', 'Ob Kartenstack, Kacheln, Routing oder lokaler Server durch Nutzer oder Organisation betrieben werden können.'
  UNION ALL SELECT 'maps', 'openness_operations', 'map_tile_api_embedding', 'Map tile API/embedding', 'Kartenkachel-API/Einbettung', 'enum', 'tradeoff', 'optional', 9030, 'The documented embedding, SDK, tile, geocoding, routing, or self-hosted tile model.', 'Das dokumentierte Modell für Einbettung, SDK, Kacheln, Geocoding, Routing oder selbstgehostete Kacheln.'
  UNION ALL SELECT 'maps', 'openness_operations', 'open_data_attribution_visible', 'Data attribution visible', 'Datenquellen-Hinweis sichtbar', 'boolean', 'informational', 'optional', 9040, 'Whether the map UI visibly documents data attribution or source credits.', 'Ob die Kartenoberfläche Datenquellen oder Quellenhinweise sichtbar dokumentiert.'
  UNION ALL SELECT 'maps', 'openness_operations', 'fit_profiles', 'Fit profiles', 'Eignungsprofile', 'multi_enum', 'informational', 'multi_select', 9050, 'Common user profiles or use cases the map product is well suited for.', 'Typische Nutzerprofile oder Anwendungsfälle, für die das Kartenprodukt gut geeignet ist.'
) AS d
...
FROM (
  ...
  UNION ALL SELECT 'maps', 'map_data_source_model', 'proprietary_provider', 'Proprietary provider', 'Proprietärer Anbieter', 'warning', 20
  ...
  UNION ALL SELECT 'maps', 'map_data_source_model', 'community_contributed', 'Community contributed', 'Community-Beiträge', 'tradeoff', 50
  ...
  UNION ALL SELECT 'maps', 'geographic_coverage_scope', 'country_specific', 'Country specific', 'Länderspezifisch', 'neutral', 30
  ...
  UNION ALL SELECT 'maps', 'poi_database_features', 'opening_hours', 'Opening hours', 'Öffnungszeiten', 'positive', 20
  ...
  UNION ALL SELECT 'maps', 'map_layers_available', 'terrain', 'Terrain', 'Gelände', 'positive', 30
  UNION ALL SELECT 'maps', 'map_layers_available', 'public_transport', 'Public transport', 'Öffentlicher Verkehr', 'positive', 40
  ...
  UNION ALL SELECT 'maps', 'routing_modes', 'walking', 'Walking', 'Fußweg', 'positive', 20
  UNION ALL SELECT 'maps', 'routing_modes', 'cycling', 'Cycling', 'Fahrrad', 'positive', 30
  UNION ALL SELECT 'maps', 'routing_modes', 'public_transit', 'Public transit', 'ÖPNV', 'positive', 40
  ...
  UNION ALL SELECT 'maps', 'public_transit_routing_model', 'static_schedules', 'Static schedules', 'Statische Fahrpläne', 'neutral', 20
  ...
  UNION ALL SELECT 'maps', 'route_optimization_features', 'avoid_ferries', 'Avoid ferries', 'Fähren vermeiden', 'neutral', 50
  ...
  UNION ALL SELECT 'maps', 'guidance_features', 'voice_guidance', 'Voice guidance', 'Sprachführung', 'positive', 10
  ...
  UNION ALL SELECT 'maps', 'offline_download_model', 'user_selected_areas', 'User-selected areas', 'Nutzergewählte Gebiete', 'positive', 30
  ...
  UNION ALL SELECT 'maps', 'offline_update_controls', 'auto_updates_wifi', 'Auto updates on Wi-Fi', 'Auto-Updates über WLAN', 'positive', 20
  ...
  UNION ALL SELECT 'maps', 'location_history_model', 'default_on_cloud', 'Default-on cloud', 'Cloud standardmäßig aktiv', 'warning', 40
  UNION ALL SELECT 'maps', 'location_history_model', 'account_required_history', 'Account-required history', 'Konto für Verlauf erforderlich', 'tradeoff', 50
  ...
  UNION ALL SELECT 'maps', 'location_data_retention', 'retained_for_service', 'Retained for service', 'Für Dienst gespeichert', 'tradeoff', 40
  UNION ALL SELECT 'maps', 'location_data_retention', 'retained_for_ads', 'Retained for ads', 'Für Werbung gespeichert', 'warning', 50
  ...
  UNION ALL SELECT 'maps', 'place_detail_fields', 'opening_hours', 'Opening hours', 'Öffnungszeiten', 'positive', 10
  ...
  UNION ALL SELECT 'maps', 'place_detail_fields', 'business_claims', 'Business claims', 'Unternehmensansprüche', 'tradeoff', 60
  ...
  UNION ALL SELECT 'maps', 'supported_mobility_services', 'public_transport', 'Public transport', 'ÖPNV', 'positive', 10
  ...
  UNION ALL SELECT 'maps', 'ev_routing_charging_features', 'live_availability', 'Live availability', 'Live-Verfügbarkeit', 'positive', 30
  ...
  UNION ALL SELECT 'maps', 'cycling_features', 'surface_quality', 'Surface quality', 'Oberflächenqualität', 'positive', 30
  UNION ALL SELECT 'maps', 'cycling_features', 'elevation_profile', 'Elevation profile', 'Höhenprofil', 'positive', 40
  ...
  UNION ALL SELECT 'maps', 'walking_hiking_features', 'footpaths', 'Footpaths', 'Fußwege', 'positive', 10
  UNION ALL SELECT 'maps', 'walking_hiking_features', 'trails', 'Trails', 'Pfade', 'positive', 20
  UNION ALL SELECT 'maps', 'walking_hiking_features', 'elevation_profile', 'Elevation profile', 'Höhenprofil', 'positive', 30
  ...
  UNION ALL SELECT 'maps', 'truck_or_professional_routing', 'height_weight_restrictions', 'Height/weight restrictions', 'Höhen-/Gewichtsbeschränkungen', 'positive', 10
  ...
  UNION ALL SELECT 'maps', 'voice_language_support', 'voice_guidance', 'Voice guidance', 'Sprachführung', 'positive', 10
  ...
  UNION ALL SELECT 'maps', 'voice_language_support', 'street_name_announcements', 'Street-name announcements', 'Straßennamen-Ansagen', 'neutral', 30
  ...
  UNION ALL SELECT 'maps', 'sharing_collaboration_features', 'public_maps', 'Public maps', 'Öffentliche Karten', 'tradeoff', 40
  ...
  UNION ALL SELECT 'maps', 'fit_profiles', 'transit_commuters', 'Transit commuters', 'ÖPNV-Pendler', 'neutral', 40
  UNION ALL SELECT 'maps', 'fit_profiles', 'cyclists_walkers', 'Cyclists/walkers', 'Radfahrer/Fußgänger', 'positive', 50
