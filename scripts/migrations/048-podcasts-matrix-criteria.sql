...
VALUES
  ('podcasts', 'content_access', 'Content Access & Discovery', 'Inhaltszugang & Entdeckung', 'How users find, subscribe to, and access podcast content through feeds, directories, and import/export capabilities.', 'Wie Benutzer Podcast-Inhalte über Feeds, Verzeichnisse und Import-/Exportfunktionen finden, abonnieren und darauf zugreifen.', 100),
  ('podcasts', 'playback_listening', 'Playback & Listening', 'Wiedergabe & Hören', 'Audio playback features for podcast listeners including speed control, downloads, timers, and transcript support.', 'Audio-Wiedergabefunktionen für Podcast-Hörer einschließlich Geschwindigkeitssteuerung, Downloads, Timer und Transkript-Unterstützung.', 200),
  ('podcasts', 'hosting_publishing', 'Hosting & Publishing', 'Hosting & Veröffentlichung', 'Features for podcast creators to host, distribute, and manage their show files, feeds, and analytics.', 'Funktionen für Podcast-Ersteller zum Hosten, Verteilen und Verwalten ihrer Sendungsdateien, Feeds und Analysen.', 300),
  ('podcasts', 'monetization_creator', 'Monetization & Creator Tools', 'Monetarisierung & Creator-Werkzeuge', 'Revenue generation and audience engagement tools available to podcast creators and publishers.', 'Einnahmegenerierung und Publikumsbindungswerkzeuge für Podcast-Ersteller und Herausgeber.', 400),
  ('podcasts', 'platform_apps', 'Platform & Apps', 'Plattform & Apps', 'Operating systems, devices, and platform integrations where the podcast tool is available.', 'Betriebssysteme, Geräte und Plattformintegrationen, auf denen das Podcast-Werkzeug verfügbar ist.', 500),
  ...
  ('podcasts', 'openness_standards', 'Openness & Standards', 'Offenheit & Standards', 'Source code availability, licensing, and adherence to open podcasting standards and protocols.', 'Quellcode-Verfügbarkeit, Lizenzierung und Einhaltung offener Podcasting-Standards und Protokolle.', 700),
  ('podcasts', 'pricing_fit', 'Pricing & Fit', 'Preise & Eignung', 'Cost structure, free tier availability, and target user profiles for the podcast tool.', 'Kostenstruktur, Verfügbarkeit kostenloser Versionen und Zielbenutzerprofile für das Podcast-Werkzeug.', 800);
...
FROM (
  SELECT 'podcasts' AS category_id, 'content_access' AS group_key, 'feed_protocol_support' AS criterion_key, 'Feed protocol support' AS label_en, 'Feed-Protokoll-Unterstützung' AS label_de, 'multi_enum' AS value_type, 'informational' AS semantics, 'multi_select' AS filter_mode, 1010 AS sort_order, 'The feed protocols supported for subscribing to and receiving podcast episode updates.' AS help_text_en, 'Die unterstützten Feed-Protokolle zum Abonnieren und Empfangen von Podcast-Episoden-Updates.' AS help_text_de
  UNION ALL SELECT 'podcasts', 'content_access', 'directory_integration', 'Podcast directory integration', 'Podcast-Verzeichnisintegration', 'multi_enum', 'informational', 'multi_select', 1020, 'Which podcast directories and indexes are integrated for discovering and subscribing to shows.', 'Welche Podcast-Verzeichnisse und Indizes für das Entdecken und Abonnieren von Sendungen integriert sind.'
  ...
  UNION ALL SELECT 'podcasts', 'content_access', 'exclusive_content_model', 'Exclusive content model', 'Exklusivinhalt-Modell', 'enum', 'tradeoff', 'optional', 1040, 'Whether the platform locks content behind its own ecosystem or keeps all shows available via open feeds.', 'Ob die Plattform Inhalte hinter ihrem eigenen Ökosystem sperrt oder alle Sendungen über offene Feeds verfügbar hält.'
  UNION ALL SELECT 'podcasts', 'content_access', 'opml_import_export', 'OPML import/export', 'OPML-Import/Export', 'boolean', 'beneficial', 'optional', 1050, 'Whether podcast subscriptions can be imported and exported via OPML files for portability between apps.', 'Ob Podcast-Abonnements über OPML-Dateien für die Portabilität zwischen Apps importiert und exportiert werden können.'
  UNION ALL SELECT 'podcasts', 'content_access', 'chapter_support', 'Chapter support', 'Kapitel-Unterstützung', 'boolean', 'informational', 'optional', 1060, 'Whether the player or platform supports in-episode chapter markers for navigation within episodes.', 'Ob der Player oder die Plattform In-Episoden-Kapitelmarker für die Navigation innerhalb von Episoden unterstützt.'
  UNION ALL SELECT 'podcasts', 'playback_listening', 'variable_playback_speed', 'Variable playback speed', 'Variable Wiedergabegeschwindigkeit', 'boolean', 'beneficial', 'optional', 2010, 'Whether the player supports adjusting audio playback speed for faster or slower listening.', 'Ob der Player die Anpassung der Audio-Wiedergabegeschwindigkeit für schnelleres oder langsameres Hören unterstützt.'
  UNION ALL SELECT 'podcasts', 'playback_listening', 'offline_download', 'Offline download', 'Offline-Download', 'boolean', 'beneficial', 'must_match', 2020, 'Whether episodes can be downloaded for offline listening without an active internet connection.', 'Ob Episoden zum Offline-Hören ohne aktive Internetverbindung heruntergeladen werden können.'
  UNION ALL SELECT 'podcasts', 'playback_listening', 'sleep_timer', 'Sleep timer', 'Schlaftimer', 'boolean', 'informational', 'optional', 2030, 'Whether the player includes a sleep timer that automatically pauses playback after a set duration.', 'Ob der Player einen Schlaftimer enthält, der die Wiedergabe nach einer festgelegten Dauer automatisch pausiert.'
  UNION ALL SELECT 'podcasts', 'playback_listening', 'queue_management', 'Queue management', 'Warteschlangenverwaltung', 'enum', 'informational', 'optional', 2040, 'The level of control users have over their episode playback queue and ordering.', 'Das Kontrollniveau, das Benutzer über ihre Episoden-Wiedergabewarteschlange und -reihenfolge haben.'
  UNION ALL SELECT 'podcasts', 'playback_listening', 'transcript_support', 'Transcript support', 'Transkript-Unterstützung', 'enum', 'informational', 'optional', 2050, 'Whether the platform supports episode transcripts and how they are generated or provided.', 'Ob die Plattform Episoden-Transkripte unterstützt und wie diese generiert oder bereitgestellt werden.'
  UNION ALL SELECT 'podcasts', 'playback_listening', 'silence_trimming', 'Silence trimming/skip', 'Stille-Kürzung/Übersprung', 'boolean', 'informational', 'optional', 2060, 'Whether the player can automatically detect and skip or shorten silent passages in episodes.', 'Ob der Player stille Passagen in Episoden automatisch erkennen und überspringen oder verkürzen kann.'
  UNION ALL SELECT 'podcasts', 'hosting_publishing', 'hosting_type', 'Hosting type', 'Hosting-Typ', 'enum', 'informational', 'must_match', 3010, 'The type of podcast hosting service provided, from full media hosting to feed-only management.', 'Die Art des bereitgestellten Podcast-Hosting-Dienstes, von vollständigem Medienhosting bis zur reinen Feed-Verwaltung.'
  UNION ALL SELECT 'podcasts', 'hosting_publishing', 'storage_model', 'Storage model', 'Speichermodell', 'enum', 'tradeoff', 'optional', 3020, 'How storage space for podcast media files is allocated and limited on the hosting platform.', 'Wie Speicherplatz für Podcast-Mediendateien auf der Hosting-Plattform zugeteilt und begrenzt wird.'
  UNION ALL SELECT 'podcasts', 'hosting_publishing', 'rss_feed_ownership', 'RSS feed ownership', 'RSS-Feed-Eigentümerschaft', 'boolean', 'beneficial', 'optional', 3030, 'Whether the podcast creator retains full ownership and control over their RSS feed URL.', 'Ob der Podcast-Ersteller die volle Eigentumsrechte und Kontrolle über seine RSS-Feed-URL behält.'
  UNION ALL SELECT 'podcasts', 'hosting_publishing', 'distribution_directories', 'Distribution to directories', 'Verteilung an Verzeichnisse', 'multi_enum', 'informational', 'multi_select', 3040, 'Which major podcast directories the hosting platform can automatically submit and distribute shows to.', 'An welche großen Podcast-Verzeichnisse die Hosting-Plattform Sendungen automatisch übermitteln und verteilen kann.'
  UNION ALL SELECT 'podcasts', 'hosting_publishing', 'custom_domain_support', 'Custom domain support', 'Benutzerdefinierte-Domain-Unterstützung', 'boolean', 'informational', 'optional', 3050, 'Whether the hosting platform allows podcasters to use their own custom domain for their podcast page.', 'Ob die Hosting-Plattform Podcastern erlaubt, ihre eigene benutzerdefinierte Domain für ihre Podcast-Seite zu verwenden.'
  UNION ALL SELECT 'podcasts', 'hosting_publishing', 'analytics_dashboard', 'Analytics dashboard', 'Analyse-Dashboard', 'boolean', 'informational', 'optional', 3060, 'Whether the platform provides a dashboard with listener statistics and episode performance metrics.', 'Ob die Plattform ein Dashboard mit Hörerstatistiken und Episoden-Leistungskennzahlen bereitstellt.'
  UNION ALL SELECT 'podcasts', 'monetization_creator', 'monetization_model', 'Monetization model', 'Monetarisierungsmodell', 'multi_enum', 'informational', 'multi_select', 4010, 'The revenue generation methods available to podcast creators on the platform.', 'Die Einnahmegenerierungsmethoden, die Podcast-Erstellern auf der Plattform zur Verfügung stehen.'
  UNION ALL SELECT 'podcasts', 'monetization_creator', 'value_4_value_payments', 'Value 4 Value / Podcasting 2.0 payments', 'Value-4-Value / Podcasting-2.0-Zahlungen', 'boolean', 'informational', 'optional', 4020, 'Whether the platform supports Podcasting 2.0 Value 4 Value streaming payments via Bitcoin or Lightning.', 'Ob die Plattform Podcasting-2.0-Value-4-Value-Streaming-Zahlungen über Bitcoin oder Lightning unterstützt.'
  UNION ALL SELECT 'podcasts', 'monetization_creator', 'listener_engagement', 'Listener engagement features', 'Hörer-Engagement-Funktionen', 'multi_enum', 'informational', 'multi_select', 4030, 'Interactive features that allow listeners to engage with podcast creators beyond passive listening.', 'Interaktive Funktionen, die es Hörern ermöglichen, über passives Hören hinaus mit Podcast-Erstellern zu interagieren.'
  UNION ALL SELECT 'podcasts', 'monetization_creator', 'collaboration_tools', 'Collaboration tools', 'Zusammenarbeitswerkzeuge', 'boolean', 'informational', 'optional', 4040, 'Whether the platform provides tools for remote recording, multi-host production, or collaborative editing.', 'Ob die Plattform Werkzeuge für Fernaufnahme, Mehrfach-Host-Produktion oder gemeinschaftliche Bearbeitung bereitstellt.'
  ...
  UNION ALL SELECT 'podcasts', 'platform_apps', 'supported_platforms', 'Supported platforms', 'Unterstützte Plattformen', 'multi_enum', 'informational', 'multi_select', 5010, 'The operating systems and device platforms on which the podcast app or service is available.', 'Die Betriebssysteme und Geräteplattformen, auf denen die Podcast-App oder der Dienst verfügbar ist.'
  UNION ALL SELECT 'podcasts', 'platform_apps', 'web_player_available', 'Web player available', 'Web-Player verfügbar', 'boolean', 'beneficial', 'optional', 5020, 'Whether the service provides a browser-based web player for listening without installing an app.', 'Ob der Dienst einen browserbasierten Web-Player zum Hören ohne App-Installation bereitstellt.'
  UNION ALL SELECT 'podcasts', 'platform_apps', 'smart_speaker_support', 'Smart speaker support', 'Smart-Speaker-Unterstützung', 'multi_enum', 'informational', 'multi_select', 5030, 'Which smart speaker ecosystems are supported for voice-controlled podcast playback.', 'Welche Smart-Speaker-Ökosysteme für sprachgesteuerte Podcast-Wiedergabe unterstützt werden.'
  UNION ALL SELECT 'podcasts', 'platform_apps', 'car_integration', 'Car integration', 'Auto-Integration', 'multi_enum', 'informational', 'multi_select', 5040, 'Which automotive infotainment integrations are supported for in-car podcast listening.', 'Welche Automobil-Infotainment-Integrationen für das Podcast-Hören im Auto unterstützt werden.'
  UNION ALL SELECT 'podcasts', 'platform_apps', 'api_available', 'API available', 'API verfügbar', 'boolean', 'beneficial', 'optional', 5050, 'Whether the platform provides a public API for developers to build integrations and extensions.', 'Ob die Plattform eine öffentliche API für Entwickler zum Erstellen von Integrationen und Erweiterungen bereitstellt.'
  UNION ALL SELECT 'podcasts', 'privacy_data', 'data_processing_location', 'Data processing location', 'Datenverarbeitungsstandort', 'enum', 'tradeoff', 'must_match', 6010, 'The geographic region where user data and listening analytics are processed and stored.', 'Die geografische Region, in der Benutzerdaten und Höranalysen verarbeitet und gespeichert werden.'
  UNION ALL SELECT 'podcasts', 'privacy_data', 'listening_data_collection', 'Listening data collection', 'Hördaten-Erfassung', 'enum', 'risk', 'optional', 6020, 'How much listening behavior data the platform collects and how it is used or shared.', 'Wie viele Hörverhaltensdaten die Plattform sammelt und wie diese verwendet oder weitergegeben werden.'
  ...
  UNION ALL SELECT 'podcasts', 'privacy_data', 'data_export_available', 'Data export available', 'Datenexport verfügbar', 'boolean', 'beneficial', 'optional', 6050, 'Whether users can export their listening history, subscriptions, and personal data from the platform.', 'Ob Benutzer ihren Hörverlauf, Abonnements und persönliche Daten von der Plattform exportieren können.'
  UNION ALL SELECT 'podcasts', 'openness_standards', 'source_code_model', 'Source code model', 'Quellcode-Modell', 'enum', 'tradeoff', 'optional', 7010, 'The availability and openness of the podcast tool source code for independent review and contribution.', 'Die Verfügbarkeit und Offenheit des Podcast-Werkzeug-Quellcodes für unabhängige Überprüfung und Beiträge.'
  ...
  UNION ALL SELECT 'podcasts', 'openness_standards', 'podcasting_2_0_support', 'Podcasting 2.0 support', 'Podcasting-2.0-Unterstützung', 'multi_enum', 'informational', 'multi_select', 7030, 'Which Podcasting 2.0 namespace features are supported by the player or hosting platform.', 'Welche Podcasting-2.0-Namespace-Funktionen vom Player oder der Hosting-Plattform unterstützt werden.'
  UNION ALL SELECT 'podcasts', 'openness_standards', 'open_protocol_commitment', 'Open protocol commitment', 'Offenes-Protokoll-Engagement', 'enum', 'informational', 'optional', 7040, 'Whether the platform prioritizes open RSS-based distribution or proprietary delivery channels.', 'Ob die Plattform offene RSS-basierte Verbreitung oder proprietäre Vertriebskanäle priorisiert.'
  UNION ALL SELECT 'podcasts', 'openness_standards', 'self_hosting_available', 'Self-hosting available', 'Selbst-Hosting verfügbar', 'boolean', 'beneficial', 'must_match', 7050, 'Whether the podcast platform can be installed and operated on self-managed infrastructure.', 'Ob die Podcast-Plattform auf selbstverwalteter Infrastruktur installiert und betrieben werden kann.'
  UNION ALL SELECT 'podcasts', 'pricing_fit', 'pricing_model', 'Pricing model', 'Preismodell', 'enum', 'informational', 'optional', 8010, 'The pricing structure for using the podcast tool, from free to subscription to pay-per-use.', 'Die Preisstruktur für die Nutzung des Podcast-Werkzeugs, von kostenlos über Abonnement bis Nutzungsgebühr.'
  UNION ALL SELECT 'podcasts', 'pricing_fit', 'free_tier_available', 'Free tier available', 'Kostenlose Version verfügbar', 'boolean', 'informational', 'must_match', 8020, 'Whether a functional free version is available without payment or time-limited trial restrictions.', 'Ob eine funktionsfähige kostenlose Version ohne Zahlungs- oder zeitlich begrenzte Testbeschränkungen verfügbar ist.'
  UNION ALL SELECT 'podcasts', 'pricing_fit', 'free_tier_limitations', 'Free tier limitations', 'Einschränkungen der kostenlosen Version', 'multi_enum', 'tradeoff', 'multi_select', 8030, 'The restrictions and limitations imposed on the free tier of the podcast tool.', 'Die Einschränkungen und Begrenzungen, die für die kostenlose Version des Podcast-Werkzeugs gelten.'
  UNION ALL SELECT 'podcasts', 'pricing_fit', 'fit_profiles', 'Fit profiles', 'Eignungsprofile', 'multi_enum', 'informational', 'multi_select', 8040, 'Target user roles and use cases the podcast tool is best suited for based on its feature set.', 'Zielbenutzerrollen und Anwendungsfälle, für die das Podcast-Werkzeug basierend auf seinem Funktionsumfang am besten geeignet ist.'
) AS d
...
FROM (
  ...
  UNION ALL SELECT 'podcasts', 'feed_protocol_support', 'proprietary', 'Proprietary feed', 'Proprietärer Feed', 'neutral', 40
  ...
  UNION ALL SELECT 'podcasts', 'hosting_type', 'full_hosting', 'Full hosting', 'Vollständiges Hosting', 'neutral', 10
  ...
  UNION ALL SELECT 'podcasts', 'monetization_model', 'listener_donations', 'Listener donations', 'Hörer-Spenden', 'neutral', 10
  ...
  UNION ALL SELECT 'podcasts', 'data_processing_location', 'eu_primary', 'EU primary', 'EU primär', 'neutral', 20
  ...
  UNION ALL SELECT 'podcasts', 'listening_data_collection', 'personal_profiling', 'Personal profiling', 'Persönliche Profilierung', 'warning', 30
  ...
  UNION ALL SELECT 'podcasts', 'source_code_model', 'fully_open', 'Fully open', 'Vollständig offen', 'positive', 10
  UNION ALL SELECT 'podcasts', 'source_code_model', 'source_available', 'Source available', 'Quellcode verfügbar', 'neutral', 20
  UNION ALL SELECT 'podcasts', 'source_code_model', 'partially_open', 'Partially open', 'Teilweise offen', 'neutral', 30
  UNION ALL SELECT 'podcasts', 'source_code_model', 'proprietary', 'Proprietary', 'Proprietär', 'warning', 40
  ...
  UNION ALL SELECT 'podcasts', 'license_type', 'proprietary', 'Proprietary', 'Proprietär', 'neutral', 60
  ...
  UNION ALL SELECT 'podcasts', 'open_protocol_commitment', 'proprietary_first', 'Proprietary first', 'Proprietär zuerst', 'warning', 20
  ...
  UNION ALL SELECT 'podcasts', 'free_tier_limitations', 'analytics_limited', 'Limited analytics', 'Eingeschränkte Analysen', 'neutral', 40
  UNION ALL SELECT 'podcasts', 'free_tier_limitations', 'bandwidth_cap', 'Bandwidth cap', 'Bandbreitenbegrenzung', 'neutral', 50
  UNION ALL SELECT 'podcasts', 'fit_profiles', 'casual_listener', 'Casual listener', 'Gelegenheitshörer', 'neutral', 10
  UNION ALL SELECT 'podcasts', 'fit_profiles', 'power_listener', 'Power listener', 'Intensivhörer', 'neutral', 20
