...
const expectedGroups = [
  ...
  },
  {
    ...
    germanHints: ["schreiben", "produktivität"],
    sortOrder: 400,
  },
  {
  ...
  },
  {
    ...
    germanHints: ["verschlüsselung", "signaturen"],
    sortOrder: 600,
  },
  {
    key: "data_portability_sync",
    labelEn: "Data, Portability & Sync",
    germanHints: ["daten", "portabilität"],
    sortOrder: 700,
  },
  {
...
const expectedCriteria: CriterionExpectation[] = [
  ...
  },
  {
    ...
    germanHints: ["unterstützte", "plattformen"],
  ...
  },
  {
    ...
    germanHints: ["unterstützte", "kontotypen"],
    valueType: "multi_enum",
    semantics: "informational",
    filterMode: "multi_select",
    sortOrder: 2010,
  ...
  },
  {
    ...
    germanHints: ["oauth2", "kontounterstützung"],
    valueType: "multi_enum",
    semantics: "beneficial",
    filterMode: "multi_select",
    sortOrder: 2030,
  ...
  },
  {
    ...
    germanHints: ["identitäts", "aliasverwaltung"],
    valueType: "multi_enum",
    semantics: "informational",
    filterMode: "multi_select",
    sortOrder: 2050,
  ...
  },
  {
    ...
    germanHints: ["proxy", "tor-unterstützung"],
    valueType: "multi_enum",
    semantics: "tradeoff",
    filterMode: "multi_select",
    sortOrder: 5060,
  },
  {
    ...
    germanHints: ["openpgp", "unterstützung"],
    valueType: "enum",
    semantics: "tradeoff",
    filterMode: "must_match",
    sortOrder: 6010,
  },
  {
    ...
    germanHints: ["s/mime", "unterstützung"],
    valueType: "enum",
    semantics: "tradeoff",
    filterMode: "optional",
    sortOrder: 6020,
  },
  {
    ...
    germanHints: ["autocrypt", "unterstützung"],
    valueType: "boolean",
    semantics: "beneficial",
    filterMode: "optional",
    sortOrder: 6030,
  },
  {
    ...
    germanHints: ["schlüsselverwaltung"],
    valueType: "enum",
    semantics: "tradeoff",
    filterMode: "optional",
    sortOrder: 6040,
  },
  {
    ...
    germanHints: ["verschlüsselter", "lokaler", "speicher"],
    valueType: "boolean",
    semantics: "beneficial",
    filterMode: "optional",
    sortOrder: 6050,
  },
  {
    ...
    germanHints: ["verschlüsselungsrichtlinie", "empfänger"],
    valueType: "boolean",
    semantics: "beneficial",
    filterMode: "optional",
    sortOrder: 6060,
  ...
  },
  {
    ...
    germanHints: ["profil-backup", "portabilität"],
    valueType: "enum",
    semantics: "beneficial",
    filterMode: "optional",
    sortOrder: 7040,
  },
  {
    ...
    germanHints: ["kontakte-sync", "unterstützung"],
    valueType: "multi_enum",
    semantics: "beneficial",
    filterMode: "multi_select",
    sortOrder: 7050,
  },
  {
    ...
    germanHints: ["kalender-sync", "unterstützung"],
    valueType: "multi_enum",
    semantics: "beneficial",
    filterMode: "multi_select",
    sortOrder: 7060,
  },
  {
    ...
    germanHints: ["add-on", "erweiterungsunterstützung"],
    valueType: "boolean",
    semantics: "tradeoff",
    filterMode: "optional",
    sortOrder: 8010,
