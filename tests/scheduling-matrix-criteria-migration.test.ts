...
const categoryId = "scheduling";
const migrationVersion = "041-scheduling-matrix-criteria";
const migrationUrl = new URL(
  "../scripts/migrations/041-scheduling-matrix-criteria.sql",
  import.meta.url,
);
...
const expectedGroups = [
  {
    key: "booking_types",
    labelEn: "Booking Types & Formats",
    sortOrder: 100,
  },
  {
    key: "availability_management",
    labelEn: "Availability & Time Rules",
    sortOrder: 200,
  },
  {
    key: "booking_pages",
    labelEn: "Booking Pages & Customization",
    sortOrder: 300,
  },
  {
    key: "calendar_integrations",
    labelEn: "Calendar & Conferencing",
    sortOrder: 400,
  },
  {
    key: "notifications_workflows",
    labelEn: "Notifications & Workflows",
    sortOrder: 500,
  },
  {
    key: "team_routing",
    labelEn: "Team Scheduling & Routing",
    sortOrder: 600,
  },
  {
    key: "privacy_data",
...
const expectedCriteria: CriterionExpectation[] = [
  // Group 1: Booking Types & Formats (100)
  {
    key: "one_on_one_booking",
    groupKey: "booking_types",
    labelEn: "One-on-one booking",
    valueType: "boolean",
  ...
  {
    key: "round_robin_assignment",
    groupKey: "booking_types",
    labelEn: "Round-robin assignment",
    valueType: "boolean",
    semantics: "beneficial",
    filterMode: "optional",
    sortOrder: 1030,
  ...
  {
    key: "collective_scheduling",
    groupKey: "booking_types",
    labelEn: "Collective scheduling",
    valueType: "boolean",
    semantics: "beneficial",
    filterMode: "optional",
    sortOrder: 1040,
  },
  {
    ...
    groupKey: "booking_types",
    labelEn: "Recurring appointments",
    valueType: "boolean",
    semantics: "beneficial",
    filterMode: "optional",
    sortOrder: 1050,
  ...
  {
    key: "event_type_variety",
    groupKey: "booking_types",
    labelEn: "Event type variety",
    valueType: "enum",
    semantics: "informational",
    filterMode: "optional",
    sortOrder: 1060,
  },
  // Group 2: Availability & Time Rules (200)
  {
    key: "calendar_connected_availability",
    groupKey: "availability_management",
    labelEn: "Calendar-connected availability",
    valueType: "boolean",
    semantics: "beneficial",
  ...
  },
  {
    key: "buffer_times",
    groupKey: "availability_management",
    labelEn: "Buffer times between bookings",
    valueType: "boolean",
    semantics: "beneficial",
    filterMode: "optional",
    sortOrder: 2030,
  },
  {
    key: "booking_limits",
    groupKey: "availability_management",
    labelEn: "Daily / weekly booking limits",
    valueType: "boolean",
    semantics: "beneficial",
    filterMode: "optional",
    sortOrder: 2040,
  ...
  {
    key: "date_range_restrictions",
    groupKey: "availability_management",
    labelEn: "Date range restrictions",
    valueType: "boolean",
    semantics: "informational",
    filterMode: "optional",
    sortOrder: 2060,
  },
  // Group 3: Booking Pages & Customization (300)
  {
    key: "branded_booking_pages",
    groupKey: "booking_pages",
    labelEn: "Branded booking pages",
    valueType: "boolean",
    semantics: "beneficial",
    filterMode: "optional",
    sortOrder: 3010,
  ...
  {
    key: "multi_event_page",
    groupKey: "booking_pages",
    labelEn: "Multi-event-type page",
    valueType: "boolean",
    semantics: "informational",
    filterMode: "optional",
    sortOrder: 3040,
  },
  {
    ...
    groupKey: "booking_pages",
    labelEn: "Custom booking questions",
    valueType: "boolean",
    semantics: "beneficial",
    filterMode: "optional",
    sortOrder: 3050,
  },
  // Group 4: Calendar & Conferencing (400)
  {
    key: "calendar_providers",
    groupKey: "calendar_integrations",
    labelEn: "Calendar provider support",
  ...
  {
    key: "two_way_calendar_sync",
    groupKey: "calendar_integrations",
    labelEn: "Two-way calendar sync",
    valueType: "boolean",
    semantics: "beneficial",
    filterMode: "must_match",
    sortOrder: 4020,
  ...
  {
    key: "conferencing_auto_link",
    groupKey: "calendar_integrations",
    labelEn: "Conferencing auto-link",
    valueType: "multi_enum",
    semantics: "informational",
    filterMode: "multi_select",
    sortOrder: 4030,
  },
  {
    key: "ical_feed",
    groupKey: "calendar_integrations",
    labelEn: "iCal feed support",
    valueType: "boolean",
    semantics: "informational",
    filterMode: "optional",
    sortOrder: 4040,
  },
  // Group 5: Notifications & Workflows (500)
  {
    key: "email_confirmations",
    groupKey: "notifications_workflows",
    labelEn: "Email confirmations",
    valueType: "boolean",
    semantics: "beneficial",
    filterMode: "optional",
    sortOrder: 5010,
  ...
  },
  {
    ...
    groupKey: "notifications_workflows",
    labelEn: "Cancellation / rescheduling",
    valueType: "enum",
    semantics: "informational",
    filterMode: "optional",
    sortOrder: 5030,
  ...
  // Group 6: Team Scheduling & Routing (600)
  {
    key: "team_member_pages",
    groupKey: "team_routing",
    labelEn: "Team member pages",
    valueType: "boolean",
    semantics: "beneficial",
    filterMode: "optional",
    sortOrder: 6010,
  ...
  {
    key: "managed_team_availability",
    groupKey: "team_routing",
    labelEn: "Managed team availability",
    valueType: "boolean",
    semantics: "beneficial",
    filterMode: "optional",
    sortOrder: 6030,
  ...
  {
    key: "event_type_limit_free",
    groupKey: "pricing_fit",
    labelEn: "Event type limit (free tier)",
    valueType: "enum",
    semantics: "informational",
    filterMode: "optional",
    sortOrder: 9030,
...
describe("scheduling matrix criteria migration", () => {
  it("adds the repository-owned migration for scheduling matrix metadata", () => {
  ...
  it("defines ordered scheduling criterion groups with localized labels", () => {
  ...
  it("defines category-native scheduling criteria with valid metadata and localized copy", () => {
  ...
  it("creates only open placeholder facts and avoids Trust Score or product fact values", () => {
    ...
    expect(normalizedFactSql).toMatch(
      /\bJOIN\s+`?entry_categories`?\s+ec\s+ON\s+ec\.entry_id\s*=\s*ce\.id\s+AND\s+ec\.category_id\s*=\s*'scheduling'/i,
    );
    expect(normalizedFactSql).toMatch(
      /\bJOIN\s+`?matrix_criteria`?\s+mc\s+ON\s+mc\.category_id\s*=\s*'scheduling'\s+WHERE\b/i,
    );
