...
const expectedGroups = [
  ...
  },
  {
    ...
    germanHints: ["wiederherstellung", "portabilitaet"],
    sortOrder: 600,
  },
  {
...
const expectedCriteria: CriterionExpectation[] = [
  ...
  },
  {
    ...
    germanHints: ["maximale", "einzeldateigroesse"],
    valueType: "number",
    semantics: "informational",
    filterMode: "range",
    sortOrder: 1040,
  ...
  },
  {
    ...
    germanHints: ["verschluesselungsmodell"],
    valueType: "enum",
    semantics: "tradeoff",
    filterMode: "must_match",
    sortOrder: 4010,
  },
  {
    ...
    germanHints: ["verschluesselte", "freigabe"],
    valueType: "boolean",
    semantics: "beneficial",
    filterMode: "optional",
    sortOrder: 4020,
  ...
  },
  {
    ...
    germanHints: ["kundenseitig", "schluessel"],
    valueType: "boolean",
    semantics: "tradeoff",
    filterMode: "optional",
    sortOrder: 4050,
  ...
  },
  {
    ...
    germanHints: ["nutzerwaehlbare", "region"],
    valueType: "boolean",
    semantics: "beneficial",
    filterMode: "optional",
    sortOrder: 5030,
  ...
  },
  {
    ...
    germanHints: ["geloeschter", "dateien"],
    valueType: "number",
    semantics: "beneficial",
    filterMode: "range",
    sortOrder: 6030,
  ...
  },
  {
    ...
    germanHints: ["integrationsunterstuetzung"],
    valueType: "multi_enum",
    semantics: "informational",
    filterMode: "multi_select",
    sortOrder: 7070,
