...
const expectedGroups = [
  ...
  },
  {
    ...
    germanHints: ["verschlüsselung", "datenschutz"],
    sortOrder: 500,
  },
  {
  ...
  },
  {
    ...
    germanHints: ["migration", "portabilität"],
    sortOrder: 700,
  },
  {
    key: "suite_productivity",
    labelEn: "Suite & Productivity",
    germanHints: ["suite", "produktivität"],
    sortOrder: 800,
  },
  {
    key: "team_admin",
...
const expectedCriteria: CriterionExpectation[] = [
  ...
  },
  {
    ...
    germanHints: ["maximale", "anhanggröße"],
    valueType: "number",
    semantics: "informational",
    filterMode: "range",
    sortOrder: 1040,
  ...
  },
  {
    ...
    germanHints: ["hardware-sicherheitsschlüssel"],
    valueType: "boolean",
    semantics: "beneficial",
    filterMode: "optional",
    sortOrder: 4020,
  ...
  },
  {
    ...
    germanHints: ["postfach", "verschlüsselungsmodell"],
    valueType: "enum",
    semantics: "tradeoff",
    filterMode: "must_match",
    sortOrder: 5010,
  },
  {
    ...
    germanHints: ["e2ee", "standardmäßig"],
    valueType: "boolean",
    semantics: "beneficial",
    filterMode: "must_match",
    sortOrder: 5020,
  },
  {
    ...
    germanHints: ["verschlüsselte", "externe"],
    valueType: "enum",
    semantics: "tradeoff",
    filterMode: "optional",
    sortOrder: 5030,
  ...
  },
  {
    ...
    germanHints: ["datenregion", "postfächer"],
    valueType: "enum",
    semantics: "tradeoff",
    filterMode: "must_match",
    sortOrder: 6010,
  },
  {
    ...
    germanHints: ["eu-postfachspeicherung", "verfügbar"],
    valueType: "boolean",
    semantics: "beneficial",
    filterMode: "must_match",
    sortOrder: 6020,
  ...
  },
  {
    ...
    germanHints: ["av-vertrag", "verfügbar"],
    valueType: "boolean",
    semantics: "informational",
    filterMode: "optional",
    sortOrder: 6040,
  ...
  },
  {
    ...
    germanHints: ["postfach-export", "verfügbar"],
    valueType: "enum",
    semantics: "beneficial",
    filterMode: "optional",
    sortOrder: 7020,
  ...
  },
  {
    ...
    germanHints: ["produktivitäts-suite"],
    valueType: "multi_enum",
    semantics: "informational",
    filterMode: "multi_select",
    sortOrder: 8030,
